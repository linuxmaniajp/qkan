...
/**
 * 利用者一覧(訪問看護療養費領収書)状態定義(QP010) 
 */
public class QP010State extends QP010Design {
  /**
   * コンストラクタです。
   */
  public QP010State(){
   ...
   */
  public void setState_VALID_DETAIL() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_INVALID_DETAIL() throws Exception {
