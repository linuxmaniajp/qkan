 ...
 * アプリ: QKANCHO
 * 開発者: 藤原　伸
 * 作成日: 2016/12/15  日本コンピューター株式会社 藤原　伸 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 請求データ作成 (P)
 * プロセス 確認・修正 (003)
...
public class QP003Design extends QkanAffairContainer implements ACAffairable {
  ...
  /**
   * 全額自己負担分医療費控除対象タイトルを取得します。
   * @return 全額自己負担分医療費控除対象タイトル
   */
  public ACTextField getContentJikohutanKoujoTitle(){
    if(contentJikohutanKoujoTitle==null){
      ...
      contentJikohutanKoujoTitle.setText("医療費控除");
  ...
  /**
   * 全額自己負担分医療費控除対象１を取得します。
   * @return 全額自己負担分医療費控除対象１
   */
  ...
  /**
   * 全額自己負担分医療費控除対象２を取得します。
   * @return 全額自己負担分医療費控除対象２
   */
  ...
  /**
   * 全額自己負担分医療費控除対象３を取得します。
   * @return 全額自己負担分医療費控除対象３
   */
  ...
  /**
   * 全額自己負担分医療費控除対象小計を取得します。
   * @return 全額自己負担分医療費控除対象小計
   */
  ...
  public ACTextField getContentEtcKoujoTitle(){
    if(contentEtcKoujoTitle==null){
      ...
      contentEtcKoujoTitle.setText("医療費控除");
  ...
  public ACIntegerCheckBox getKoujoDispCheck(){
    if(koujoDispCheck==null){
      ...
      koujoDispCheck.setText("医療費控除計算の補助を表示する");
  ...
  public ACTextField getContentHokenHimokuTitle(){
    if(contentHokenHimokuTitle==null){
      ...
      contentHokenHimokuTitle.setText("介護保険");
  ...
  public ACTextField getContentHokenUseTitle(){
    if(contentHokenUseTitle==null){
      ...
      contentHokenUseTitle.setText("利用者負担額");
  ...
  /**
   * 介護保険医療費控除対象タイトルを取得します。
   * @return 介護保険医療費控除対象タイトル
   */
  public ACTextField getContentHokenKoujoTitle(){
    if(contentHokenKoujoTitle==null){
      ...
      contentHokenKoujoTitle.setText("医療費控除");
  ...
  /**
   * 介護保険医療系自己負担分費目を取得します。
   * @return 介護保険医療系自己負担分費目
   */
  public ACTextField getContentHokenIryoHimoku(){
    if(contentHokenIryoHimoku==null){
      ...
      contentHokenIryoHimoku.setText("医療系サービス");
  ...
  /**
   * 介護保険医療系自己負担分利用料を取得します。
   * @return 介護保険医療系自己負担分利用料
   */
  ...
  /**
   * 介護保険医療系自己負担分医療費控除対象を取得します。
   * @return 介護保険医療系自己負担分医療費控除対象
   */
  ...
  /**
   * 介護保険福祉系自己負担分費目を取得します。
   * @return 介護保険福祉系自己負担分費目
   */
  public ACTextField getContentHokenFukushiHimoku(){
    if(contentHokenFukushiHimoku==null){
      ...
      contentHokenFukushiHimoku.setText("福祉系サービス");
  ...
  /**
   * 介護保険福祉系自己負担分利用料を取得します。
   * @return 介護保険福祉系自己負担分利用料
   */
  ...
  /**
   * 介護保険福祉系自己負担分医療費控除対象を取得します。
   * @return 介護保険福祉系自己負担分医療費控除対象
   */
  ...
  public ACLabel getContentKoujyoLabelMemo(){
    if(contentKoujyoLabelMemo==null){
      ...
      contentKoujyoLabelMemo.setText("<html><br>・医療費控除のチェック状態は保存されません。<br>・領収書には「うち医療費控除対象額」が印字されます。<br>・訪問介護等で一部対象外となる場合の計算には対応しておりませんので、「うち医療費控除対象額」を直接修正してください。</html>");
  ...
  public ACButton getReflection(){
    if(reflection==null){
      ...
      reflection.setToolTipText("チェックを入れた項目の合計を医療費控除対象額へ反映します。");
  ...
  public ACLabel getContentKoujyoLabel2(){
    if(contentKoujyoLabel2==null){
      ...
      contentKoujyoLabel2.setText("医療費控除チェック合計");
  ...
  protected void addTabs(){
    ...
    tabs.addTab("備考", getContentBikou());
  ...
  /**
   * 介護保険医療系自己負担分医療費控除対象に内部項目を追加します。
   */
  ...
  /**
   * 介護保険福祉系自己負担分医療費控除対象に内部項目を追加します。
   */
