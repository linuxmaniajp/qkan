    ...
    public void doFindKoujo() throws Exception {
        ...
        for (int i = 0; i < koujoList.size(); i++) {
            ...
            if ("13".equals(serviceCodeKind) || "14".equals(serviceCodeKind) || "16".equals(serviceCodeKind)
                ...
                || ("".equals(serviceCodeKind) && styleType == QkanConstants.CLAIM_STYLE_FORMAT_4_3)// 特定入所者 短期介護医療院 H30.4改正対応
                || ("".equals(serviceCodeKind) && styleType == QkanConstants.CLAIM_STYLE_FORMAT_4_4)// 特定入所者 予防短期介護医療院 H30.4改正対応
                ...
                || ("".equals(serviceCodeKind) && styleType == QkanConstants.CLAIM_STYLE_FORMAT_9_2)// 特定入所者 介護医療院 H30.4改正対応
