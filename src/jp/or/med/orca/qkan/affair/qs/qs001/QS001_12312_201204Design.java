...
/**
 * サービスパターン短期入所療養介護（診療所療養）画面項目デザイン(QS001_12312_201204) 
 */
public class QS001_12312_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_12312_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12312_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12312_201204Design getThis() {
    return this;
  }
}
