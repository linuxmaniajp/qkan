...
/**
 * サービスパターン介護予防認知症対応型共同生活介護（短期利用以外）イベント定義(QS001148_H2104) 
 */
public abstract class QS001148_H2104Event extends QS001148_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001148_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
