...
/**
 * サービスパターンその他の生活支援サービス(その他定率)画面項目デザイン(QS001_51311_201504) 
 */
public class QS001_51311_201504Design extends QS001ServicePanelSogo {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_51311_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_51311_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_51311_201504Design getThis() {
    return this;
  }
}
