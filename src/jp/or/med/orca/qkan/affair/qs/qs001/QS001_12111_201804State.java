...
/**
 * サービスパターン短期入所生活介護状態定義(QS001_12111_201804) 
 */
public class QS001_12111_201804State extends QS001_12111_201804Design {
  /**
   * コンストラクタです。
   */
  public QS001_12111_201804State(){
  }
  ...
  public void setState_CONVENTIONAL_FORM() throws Exception {
        ...
        getSymbiosisTypeRadio().setEnabled(false);
        getSymbiosisTypeRadio().getParent().setEnabled(false);

        getDeploymentLifeCounselor().setEnabled(false);
        getDeploymentLifeCounselor().getParent().setEnabled(false);
   ...
   * @throws Exception 処理例外
   */
  public void setState_ADJOINING_FORM() throws Exception {
        ...
        getSymbiosisTypeRadio().setEnabled(true);
        getSymbiosisTypeRadio().getParent().setEnabled(true);

        getDeploymentLifeCounselor().setEnabled(true);
        getDeploymentLifeCounselor().getParent().setEnabled(true);
   ...
   * @throws Exception 処理例外
   */
  public void setState_VALID_STAY_PEOPLE_COUNT() throws Exception {

        getStayPeopleCountRadioGroup().setEnabled(true);
        getStayPeopleCountRadioGroup().getParent().setEnabled(true);
   ...
   * @throws Exception 処理例外
   */
  public void setState_INVALID_STAY_PEOPLE_COUNT() throws Exception {

        getStayPeopleCountRadioGroup().setEnabled(false);
        getStayPeopleCountRadioGroup().getParent().setEnabled(false);
