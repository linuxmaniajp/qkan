...
/**
 * サービスパターン通所型サービス(独自)イベント定義(QS001_50611_201804) 
 */
public abstract class QS001_50611_201804Event extends QS001_50611_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_50611_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
