...
/**
 * サービスパターン特定施設入所者生活介護(QS001_13311_201204)
 */
@SuppressWarnings("serial")
public class QS001_13311_201204 extends QS001_13311_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_13311_201204() {
        // 必須の事業所設定項目
        putCheckProviderBindPath("介護職員処遇改善加算", "4");

        // 値を転記する事業所設定項目
        putImportProviderBindPath("人員配置区分", "1330103", "1330105");
        putImportProviderBindPath("個別機能訓練指導加算", "1330101", "1330103");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_13311_201204.class.getName(),
                param));
    }
