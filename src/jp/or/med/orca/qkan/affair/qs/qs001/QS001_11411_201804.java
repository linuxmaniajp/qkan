...
/**
 * サービスパターン訪問リハ(QS001_11411_201804)
 */
@SuppressWarnings("serial")
public class QS001_11411_201804 extends QS001_11411_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_11411_201804() {

        // 値を転記する事業所設定項目
        putImportProviderBindPath("施設区分", "1140101", "1140103");
        putImportProviderBindPath("サービス提供体制強化加算", "1140102", "1140107");
        putImportProviderBindPath("リハビリテーション・マネジメント加算", "1140104", "1140110");
        putImportProviderBindPath("社会参加支援加算", "1140105", "1140112");

        // 値により入力を禁止する事業所設定項目
        putRestrictProviderBindPath("社会参加支援加算", "1140105", "1140112");
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_11411_201804.class.getName(),
                param));
    }
    ...
    public VRMap getValidData() throws Exception {
        ...
        if (!getHoumonRehabilitationFacilityDivision().isSelected()) {
            // 施設区分(houmonRehabilitationFacilityDivision)が未選択の場合
        ...
        if ((!getHoumonRehabilitationBeginTime().isValidDate())
            ...
            // 開始時刻コンボ(houmonRehabilitationBeginTime)と終了時刻コンボ(houmonRehabilitationEndTime)のいずれかが空欄もしくは不正の場合
