...
/**
 * サービスパターン介護予防短期入所療養介護（病院）イベント定義(QS001_12611_201804) 
 */
@SuppressWarnings("serial")
public abstract class QS001_12611_201804Event extends QS001_12611_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12611_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int SYSTEM_SERVICE_KIND_DETAIL = 12611;
  //getter/setter
