...
/**
 * サービスパターン介護予防通所介護イベント定義(QS001135_H2104) 
 */
public abstract class QS001135_H2104Event extends QS001135_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001135_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
   ...
   *
   */
  public abstract void checkActivityState() throws Exception;
