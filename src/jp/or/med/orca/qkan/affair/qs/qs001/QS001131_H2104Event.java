...
/**
 * サービスパターン介護予防訪問入浴介護イベント定義(QS001131_H2104) 
 */
public abstract class QS001131_H2104Event extends QS001131_H2104Design implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001131_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
