 ...
 * アプリ: QKANCHO
 * 開発者: 小笠　貴志
 * 作成日: 2006/03/24  日本コンピューター株式会社 小笠　貴志 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン特定施設入所者生活介護イベント定義(QS001115) 
 */
public abstract class QS001115Event extends QS001115State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001115Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
