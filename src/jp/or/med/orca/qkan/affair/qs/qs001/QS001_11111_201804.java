...
/**
 * サービスパターン訪問介護(QS001_11111_201804)
 */
@SuppressWarnings("serial")
public class QS001_11111_201804 extends QS001_11111_201804Event {
	
	
    /**
     * コンストラクタです。
     */
    public QS001_11111_201804() {
        // 必須の事業所設定項目
...
// 2015/2/26 [H27.4改正対応][Yoichiro Kamei] add - end
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_11111_201804.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            obj = VRBindPathParser.get("1110106", provider);
            if (obj != null) {
                // 事業所登録の設定項目に合わせ初期値を調整
                switch (ACCastUtilities.toInt(obj)) {
                case 2: // ありだった場合
                    VRBindPathParser.set("22", defaultMap, new Integer(4));
                    break;
                }
            }
            // 共生型サービスの提供（居宅介護事業所）
            obj = VRBindPathParser.get("1110105", provider);
            if (obj != null) {
                // 事業所登録の設定項目に合わせ初期値を調整
                switch (ACCastUtilities.toInt(obj)) {
                case 2: // ありだった場合
                    VRBindPathParser.set("22", defaultMap, new Integer(3));
                    break;
                }
            }
            // 2018/02/20 [H30.4改正対応][Yoichiro Kamei] add - begin
