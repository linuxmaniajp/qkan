...
/**
 * サービスパターン介護予防通所リハビリテーションイベント定義(QS001136_H2104) 
 */
public abstract class QS001136_H2104Event extends QS001136_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001136_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
