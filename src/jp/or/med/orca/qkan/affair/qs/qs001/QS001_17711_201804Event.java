 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン複合型サービスI (QS001_17711_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン複合型サービス（看護小規模多機能型居宅介護・短期利用以外）イベント定義(QS001_17711_201804) 
 */
public abstract class QS001_17711_201804Event extends QS001_17711_201804SQL implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_17711_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
