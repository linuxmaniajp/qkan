 ...
 * アプリ: QKANCHO
 * 開発者: 堤 瑞樹
 * 作成日: 2006/01/30  日本コンピューター株式会社 堤 瑞樹 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
...
/**
 * サービスパターン短期入所療養介護(介護老人保健施設)イベント定義(QS001012) 
 */
public abstract class QS001012Event extends QS001012State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001012Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
