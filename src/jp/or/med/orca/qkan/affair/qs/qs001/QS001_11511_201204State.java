 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2012/03/01  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
...
/**
 * サービスパターン通所介護状態定義(QS001_11511_201204) 
 */
public class QS001_11511_201204State extends QS001_11511_201204Design {
  /**
   * コンストラクタです。
   */
  public QS001_11511_201204State(){
  }
