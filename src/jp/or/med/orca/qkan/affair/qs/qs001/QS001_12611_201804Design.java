...
/**
 * サービスパターン介護予防短期入所療養介護（病院）画面項目デザイン(QS001_12611_201804) 
 */
public class QS001_12611_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getShortStayHospitalRecuperationInstitutionDivisionRadioItem3(){
    if(shortStayHospitalRecuperationInstitutionDivisionRadioItem3==null){
      ...
      shortStayHospitalRecuperationInstitutionDivisionRadioItem3.setText("病院経過型");
  ...
  public ACRadioButtonItem getMedicalFacilityHospitalHospitalInstitutionDivisionRadioItem4(){
    if(medicalFacilityHospitalHospitalInstitutionDivisionRadioItem4==null){
      ...
      medicalFacilityHospitalHospitalInstitutionDivisionRadioItem4.setText("ユニット型病院経過型");
  ...
  public ACValueArrayRadioButtonGroup getShortStayHospitalRecuperationType(){
    if(shortStayHospitalRecuperationType==null){
      ...
      shortStayHospitalRecuperationType.setBindPath("1260105");
  ...
  public ACRadioButtonItem getShortStayHospitalRecuperationAdditionTypeNormal(){
    if(shortStayHospitalRecuperationAdditionTypeNormal==null){
      ...
      shortStayHospitalRecuperationAdditionTypeNormal.setGroup(getShortStayHospitalRecuperationType());
  ...
  public ACRadioButtonItem getShortStayHospitalRecuperationAdditionTypeNone(){
    if(shortStayHospitalRecuperationAdditionTypeNone==null){
      ...
      shortStayHospitalRecuperationAdditionTypeNone.setGroup(getShortStayHospitalRecuperationType());
  ...
  public ACValueArrayRadioButtonGroup getShortStayHospitalRecuperationAdditionType(){
    if(shortStayHospitalRecuperationAdditionType==null){
      ...
      shortStayHospitalRecuperationAdditionType.setBindPath("1260120");
  ...
  public ACValueArrayRadioButtonGroup getDementiaProfessionalCareAddRadioGroup(){
    if(dementiaProfessionalCareAddRadioGroup==null){
      ...
      dementiaProfessionalCareAddRadioGroup.setBindPath("1260121");
   ...
   * コンストラクタです。
   */
  public QS001_12611_201804Design() {
  ...
  protected void addTab1(){
    ...
    tab1.add(getShortStayHospitalRecuperationTypeContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addShortStayHospitalRecuperationTypeModel(){
    ...
    getShortStayHospitalRecuperationTypeModel().add(getShortStayHospitalRecuperationAdditionTypeNormal());

    getShortStayHospitalRecuperationAdditionTypeNone().setButtonIndex(2);

    getShortStayHospitalRecuperationTypeModel().add(getShortStayHospitalRecuperationAdditionTypeNone());
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12611_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12611_201804Design getThis() {
    return this;
  }
}
