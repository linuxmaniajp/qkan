...
/**
 * サービスパターン介護予防短期入所療養介護（診療所）(QS001140)
 */
public class QS001140 extends QS001140Event {
    /**
     * コンストラクタです。
     */
    public QS001140() {
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            case 2:
                // 値が2（減算型Ⅰ）だった場合
                // defaultMapに KEY：1260205 VALUE：2（減算型Ⅰ）を設定する。
                VRBindPathParser.set("1260205", defaultMap, new Integer(2));
                break;
            case 3:
                // 値が3（減算型Ⅱ）だった場合
