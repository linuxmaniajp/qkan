 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン予防小規模多機能型介護(短期利用) (QS001_16911_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン予防小規模多機能型介護(短期利用)画面項目デザイン(QS001_16911_201804) 
 */
public class QS001_16911_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getRehabilitationSpecialistPersonnelCooperationRadioGroup(){
    if(rehabilitationSpecialistPersonnelCooperationRadioGroup==null){
      ...
      rehabilitationSpecialistPersonnelCooperationRadioGroup.setBindPath("1690104");
   ...
   * コンストラクタです。
   */
  public QS001_16911_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_16911_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_16911_201804Design getThis() {
    return this;
  }
}
