 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン短期入所療養介護（認知症疾患） (QS001_12313_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所療養介護（認知症疾患）(QS001_12313_201204)
 */
@SuppressWarnings("serial")
public class QS001_12313_201204 extends QS001_12313_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_12313_201204() {
        // 必須の事業所設定項目
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12313_201204.class.getName(),
                param));
    }
