 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2006/02/28  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン夜間対応型訪問介護イベント定義(QS001123) 
 */
public abstract class QS001123Event extends QS001123State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001123Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
