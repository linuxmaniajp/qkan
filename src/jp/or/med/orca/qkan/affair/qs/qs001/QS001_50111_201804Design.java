 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン訪問型サービス（みなし） (QS001_50111_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン訪問型サービス（みなし）画面項目デザイン(QS001_50111_201804) 
 */
public class QS001_50111_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_50111_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_50111_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_50111_201804Design getThis() {
    return this;
  }
}
