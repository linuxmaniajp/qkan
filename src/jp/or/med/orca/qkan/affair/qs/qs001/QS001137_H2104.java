 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン介護予防短期入所生活介護 (QS001137_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防短期入所生活介護(QS001137_H2104)
 */
public class QS001137_H2104 extends QS001137_H2104Event {
    /**
     * コンストラクタです。
     */
    public QS001137_H2104() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001137_H2104.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            Object obj;
            // 療養食
            switch (ACCastUtilities.toInt(VRBindPathParser.get("1240117",
                    provider), 0)) {
            case 2:
                // 「あり」の場合
                // 有効にする。
            ...
            // 常にdefaultMapに KEY：1240112 VALUE：1（なし）を設定する。
    ...
    public void checkState() throws Exception {
        ...
        if (providerInfoMap != null) {
            ...
            //若年性認知症利用者受入加算（事業所パネル）KEY：1240116の値をチェックする。
            obj = VRBindPathParser.get("1240116", providerInfoMap);
            switch (ACCastUtilities.toInt(obj,0)) {
            //値が次のいずれかだった場合
            case 2:
                //2（あり）
