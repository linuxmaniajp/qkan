 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2018/03/01  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン短期入所生活介護イベント定義(QS001_12111_201804) 
 */
public abstract class QS001_12111_201804Event extends QS001_12111_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12111_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  protected void addEvents() {
    ...
    getNurseStructuralAddRadioItem2().addActionListener(new ActionListener(){
        private boolean lockFlag = false;
        public void actionPerformed(ActionEvent e) {
            if (lockFlag) {
                return;
            ...
            lockFlag = true;
            try {
                nurseStructuralAddRadioItem2ActionPerformed(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
    ...
    getNurseStructuralAddRadioItem1().addActionListener(new ActionListener(){
        private boolean lockFlag = false;
        public void actionPerformed(ActionEvent e) {
            if (lockFlag) {
                return;
            ...
            lockFlag = true;
            try {
                nurseStructuralAddRadioItem1ActionPerformed(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
    ...
    getNurseStructuralAddRadioItem3().addActionListener(new ActionListener(){
        private boolean lockFlag = false;
        public void actionPerformed(ActionEvent e) {
            if (lockFlag) {
                return;
            ...
            lockFlag = true;
            try {
                nurseStructuralAddRadioItem3ActionPerformed(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
    ...
    getNurseStructuralAddRadioItem4().addActionListener(new ActionListener(){
        private boolean lockFlag = false;
        public void actionPerformed(ActionEvent e) {
            if (lockFlag) {
                return;
            ...
            lockFlag = true;
            try {
                nurseStructuralAddRadioItem4ActionPerformed(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void nurseStructuralAddRadioItem2ActionPerformed(ActionEvent e) throws Exception;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void nurseStructuralAddRadioItem1ActionPerformed(ActionEvent e) throws Exception;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void nurseStructuralAddRadioItem3ActionPerformed(ActionEvent e) throws Exception;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void nurseStructuralAddRadioItem4ActionPerformed(ActionEvent e) throws Exception;
