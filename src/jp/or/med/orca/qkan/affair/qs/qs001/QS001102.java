...
/**
 * サービスパターン訪問入浴介護(QS001102)
 */
public class QS001102 extends QS001102Event {
    /**
     * コンストラクタです。
     */
    public QS001102() {
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001102.class.getName(), param));
    }
    ...
    public void initialize() throws Exception {
        ...
        VRBindPathParser.set("1120103", defaultMap, new Integer(1));
        // 入浴介護区分(homonNyuyokuPartsRadio)の「なし」を選択する。
        VRBindPathParser.set("1120104", defaultMap, new Integer(1));
        // ※展開
