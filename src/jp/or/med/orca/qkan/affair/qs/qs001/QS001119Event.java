 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2006/03/24  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン介護老人保健施設イベント定義(QS001119) 
 */
public abstract class QS001119Event extends QS001119State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001119Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
