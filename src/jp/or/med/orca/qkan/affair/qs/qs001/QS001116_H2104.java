...
/**
 * サービスパターン福祉用具(QS001116_H2104) 
 */
public class QS001116_H2104 extends QS001116_H2104Event {
  /**
   * コンストラクタです。
   */
  public QS001116_H2104(){
  }
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QS001116_H2104.class.getName(), param));
  }
      ...
      if (provider != null) {
          ...
          // 中山間地域事業所であるかの判定ロジック
            ...
            VRList serviceInfo = QkanCommon.getProviderServiceDetail(
                    getDBManager(), providerID, ACCastUtilities.toInt("11711",
                            0));
