...
/**
 * サービスパターン地域密着型介護老人福祉施設入所者生活介護イベント定義(QS001_15411_201504) 
 */
public abstract class QS001_15411_201504Event extends QS001_15411_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_15411_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  protected void addEvents() {
    ...
    getOralMaintenanceAdd().addActionListener(new ActionListener(){
        private boolean lockFlag = false;
        public void actionPerformed(ActionEvent e) {
            if (lockFlag) {
                return;
            ...
            lockFlag = true;
            try {
                oralMaintenanceAddActionPerformed(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
    ...
    getOralMaintenanceAddItem3().addActionListener(new ActionListener(){
        private boolean lockFlag = false;
        public void actionPerformed(ActionEvent e) {
            if (lockFlag) {
                return;
            ...
            lockFlag = true;
            try {
                oralMaintenanceAddItem3ActionPerformed(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void oralMaintenanceAddActionPerformed(ActionEvent e) throws Exception;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void oralMaintenanceAddItem3ActionPerformed(ActionEvent e) throws Exception;
