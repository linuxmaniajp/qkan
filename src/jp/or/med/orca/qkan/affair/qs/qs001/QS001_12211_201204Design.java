...
/**
 * サービスパターン短期入所療養介護（介護老人保健施設）画面項目デザイン(QS001_12211_201204) 
 */
public class QS001_12211_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup shortStayRecuperationHealthPersonnelDivision2;

  private ACListModelAdapter shortStayRecuperationHealthPersonnelDivision2Model;

  private ACRadioButtonItem shortStayRecuperationHealthPersonnelDivision21;

  private ACRadioButtonItem shortStayRecuperationHealthPersonnelDivision22;
  ...
  private ACValueArrayRadioButtonGroup shortStayRecuperationHealthFacilityRecuperationRadio;
  ...
  public ACValueArrayRadioButtonGroup getShortStayRecuperationHealthFacilityInstitutionDivisionRadio(){
    if(shortStayRecuperationHealthFacilityInstitutionDivisionRadio==null){
      ...
      shortStayRecuperationHealthFacilityInstitutionDivisionRadio.setValues(new int[]{1,2,3,4,5,6,7});
  ...
  public ACRadioButtonItem getShortStayRecuperationHealthFacilityInstitutionDivisionRadioItem7(){
    if(shortStayRecuperationHealthFacilityInstitutionDivisionRadioItem7==null){
      ...
      shortStayRecuperationHealthFacilityInstitutionDivisionRadioItem7.setText("日帰りショートステイ");
  ...
  public ACRadioButtonItem getShortStayRecuperationHealthPersonnelDivision11(){
    if(shortStayRecuperationHealthPersonnelDivision11==null){
      ...
      shortStayRecuperationHealthPersonnelDivision11.setText("従来型");
   ...
   * @return 人員配置区分（療養型）
   */
  public ACValueArrayRadioButtonGroup getShortStayRecuperationHealthPersonnelDivision2(){
    if(shortStayRecuperationHealthPersonnelDivision2==null){

      shortStayRecuperationHealthPersonnelDivision2 = new ACValueArrayRadioButtonGroup();

      shortStayRecuperationHealthPersonnelDivision2.setBindPath("1220132");

      shortStayRecuperationHealthPersonnelDivision2.setUseClearButton(false);

      shortStayRecuperationHealthPersonnelDivision2.setModel(getShortStayRecuperationHealthPersonnelDivision2Model());

      shortStayRecuperationHealthPersonnelDivision2.setValues(new int[]{1,2});

      addShortStayRecuperationHealthPersonnelDivision2();
    }
    return shortStayRecuperationHealthPersonnelDivision2;
   ...
   */
  protected ACListModelAdapter getShortStayRecuperationHealthPersonnelDivision2Model(){
    if(shortStayRecuperationHealthPersonnelDivision2Model==null){
      shortStayRecuperationHealthPersonnelDivision2Model = new ACListModelAdapter();
      addShortStayRecuperationHealthPersonnelDivision2Model();
    }
    return shortStayRecuperationHealthPersonnelDivision2Model;
  }
   ...
   * @return 療養型
   */
  public ACRadioButtonItem getShortStayRecuperationHealthPersonnelDivision21(){
    if(shortStayRecuperationHealthPersonnelDivision21==null){

      shortStayRecuperationHealthPersonnelDivision21 = new ACRadioButtonItem();

      shortStayRecuperationHealthPersonnelDivision21.setText("療養型");

      shortStayRecuperationHealthPersonnelDivision21.setGroup(getShortStayRecuperationHealthPersonnelDivision2());

      shortStayRecuperationHealthPersonnelDivision21.setConstraints(VRLayout.FLOW);

      addShortStayRecuperationHealthPersonnelDivision21();
    }
    return shortStayRecuperationHealthPersonnelDivision21;
   ...
   * @return 療養強化型
   */
  public ACRadioButtonItem getShortStayRecuperationHealthPersonnelDivision22(){
    if(shortStayRecuperationHealthPersonnelDivision22==null){

      shortStayRecuperationHealthPersonnelDivision22 = new ACRadioButtonItem();

      shortStayRecuperationHealthPersonnelDivision22.setText("療養強化型");

      shortStayRecuperationHealthPersonnelDivision22.setGroup(getShortStayRecuperationHealthPersonnelDivision2());

      shortStayRecuperationHealthPersonnelDivision22.setConstraints(VRLayout.FLOW);

      addShortStayRecuperationHealthPersonnelDivision22();
    }
    return shortStayRecuperationHealthPersonnelDivision22;
  ...
  public ACRadioButtonItem getShortStayRecuperationHealthFacilitySickroomDivisionRadioItem3(){
    if(shortStayRecuperationHealthFacilitySickroomDivisionRadioItem3==null){
      ...
      shortStayRecuperationHealthFacilitySickroomDivisionRadioItem3.setText("ユニット型個室");
  ...
  public ACRadioButtonItem getShortStayRecuperationHealthFacilitySickroomDivisionRadioItem4(){
    if(shortStayRecuperationHealthFacilitySickroomDivisionRadioItem4==null){
      ...
      shortStayRecuperationHealthFacilitySickroomDivisionRadioItem4.setText("ユニット型準個室");
   ...
   * @return 療養体制維持特別加算
   */
  public ACValueArrayRadioButtonGroup getShortStayRecuperationHealthFacilityRecuperationRadio(){
    if(shortStayRecuperationHealthFacilityRecuperationRadio==null){

      shortStayRecuperationHealthFacilityRecuperationRadio = new ACValueArrayRadioButtonGroup();

      getShortStayRecuperationHealthFacilityRecuperationRadioContainer().setText("療養体制維持特別加算");
      ...
      shortStayRecuperationHealthFacilityRecuperationRadio.setValues(new int[]{1,2});
  ...
  public ACRadioButtonItem getShortStayRecuperationHealthFacilityRecuperationRadioItem1(){
    if(shortStayRecuperationHealthFacilityRecuperationRadioItem1==null){
      ...
      shortStayRecuperationHealthFacilityRecuperationRadioItem1.setText("なし");
  ...
  public ACRadioButtonItem getShortStayRecuperationHealthFacilityRecuperationRadioItem2(){
    if(shortStayRecuperationHealthFacilityRecuperationRadioItem2==null){
      ...
      shortStayRecuperationHealthFacilityRecuperationRadioItem2.setText("あり");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      getServiceAddProvisionStructuralRadioGroupContainer().setText("サービス提供体制" + ACConstants.LINE_SEPARATOR + "強化加算");
   ...
   * コンストラクタです。
   */
  public QS001_12211_201204Design() {
  ...
  protected void addShortStayRecuperationHealthPersonnelDivisionContainer(){
    ...
    shortStayRecuperationHealthPersonnelDivisionContainer.add(getShortStayRecuperationHealthPersonnelDivision1(), VRLayout.FLOW_INSETLINE_RETURN);

    shortStayRecuperationHealthPersonnelDivisionContainer.add(getShortStayRecuperationHealthPersonnelDivision2(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   */
  protected void addShortStayRecuperationHealthPersonnelDivision2(){
   ...
   */
  protected void addShortStayRecuperationHealthPersonnelDivision2Model(){

    getShortStayRecuperationHealthPersonnelDivision21().setButtonIndex(1);

    getShortStayRecuperationHealthPersonnelDivision2Model().add(getShortStayRecuperationHealthPersonnelDivision21());

    getShortStayRecuperationHealthPersonnelDivision22().setButtonIndex(2);

    getShortStayRecuperationHealthPersonnelDivision2Model().add(getShortStayRecuperationHealthPersonnelDivision22());
   ...
   * 療養型に内部項目を追加します。
   */
  protected void addShortStayRecuperationHealthPersonnelDivision21(){
   ...
   * 療養強化型に内部項目を追加します。
   */
  protected void addShortStayRecuperationHealthPersonnelDivision22(){
  ...
  protected void addTab2(){
    ...
    tab2.add(getShortStayRecuperationHealthFacilityEtcRehabilitationContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTab3(){
    ...
    tab3.add(getSeverelyMedicalManagementAddContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12211_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12211_201204Design getThis() {
    return this;
  }
}
