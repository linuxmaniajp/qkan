 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護福祉施設 (QS001118_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護福祉施設画面項目デザイン(QS001118_H2104) 
 */
public class QS001118_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACClearableRadioButtonGroup kaigoWelfareFacilityCalculationDivisionRadilo;
   ...
   * @return 算定区分
   */
  public ACClearableRadioButtonGroup getKaigoWelfareFacilityCalculationDivisionRadilo(){
    if(kaigoWelfareFacilityCalculationDivisionRadilo==null){

      kaigoWelfareFacilityCalculationDivisionRadilo = new ACClearableRadioButtonGroup();
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001118_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001118_H2104Design getThis() {
    return this;
  }
}
