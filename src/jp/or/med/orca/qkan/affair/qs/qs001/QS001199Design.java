 ...
 * アプリ: QKANCHO
 * 開発者: 松本　幸一
 * 作成日: 2006/03/21  日本コンピューター株式会社 松本　幸一 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム サービス予定作成/変更 (S)
 * プロセス サービス予定週間 (001)
 * プログラム 特定診療費画面 (QS001199)
 *
 *****************************************************************
 */
...
/**
 * 特定診療費画面画面項目デザイン(QS001199) 
 */
public class QS001199Design extends QkanAffairDialog {
  //GUIコンポーネント
  ...
  private ACIntegerCheckBox rehabilitationManagement;
  ...
  public ACComboBox getScienceTherapy1Combo(){
    if(scienceTherapy1Combo==null){
      ...
      scienceTherapy1Combo.setBindPath("3010115");
  ...
  public ACComboBox getScienceTherapy2Combo(){
    if(scienceTherapy2Combo==null){
      ...
      scienceTherapy2Combo.setBindPath("3010116");
  ...
  public ACComboBox getScienceTherapy3Combo(){
    if(scienceTherapy3Combo==null){
      ...
      scienceTherapy3Combo.setBindPath("3010117");
  ...
  public ACComboBox getScience1Combo(){
    if(science1Combo==null){
      ...
      science1Combo.setBindPath("3010119");
  ...
  public ACComboBox getScience2Combo(){
    if(science2Combo==null){
      ...
      science2Combo.setBindPath("3010120");
  ...
  public ACComboBox getScience3Combo(){
    if(science3Combo==null){
      ...
      science3Combo.setBindPath("3010121");
  ...
  public ACIntegerCheckBox getRehabilitationSystem(){
    if(rehabilitationSystem==null){
      ...
      rehabilitationSystem.setBindPath("3010139");
  ...
  /**
   * 作業療法ADL加算コンボモデルを取得します。
   * @return 作業療法ADL加算コンボモデル
   */
  ...
  public ACIntegerCheckBox getRehabilitationSystem2(){
    if(rehabilitationSystem2==null){
      ...
      rehabilitationSystem2.setBindPath("3010140");
  ...
  public ACIntegerCheckBox getRehabilitationSystem3(){
    if(rehabilitationSystem3==null){
      ...
      rehabilitationSystem3.setBindPath("3010141");
   ...
   */
  public ACIntegerCheckBox getRehabilitationManagement(){
    if(rehabilitationManagement==null){

      rehabilitationManagement = new ACIntegerCheckBox();

      rehabilitationManagement.setText("リハビリ・マネジメント加算");

      rehabilitationManagement.setBindPath("3010142");

      addRehabilitationManagement();
    }
    return rehabilitationManagement;
  ...
  protected void addGuidanceManagements(){
    ...
    guidanceManagements.add(getMedicalScienceInfo2(), VRLayout.FLOW_INSETLINE);
  ...
  protected void addScienceTherapys(){
    ...
    scienceTherapys.add(getScienceTherapy2Container(), VRLayout.FLOW_INSETLINE);

    scienceTherapys.add(getScienceTherapy3Container(), VRLayout.FLOW_INSETLINE_RETURN);

    scienceTherapys.add(getScience1Container(), VRLayout.FLOW_INSETLINE);

    scienceTherapys.add(getScience2Container(), VRLayout.FLOW_INSETLINE);

    scienceTherapys.add(getScience3Container(), VRLayout.FLOW_INSETLINE_RETURN);

    scienceTherapys.add(getNormalLifeConteiner(), VRLayout.FLOW_INSETLINE);
    ...
    scienceTherapys.add(getRehabilitationSystem(), VRLayout.FLOW_INSETLINE);
  ...
  protected void addWorkTherapyFrames(){
    ...
    workTherapyFrames.add(getNormalLife2Container(), VRLayout.FLOW_INSETLINE);
    ...
    workTherapyFrames.add(getRehabilitationSystem2(), VRLayout.FLOW_INSETLINE);
  ...
  protected void addEtcFrames(){
    ...
    etcFrames.add(getRehabilitationSystem3(), VRLayout.FLOW_INSETLINE_RETURN);

    etcFrames.add(getDinner(), VRLayout.FLOW_INSETLINE);

    etcFrames.add(getRehabilitationManagement(), VRLayout.FLOW_INSETLINE);

    etcFrames.add(getConcentratedRehabilitation(), VRLayout.FLOW_INSETLINE);
   ...
   */
  protected void addRehabilitationManagement(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      new QS001199Design().setVisible(true);
      System.exit(0);
    } catch (Exception e) {
      e.printStackTrace();
    }
   ...
   * 自身を返します。
   */
  protected QS001199Design getThis() {
    return this;
  }
}
