...
/**
 * サービスパターン特定施設入所者生活介護(QS001115_H2104)
 */
public class QS001115_H2104 extends QS001115_H2104Event {
    /**
     * コンストラクタです。
     */
    public QS001115_H2104() {
    }
    ...
    protected void visitNursingFacilitiesDivisionRadioActionPerformed(
        ...
        if (getVisitNursingFacilitiesDivisionRadioItem1().isSelected()) {
            ...
            VRMap comboItemMap = new VRHashMap();
            comboItemMap.setData("1330112", QkanCommon.getArrayFromMasterCode(
                    207, "1330112"));
            // ※展開
            // 自身(this)にcomboItemMapに設定する。
            getThis().setModelSource(comboItemMap);
    ...
    protected void expertPlaceNursingRadioActionPerformed(ActionEvent e)
        ...
        case 4: // 大規模事業所 II
            ...
            comboItemMap.setData("1330115", QkanCommon.getArrayFromMasterCode(
                    240, "1330115"));
            // ※展開
            // 自身(this)にcomboItemMapに設定する。
            getThis().setModelSource(comboItemMap);
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001115_H2104.class.getName(),
                param));
    }
    ...
    public void initialize() throws Exception {
        ...
        comboItemMap.setData("1330117", QkanCommon.getArrayFromMasterCode(279,
                "1330117"));
        // 福祉用具
...
//            // 医療機関連携加算
//            obj = VRBindPathParser.get("1330106", provider);
//            if (obj != null) {
//                switch (ACCastUtilities.toInt(obj)) {
//                case 1:
//                    // なし
//                    defaultMap.setData("1330124", obj);
//                    setState_INVALID_MEDICAL_COORDINATE();
//                    break;
//                case 2:
//                    // あり
//                    defaultMap.setData("1330124", obj);
//                    setState_VALID_MEDICAL_COORDINATE();
//                    break;
//                }
//            }
//            
//            // 障害者等支援加算
//            obj = VRBindPathParser.get("1330107", provider);
//            if (obj != null) {
//                switch (ACCastUtilities.toInt(obj)) {
//                case 1:
//                    // なし
//                    defaultMap.setData("1330125", obj);
//                    setState_INVALID_IMPAIRED_PERSON_HELP();
//                    break;
//                case 2:
//                    // あり
//                    defaultMap.setData("1330125", obj);
//                    setState_VALID_IMPAIRED_PERSON_HELP();
//                    break;
//                }
//            }
            // ※展開
