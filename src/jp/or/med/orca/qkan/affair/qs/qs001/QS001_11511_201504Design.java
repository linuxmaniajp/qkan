...
/**
 * サービスパターン通所介護画面項目デザイン(QS001_11511_201504) 
 */
public class QS001_11511_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getIndividualPickupSystem(){
    if(individualPickupSystem==null){
      ...
      individualPickupSystem.setBindPath("1150123");
  ...
  public ACValueArrayRadioButtonGroup getBathingAssistanceSystem(){
    if(bathingAssistanceSystem==null){
      ...
      bathingAssistanceSystem.setBindPath("1150124");
   ...
   * コンストラクタです。
   */
  public QS001_11511_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_11511_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_11511_201504Design getThis() {
    return this;
  }
}
