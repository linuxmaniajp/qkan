...
/**
 * サービスパターン介護予防認知症対応型通所介護画面項目デザイン(QS001_17411_201804) 
 */
public class QS001_17411_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getImprovementCollaboration(){
    if(improvementCollaboration==null){
      ...
      improvementCollaboration.setBindPath("1740112");
  ...
  public ACValueArrayRadioButtonGroup getNutritionScreening(){
    if(nutritionScreening==null){
      ...
      nutritionScreening.setBindPath("1740113");
   ...
   * コンストラクタです。
   */
  public QS001_17411_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17411_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17411_201804Design getThis() {
    return this;
  }
}
