 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン福祉用具 (QS001_11711_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン福祉用具イベント定義(QS001_11711_201804) 
 */
public abstract class QS001_11711_201804Event extends QS001_11711_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_11711_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  private int serviceKindDetail = 11711;
  //getter/setter
  ...
  /**
   * serviceKindDetailを返します。
   * @return serviceKindDetail
   */
  protected int getServiceKindDetail(){
    return serviceKindDetail;
  }
  /**
   * serviceKindDetailを設定します。
   * @param serviceKindDetail serviceKindDetail
   */
  protected void setServiceKindDetail(int serviceKindDetail){
