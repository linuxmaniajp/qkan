...
/**
 * サービスパターン短期入所療養介護（認知症疾患）イベント定義(QS001113_H2104) 
 */
public abstract class QS001113_H2104Event extends QS001113_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001113_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
