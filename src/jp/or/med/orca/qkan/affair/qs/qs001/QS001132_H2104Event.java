...
/**
 * サービスパターン介護予防訪問看護イベント定義(QS001132_H2104) 
 */
public abstract class QS001132_H2104Event extends QS001132_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001132_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
