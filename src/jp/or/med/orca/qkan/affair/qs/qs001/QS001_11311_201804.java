...
/**
 * サービスパターン訪問看護（介護)(QS001_11311_201804)
 */
@SuppressWarnings("serial")
public class QS001_11311_201804 extends QS001_11311_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_11311_201804() {

        // 値を転記する事業所設定項目
        putImportProviderBindPath("施設等の区分", "1130101", "1130103");
        //putImportProviderBindPath("特別管理加算", "1130102", "1130116");
        putImportProviderBindPath("看護体制強化加算", "1130109", "1130124");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_11311_201804.class.getName(),
                param));
    }
        ...
        if (shisetsu != 3) {
            ...
            if (isEnabledAndSelected(getHoumonKangoKaigoTime1())
                ...
                if (isEnabledAndSelected(getHoumonKangoNumberOfPeople2())
                		|| isEnabledAndSelected(getHoumonKangoNumberOfPeople3())) {
                    // 訪問人数が2人である場合
