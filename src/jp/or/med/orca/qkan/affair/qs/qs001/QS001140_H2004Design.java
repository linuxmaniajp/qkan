...
/**
 * サービスパターン介護予防短期入所療養介護（診療所）画面項目デザイン(QS001140_H2004) 
 */
public class QS001140_H2004Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getShortStayClinicRecuperationSubtractionType(){
    if(shortStayClinicRecuperationSubtractionType==null){
      ...
      shortStayClinicRecuperationSubtractionType.setBindPath("1260205");
  ...
  public ACClearableRadioButtonGroup getShortStayClinicRecuperationDieticianManageRadio(){
    if(shortStayClinicRecuperationDieticianManageRadio==null){
      ...
      shortStayClinicRecuperationDieticianManageRadio.setBindPath("1260206");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001140_H2004Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001140_H2004Design getThis() {
    return this;
  }
}
