...
/**
 * サービスパターン短期入所療養介護（病院療養）イベント定義(QS001_12311_201504) 
 */
public abstract class QS001_12311_201504Event extends QS001_12311_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12311_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
