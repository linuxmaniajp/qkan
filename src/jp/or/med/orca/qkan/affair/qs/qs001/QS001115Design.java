 ...
 * アプリ: QKANCHO
 * 開発者: 松本　幸一
 * 作成日: 2006/06/02  日本コンピューター株式会社 松本　幸一 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン特定施設入所者生活介護画面項目デザイン(QS001115) 
 */
public class QS001115Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getExpertPlaceNursingRadio(){
    if(expertPlaceNursingRadio==null){
      ...
      expertPlaceNursingRadio.setBindPath("1330114");
  ...
  public ACRadioButtonItem getExpertPlaceNursingRadioItem3(){
    if(expertPlaceNursingRadioItem3==null){
      ...
      expertPlaceNursingRadioItem3.setText("療養通所");

      expertPlaceNursingRadioItem3.setGroup(getExpertPlaceNursingRadio());

      expertPlaceNursingRadioItem3.setConstraints(VRLayout.FLOW);
  ...
  public ACClearableRadioButtonGroup getExpertPlaceRehabiliRadio(){
    if(expertPlaceRehabiliRadio==null){
      ...
      expertPlaceRehabiliRadio.setBindPath("1330116");
  ...
  public ACRadioButtonItem getExpertPlaceRehabiliRadioItem1(){
    if(expertPlaceRehabiliRadioItem1==null){
      ...
      expertPlaceRehabiliRadioItem1.setText("通常規模医療機関");

      expertPlaceRehabiliRadioItem1.setGroup(getExpertPlaceRehabiliRadio());

      expertPlaceRehabiliRadioItem1.setConstraints(VRLayout.FLOW);
  ...
  public ACRadioButtonItem getExpertPlaceRehabiliRadioItem2(){
    if(expertPlaceRehabiliRadioItem2==null){
      ...
      expertPlaceRehabiliRadioItem2.setText("小規模診療所");
  ...
  public ACRadioButtonItem getExpertPlaceRehabiliRadioItem3(){
    if(expertPlaceRehabiliRadioItem3==null){
      ...
      expertPlaceRehabiliRadioItem3.setText("介護老人保健施設");
  ...
  protected void addTabPanel2(){
    ...
    tabPanel2.add(getVisitRehabiliGroup(), VRLayout.NORTH);
  ...
  protected void addTabPanel3(){
    ...
    tabPanel3.add(getExpertPlaceRehabiliGroup(), VRLayout.NORTH);

    tabPanel3.add(getWelfareToolsGroup(), VRLayout.NORTH);
  ...
  protected void addTabPanel4(){
    ...
    tabPanel4.add(getNinchishoTaioTsushoGroup(), VRLayout.NORTH);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001115Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001115Design getThis() {
    return this;
  }
}
