...
/**
 * サービスパターン短期入所療養介護(介護老人保健施設)イベント定義(QS001110_H2104) 
 */
public abstract class QS001110_H2104Event extends QS001110_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001110_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
