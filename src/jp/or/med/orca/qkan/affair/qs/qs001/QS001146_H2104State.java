...
/**
 * サービスパターン介護予防認知症対応型通所介護状態定義(QS001146_H2104) 
 */
public class QS001146_H2104State extends QS001146_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001146_H2104State(){
  }
   ...
   * @throws Exception 処理例外
   */
  public void setState_BATH_CARE_ENABLE_FALSE() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_BATH_CARE_ENABLE_TRUE() throws Exception {
  ...
  /**
   * 「個別機能訓練加算・無効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_FUNCTION_TRAINING_ENABLE_FALSE() throws Exception {
  ...
  /**
   * 「個別機能訓練加算・有効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_FUNCTION_TRAINING_ENABLE_TRUE() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_NOURISHMENT_MANAGEMENT_ENABLE_FALSE() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_NOURISHMENT_MANAGEMENT_ENABLE_TRUE() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_ORAL_FUNCTION_ENABLE_FALSE() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_ORAL_FUNCTION_ENABLE_TRUE() throws Exception {
