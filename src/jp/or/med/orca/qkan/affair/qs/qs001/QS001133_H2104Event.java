...
/**
 * サービスパターン介護予防訪問リハビリテーションイベント定義(QS001133_H2104) 
 */
public abstract class QS001133_H2104Event extends QS001133_H2104Design implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001133_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
