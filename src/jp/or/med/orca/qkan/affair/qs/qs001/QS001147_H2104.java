 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン介護予防小規模多機能居宅介護 (QS001147_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防小規模多機能居宅介護(QS001147_H2104) 
 */
public class QS001147_H2104 extends QS001147_H2104Event {
  /**
   * コンストラクタです。
   */
  public QS001147_H2104(){
  }
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QS001147_H2104.class.getName(), param));
  }
  ...
  public void providerSelected(VRMap provider) throws Exception{
      ...
      if (provider != null) {
          ...
          //サービス提供体制強化加算
          obj = VRBindPathParser.get("1750102", provider);
          if (obj != null) {
              VRBindPathParser.set("1750108", defaultMap, obj);
          }
