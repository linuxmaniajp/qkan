 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン認知症対応共同生活介護（短期利用以外） (QS001126_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン認知症対応共同生活介護（短期利用以外）画面項目デザイン(QS001126_H2104) 
 */
public class QS001126_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getWatchKaigoAddRadioGroup(){
    if(watchKaigoAddRadioGroup==null){
      ...
      watchKaigoAddRadioGroup.setValues(new int[]{1,2});
  ...
  public ACRadioButtonItem getWatchKaigoAddRadioItem1(){
    if(watchKaigoAddRadioItem1==null){
      ...
      watchKaigoAddRadioItem1.setConstraints(VRLayout.FLOW);
  ...
  public ACRadioButtonItem getWatchKaigoAddRadioItem2(){
    if(watchKaigoAddRadioItem2==null){
      ...
      watchKaigoAddRadioItem2.setText("あり");

      watchKaigoAddRadioItem2.setGroup(getWatchKaigoAddRadioGroup());

      watchKaigoAddRadioItem2.setConstraints(VRLayout.FLOW);
  ...
  protected void addTab1(){
    ...
    tab1.add(getWatchKaigoAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001126_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001126_H2104Design getThis() {
    return this;
  }
}
