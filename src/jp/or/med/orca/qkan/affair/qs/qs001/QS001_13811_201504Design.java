 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン認知症対応共同生活介護（短期利用） (QS001_13811_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン認知症対応共同生活介護（短期利用）画面項目デザイン(QS001_13811_201504) 
 */
public class QS001_13811_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * 自身を返します。
   */
  protected QS001_13811_201504Design getThis() {
    return this;
  }
}
