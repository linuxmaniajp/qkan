...
/**
 * サービスパターン介護予防認知症対応型共同生活介護イベント定義(QS001149_H2104) 
 */
public abstract class QS001149_H2104Event extends QS001149_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001149_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
