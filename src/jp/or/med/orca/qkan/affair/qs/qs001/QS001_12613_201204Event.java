...
/**
 * サービスパターン介護予防短期入所療養介護（認知症）イベント定義(QS001_12613_201204) 
 */
@SuppressWarnings("serial")
public abstract class QS001_12613_201204Event extends QS001_12613_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12613_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
