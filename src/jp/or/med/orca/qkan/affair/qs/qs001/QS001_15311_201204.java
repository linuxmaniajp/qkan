...
/**
 * サービスパターン介護療養型医療施設（病院）(QS001_15311_201204)
 */
@SuppressWarnings("serial")
public class QS001_15311_201204 extends QS001_15311_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_15311_201204() {
        
        // 必須の事業所設定項目
        putCheckProviderBindPath("介護職員処遇改善加算", "4");
        
        // 事業所からの値引き継ぎ
        putImportProviderBindPath("人員配置区分", "1530129", "1530102");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_15311_201204.class.getName(),
                param));
    }
