...
/**
 * サービスパターン地域密着型介護福祉施設(QS001129_H2104) 
 */
public class QS001129_H2104 extends QS001129_H2104Event {
	...
	public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            //療養食加算（事業所パネル）KEY：1540132の値をチェックする。
            ...
            //常にdefaultMapに KEY：1540127 VALUE：1（なし）を設定する。
            VRBindPathParser.set("1540127", defaultMap, new Integer(1));   
            
            
            //若年性認知症利用者受入加算（事業所パネル）KEY：1540131の値をチェックする。
            ...
            //常にdefaultMapに KEY：1540132 VALUE：1（なし）を設定する。
