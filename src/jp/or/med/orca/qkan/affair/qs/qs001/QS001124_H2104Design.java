...
/**
 * サービスパターン認知症対応型通所介護画面項目デザイン(QS001124_H2104) 
 */
public class QS001124_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001124_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001124_H2104Design getThis() {
    return this;
  }
}
