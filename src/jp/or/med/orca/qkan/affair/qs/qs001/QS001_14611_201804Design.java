...
/**
 * サービスパターン介護予防支援費画面項目デザイン(QS001_14611_201804) 
 */
public class QS001_14611_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_14611_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_14611_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_14611_201804Design getThis() {
    return this;
  }
}
