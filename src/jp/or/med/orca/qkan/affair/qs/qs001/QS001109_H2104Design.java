...
/**
 * サービスパターン短期入所生活介護画面項目デザイン(QS001109_H2104) 
 */
public class QS001109_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  protected void addTab2(){
    ...
    tab2.add(getShortStayLifeStayheavyAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001109_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001109_H2104Design getThis() {
    return this;
  }
}
