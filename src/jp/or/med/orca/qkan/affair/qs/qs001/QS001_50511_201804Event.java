...
/**
 * サービスパターン通所型サービス(みなし)イベント定義(QS001_50511_201804) 
 */
public abstract class QS001_50511_201804Event extends QS001_50511_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_50511_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  protected void addEvents() {
    getCrackOnCntCheck().addActionListener(new ActionListener(){
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            lockFlag = true;
            try {
                crackOnCntCheckActionPerformed(e);
            }catch(Throwable ex){
   ...
   */
  protected abstract void crackOnCntCheckActionPerformed(ActionEvent e) throws Exception;
