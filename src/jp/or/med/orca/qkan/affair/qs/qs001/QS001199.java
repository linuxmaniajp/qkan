 ...
 * アプリ: QKANCHO
 * 開発者: 田中　統蔵
 * 作成日: 2006/03/09  日本コンピューター株式会社 田中　統蔵 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 ...
 * 特定診療費画面(QS001199) 
 */
public class QS001199 extends QS001199Event {
  /**
   * コンストラクタです。
   */
  public QS001199(){
  ...
  protected void applyActionPerformed(ActionEvent e) throws Exception {
      ...
      //リハビリマネジメント加算(rehabilitationManagement)が未選択ならば、リハビリマネジメント加算(rehabilitationManagement)のbindPathを削除する。
      if (!getRehabilitationManagement().isSelected()) {
          getValues().remove(getRehabilitationManagement().getBindPath());
      }
  ...
  public static void main(String[] args) {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001199.class.getName(), param));
  }
  ...
  public static String[] getTargetBindPathes(int systemServiceKindDetail)
      ...
      case 12612: //介護予防短期入所療養介護（診療所）
          return new String[] { "3010101", "3010102", "3010104", "3010105",
                  ...
                  //"3010109",
                  "3010110",
                  "3010111", "3010112", "3010113", "3010115", "3010116", 
                  "3010117", "3010119", "3010120", "3010121", "3010122", 
                  "3010123", "3010124", "3010126", "3010128", "3010129", 
      ...
      default:
          return new String[] { "3010101", "3010102", "3010103", "3010104",
                  "3010105", "3010106", "3010107", "3010108", 
                  //"3010109",
                  "3010110", "3010111", "3010112", "3010113", "3010115", 
                  "3010116", "3010117", "3010119", "3010120", "3010121", 
                  "3010122", "3010123", "3010124", "3010126", "3010128", 
                  "3010129", "3010130", "3010131", "3010133", "3010135", 
                  "3010136", "3010137", "3010138", "3010139", "3010140", 
                  "3010141", "3010142", "3010143"};
      }
  }
}
