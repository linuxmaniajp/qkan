 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防認知症対応型共同生活介護（短期利用） (QS001_13911_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防認知症対応型共同生活介護（短期利用）画面項目デザイン(QS001_13911_201804) 
 */
public class QS001_13911_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getImprovementCollaboration(){
    if(improvementCollaboration==null){
      ...
      improvementCollaboration.setBindPath("1390110");
   ...
   * コンストラクタです。
   */
  public QS001_13911_201804Design() {
  ...
  protected void addTab2(){
    ...
    tab2.add(getShortStayLifeAddition30Orver(), VRLayout.FLOW);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_13911_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_13911_201804Design getThis() {
    return this;
  }
}
