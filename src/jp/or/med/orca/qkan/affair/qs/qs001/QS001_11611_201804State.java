...
/**
 * サービスパターン通所リハ状態定義(QS001_11611_201804) 
 */
public class QS001_11611_201804State extends QS001_11611_201804Design {
  /**
   * コンストラクタです。
   */
  public QS001_11611_201804State(){
  }
  ...
  /**
   * 「短期集中個別リハビリ実施・有効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_VALID_HOUMON_REHABILITATION_SHORT_CONCENTRATION() throws Exception {
  ...
  /**
   * 「短期集中個別リハビリ実施・無効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_INVALID_HOUMON_REHABILITATION_SHORT_CONCENTRATION() throws Exception {
  ...
  /**
   * 「認知症短期集中リハビリ実施加算・有効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_VALID_DEMENTIA_REHABILITATION_SHORT_CONCENTRATION() throws Exception {
  ...
  /**
   * 「認知症短期集中リハビリ実施加算・無効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_INVALID_DEMENTIA_REHABILITATION_SHORT_CONCENTRATION() throws Exception {
  ...
  /**
   * 「生活行為向上リハビリ実施加算・有効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_VALID_LIFE_ACTSIMPROVE_REHABILITATION() throws Exception {
  ...
  /**
   * 「生活行為向上リハビリ実施加算・無効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_INVALID_LIFE_ACTSIMPROVE_REHABILITATION() throws Exception {
