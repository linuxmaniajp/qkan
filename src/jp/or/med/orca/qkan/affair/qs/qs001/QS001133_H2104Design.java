...
/**
 * サービスパターン介護予防訪問リハビリテーション画面項目デザイン(QS001133_H2104) 
 */
public class QS001133_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001133_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001133_H2104Design getThis() {
    return this;
  }
}
