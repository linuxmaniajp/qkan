...
/**
 * サービスパターン介護予防居宅療養管理指導状態定義(QS001134_H2104) 
 */
public class QS001134_H2104State extends QS001134_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001134_H2104State(){
  }
  ...
  public void setState_STATE_MODE_1() throws Exception {
        ...
        getRecuperationManagementGuidanceTimesGroup().setEnabled(false);

        getPatientDivisionRadio().setEnabled(false);
        getPatientDivisionRadio().getParent().setEnabled(false);
  ...
  public void setState_STATE_MODE_3() throws Exception {
        ...
        getRecuperationManagementGuidanceTimesGroup().setEnabled(true);

        getPatientDivisionRadio().setEnabled(true);
        getPatientDivisionRadio().getParent().setEnabled(true);
