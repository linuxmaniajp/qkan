 ...
 * アプリ: QKANCHO
 * 開発者: 日高　しのぶ
 * 作成日: 2016/12/01  MIS九州株式会社 日高　しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン通所型サービス(独自)イベント定義(QS001_50611_201504) 
 */
public abstract class QS001_50611_201504Event extends QS001_50611_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_50611_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
