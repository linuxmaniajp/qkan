...
/**
 * サービスパターン介護予防短期入所療養介護（診療所）(QS001_12612_201804)
 */
@SuppressWarnings("serial")
public class QS001_12612_201804 extends QS001_12612_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_12612_201804() {
        // 必須の事業所設定項目
        ...
        putImportProviderBindPath("食堂の有無", "1260220", "1260218"); //[H30.4改正]
        ...
        putRestrictProviderBindPath("認知症専門ケア加算", "1260221", "1260219"); //[H30.4改正]
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12612_201804.class.getName(),
                param));
    }
