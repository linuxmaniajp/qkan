...
/**
 * サービスパターン短期入所療養介護(介護老人保健施設)(QS001110_H2104)
 */
public class QS001110_H2104 extends QS001110_H2104Event {
    /**
     * コンストラクタです。
     */
    public QS001110_H2104() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001110_H2104.class.getName(),
                param));
    }
    ...
    public void initialize() throws Exception {
        ...
        comboItemMap.setData("1220125", QkanCommon.getArrayFromMasterCode(273,
                "1220125"));
        // ※展開
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            // 療養食
            obj = VRBindPathParser.get("1220123", provider);
            if (obj != null) {
                switch (ACCastUtilities.toInt(obj)) {
                case 2:
                    // 「あり」の場合
...
//                    VRBindPathParser.set("1220110", defaultMap, obj);
            ...
            //常にdefaultMapに KEY：1220110 VALUE：1（なし）を設定する。
            VRBindPathParser.set("1220110", defaultMap, new Integer(1));   
            ...
            //夜勤職員配置加算
            obj = VRBindPathParser.get("1220122", provider);
            if (obj != null) {
                VRBindPathParser.set("1220122", defaultMap, obj);
            }
            //若年性認知症利用者受入加算
            obj = VRBindPathParser.get("1220124", provider);
            if (obj != null) {
                VRBindPathParser.set("1220123", defaultMap, obj);
            }

            //認知症ケア加算（事業所パネル）KEY：1220119の値をチェックする。
            obj = VRBindPathParser.get("1220119", provider);
            ...
            //常にdefaultMapに KEY：1220116 VALUE：1（なし）を設定する。
            VRBindPathParser.set("1220116", defaultMap, new Integer(1));   
            
            
            //サービス提供体制強化加算
            obj = VRBindPathParser.get("1220125", provider);
            if (obj != null) {
                VRBindPathParser.set("1220124", defaultMap, obj);
            }
            

            //若年性認知症利用者受入加算（事業所パネル）KEY：1220124の値をチェックする。
            obj = VRBindPathParser.get("1220124", provider);
            switch (ACCastUtilities.toInt(obj,0)) {
            //値が次のいずれかだった場合
            case 2:
            ...
            //常にdefaultMapに KEY：1220123 VALUE：1（なし）を設定する。
            VRBindPathParser.set("1220123", defaultMap, new Integer(1));   
