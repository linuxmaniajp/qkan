...
/**
 * サービスパターン地域密着型介護福祉施設イベント定義(QS001129_H2104) 
 */
public abstract class QS001129_H2104Event extends QS001129_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001129_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
