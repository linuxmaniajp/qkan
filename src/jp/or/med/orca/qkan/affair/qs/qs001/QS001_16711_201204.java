 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン介護予防福祉用具貸与 (QS001_16711_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防福祉用具貸与(QS001_16711_201204)
 */
@SuppressWarnings("serial")
public class QS001_16711_201204 extends QS001_16711_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_16711_201204() {
        //設定なし
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_16711_201204.class.getName(),
                param));
    }
    ...
    public void initialize() throws Exception {
        ...
        comboItemMap.setData("1670101",
                QkanCommon.getArrayFromMasterCode(47, "1670101"));
        // ※展開
