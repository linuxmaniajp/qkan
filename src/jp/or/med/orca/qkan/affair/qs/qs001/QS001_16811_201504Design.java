 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン小規模多機能型介護 (QS001_16811_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン小規模多機能型介護画面項目デザイン(QS001_16811_201504) 
 */
public class QS001_16811_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_16811_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_16811_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_16811_201504Design getThis() {
    return this;
  }
}
