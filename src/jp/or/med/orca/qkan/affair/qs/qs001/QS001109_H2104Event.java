...
/**
 * サービスパターン短期入所生活介護イベント定義(QS001109_H2104) 
 */
public abstract class QS001109_H2104Event extends QS001109_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001109_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
