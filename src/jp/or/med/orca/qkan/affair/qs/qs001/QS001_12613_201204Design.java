...
/**
 * サービスパターン介護予防短期入所療養介護（認知症）画面項目デザイン(QS001_12613_201204) 
 */
public class QS001_12613_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_12613_201204Design() {
  ...
  protected void addTab1(){
    ...
    tab1.add(getShortStayDementiaRecuperationSpecificConsultationFee(), VRLayout.FLOW);

    tab1.add(getShortStayDementiaRecuperationSpecificConsultationFeeOutline(), VRLayout.FLOW_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12613_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12613_201204Design getThis() {
    return this;
  }
}
