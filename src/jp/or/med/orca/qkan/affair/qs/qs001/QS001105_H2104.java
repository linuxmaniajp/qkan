...
/**
 * サービスパターン訪問リハ(QS001105_H2104)
 */
public class QS001105_H2104 extends QS001105_H2104Event {
    /**
     * コンストラクタです。
     */
    public QS001105_H2104() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001105_H2104.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            if (obj != null) {
                VRBindPathParser.set("1140107", defaultMap, obj);
            }
            // ※展開
            // 自身(this)にdefaultMapに設定する。
            getThis().setSource(defaultMap);
