 ...
 * アプリ: QKANCHO
 * 開発者: 田中　統蔵
 * 作成日: 2009/03/10  日本コンピューター株式会社 田中　統蔵 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン短期入所療養介護（診療所療養）画面項目デザイン(QS001112_H2104) 
 */
public class QS001112_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001112_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001112_H2104Design getThis() {
    return this;
  }
}
