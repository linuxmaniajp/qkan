...
/**
 * サービスパターン介護予防短期入所療養介護（介護老人保健施設）イベント定義(QS001_12511_201204) 
 */
@SuppressWarnings("serial")
public abstract class QS001_12511_201204Event extends QS001_12511_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12511_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int SYSTEM_SERVICE_KIND_DETAIL = 12511;
  //getter/setter
