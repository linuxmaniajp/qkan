...
/**
 * サービスパターン短期入所療養介護(介護老人保健施設)(QS001_12211_201804)
 */
@SuppressWarnings("serial")
public class QS001_12211_201804 extends QS001_12211_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_12211_201804() {
        // 必須の事業所設定項目
        ...
        putImportProviderBindPath("療養体制維持特別加算I", "1220121", "1220121");
        putImportProviderBindPath("療養体制維持特別加算II", "1220133", "1220135"); //[H30.4改正]
        ...
        putRestrictProviderBindPath("認知症専門ケア加算", "1220132", "1220134"); //[H30.4改正]
        putRestrictProviderBindPath("在宅復帰・在宅療養支援機能加算", "1220131", "1220133"); //[H30.4改正]
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12211_201804.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            // 在宅復帰・在宅療養支援機能加算
            obj = VRBindPathParser.get("1220131", provider);
            if (obj != null) {
                // 事業所登録の減算項目に合わせ初期値を調整
                switch (ACCastUtilities.toInt(obj)) {
                case 1: // なしだった場合
                    VRBindPathParser.set("1220133", defaultMap, new Integer(1));
                    break;
                case 2: // I型だった場合
                case 3: // II型だった場合
                    VRBindPathParser.set("1220133", defaultMap, new Integer(2));
                    break;
                }
            }
...
//[H30.4改正] チェックボックスに変更した為、必須チェック外す
//        // 療養体制維持特別加算
