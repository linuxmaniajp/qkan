...
/**
 * サービスパターン介護予防居宅療養管理指導画面項目デザイン(QS001_13411_201204) 
 */
public class QS001_13411_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_13411_201204Design() {
  ...
  protected void addTab1(){
    ...
    tab1.add(getSpecialMedicineRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_13411_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_13411_201204Design getThis() {
    return this;
  }
}
