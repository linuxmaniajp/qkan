...
/**
 * サービスパターン介護療養型医療施設（認知症）イベント定義(QS001_15313_201804) 
 */
public abstract class QS001_15313_201804Event extends QS001_15313_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_15313_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
