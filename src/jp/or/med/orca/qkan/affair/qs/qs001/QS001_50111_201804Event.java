...
/**
 * サービスパターン訪問型サービス（みなし）イベント定義(QS001_50111_201804) 
 */
public abstract class QS001_50111_201804Event extends QS001_50111_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_50111_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
