 ...
 * アプリ: QKANCHO
 * 開発者: 亀井　陽一郎
 * 作成日: 2016/07/19  日本コンピューター株式会社 亀井　陽一郎 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン訪問型サービス（みなし）状態定義(QS001_50111_201804) 
 */
public class QS001_50111_201804State extends QS001_50111_201804Design {
  /**
   * コンストラクタです。
   */
  public QS001_50111_201804State(){
  }
