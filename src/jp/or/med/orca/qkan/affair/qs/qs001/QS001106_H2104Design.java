 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン短期入所療養介護（居宅療養管理指導） (QS001106_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所療養介護（居宅療養管理指導）画面項目デザイン(QS001106_H2104) 
 */
public class QS001106_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getPatientGroup(){
    if(patientGroup==null){
      ...
      patientGroup.setFollowChildEnabled(false);
  ...
  public ACRadioButtonItem getPatientRadioItem1(){
    if(patientRadioItem1==null){
      ...
      patientRadioItem1.setText("在宅利用者");
  ...
  public ACRadioButtonItem getPatientRadioItem2(){
    if(patientRadioItem2==null){
      ...
      patientRadioItem2.setText("居宅系施設入居者");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001106_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001106_H2104Design getThis() {
    return this;
  }
}
