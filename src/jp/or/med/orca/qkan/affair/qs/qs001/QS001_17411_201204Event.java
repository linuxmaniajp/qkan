...
/**
 * サービスパターン介護予防認知症対応型通所介護イベント定義(QS001_17411_201204) 
 */
@SuppressWarnings("serial")
public abstract class QS001_17411_201204Event extends QS001_17411_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_17411_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
   ...
   * @return int
   */
  public abstract int getNintiTusyoTime() throws Exception;
