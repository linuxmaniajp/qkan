 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2009/03/17  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン介護予防福祉用具貸与状態定義(QS001144_H2104) 
 */
public class QS001144_H2104State extends QS001144_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001144_H2104State(){
  }
