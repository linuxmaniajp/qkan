 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン居宅介護支援 (QS001_14311_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン居宅介護支援画面項目デザイン(QS001_14311_201804) 
 */
public class QS001_14311_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACRadioButtonItem dischargeAddRadioItem4;

  private ACRadioButtonItem dischargeAddRadioItem5;

  private ACRadioButtonItem dischargeAddRadioItem6;
  ...
  private ACRadioButtonItem kaigoSupportSpecificStandardRadioItem4;

  private ACRadioButtonItem kaigoSupportSpecificStandardRadioItem5;
  ...
  private ACValueArrayRadioButtonGroup terminalCareManagementAddRadioGroup;

  private ACLabelContainer terminalCareManagementAddRadioGroupContainer;

  private ACListModelAdapter terminalCareManagementAddRadioGroupModel;

  private ACRadioButtonItem terminalCareManagementAddRadioItem1;

  private ACRadioButtonItem terminalCareManagementAddRadioItem2;
  ...
  public ACValueArrayRadioButtonGroup getDischargeAddRadio(){
    if(dischargeAddRadio==null){
      ...
      dischargeAddRadio.setValues(new int[]{1,2,3,4,5,6});
  ...
  public ACRadioButtonItem getDischargeAddRadioItem2(){
    if(dischargeAddRadioItem2==null){
      ...
      dischargeAddRadioItem2.setText("Iイ型");
  ...
  public ACRadioButtonItem getDischargeAddRadioItem3(){
    if(dischargeAddRadioItem3==null){
      ...
      dischargeAddRadioItem3.setText("Iロ型");

      dischargeAddRadioItem3.setGroup(getDischargeAddRadio());

      dischargeAddRadioItem3.setConstraints(VRLayout.FLOW_RETURN);
   ...
   * @return IIイ型
   */
  public ACRadioButtonItem getDischargeAddRadioItem4(){
    if(dischargeAddRadioItem4==null){

      dischargeAddRadioItem4 = new ACRadioButtonItem();

      dischargeAddRadioItem4.setText("IIイ型");

      dischargeAddRadioItem4.setGroup(getDischargeAddRadio());

      dischargeAddRadioItem4.setConstraints(VRLayout.FLOW);

      addDischargeAddRadioItem4();
    }
    return dischargeAddRadioItem4;
   ...
   * @return IIロ型
   */
  public ACRadioButtonItem getDischargeAddRadioItem5(){
    if(dischargeAddRadioItem5==null){

      dischargeAddRadioItem5 = new ACRadioButtonItem();

      dischargeAddRadioItem5.setText("IIロ型");

      dischargeAddRadioItem5.setGroup(getDischargeAddRadio());

      dischargeAddRadioItem5.setConstraints(VRLayout.FLOW);

      addDischargeAddRadioItem5();
    }
    return dischargeAddRadioItem5;
   ...
   * @return III型
   */
  public ACRadioButtonItem getDischargeAddRadioItem6(){
    if(dischargeAddRadioItem6==null){

      dischargeAddRadioItem6 = new ACRadioButtonItem();

      dischargeAddRadioItem6.setText("III型");

      dischargeAddRadioItem6.setGroup(getDischargeAddRadio());

      dischargeAddRadioItem6.setConstraints(VRLayout.FLOW);

      addDischargeAddRadioItem6();
    }
    return dischargeAddRadioItem6;
  ...
  public ACValueArrayRadioButtonGroup getKaigoSupportSpecificStandardRadio(){
    if(kaigoSupportSpecificStandardRadio==null){
      ...
      kaigoSupportSpecificStandardRadio.setValues(new int[]{1,2,3,4,5});
  ...
  public ACRadioButtonItem getKaigoSupportSpecificStandardRadioItem2(){
    if(kaigoSupportSpecificStandardRadioItem2==null){
      ...
      kaigoSupportSpecificStandardRadioItem2.setConstraints(VRLayout.FLOW_RETURN);
   ...
   * @return III型
   */
  public ACRadioButtonItem getKaigoSupportSpecificStandardRadioItem4(){
    if(kaigoSupportSpecificStandardRadioItem4==null){

      kaigoSupportSpecificStandardRadioItem4 = new ACRadioButtonItem();

      kaigoSupportSpecificStandardRadioItem4.setText("III型");

      kaigoSupportSpecificStandardRadioItem4.setGroup(getKaigoSupportSpecificStandardRadio());

      kaigoSupportSpecificStandardRadioItem4.setConstraints(VRLayout.FLOW);

      addKaigoSupportSpecificStandardRadioItem4();
    }
    return kaigoSupportSpecificStandardRadioItem4;
   ...
   * @return IV型
   */
  public ACRadioButtonItem getKaigoSupportSpecificStandardRadioItem5(){
    if(kaigoSupportSpecificStandardRadioItem5==null){

      kaigoSupportSpecificStandardRadioItem5 = new ACRadioButtonItem();

      kaigoSupportSpecificStandardRadioItem5.setText("IV型");

      kaigoSupportSpecificStandardRadioItem5.setGroup(getKaigoSupportSpecificStandardRadio());

      kaigoSupportSpecificStandardRadioItem5.setConstraints(VRLayout.FLOW);

      addKaigoSupportSpecificStandardRadioItem5();
    }
    return kaigoSupportSpecificStandardRadioItem5;
  ...
  /**
   * 看護小規模多機能型居宅介護事業所連携加算を取得します。
   * @return 看護小規模多機能型居宅介護事業所連携加算
   */
  public ACValueArrayRadioButtonGroup getCompositionServiceRadioGroup(){
    if(compositionServiceRadioGroup==null){
      ...
      getCompositionServiceRadioGroupContainer().setText("看護小規模多機能型居宅介護" + ACConstants.LINE_SEPARATOR + "事業所連携加算");
  ...
  /**
   * 看護小規模多機能型居宅介護事業所連携加算コンテナを取得します。
   * @return 看護小規模多機能型居宅介護事業所連携加算コンテナ
   */
  ...
  /**
   * 看護小規模多機能型居宅介護事業所連携加算モデルを取得します。
   * @return 看護小規模多機能型居宅介護事業所連携加算モデル
   */
   ...
   */
  public ACValueArrayRadioButtonGroup getTerminalCareManagementAddRadioGroup(){
    if(terminalCareManagementAddRadioGroup==null){

      terminalCareManagementAddRadioGroup = new ACValueArrayRadioButtonGroup();

      getTerminalCareManagementAddRadioGroupContainer().setText("ターミナルケアマネジメント加算");

      terminalCareManagementAddRadioGroup.setBindPath("1430117");

      terminalCareManagementAddRadioGroup.setNoSelectIndex(0);

      terminalCareManagementAddRadioGroup.setUseClearButton(false);

      terminalCareManagementAddRadioGroup.setModel(getTerminalCareManagementAddRadioGroupModel());

      terminalCareManagementAddRadioGroup.setValues(new int[]{1,2});

      addTerminalCareManagementAddRadioGroup();
    }
    return terminalCareManagementAddRadioGroup;
   ...
   */
  protected ACLabelContainer getTerminalCareManagementAddRadioGroupContainer(){
    if(terminalCareManagementAddRadioGroupContainer==null){
      terminalCareManagementAddRadioGroupContainer = new ACLabelContainer();
      terminalCareManagementAddRadioGroupContainer.setFollowChildEnabled(true);
      terminalCareManagementAddRadioGroupContainer.setVAlignment(VRLayout.CENTER);
      terminalCareManagementAddRadioGroupContainer.add(getTerminalCareManagementAddRadioGroup(), null);
    }
    return terminalCareManagementAddRadioGroupContainer;
  }
   ...
   */
  protected ACListModelAdapter getTerminalCareManagementAddRadioGroupModel(){
    if(terminalCareManagementAddRadioGroupModel==null){
      terminalCareManagementAddRadioGroupModel = new ACListModelAdapter();
      addTerminalCareManagementAddRadioGroupModel();
    }
    return terminalCareManagementAddRadioGroupModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getTerminalCareManagementAddRadioItem1(){
    if(terminalCareManagementAddRadioItem1==null){

      terminalCareManagementAddRadioItem1 = new ACRadioButtonItem();

      terminalCareManagementAddRadioItem1.setText("なし");

      terminalCareManagementAddRadioItem1.setGroup(getTerminalCareManagementAddRadioGroup());

      terminalCareManagementAddRadioItem1.setConstraints(VRLayout.FLOW);

      addTerminalCareManagementAddRadioItem1();
    }
    return terminalCareManagementAddRadioItem1;
   ...
   * @return あり
   */
  public ACRadioButtonItem getTerminalCareManagementAddRadioItem2(){
    if(terminalCareManagementAddRadioItem2==null){

      terminalCareManagementAddRadioItem2 = new ACRadioButtonItem();

      terminalCareManagementAddRadioItem2.setText("あり");

      terminalCareManagementAddRadioItem2.setGroup(getTerminalCareManagementAddRadioGroup());

      terminalCareManagementAddRadioItem2.setConstraints(VRLayout.FLOW);

      addTerminalCareManagementAddRadioItem2();
    }
    return terminalCareManagementAddRadioItem2;
   ...
   * コンストラクタです。
   */
  public QS001_14311_201804Design() {
  ...
  protected void addDischargeAddRadioModel(){
    ...
    getDischargeAddRadioItem4().setButtonIndex(4);

    getDischargeAddRadioModel().add(getDischargeAddRadioItem4());

    getDischargeAddRadioItem5().setButtonIndex(5);

    getDischargeAddRadioModel().add(getDischargeAddRadioItem5());

    getDischargeAddRadioItem6().setButtonIndex(6);

    getDischargeAddRadioModel().add(getDischargeAddRadioItem6());
   ...
   * IIイ型に内部項目を追加します。
   */
  protected void addDischargeAddRadioItem4(){
   ...
   * IIロ型に内部項目を追加します。
   */
  protected void addDischargeAddRadioItem5(){
   ...
   * III型に内部項目を追加します。
   */
  protected void addDischargeAddRadioItem6(){
  ...
  protected void addKaigoSupportSpecificStandardRadioModel(){
    ...
    getKaigoSupportSpecificStandardRadioItem4().setButtonIndex(4);

    getKaigoSupportSpecificStandardRadioModel().add(getKaigoSupportSpecificStandardRadioItem4());

    getKaigoSupportSpecificStandardRadioItem5().setButtonIndex(5);

    getKaigoSupportSpecificStandardRadioModel().add(getKaigoSupportSpecificStandardRadioItem5());
   ...
   * III型に内部項目を追加します。
   */
  protected void addKaigoSupportSpecificStandardRadioItem4(){
   ...
   * IV型に内部項目を追加します。
   */
  protected void addKaigoSupportSpecificStandardRadioItem5(){
  ...
  protected void addTab2(){
    ...
    tab2.add(getTerminalCareManagementAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  /**
   * 看護小規模多機能型居宅介護事業所連携加算に内部項目を追加します。
   */
  ...
  /**
   * 看護小規模多機能型居宅介護事業所連携加算モデルに内部項目を追加します。
   */
   ...
   */
  protected void addTerminalCareManagementAddRadioGroup(){
   ...
   */
  protected void addTerminalCareManagementAddRadioGroupModel(){

    getTerminalCareManagementAddRadioItem1().setButtonIndex(1);

    getTerminalCareManagementAddRadioGroupModel().add(getTerminalCareManagementAddRadioItem1());

    getTerminalCareManagementAddRadioItem2().setButtonIndex(2);

    getTerminalCareManagementAddRadioGroupModel().add(getTerminalCareManagementAddRadioItem2());
   ...
   * なしに内部項目を追加します。
   */
  protected void addTerminalCareManagementAddRadioItem1(){
   ...
   * ありに内部項目を追加します。
   */
  protected void addTerminalCareManagementAddRadioItem2(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_14311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_14311_201804Design getThis() {
    return this;
  }
}
