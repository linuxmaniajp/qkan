...
/**
 * サービスパターン介護老人保健施設(QS001119_H2005) 
 */
public class QS001119_H2005 extends QS001119_H2005Event {
  /**
   * コンストラクタです。
   */
  public QS001119_H2005(){
  }
  ...
  public void providerSelected(VRMap provider) throws Exception {
      ...
      if (provider != null) {
          ...
          // 施設区分（体制）
          index = ACCastUtilities.toInt(VRBindPathParser.get("1520122", provider),0);
          // 設定
          ...
          // 療養体制維持特別加算
          index = ACCastUtilities.toInt(VRBindPathParser.get("1520124", provider),0);
          // 設定
