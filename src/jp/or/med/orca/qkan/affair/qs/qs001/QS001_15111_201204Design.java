 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護福祉施設 (QS001_15111_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護福祉施設画面項目デザイン(QS001_15111_201204) 
 */
public class QS001_15111_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_15111_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_15111_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_15111_201204Design getThis() {
    return this;
  }
}
