 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン訪問介護 (QS001_11111_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン訪問介護画面項目デザイン(QS001_11111_201804) 
 */
public class QS001_11111_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACRadioButtonItem specificProviderAddRadioItem5;
  ...
  private ACIntegerCheckBox houmonKaigoMoreTimesCheck;

  private ACValueArrayRadioButtonGroup houmonSymbiosisTypeRadio;

  private ACLabelContainer houmonSymbiosisTypeRadioContainer;

  private ACListModelAdapter houmonSymbiosisTypeRadioModel;

  private ACRadioButtonItem houmonSymbiosisTypeRadioItem1;

  private ACRadioButtonItem houmonSymbiosisTypeRadioItem2;

  private ACRadioButtonItem houmonSymbiosisTypeRadioItem3;

  private ACRadioButtonItem houmonSymbiosisTypeRadioItem4;
  ...
  public ACRadioButtonItem getHoumonKaigoClassOther(){
    if(houmonKaigoClassOther==null){
      ...
      houmonKaigoClassOther.setText("初任以外");
  ...
  public ACValueArrayRadioButtonGroup getSpecificProviderAddRadio(){
    if(specificProviderAddRadio==null){
      ...
      specificProviderAddRadio.setValues(new int[]{1,2,3,4,5});
  ...
  public ACRadioButtonItem getSpecificProviderAddRadioItem3(){
    if(specificProviderAddRadioItem3==null){
      ...
      specificProviderAddRadioItem3.setConstraints(VRLayout.FLOW_RETURN);
   ...
   * @return IV型
   */
  public ACRadioButtonItem getSpecificProviderAddRadioItem5(){
    if(specificProviderAddRadioItem5==null){

      specificProviderAddRadioItem5 = new ACRadioButtonItem();

      specificProviderAddRadioItem5.setText("IV型");

      specificProviderAddRadioItem5.setGroup(getSpecificProviderAddRadio());

      specificProviderAddRadioItem5.setConstraints(VRLayout.FLOW);

      addSpecificProviderAddRadioItem5();
    }
    return specificProviderAddRadioItem5;
   ...
   * @return 頻回の訪問として行う
   */
  public ACIntegerCheckBox getHoumonKaigoMoreTimesCheck(){
    if(houmonKaigoMoreTimesCheck==null){

      houmonKaigoMoreTimesCheck = new ACIntegerCheckBox();

      houmonKaigoMoreTimesCheck.setText("頻回の訪問として行う");

      houmonKaigoMoreTimesCheck.setBindPath("1110114");

      houmonKaigoMoreTimesCheck.setSelectValue(2);

      houmonKaigoMoreTimesCheck.setUnSelectValue(1);

      addHoumonKaigoMoreTimesCheck();
    }
    return houmonKaigoMoreTimesCheck;
   ...
   * @return 共生型
   */
  public ACValueArrayRadioButtonGroup getHoumonSymbiosisTypeRadio(){
    if(houmonSymbiosisTypeRadio==null){

      houmonSymbiosisTypeRadio = new ACValueArrayRadioButtonGroup();

      getHoumonSymbiosisTypeRadioContainer().setText("共生型");

      houmonSymbiosisTypeRadio.setBindPath("22");

      houmonSymbiosisTypeRadio.setNoSelectIndex(0);

      houmonSymbiosisTypeRadio.setUseClearButton(false);

      houmonSymbiosisTypeRadio.setModel(getHoumonSymbiosisTypeRadioModel());

      houmonSymbiosisTypeRadio.setValues(new int[]{1,2,3,4});

      addHoumonSymbiosisTypeRadio();
    }
    return houmonSymbiosisTypeRadio;
   ...
   * @return 共生型コンテナ
   */
  protected ACLabelContainer getHoumonSymbiosisTypeRadioContainer(){
    if(houmonSymbiosisTypeRadioContainer==null){
      houmonSymbiosisTypeRadioContainer = new ACLabelContainer();
      houmonSymbiosisTypeRadioContainer.setFollowChildEnabled(true);
      houmonSymbiosisTypeRadioContainer.setVAlignment(VRLayout.CENTER);
      houmonSymbiosisTypeRadioContainer.add(getHoumonSymbiosisTypeRadio(), null);
    }
    return houmonSymbiosisTypeRadioContainer;
  }
   ...
   * @return 共生型モデル
   */
  protected ACListModelAdapter getHoumonSymbiosisTypeRadioModel(){
    if(houmonSymbiosisTypeRadioModel==null){
      houmonSymbiosisTypeRadioModel = new ACListModelAdapter();
      addHoumonSymbiosisTypeRadioModel();
    }
    return houmonSymbiosisTypeRadioModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getHoumonSymbiosisTypeRadioItem1(){
    if(houmonSymbiosisTypeRadioItem1==null){

      houmonSymbiosisTypeRadioItem1 = new ACRadioButtonItem();

      houmonSymbiosisTypeRadioItem1.setText("なし");

      houmonSymbiosisTypeRadioItem1.setGroup(getHoumonSymbiosisTypeRadio());

      houmonSymbiosisTypeRadioItem1.setConstraints(VRLayout.FLOW);

      addHoumonSymbiosisTypeRadioItem1();
    }
    return houmonSymbiosisTypeRadioItem1;
   ...
   * @return 居宅1
   */
  public ACRadioButtonItem getHoumonSymbiosisTypeRadioItem2(){
    if(houmonSymbiosisTypeRadioItem2==null){

      houmonSymbiosisTypeRadioItem2 = new ACRadioButtonItem();

      houmonSymbiosisTypeRadioItem2.setText("居宅1");

      houmonSymbiosisTypeRadioItem2.setGroup(getHoumonSymbiosisTypeRadio());

      houmonSymbiosisTypeRadioItem2.setConstraints(VRLayout.FLOW);

      addHoumonSymbiosisTypeRadioItem2();
    }
    return houmonSymbiosisTypeRadioItem2;
   ...
   * @return 居宅2
   */
  public ACRadioButtonItem getHoumonSymbiosisTypeRadioItem3(){
    if(houmonSymbiosisTypeRadioItem3==null){

      houmonSymbiosisTypeRadioItem3 = new ACRadioButtonItem();

      houmonSymbiosisTypeRadioItem3.setText("居宅2");

      houmonSymbiosisTypeRadioItem3.setGroup(getHoumonSymbiosisTypeRadio());

      houmonSymbiosisTypeRadioItem3.setConstraints(VRLayout.FLOW);

      addHoumonSymbiosisTypeRadioItem3();
    }
    return houmonSymbiosisTypeRadioItem3;
   ...
   * @return 重度訪問
   */
  public ACRadioButtonItem getHoumonSymbiosisTypeRadioItem4(){
    if(houmonSymbiosisTypeRadioItem4==null){

      houmonSymbiosisTypeRadioItem4 = new ACRadioButtonItem();

      houmonSymbiosisTypeRadioItem4.setText("重度訪問");

      houmonSymbiosisTypeRadioItem4.setGroup(getHoumonSymbiosisTypeRadio());

      houmonSymbiosisTypeRadioItem4.setConstraints(VRLayout.FLOW);

      addHoumonSymbiosisTypeRadioItem4();
    }
    return houmonSymbiosisTypeRadioItem4;
   ...
   * コンストラクタです。
   */
  public QS001_11111_201804Design() {
  ...
  protected void addSpecificProviderAddRadioModel(){
    ...
    getSpecificProviderAddRadioItem5().setButtonIndex(5);

    getSpecificProviderAddRadioModel().add(getSpecificProviderAddRadioItem5());
   ...
   * IV型に内部項目を追加します。
   */
  protected void addSpecificProviderAddRadioItem5(){
  ...
  protected void addTab2(){
    ...
    tab2.add(getHoumonKaigoEmergencyAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
    ...
    tab2.add(getHoumonKaigoMoreTimesCheck(), VRLayout.FLOW);

    tab2.add(getHoumonSymbiosisTypeRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  /**
   * 頻回の訪問として行うに内部項目を追加します。
   */
  protected void addHoumonKaigoMoreTimesCheck(){
   ...
   * 共生型に内部項目を追加します。
   */
  protected void addHoumonSymbiosisTypeRadio(){
   ...
   * 共生型モデルに内部項目を追加します。
   */
  protected void addHoumonSymbiosisTypeRadioModel(){

    getHoumonSymbiosisTypeRadioItem1().setButtonIndex(1);

    getHoumonSymbiosisTypeRadioModel().add(getHoumonSymbiosisTypeRadioItem1());

    getHoumonSymbiosisTypeRadioItem2().setButtonIndex(2);

    getHoumonSymbiosisTypeRadioModel().add(getHoumonSymbiosisTypeRadioItem2());

    getHoumonSymbiosisTypeRadioItem3().setButtonIndex(3);

    getHoumonSymbiosisTypeRadioModel().add(getHoumonSymbiosisTypeRadioItem3());

    getHoumonSymbiosisTypeRadioItem4().setButtonIndex(4);

    getHoumonSymbiosisTypeRadioModel().add(getHoumonSymbiosisTypeRadioItem4());
   ...
   * なしに内部項目を追加します。
   */
  protected void addHoumonSymbiosisTypeRadioItem1(){
   ...
   * 居宅1に内部項目を追加します。
   */
  protected void addHoumonSymbiosisTypeRadioItem2(){
   ...
   * 居宅2に内部項目を追加します。
   */
  protected void addHoumonSymbiosisTypeRadioItem3(){
   ...
   * 重度訪問に内部項目を追加します。
   */
  protected void addHoumonSymbiosisTypeRadioItem4(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_11111_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_11111_201804Design getThis() {
    return this;
  }
}
