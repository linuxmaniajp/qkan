 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防短期入所生活介護 (QS001_12411_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防短期入所生活介護画面項目デザイン(QS001_12411_201204) 
 */
public class QS001_12411_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_12411_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12411_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12411_201204Design getThis() {
    return this;
  }
}
