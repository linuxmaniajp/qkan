...
/**
 * サービスパターン短期入所療養介護（病院療養）画面項目デザイン(QS001_12311_201504) 
 */
public class QS001_12311_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_12311_201504Design() {
  ...
  protected void addTab2(){
    ...
    tab2.add(getShortStayHospitalRecuperationAdditionTypeForShortstayContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12311_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12311_201504Design getThis() {
    return this;
  }
}
