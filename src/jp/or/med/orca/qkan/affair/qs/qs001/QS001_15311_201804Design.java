...
/**
 * サービスパターン介護療養型医療施設（病院）画面項目デザイン(QS001_15311_201804) 
 */
public class QS001_15311_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getHospitalizedPatientsCriteriaRadio(){
    if(hospitalizedPatientsCriteriaRadio==null){
      ...
      hospitalizedPatientsCriteriaRadio.setBindPath("1530171");
  ...
  public ACValueArrayRadioButtonGroup getMedicalFacilityHospitalEnvironmentalRadio(){
    if(medicalFacilityHospitalEnvironmentalRadio==null){
      ...
      medicalFacilityHospitalEnvironmentalRadio.setValues(new int[]{1,2});
  ...
  public ACValueArrayRadioButtonGroup getHospitalRecuperationAdditionType(){
    if(hospitalRecuperationAdditionType==null){
      ...
      hospitalRecuperationAdditionType.setBindPath("1530172");
  ...
  public ACValueArrayRadioButtonGroup getLowNutritionalRiskImprovementAdd(){
    if(lowNutritionalRiskImprovementAdd==null){
      ...
      lowNutritionalRiskImprovementAdd.setBindPath("1530173");
  ...
  public ACValueArrayRadioButtonGroup getExcretionSupport(){
    if(excretionSupport==null){
      ...
      excretionSupport.setBindPath("1530174");
   ...
   * コンストラクタです。
   */
  public QS001_15311_201804Design() {
  ...
  protected void addMedicalFacilityHospitalNightShiftSubtractionRadioModel(){
    ...
    getMedicalFacilityHospitalNightShiftSubtractionRadioItem5().setButtonIndex(2);
  ...
  protected void addTab4(){
    ...
    tab4.add(getHospitalRecuperationAdditionTypeContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_15311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_15311_201804Design getThis() {
    return this;
  }
}
