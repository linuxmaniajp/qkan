...
/**
 * サービスパターン短期入所療養介護（診療所療養）(QS001_12312_201204)
 */
@SuppressWarnings("serial")
public class QS001_12312_201204 extends QS001_12312_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_12312_201204() {
        // 必須の事業所設定項目
        putCheckProviderBindPath("介護職員処遇改善加算", "4");

        // 値を転記する事業所設定項目
        putImportProviderBindPath("施設区分", "1230201", "1230201");
        putImportProviderBindPath("人員配置", "1230202", "1230202");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12312_201204.class.getName(),
                param));
    }
    ...
    public void checkState() throws Exception {
        ...
        // 緊急短期入所受入加算
        if (getShortStayClinicRecuperationEmergencyNetworkAddRadio().getSelectedIndex() == 2) {
            setState_INVALID_YOUNG_DEMENTIA_PATINET();
        } else {
            setState_VALID_YOUNG_DEMENTIA_PATINET();
        }
