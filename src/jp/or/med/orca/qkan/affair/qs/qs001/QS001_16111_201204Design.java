...
/**
 * サービスパターン介護予防訪問介護画面項目デザイン(QS001_16111_201204) 
 */
public class QS001_16111_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getClassEmploymentAddRadioItem1(){
    if(classEmploymentAddRadioItem1==null){
      ...
      //2014/03/03 [Shinobu Hitaka] edit - begin 【ホームヘルパー2級→介護職員初任者研修】
      //classEmploymentAddRadioItem1.setText("2級以外");
      classEmploymentAddRadioItem1.setText("初任以外");
      //2014/03/03 [Shinobu Hitaka] edit - end   【ホームヘルパー2級→介護職員初任者研修】
  ...
  public ACRadioButtonItem getClassEmploymentAddRadioItem2(){
    if(classEmploymentAddRadioItem2==null){
      ...
      //2014/03/03 [Shinobu Hitaka] edit - begin 【ホームヘルパー2級→介護職員初任者研修】
      //classEmploymentAddRadioItem2.setText("2級");
   ...
   * コンストラクタです。
   */
  public QS001_16111_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_16111_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_16111_201204Design getThis() {
    return this;
  }
}
