...
/**
 * サービスパターン介護療養型医療施設（診療所）画面項目デザイン(QS001121) 
 */
public class QS001121Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001121Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001121Design getThis() {
    return this;
  }
}
