...
/**
 * サービスパターン短期入所療養介護（診療所療養）イベント定義(QS001_12312_201504) 
 */
public abstract class QS001_12312_201504Event extends QS001_12312_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12312_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
