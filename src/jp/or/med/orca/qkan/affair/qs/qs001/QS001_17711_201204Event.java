 ...
 * アプリ: QKANCHO
 * 開発者: 上司　和善
 * 作成日: 2012/02/24  日本コンピューター株式会社 上司　和善 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン複合型サービスIイベント定義(QS001_17711_201204) 
 */
public abstract class QS001_17711_201204Event extends QS001_17711_201204SQL implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_17711_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
