...
/**
 * サービスパターン介護予防短期入所療養介護（病院）イベント定義(QS001139_H2104) 
 */
public abstract class QS001139_H2104Event extends QS001139_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001139_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
