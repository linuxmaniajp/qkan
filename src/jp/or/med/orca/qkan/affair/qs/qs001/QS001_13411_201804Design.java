...
/**
 * サービスパターン介護予防居宅療養管理指導画面項目デザイン(QS001_13411_201804) 
 */
public class QS001_13411_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getPatientRadioGroup(){
    if(patientRadioGroup==null){
      ...
      patientRadioGroup.setBindPath("1340111");
  ...
  public ACRadioButtonItem getPatientLocationRadioItem1(){
    if(patientLocationRadioItem1==null){
      ...
      patientLocationRadioItem1.setText("単一建物居住者（1人）");
  ...
  public ACRadioButtonItem getPatientLocationRadioItem2(){
    if(patientLocationRadioItem2==null){
      ...
      patientLocationRadioItem2.setText("単一建物居住者（2～9人）");
  ...
  public ACRadioButtonItem getPatientLocationRadioItem3(){
    if(patientLocationRadioItem3==null){
      ...
      patientLocationRadioItem3.setText("上記以外");
   ...
   * コンストラクタです。
   */
  public QS001_13411_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_13411_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_13411_201804Design getThis() {
    return this;
  }
}
