...
/**
 * サービスパターン介護療養型医療施設（診療所）イベント定義(QS001_15312_201504) 
 */
public abstract class QS001_15312_201504Event extends QS001_15312_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_15312_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
