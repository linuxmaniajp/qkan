 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン短期入所療養介護（病院療養） (QS001_12311_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所療養介護（病院療養）(QS001_12311_201504)
 */
@SuppressWarnings("serial")
public class QS001_12311_201504 extends QS001_12311_201504Event {
    /**
     * コンストラクタです。
     */
    public QS001_12311_201504() {
        // 必須の事業所設定項目
        putCheckProviderBindPath("介護職員処遇改善加算", "4");

        // 値を転記する事業所設定項目
        putImportProviderBindPath("施設区分", "1230124", "1230101");
        putImportProviderBindPath("人員配置区分（病院療養型用）", "1230126", "1230102");
        putImportProviderBindPath("療養環境基準", "1230123", "1230116");
        putImportProviderBindPath("医師の配置基準", "1230105", "1230107");
        putImportProviderBindPath("サービス提供体制強化加算", "1230122", "1230115");
        putImportProviderBindPath("ユニットケア体制", "1230127", "1230111");
        
        putImportProviderBindPath("人員配置区分（ユニット型病院療養型用）", "1230129", "1230122");
        putImportProviderBindPath("人員配置区分（病院経過型用）", "1230130", "1230123");

        // 値により入力を禁止する事業所設定項目
        putRestrictProviderBindPath("療養食", "1230121", "1230110");
        putRestrictProviderBindPath("若年性認知症利用者受入加算", "1230120", "1230114");
        putRestrictProviderBindPath("ユニットケア体制", "1230127", "1230111");
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12311_201504.class.getName(),
                param));
    }
