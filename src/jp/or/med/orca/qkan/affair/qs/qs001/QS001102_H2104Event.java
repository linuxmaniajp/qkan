...
/**
 * サービスパターン訪問入浴介護イベント定義(QS001102_H2104) 
 */
public abstract class QS001102_H2104Event extends QS001102_H2104Design implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001102_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
