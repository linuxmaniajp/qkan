...
/**
 * サービスパターン介護予防認知症対応型通所介護画面項目デザイン(QS001146_H2104) 
 */
public class QS001146_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001146_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001146_H2104Design getThis() {
    return this;
  }
}
