 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン介護予防短期入所療養介護（介護老人保健施設） (QS001_12511_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防短期入所療養介護（介護老人保健施設）(QS001_12511_201204)
 */
@SuppressWarnings("serial")
public class QS001_12511_201204 extends QS001_12511_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_12511_201204() {
        ...
        putImportProviderBindPath("人員配置区分（療養型）", "1250124", "1250125");
        putImportProviderBindPath("施設等の区分（体制）", "1250116", "1250113");
        putImportProviderBindPath("夜間勤務条件基準", "1250102", "1250104");
        putImportProviderBindPath("ユニットケア体制", "1250104", "1250112");
        putImportProviderBindPath("リハビリテーション機能強化", "1250105", "1250105");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12511_201204.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            switch (ACCastUtilities.toInt(
                    VRBindPathParser.get("1250122", provider), 0)) {
            case 1:
                // 値が1（なし）だった場合
