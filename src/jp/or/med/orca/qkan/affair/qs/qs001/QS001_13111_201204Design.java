 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン短期入所療養介護（居宅療養管理指導） (QS001_13111_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所療養介護（居宅療養管理指導）画面項目デザイン(QS001_13111_201204) 
 */
public class QS001_13111_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup recuperationManagementGuidanceOccupationalCategoryZaiSouShinRadio;
   ...
   * @return 医学総合管理料
   */
  public ACValueArrayRadioButtonGroup getRecuperationManagementGuidanceOccupationalCategoryZaiSouShinRadio(){
    if(recuperationManagementGuidanceOccupationalCategoryZaiSouShinRadio==null){
      ...
      recuperationManagementGuidanceOccupationalCategoryZaiSouShinRadio.setValues(new int[]{1,2});
  ...
  public ACValueArrayRadioButtonGroup getPatientRadioGroup(){
    if(patientRadioGroup==null){
      ...
      patientRadioGroup.setBindPath("16");
      ...
      patientRadioGroup.setValues(new int[]{1,2});
   ...
   * コンストラクタです。
   */
  public QS001_13111_201204Design() {
  ...
  protected void addPatientRadioGroupModel(){
    ...
    getPatientRadioGroupModel().add(getPatientRadioItem1());

    getPatientRadioItem2().setButtonIndex(2);

    getPatientRadioGroupModel().add(getPatientRadioItem2());
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_13111_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_13111_201204Design getThis() {
    return this;
  }
}
