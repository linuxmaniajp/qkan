...
/**
 * サービスパターン介護予防訪問看護(QS001_16311_201804)
 */
@SuppressWarnings("serial")
public class QS001_16311_201804 extends QS001_16311_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_16311_201804() {
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_16311_201804.class.getName(),
                param));
    }
    ...
    public void checkState() throws Exception {
        ...
        case 3:
        case 4:
            if (getVisitPersonAddRadio().getSelectedIndex() == 2 || getVisitPersonAddRadio().getSelectedIndex() == 3) {
                // 訪問人数が2人の場合
