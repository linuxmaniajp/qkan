 ...
 * アプリ: QKANCHO
 * 開発者: 松本　幸一
 * 作成日: 2006/06/05  日本コンピューター株式会社 松本　幸一 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン介護予防特定施設入居者生活介護画面項目デザイン(QS001143) 
 */
public class QS001143Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001143Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001143Design getThis() {
    return this;
  }
}
