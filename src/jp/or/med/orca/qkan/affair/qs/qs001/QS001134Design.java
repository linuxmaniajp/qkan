...
/**
 * サービスパターン介護予防居宅療養管理指導画面項目デザイン(QS001134) 
 */
public class QS001134Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getRecuperationManagementGuidanceOccupationalCategory(){
    if(recuperationManagementGuidanceOccupationalCategory==null){
      ...
      recuperationManagementGuidanceOccupationalCategory.setBindPath("1340101");
  ...
  public ACClearableRadioButtonGroup getRecuperationManagementGuidanceTimesHospitalRadio(){
    if(recuperationManagementGuidanceTimesHospitalRadio==null){
      ...
      recuperationManagementGuidanceTimesHospitalRadio.setBindPath("1340105");
  ...
  public ACClearableRadioButtonGroup getRecuperationManagementGuidanceTimesDrugstoreRadio(){
    if(recuperationManagementGuidanceTimesDrugstoreRadio==null){
      ...
      recuperationManagementGuidanceTimesDrugstoreRadio.setBindPath("1340106");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001134Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001134Design getThis() {
    return this;
  }
}
