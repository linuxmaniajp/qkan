...
/**
 * サービスパターン短期入所療養介護（病院療養）イベント定義(QS001111_H2104) 
 */
public abstract class QS001111_H2104Event extends QS001111_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001111_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
