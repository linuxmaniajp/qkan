...
/**
 * サービスパターン介護老人保健施設画面項目デザイン(QS001_15211_201504) 
 */
public class QS001_15211_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_15211_201504Design() {
  ...
  protected void addTab6(){
    ...
    tab6.add(getServiceAddProvisionStructuralRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_15211_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_15211_201504Design getThis() {
    return this;
  }
}
