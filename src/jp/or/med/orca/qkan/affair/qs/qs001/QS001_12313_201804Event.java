...
/**
 * サービスパターン短期入所療養介護（認知症疾患）イベント定義(QS001_12313_201804) 
 */
public abstract class QS001_12313_201804Event extends QS001_12313_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12313_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
