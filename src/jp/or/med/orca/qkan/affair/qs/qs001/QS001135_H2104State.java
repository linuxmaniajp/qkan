...
/**
 * サービスパターン介護予防通所介護状態定義(QS001135_H2104) 
 */
public class QS001135_H2104State extends QS001135_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001135_H2104State(){
  }

  /**
   * 「アクティビティ実施加算・無効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_ACTIVITY_ENABLE_FALSE() throws Exception {
  ...
  /**
   * 「アクティビティ実施加算・有効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_ACTIVITY_ENABLE_TRUE() throws Exception {
