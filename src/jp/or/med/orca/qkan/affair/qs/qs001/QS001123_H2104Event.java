...
/**
 * サービスパターン夜間対応型訪問介護イベント定義(QS001123_H2104) 
 */
public abstract class QS001123_H2104Event extends QS001123_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001123_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
