...
/**
 * サービスパターン居宅介護支援(QS001_14311_201804)
 */
@SuppressWarnings("serial")
public class QS001_14311_201804 extends QS001_14311_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_14311_201804() {
        // チェック
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_14311_201804.class.getName(),
                param));
    }
    ...
    public void changeState() throws Exception {
        ...
        // [H30.4法改正対応][Shinobu Hitaka] 2018/03/06 add begin
        // 特定事業所加算IVを選択不可（2019.4.1から算定可）
        if (getCalculater().getTargetDate() != null && 
                ACDateUtilities.getDifferenceOnDay(ACDateUtilities.createDate(2019, 4, 1), getCalculater().getTargetDate()) > 0) {
        	getKaigoSupportSpecificStandardRadioItem5().setEnabled(false);
        }
        // [H30.4法改正対応][Shinobu Hitaka] 2018/03/06 add end
