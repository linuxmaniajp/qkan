 ...
 * アプリ: QKANCHO
 * 開発者: 亀井　陽一郎
 * 作成日: 2018/02/19  日本コンピューター株式会社 亀井　陽一郎 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * 特別診療費画面画面項目デザイン(QS001S03_201804) 
 */
public class QS001S03_201804Design extends QkanAffairDialog {
  //GUIコンポーネント
  ...
  protected void addEtcFrames(){
    ...
    etcFrames.add(getGroupCommunicationContainer(), VRLayout.FLOW_INSETLINE);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      new QS001S03_201804Design().setVisible(true);
      System.exit(0);
    } catch (Exception e) {
      e.printStackTrace();
    }
   ...
   * 自身を返します。
   */
  protected QS001S03_201804Design getThis() {
    return this;
  }
}
