 ...
 * アプリ: QKANCHO
 * 開発者: 堤 瑞樹
 * 作成日: 2006/03/14  日本コンピューター株式会社 堤 瑞樹 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン訪問看護（介護)イベント定義(QS001103) 
 */
public abstract class QS001103Event extends QS001103State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001103Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
