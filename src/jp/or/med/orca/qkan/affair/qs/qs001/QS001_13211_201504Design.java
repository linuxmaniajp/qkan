 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン認知症対応共同生活介護（短期利用以外） (QS001_13211_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン認知症対応共同生活介護（短期利用以外）画面項目デザイン(QS001_13211_201504) 
 */
public class QS001_13211_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_13211_201504Design() {
  ...
  protected void addTab2(){
    ...
    tab2.add(getKaigoHealthCareOfTheAgedCalculationDivisionRadioContainer(), VRLayout.FLOW_INSETLINE);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_13211_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_13211_201504Design getThis() {
    return this;
  }
}
