 ...
 * アプリ: QKANCHO
 * 開発者: サービス予定
 * 作成日: 2017/06/19  日本コンピューター株式会社 サービス予定 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン介護予防ケアマネジメントSQL定義(QS001_51511_201504) 
 */
public class QS001_51511_201504SQL extends QS001_51511_201504State {
  private ACSQLSafeDateFormat dateFormat = new ACSQLSafeDateFormat();
  /**
   * コンストラクタです。
   */
  public QS001_51511_201504SQL() {
  }
