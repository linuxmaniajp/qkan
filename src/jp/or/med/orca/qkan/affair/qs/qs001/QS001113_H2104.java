...
/**
 * サービスパターン短期入所療養介護（認知症疾患）(QS001113_H2104) 
 */
public class QS001113_H2104 extends QS001113_H2104Event {
  /**
   * コンストラクタです。
   */
  public QS001113_H2104(){
  }
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QS001113_H2104.class.getName(), param));
  }
  ...
  public void initialize() throws Exception{
      ...
      getShortStayDementiaRecuperationSpecificConsultationFee()
        ...
        comboItemMap.setData("1230352", QkanCommon.getArrayFromMasterCode(273,
                "1230352"));
        // ※展開
  ...
  public void providerSelected(VRMap provider) throws Exception{
      ...
      if (provider != null) {
          ...
          // 療養食
          switch (ACCastUtilities.toInt(VRBindPathParser.get("1230318", provider),0)) {
          case 2:
              // 「あり」の場合
              // 有効にする。
              setState_VALID_MEDICAL_EXPENSES();
              // [ID:0000481][Tozo TANAKA] 2009/04/08 delete begin 平成21年4月法改正対応(療養食)
//              defaultMap.setData("1230307",new Integer(2));
          ...
          // [ID:0000481][Tozo TANAKA] 2009/04/08 delete begin 平成21年4月法改正対応(療養食)
//              defaultMap.setData("1230307",new Integer(1));
              // [ID:0000481][Tozo TANAKA] 2009/04/08 delete end
              break;
          }
          // [ID:0000481][Tozo TANAKA] 2009/04/08 add begin 平成21年4月法改正対応(療養食)
          //常にdefaultMapに KEY：1230307 VALUE：1（なし）を設定する。
          VRBindPathParser.set("1230307", defaultMap, new Integer(1));   
...
//                  defaultMap.setData("1230310", obj);
          ...
          //サービス提供体制強化加算
          obj = VRBindPathParser.get("1230319", provider);
          if (obj != null) {
              VRBindPathParser.set("1230351", defaultMap, obj);
          }
