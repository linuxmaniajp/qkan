...
/**
 * サービスパターン認知症対応共同生活介護状態定義(QS001126_H2104) 
 */
public class QS001126_H2104State extends QS001126_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001126_H2104State(){
  }
   ...
   * @throws Exception 処理例外
   */
  public void setState_VALID_WATCH_KAIGO() throws Exception {

        getWatchKaigoAddRadioGroup().setEnabled(true);
   ...
   * @throws Exception 処理例外
   */
  public void setState_INVALID_WATCH_KAIGO() throws Exception {

        getWatchKaigoAddRadioGroup().setEnabled(false);
