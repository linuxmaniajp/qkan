 ...
 * アプリ: QKANCHO
 * 開発者: サービス予定
 * 作成日: 2009/02/10  日本コンピューター株式会社 サービス予定 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン介護予防小規模多機能型居宅介護SQL定義(QS001147_H2104) 
 */
public class QS001147_H2104SQL extends QS001147_H2104Design {
  private ACSQLSafeDateFormat dateFormat = new ACSQLSafeDateFormat();
  /**
   * コンストラクタです。
   */
  public QS001147_H2104SQL() {
  }
