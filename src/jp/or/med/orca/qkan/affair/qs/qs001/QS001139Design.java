...
/**
 * サービスパターン介護予防短期入所療養介護（病院）画面項目デザイン(QS001139) 
 */
public class QS001139Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getShortStayHospitalRecuperationSubtractionType(){
    if(shortStayHospitalRecuperationSubtractionType==null){
      ...
      shortStayHospitalRecuperationSubtractionType.setBindPath("1260106");
  ...
  public ACClearableRadioButtonGroup getShortStayHospitalRecuperationDieticianManageRadio(){
    if(shortStayHospitalRecuperationDieticianManageRadio==null){
      ...
      shortStayHospitalRecuperationDieticianManageRadio.setBindPath("1260108");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001139Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001139Design getThis() {
    return this;
  }
}
