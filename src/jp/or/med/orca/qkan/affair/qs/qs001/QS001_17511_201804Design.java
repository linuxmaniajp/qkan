 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防小規模多機能型居宅介護 (QS001_17511_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防小規模多機能型居宅介護画面項目デザイン(QS001_17511_201804) 
 */
public class QS001_17511_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getComprehensiveManagementSystemRadioGroup(){
    if(comprehensiveManagementSystemRadioGroup==null){
      ...
      comprehensiveManagementSystemRadioGroup.setBindPath("1750110");
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1750111");
  ...
  public ACValueArrayRadioButtonGroup getRehabilitationSpecialistPersonnelCooperationRadioGroup(){
    if(rehabilitationSpecialistPersonnelCooperationRadioGroup==null){
      ...
      rehabilitationSpecialistPersonnelCooperationRadioGroup.setBindPath("1750112");
  ...
  public ACValueArrayRadioButtonGroup getNutritionScreening(){
    if(nutritionScreening==null){
      ...
      nutritionScreening.setBindPath("1750113");
   ...
   * コンストラクタです。
   */
  public QS001_17511_201804Design() {
  ...
  protected void addRegionSmallscaleMultiPatterns(){
    ...
    regionSmallscaleMultiPatterns.addTab("3", getTab3());
  ...
  protected void addTab1(){
    ...
    tab1.add(getComprehensiveManagementSystemRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17511_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17511_201804Design getThis() {
    return this;
  }
}
