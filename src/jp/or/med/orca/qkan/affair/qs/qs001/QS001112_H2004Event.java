...
/**
 * サービスパターン短期入所療養介護（診療所療養）イベント定義(QS001112_H2004) 
 */
public abstract class QS001112_H2004Event extends QS001112_H2004State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001112_H2004Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
