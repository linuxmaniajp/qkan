...
/**
 * サービスパターン介護予防特定施設入居者生活介護(QS001_13511_201804)
 */
@SuppressWarnings("serial")
public class QS001_13511_201804 extends QS001_13511_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_13511_201804() {
        ...
        putRestrictProviderBindPath("生活機能向上連携加算", "1350110", "1350150"); //[H30.4改正]
        putRestrictProviderBindPath("若年性認知症入居者受入加算", "1350110", "1350151"); //[H30.4改正]
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_13511_201804.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            // 身体拘束未実施減算
            Object obj = VRBindPathParser.get("1350109", provider);
            if (obj != null) {
                // 身体拘束未実施取組みなしだった場合
                if (ACCastUtilities.toInt(obj) == 1) {
                    VRBindPathParser.set("1350149", defaultMap, new Integer(2));
                } else if (ACCastUtilities.toInt(obj) == 2) {
                    // 身体拘束未実施取組みありだった場合
                    VRBindPathParser.set("1350149", defaultMap, new Integer(1));
                }
            }
