...
/**
 * サービスパターン介護老人保健施設イベント定義(QS001119_H2005) 
 */
public abstract class QS001119_H2005Event extends QS001119_H2005State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001119_H2005Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
