...
/**
 * サービスパターン訪問リハイベント定義(QS001_11411_201204) 
 */
public abstract class QS001_11411_201204Event extends QS001_11411_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_11411_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
