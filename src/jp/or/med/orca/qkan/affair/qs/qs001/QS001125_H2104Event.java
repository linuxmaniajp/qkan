...
/**
 * サービスパターン小規模多機能型介護イベント定義(QS001125_H2104) 
 */
public abstract class QS001125_H2104Event extends QS001125_H2104SQL implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001125_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
