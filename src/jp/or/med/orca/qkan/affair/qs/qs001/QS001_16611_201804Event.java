...
/**
 * サービスパターン介護予防通所リハビリテーションイベント定義(QS001_16611_201804) 
 */
@SuppressWarnings("serial")
public abstract class QS001_16611_201804Event extends QS001_16611_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_16611_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
