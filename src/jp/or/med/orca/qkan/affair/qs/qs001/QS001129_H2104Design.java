 ...
 * アプリ: QKANCHO
 * 開発者: 田中　統蔵
 * 作成日: 2009/03/17  日本コンピューター株式会社 田中　統蔵 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム サービス予定作成/変更 (S)
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン地域密着型介護福祉施設 (QS001129_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン地域密着型介護福祉施設画面項目デザイン(QS001129_H2104) 
 */
public class QS001129_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup oralKeppAddRadioGroup;

  private ACLabelContainer oralKeppAddRadioGroupContainer;

  private ACListModelAdapter oralKeppAddRadioGroupModel;

  private ACRadioButtonItem oralKeppAddRadioItem1;

  private ACRadioButtonItem oralKeppAddRadioItem2;
  ...
  private ACClearableRadioButtonGroup smallBaseFacilitiesAddRadio;
  ...
  public ACLabelContainer getProviderDivisionContena(){
    if(providerDivisionContena==null){
      ...
      providerDivisionContena.setText("施設等の区分");
  ...
  public ACIntegerCheckBox getPassageRegionServiceCheck(){
    if(passageRegionServiceCheck==null){
      ...
      passageRegionServiceCheck.setText("経過的地域密着サービス");
  ...
  public ACValueArrayRadioButtonGroup getNurseStructuralAddRadioGroup(){
    if(nurseStructuralAddRadioGroup==null){
      ...
      nurseStructuralAddRadioGroup.setBindPath("1540130");
  ...
  public ACClearableRadioButtonGroup getKaigoWelfareFacilityPsychiatristRadio(){
    if(kaigoWelfareFacilityPsychiatristRadio==null){
      ...
      getKaigoWelfareFacilityPsychiatristRadioContainer().setText("精神科療養指導加算");
   ...
   * @return 口腔機能維持管理加算
   */
  public ACValueArrayRadioButtonGroup getOralKeppAddRadioGroup(){
    if(oralKeppAddRadioGroup==null){

      oralKeppAddRadioGroup = new ACValueArrayRadioButtonGroup();

      getOralKeppAddRadioGroupContainer().setText("口腔機能維持管理加算");

      oralKeppAddRadioGroup.setBindPath("1540133");

      oralKeppAddRadioGroup.setNoSelectIndex(0);

      oralKeppAddRadioGroup.setUseClearButton(false);

      oralKeppAddRadioGroup.setModel(getOralKeppAddRadioGroupModel());

      oralKeppAddRadioGroup.setValues(new int[]{1,2});

      addOralKeppAddRadioGroup();
    }
    return oralKeppAddRadioGroup;
   ...
   */
  protected ACLabelContainer getOralKeppAddRadioGroupContainer(){
    if(oralKeppAddRadioGroupContainer==null){
      oralKeppAddRadioGroupContainer = new ACLabelContainer();
      oralKeppAddRadioGroupContainer.setFollowChildEnabled(true);
      oralKeppAddRadioGroupContainer.setVAlignment(VRLayout.CENTER);
      oralKeppAddRadioGroupContainer.add(getOralKeppAddRadioGroup(), null);
    }
    return oralKeppAddRadioGroupContainer;
  }
   ...
   */
  protected ACListModelAdapter getOralKeppAddRadioGroupModel(){
    if(oralKeppAddRadioGroupModel==null){
      oralKeppAddRadioGroupModel = new ACListModelAdapter();
      addOralKeppAddRadioGroupModel();
    }
    return oralKeppAddRadioGroupModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getOralKeppAddRadioItem1(){
    if(oralKeppAddRadioItem1==null){

      oralKeppAddRadioItem1 = new ACRadioButtonItem();

      oralKeppAddRadioItem1.setText("なし");

      oralKeppAddRadioItem1.setGroup(getOralKeppAddRadioGroup());

      oralKeppAddRadioItem1.setConstraints(VRLayout.FLOW);

      addOralKeppAddRadioItem1();
    }
    return oralKeppAddRadioItem1;
   ...
   * @return あり
   */
  public ACRadioButtonItem getOralKeppAddRadioItem2(){
    if(oralKeppAddRadioItem2==null){

      oralKeppAddRadioItem2 = new ACRadioButtonItem();

      oralKeppAddRadioItem2.setText("あり");

      oralKeppAddRadioItem2.setGroup(getOralKeppAddRadioGroup());

      oralKeppAddRadioItem2.setConstraints(VRLayout.FLOW);

      addOralKeppAddRadioItem2();
    }
    return oralKeppAddRadioItem2;
   ...
   * @return 小規模拠点集合型施設加算
   */
  public ACClearableRadioButtonGroup getSmallBaseFacilitiesAddRadio(){
    if(smallBaseFacilitiesAddRadio==null){

      smallBaseFacilitiesAddRadio = new ACClearableRadioButtonGroup();

      getSmallBaseFacilitiesAddRadioContainer().setText("小規模拠点集合型施設加算");
  ...
  /**
   * 小規模拠点集合型施設加算コンテナを取得します。
   * @return 小規模拠点集合型施設加算コンテナ
   */
  ...
  /**
   * 小規模拠点集合型施設加算モデルを取得します。
   * @return 小規模拠点集合型施設加算モデル
   */
  ...
  public ACRadioButtonItem getSmallBaseFacilitiesAddRadioItem1(){
    if(smallBaseFacilitiesAddRadioItem1==null){
      ...
      smallBaseFacilitiesAddRadioItem1.setText("なし");
  ...
  public ACRadioButtonItem getSmallBaseFacilitiesAddRadioItem2(){
    if(smallBaseFacilitiesAddRadioItem2==null){
      ...
      smallBaseFacilitiesAddRadioItem2.setText("あり");
  ...
  protected void addTab1(){
    ...
    tab1.add(getNurseStructuralAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTab2(){
    ...
    tab2.add(getOralKeppAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   */
  protected void addOralKeppAddRadioGroup(){
   ...
   */
  protected void addOralKeppAddRadioGroupModel(){

    getOralKeppAddRadioItem1().setButtonIndex(1);

    getOralKeppAddRadioGroupModel().add(getOralKeppAddRadioItem1());

    getOralKeppAddRadioItem2().setButtonIndex(2);

    getOralKeppAddRadioGroupModel().add(getOralKeppAddRadioItem2());
   ...
   * なしに内部項目を追加します。
   */
  protected void addOralKeppAddRadioItem1(){
   ...
   * ありに内部項目を追加します。
   */
  protected void addOralKeppAddRadioItem2(){
  ...
  protected void addTab4(){
    ...
    tab4.add(getSmallBaseFacilitiesAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001129_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001129_H2104Design getThis() {
    return this;
  }
}
