 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防短期入所生活介護 (QS001_12411_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防短期入所生活介護画面項目デザイン(QS001_12411_201804) 
 */
public class QS001_12411_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getSymbiosisTypeRadio(){
    if(symbiosisTypeRadio==null){
      ...
      symbiosisTypeRadio.setValues(new int[]{1,10});
  ...
  public ACValueArrayRadioButtonGroup getDeploymentLifeCounselor(){
    if(deploymentLifeCounselor==null){
      ...
      deploymentLifeCounselor.setBindPath("1240116");
  ...
  public ACValueArrayRadioButtonGroup getImprovementCollaboration(){
    if(improvementCollaboration==null){
      ...
      improvementCollaboration.setBindPath("1240117");
  ...
  public ACValueArrayRadioButtonGroup getDementiaProfessionalCareAddRadioGroup(){
    if(dementiaProfessionalCareAddRadioGroup==null){
      ...
      dementiaProfessionalCareAddRadioGroup.setBindPath("1240118");
   ...
   * コンストラクタです。
   */
  public QS001_12411_201804Design() {
  ...
  protected void addSymbiosisTypeRadioModel(){
    ...
    getSymbiosisTypeRadioItem2().setButtonIndex(10);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12411_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12411_201804Design getThis() {
    return this;
  }
}
