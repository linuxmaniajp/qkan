 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2009/03/13  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン通所介護画面項目デザイン(QS001107_H2104) 
 */
public class QS001107_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACRadioButtonItem tsuusyoKaigoAdditionFunctionTrainingRadioItem3;
  ...
  public ACClearableRadioButtonGroup getTsuusyoKaigoAdditionFunctionTrainingRadio(){
    if(tsuusyoKaigoAdditionFunctionTrainingRadio==null){
      ...
      tsuusyoKaigoAdditionFunctionTrainingRadio.setBindPath("1150114");
  ...
  public ACRadioButtonItem getTsuusyoKaigoAdditionFunctionTrainingRadioItem2(){
    if(tsuusyoKaigoAdditionFunctionTrainingRadioItem2==null){
      ...
      tsuusyoKaigoAdditionFunctionTrainingRadioItem2.setText("加算型I");

      tsuusyoKaigoAdditionFunctionTrainingRadioItem2.setGroup(getTsuusyoKaigoAdditionFunctionTrainingRadio());

      tsuusyoKaigoAdditionFunctionTrainingRadioItem2.setConstraints(VRLayout.FLOW_RETURN);
   ...
   * @return 加算型II
   */
  public ACRadioButtonItem getTsuusyoKaigoAdditionFunctionTrainingRadioItem3(){
    if(tsuusyoKaigoAdditionFunctionTrainingRadioItem3==null){

      tsuusyoKaigoAdditionFunctionTrainingRadioItem3 = new ACRadioButtonItem();

      tsuusyoKaigoAdditionFunctionTrainingRadioItem3.setText("加算型II");

      tsuusyoKaigoAdditionFunctionTrainingRadioItem3.setGroup(getTsuusyoKaigoAdditionFunctionTrainingRadio());

      tsuusyoKaigoAdditionFunctionTrainingRadioItem3.setConstraints(VRLayout.FLOW);

      addTsuusyoKaigoAdditionFunctionTrainingRadioItem3();
    }
    return tsuusyoKaigoAdditionFunctionTrainingRadioItem3;
  ...
  protected void addTab1(){
    ...
    tab1.add(getTsuusyoKaigoAdditionFunctionTrainingRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTsuusyoKaigoAdditionFunctionTrainingRadioModel(){
    ...
    getTsuusyoKaigoAdditionFunctionTrainingRadioItem3().setButtonIndex(3);

    getTsuusyoKaigoAdditionFunctionTrainingRadioModel().add(getTsuusyoKaigoAdditionFunctionTrainingRadioItem3());
   ...
   * 加算型IIに内部項目を追加します。
   */
  protected void addTsuusyoKaigoAdditionFunctionTrainingRadioItem3(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001107_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001107_H2104Design getThis() {
    return this;
  }
}
