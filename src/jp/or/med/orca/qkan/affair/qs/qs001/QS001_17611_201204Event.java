...
/**
 * サービスパターン定期巡回・随時対応型訪問介護看護イベント定義(QS001_17611_201204) 
 */
public abstract class QS001_17611_201204Event extends QS001_17611_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_17611_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
