...
/**
 * サービスパターン夜間対応型訪問介護イベント定義(QS001_17111_201204) 
 */
public abstract class QS001_17111_201204Event extends QS001_17111_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_17111_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
