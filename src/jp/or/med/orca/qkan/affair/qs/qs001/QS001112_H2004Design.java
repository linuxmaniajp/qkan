 ...
 * アプリ: QKANCHO
 * 開発者: 松本　幸一
 * 作成日: 2008/03/18  日本コンピューター株式会社 松本　幸一 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン短期入所療養介護（診療所療養）画面項目デザイン(QS001112_H2004) 
 */
public class QS001112_H2004Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACClearableRadioButtonGroup shortStayClinicRecuperationProvisionBase;
   ...
   * @return 設備基準減算
   */
  public ACClearableRadioButtonGroup getShortStayClinicRecuperationProvisionBase(){
    if(shortStayClinicRecuperationProvisionBase==null){

      shortStayClinicRecuperationProvisionBase = new ACClearableRadioButtonGroup();
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001112_H2004Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001112_H2004Design getThis() {
    return this;
  }
}
