...
/**
 * サービスパターン介護療養型医療施設（病院）画面項目デザイン(QS001023) 
 */
public class QS001023Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getMedicalFacilityHospitalInstitutionDivisionRadio(){
    if(medicalFacilityHospitalInstitutionDivisionRadio==null){
      ...
      getMedicalFacilityHospitalInstitutionDivisionRadioContainer().setText("施設区分");
  ...
  public ACRadioButtonItem getMedicalFacilityHospitalDoctorArrangeStandardRadioItem1(){
    if(medicalFacilityHospitalDoctorArrangeStandardRadioItem1==null){
      ...
      medicalFacilityHospitalDoctorArrangeStandardRadioItem1.setConstraints(VRLayout.FLOW);
  ...
  public ACRadioButtonItem getMedicalFacilityHospitalDoctorArrangeStandardRadioItem2(){
    if(medicalFacilityHospitalDoctorArrangeStandardRadioItem2==null){
      ...
      medicalFacilityHospitalDoctorArrangeStandardRadioItem2.setText("49条適用");
  ...
  public ACRadioButtonItem getMedicalFacilityHospitalNutritionManageRadioItem2(){
    if(medicalFacilityHospitalNutritionManageRadioItem2==null){
      ...
      medicalFacilityHospitalNutritionManageRadioItem2.setText("管理栄養士配置加算");
  ...
  public ACRadioButtonItem getMedicalFacilityHospitalNutritionManageRadioItem3(){
    if(medicalFacilityHospitalNutritionManageRadioItem3==null){
      ...
      medicalFacilityHospitalNutritionManageRadioItem3.setText("栄養士配置加算");
  ...
  protected void addTab1(){
    ...
    tab1.add(getMedicalFacilityHospitalStandardRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab1.add(getMedicalFacilityHospitalMedicalExaminationRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTab2(){
    ...
    tab2.add(getMedicalFacilityHospitalConsultationFee(), VRLayout.FLOW);

    tab2.add(getMedicalFacilityHospitalConsultationFeeLabel(), VRLayout.FLOW_RETURN);

    tab2.add(getMedicalFacilityHospitalSubstractionContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab2.add(getMedicalFacilityDinnerContainer(), VRLayout.FLOW_DOUBLEINSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.getInstance().getContentPane().add(new QS001023Design());
   ...
   * 自身を返します。
   */
  protected QS001023Design getThis() {
    return this;
  }
}
