 ...
 * アプリ: QKANCHO
 * 開発者: サービス予定
 * 作成日: 2009/03/02  日本コンピューター株式会社 サービス予定 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン介護予防支援費SQL定義(QS001145_H2104) 
 */
public class QS001145_H2104SQL extends QS001145_H2104State {
  private ACSQLSafeDateFormat dateFormat = new ACSQLSafeDateFormat();
  /**
   * コンストラクタです。
   */
  public QS001145_H2104SQL() {
  }
