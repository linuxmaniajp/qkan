...
/**
 * サービスパターン認知症対応型通所介護画面項目デザイン(QS001_17211_201504) 
 */
public class QS001_17211_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_17211_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17211_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17211_201504Design getThis() {
    return this;
  }
}
