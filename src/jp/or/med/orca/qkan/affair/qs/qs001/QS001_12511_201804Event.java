...
/**
 * サービスパターン介護予防短期入所療養介護（介護老人保健施設）イベント定義(QS001_12511_201804) 
 */
@SuppressWarnings("serial")
public abstract class QS001_12511_201804Event extends QS001_12511_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12511_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
