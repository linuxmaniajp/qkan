...
/**
 * サービスパターン訪問入浴介護画面項目デザイン(QS001004) 
 */
public class QS001004Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getHomonNyuyokuClass(){
    if(homonNyuyokuClass==null){
      ...
      getHomonNyuyokuClassContainer().setText("訪問者種別");
  ...
  protected void addThis(){
    ...
    this.add(getHomonNyuyokuPatterns(), VRLayout.WEST);
  ...
  protected void addHomonNyuyokuClassModel(){
    ...
    getHomonNyuyokuClassDouble().setButtonIndex(0);
    getHomonNyuyokuClassModel().add(getHomonNyuyokuClassDouble());

    getHomonNyuyokuClassSingle().setButtonIndex(1);
  ...
  protected void addHomonNyuyokuPartsRadioModel(){
    ...
    getHomonNyuyokuPartsRadioItem1().setButtonIndex(0);
    getHomonNyuyokuPartsRadioModel().add(getHomonNyuyokuPartsRadioItem1());

    getHomonNyuyokuPartsRadioItem2().setButtonIndex(1);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.getInstance().getContentPane().add(new QS001004Design());
