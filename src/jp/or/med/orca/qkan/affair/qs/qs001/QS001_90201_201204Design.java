 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン主な日常生活上の活動 (QS001_90201_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン主な日常生活上の活動画面項目デザイン(QS001_90201_201204) 
 */
@SuppressWarnings("serial")
public class QS001_90201_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_90201_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_90201_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_90201_201204Design getThis() {
    return this;
  }
}
