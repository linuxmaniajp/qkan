 ...
 * アプリ: QKANCHO
 * 開発者: 日高　しのぶ
 * 作成日: 2018/03/09  日本コンピューター株式会社 日高　しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム サービス予定作成/変更 (S)
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防特定施設入居者生活介護 (QS001_13511_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防特定施設入居者生活介護画面項目デザイン(QS001_13511_201804) 
 */
public class QS001_13511_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getPhysicalRestraintNotRepealed(){
    if(physicalRestraintNotRepealed==null){
      ...
      physicalRestraintNotRepealed.setBindPath("1350149");
  ...
  public ACValueArrayRadioButtonGroup getImprovementCollaboration(){
    if(improvementCollaboration==null){
      ...
      improvementCollaboration.setBindPath("1350150");
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1350151");
  ...
  public ACValueArrayRadioButtonGroup getOralHygieneControlSystem(){
    if(oralHygieneControlSystem==null){
      ...
      oralHygieneControlSystem.setBindPath("1350152");
  ...
  public ACValueArrayRadioButtonGroup getNutritionScreening(){
    if(nutritionScreening==null){
      ...
      nutritionScreening.setBindPath("1350153");
  ...
  public ACRadioButtonItem getOutsideServiceRadioItem9(){
    if(outsideServiceRadioItem9==null){
      ...
      outsideServiceRadioItem9.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACRadioButtonItem getOutsideServiceRadioItem10(){
    if(outsideServiceRadioItem10==null){
      ...
      outsideServiceRadioItem10.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACRadioButtonItem getVisitCareRadioItem2(){
    if(visitCareRadioItem2==null){
      ...
      visitCareRadioItem2.setConstraints(VRLayout.FLOW);
  ...
  public ACValueArrayRadioButtonGroup getExpertPlaceRehabiliRadio(){
    if(expertPlaceRehabiliRadio==null){
      ...
      expertPlaceRehabiliRadio.setValues(new int[]{1,2,3});
  ...
  public ACRadioButtonItem getExpertPlaceRehabiliRadioItem3(){
    if(expertPlaceRehabiliRadioItem3==null){
      ...
      expertPlaceRehabiliRadioItem3.setText("介護医療院");
  ...
  public ACRadioButtonItem getVisitCareServiceRadioItem2(){
    if(visitCareServiceRadioItem2==null){
      ...
      visitCareServiceRadioItem2.setConstraints(VRLayout.FLOW);
   ...
   * コンストラクタです。
   */
  public QS001_13511_201804Design() {
  ...
  protected void addServicePanelAdd(){
    ...
    servicePanelAdd.add(getPhysicalRestraintNotRepealedContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    servicePanelAdd.add(getImprovementCollaborationContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    servicePanelAdd.add(getYoungDementiaPatinetAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTabPanel4(){
    ...
    tabPanel4.add(getVisitCareGroup(), VRLayout.NORTH);
  ...
  protected void addTabPanel5(){
    ...
    tabPanel5.add(getVisitRehabiliGroup(), VRLayout.NORTH);
  ...
  protected void addTabPanel9(){
    ...
    tabPanel9.add(getVisitCareServiceGroup(), VRLayout.NORTH);

    tabPanel9.add(getExpertPlaceNursingServiceGroup(), VRLayout.NORTH);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_13511_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_13511_201804Design getThis() {
    return this;
  }
}
