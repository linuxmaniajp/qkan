...
/**
 * サービスパターン介護予防短期入所療養介護（診療所）画面項目デザイン(QS001_12612_201204) 
 */
public class QS001_12612_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup shortStayClinicRecuperationDivision;
   ...
   * @return 人員配置区分
   */
  public ACValueArrayRadioButtonGroup getShortStayClinicRecuperationDivision(){
    if(shortStayClinicRecuperationDivision==null){

      shortStayClinicRecuperationDivision = new ACValueArrayRadioButtonGroup();
      ...
      shortStayClinicRecuperationDivision.setValues(new int[]{1,2});
   ...
   * コンストラクタです。
   */
  public QS001_12612_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12612_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12612_201204Design getThis() {
    return this;
  }
}
