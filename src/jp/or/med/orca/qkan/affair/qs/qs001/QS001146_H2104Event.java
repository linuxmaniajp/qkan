...
/**
 * サービスパターン介護予防認知症対応型通所介護イベント定義(QS001146_H2104) 
 */
public abstract class QS001146_H2104Event extends QS001146_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001146_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
