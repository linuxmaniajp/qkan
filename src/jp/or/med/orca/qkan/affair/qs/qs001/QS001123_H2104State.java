...
/**
 * サービスパターン夜間対応型訪問介護状態定義(QS001123_H2104) 
 */
public class QS001123_H2104State extends QS001123_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001123_H2104State(){
  }
  ...
  /**
   * 「24時間通報対応・有効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_VALID_24MESSAGE() throws Exception {

        getHours24MessageAddRadioGroup().setEnabled(true);

  }

  /**
   * 「24時間通報対応・無効」の状態に設定します。
   * @throws Exception 処理例外
   */
