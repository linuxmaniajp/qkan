 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン特定施設入所者生活介護（短期利用） (QS001_12711_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン特定施設入所者生活介護（短期利用）画面項目デザイン(QS001_12711_201804) 
 */
public class QS001_12711_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup juvenileDementiaAcceptanceRadio;

  private ACLabelContainer juvenileDementiaAcceptanceRadioContainer;

  private ACListModelAdapter juvenileDementiaAcceptanceRadioModel;

  private ACRadioButtonItem juvenileDementiaAcceptanceRadioItem1;

  private ACRadioButtonItem juvenileDementiaAcceptanceRadioItem2;
   ...
   * @return 若年性認知症受入加算
   */
  public ACValueArrayRadioButtonGroup getJuvenileDementiaAcceptanceRadio(){
    if(juvenileDementiaAcceptanceRadio==null){

      juvenileDementiaAcceptanceRadio = new ACValueArrayRadioButtonGroup();

      getJuvenileDementiaAcceptanceRadioContainer().setText("若年性認知症受入加算");

      juvenileDementiaAcceptanceRadio.setBindPath("1270104");

      juvenileDementiaAcceptanceRadio.setUseClearButton(false);

      juvenileDementiaAcceptanceRadio.setModel(getJuvenileDementiaAcceptanceRadioModel());

      juvenileDementiaAcceptanceRadio.setValues(new int[]{1,2});

      addJuvenileDementiaAcceptanceRadio();
    }
    return juvenileDementiaAcceptanceRadio;
   ...
   */
  protected ACLabelContainer getJuvenileDementiaAcceptanceRadioContainer(){
    if(juvenileDementiaAcceptanceRadioContainer==null){
      juvenileDementiaAcceptanceRadioContainer = new ACLabelContainer();
      juvenileDementiaAcceptanceRadioContainer.setFollowChildEnabled(true);
      juvenileDementiaAcceptanceRadioContainer.setVAlignment(VRLayout.CENTER);
      juvenileDementiaAcceptanceRadioContainer.add(getJuvenileDementiaAcceptanceRadio(), null);
    }
    return juvenileDementiaAcceptanceRadioContainer;
  }
   ...
   */
  protected ACListModelAdapter getJuvenileDementiaAcceptanceRadioModel(){
    if(juvenileDementiaAcceptanceRadioModel==null){
      juvenileDementiaAcceptanceRadioModel = new ACListModelAdapter();
      addJuvenileDementiaAcceptanceRadioModel();
    }
    return juvenileDementiaAcceptanceRadioModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getJuvenileDementiaAcceptanceRadioItem1(){
    if(juvenileDementiaAcceptanceRadioItem1==null){

      juvenileDementiaAcceptanceRadioItem1 = new ACRadioButtonItem();

      juvenileDementiaAcceptanceRadioItem1.setText("なし");

      juvenileDementiaAcceptanceRadioItem1.setGroup(getJuvenileDementiaAcceptanceRadio());

      juvenileDementiaAcceptanceRadioItem1.setConstraints(VRLayout.FLOW);

      addJuvenileDementiaAcceptanceRadioItem1();
    }
    return juvenileDementiaAcceptanceRadioItem1;
   ...
   * @return あり
   */
  public ACRadioButtonItem getJuvenileDementiaAcceptanceRadioItem2(){
    if(juvenileDementiaAcceptanceRadioItem2==null){

      juvenileDementiaAcceptanceRadioItem2 = new ACRadioButtonItem();

      juvenileDementiaAcceptanceRadioItem2.setText("あり");

      juvenileDementiaAcceptanceRadioItem2.setGroup(getJuvenileDementiaAcceptanceRadio());

      juvenileDementiaAcceptanceRadioItem2.setConstraints(VRLayout.FLOW);

      addJuvenileDementiaAcceptanceRadioItem2();
    }
    return juvenileDementiaAcceptanceRadioItem2;
   ...
   * コンストラクタです。
   */
  public QS001_12711_201804Design() {
  ...
  protected void addSpecificFacilityPatterns(){
    ...
    specificFacilityPatterns.add(getJuvenileDementiaAcceptanceRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   */
  protected void addJuvenileDementiaAcceptanceRadio(){
   ...
   */
  protected void addJuvenileDementiaAcceptanceRadioModel(){

    getJuvenileDementiaAcceptanceRadioItem1().setButtonIndex(1);

    getJuvenileDementiaAcceptanceRadioModel().add(getJuvenileDementiaAcceptanceRadioItem1());

    getJuvenileDementiaAcceptanceRadioItem2().setButtonIndex(2);

    getJuvenileDementiaAcceptanceRadioModel().add(getJuvenileDementiaAcceptanceRadioItem2());
   ...
   * なしに内部項目を追加します。
   */
  protected void addJuvenileDementiaAcceptanceRadioItem1(){
   ...
   * ありに内部項目を追加します。
   */
  protected void addJuvenileDementiaAcceptanceRadioItem2(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12711_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12711_201804Design getThis() {
    return this;
  }
}
