 ...
 * アプリ: QKANCHO
 * 開発者: 亀井　陽一郎
 * 作成日: 2018/02/13  日本コンピューター株式会社 亀井　陽一郎 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン小規模多機能型介護画面項目デザイン(QS001_16811_201804) 
 */
public class QS001_16811_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getStaffSubtractionRadio(){
    if(staffSubtractionRadio==null){
      ...
      staffSubtractionRadio.setBindPath("1680101");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("1680102");
  ...
  public ACValueArrayRadioButtonGroup getRehabilitationSpecialistPersonnelCooperationRadioGroup(){
    if(rehabilitationSpecialistPersonnelCooperationRadioGroup==null){
      ...
      rehabilitationSpecialistPersonnelCooperationRadioGroup.setBindPath("1680104");
  ...
  public ACTextField getTekiyouText(){
    if(tekiyouText==null){
      ...
      tekiyouText.setBindPath("1680103");
   ...
   * コンストラクタです。
   */
  public QS001_16811_201804Design() {
  ...
  protected void addRegionSmallscaleMultiPatterns(){
    ...
    regionSmallscaleMultiPatterns.add(getRehabilitationSpecialistPersonnelCooperationRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_16811_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_16811_201804Design getThis() {
    return this;
  }
}
