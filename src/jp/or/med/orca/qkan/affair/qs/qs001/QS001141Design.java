...
/**
 * サービスパターン介護予防短期入所療養介護（認知症）画面項目デザイン(QS001141) 
 */
public class QS001141Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getShortStayDementiaRecuperationDieticianManageRadio(){
    if(shortStayDementiaRecuperationDieticianManageRadio==null){
      ...
      shortStayDementiaRecuperationDieticianManageRadio.setBindPath("1260306");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001141Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001141Design getThis() {
    return this;
  }
}
