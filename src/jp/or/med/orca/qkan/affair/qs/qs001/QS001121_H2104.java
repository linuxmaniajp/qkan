...
/**
 * サービスパターン介護療養型医療施設（診療所）(QS001121_H2104)
 */
...
//                    defaultMap.setData("1530212", new Integer(2));
            ...
            //常にdefaultMapに KEY：1530212 VALUE：1（なし）を設定する。
            VRBindPathParser.set("1530212", defaultMap, new Integer(1));   
            ...
            //設備基準（事業所パネル）KEY：1530219の値をチェックする。
            ...
            //常にdefaultMapに KEY：1530262 VALUE：1（なし）を設定する。
            VRBindPathParser.set("1530262", defaultMap, new Integer(1));
            
            //認知症専門ケア加算（事業所パネル）KEY：1530222の値をチェックする。
            ...
            //常にdefaultMapに KEY：1530263 VALUE：1（なし）を設定する。
            VRBindPathParser.set("1530263", defaultMap, new Integer(1));   
            
            //サービス提供体制強化加算（事業所パネル）KEY：1530223の値をチェックする。
            ...
            case 4:
                //4（III型）
                //defaultMapに KEY：1530264 VALUE：事業所の値を設定する。
                VRBindPathParser.set("1530264", defaultMap, obj);   
                break;
            default:
                //値が上記以外だった場合
                //defaultMapに KEY：1530264 VALUE：1（なし）を設定する。
