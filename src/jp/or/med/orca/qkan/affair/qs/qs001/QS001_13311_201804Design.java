 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン特定施設入所者生活介護 (QS001_13311_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン特定施設入所者生活介護画面項目デザイン(QS001_13311_201804) 
 */
public class QS001_13311_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACRadioButtonItem visitRehabiliRadioItem3;
  ...
  public ACValueArrayRadioButtonGroup getPhysicalRestraintNotRepealed(){
    if(physicalRestraintNotRepealed==null){
      ...
      physicalRestraintNotRepealed.setBindPath("1330137");
  ...
  public ACValueArrayRadioButtonGroup getSupportForContinuedTenancy(){
    if(supportForContinuedTenancy==null){
      ...
      supportForContinuedTenancy.setBindPath("1330138");
  ...
  public ACValueArrayRadioButtonGroup getImprovementCollaboration(){
    if(improvementCollaboration==null){
      ...
      improvementCollaboration.setBindPath("1330139");
  ...
  public ACValueArrayRadioButtonGroup getOralHygieneControlSystem(){
    if(oralHygieneControlSystem==null){
      ...
      oralHygieneControlSystem.setBindPath("1330141");
  ...
  public ACValueArrayRadioButtonGroup getNutritionScreening(){
    if(nutritionScreening==null){
      ...
      nutritionScreening.setBindPath("1330142");
  ...
  public ACValueArrayRadioButtonGroup getCollaborationAtDischargeRadioGroup(){
    if(collaborationAtDischargeRadioGroup==null){
      ...
      collaborationAtDischargeRadioGroup.setBindPath("1330143");
  ...
  public ACRadioButtonItem getDementiaProfessionalCareAddRadioItem1(){
    if(dementiaProfessionalCareAddRadioItem1==null){
      ...
      dementiaProfessionalCareAddRadioItem1.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACValueArrayRadioButtonGroup getVisitRehabiliRadio(){
    if(visitRehabiliRadio==null){
      ...
      visitRehabiliRadio.setValues(new int[]{1,2,3});
  ...
  public ACRadioButtonItem getVisitRehabiliRadioItem2(){
    if(visitRehabiliRadioItem2==null){
      ...
      visitRehabiliRadioItem2.setConstraints(VRLayout.FLOW_RETURN);
   ...
   * @return 介護医療院
   */
  public ACRadioButtonItem getVisitRehabiliRadioItem3(){
    if(visitRehabiliRadioItem3==null){

      visitRehabiliRadioItem3 = new ACRadioButtonItem();

      visitRehabiliRadioItem3.setText("介護医療院");

      visitRehabiliRadioItem3.setGroup(getVisitRehabiliRadio());

      visitRehabiliRadioItem3.setConstraints(VRLayout.FLOW);

      addVisitRehabiliRadioItem3();
    }
    return visitRehabiliRadioItem3;
  ...
  public ACValueArrayRadioButtonGroup getExpertPlaceNursingRadio(){
    if(expertPlaceNursingRadio==null){
      ...
      expertPlaceNursingRadio.setValues(new int[]{1,2,3});
  ...
  public ACValueArrayRadioButtonGroup getExpertPlaceRehabiliRadio(){
    if(expertPlaceRehabiliRadio==null){
      ...
      expertPlaceRehabiliRadio.setValues(new int[]{1,2,3,4,5,6,7,8,9});
  ...
  /**
   * 通常規模事業所（介護医療院）を取得します。
   * @return 通常規模事業所（介護医療院）
   */
  public ACRadioButtonItem getExpertPlaceRehabiliRadioItem7(){
    if(expertPlaceRehabiliRadioItem7==null){

      expertPlaceRehabiliRadioItem7 = new ACRadioButtonItem();

      expertPlaceRehabiliRadioItem7.setText("通常規模事業所（介護医療院）");

      expertPlaceRehabiliRadioItem7.setGroup(getExpertPlaceRehabiliRadio());

      expertPlaceRehabiliRadioItem7.setConstraints(VRLayout.FLOW_RETURN);

      addExpertPlaceRehabiliRadioItem7();
    }
    return expertPlaceRehabiliRadioItem7;
   ...
   */
  public ACRadioButtonItem getExpertPlaceRehabiliRadioItem8(){
    if(expertPlaceRehabiliRadioItem8==null){

      expertPlaceRehabiliRadioItem8 = new ACRadioButtonItem();

      expertPlaceRehabiliRadioItem8.setText("大規模事業所 I（介護医療院）");

      expertPlaceRehabiliRadioItem8.setGroup(getExpertPlaceRehabiliRadio());

      expertPlaceRehabiliRadioItem8.setConstraints(VRLayout.FLOW_RETURN);

      addExpertPlaceRehabiliRadioItem8();
    }
    return expertPlaceRehabiliRadioItem8;
  ...
  public ACRadioButtonItem getExpertPlaceRehabiliRadioItem6(){
    if(expertPlaceRehabiliRadioItem6==null){
      ...
      expertPlaceRehabiliRadioItem6.setConstraints(VRLayout.FLOW_RETURN);
   ...
   */
  public ACRadioButtonItem getExpertPlaceRehabiliRadioItem9(){
    if(expertPlaceRehabiliRadioItem9==null){

      expertPlaceRehabiliRadioItem9 = new ACRadioButtonItem();

      expertPlaceRehabiliRadioItem9.setText("大規模事業所 II（介護医療院）");

      expertPlaceRehabiliRadioItem9.setGroup(getExpertPlaceRehabiliRadio());

      expertPlaceRehabiliRadioItem9.setConstraints(VRLayout.FLOW);

      addExpertPlaceRehabiliRadioItem9();
    }
    return expertPlaceRehabiliRadioItem9;
  ...
  public ACValueArrayRadioButtonGroup getTimeDivisionRadio(){
    if(timeDivisionRadio==null){
      ...
      timeDivisionRadio.setValues(new int[]{1,2,3,4,5,6,7});
  ...
  public ACRadioButtonItem getTimeDivisionRadioItem3(){
    if(timeDivisionRadioItem3==null){
      ...
      timeDivisionRadioItem3.setText("4から5時間");
  ...
  public ACRadioButtonItem getTimeDivisionRadioItem4(){
    if(timeDivisionRadioItem4==null){
      ...
      timeDivisionRadioItem4.setText("5から6時間");
  ...
  public ACRadioButtonItem getTimeDivisionRadioItem5(){
    if(timeDivisionRadioItem5==null){
      ...
      timeDivisionRadioItem5.setText("6から7時間");
  ...
  public ACRadioButtonItem getTimeDivisionRadioItem6(){
    if(timeDivisionRadioItem6==null){
      ...
      timeDivisionRadioItem6.setText("7から8時間");
  ...
  public ACRadioButtonItem getTimeDivisionRadioItem7(){
    if(timeDivisionRadioItem7==null){
      ...
      timeDivisionRadioItem7.setText("8から9時間");
   ...
   * @return タブパネル9
   */
  public ACPanel getTabPanel9(){
    if(tabPanel9==null){

      tabPanel9 = new ACPanel();

      tabPanel9.setFollowChildEnabled(true);
   ...
   * コンストラクタです。
   */
  public QS001_13311_201804Design() {
  ...
  protected void addTabPanel1(){
    ...
    tabPanel1.add(getPhysicalRestraintNotRepealedContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tabPanel1.add(getSupportForContinuedTenancyContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTabPanel2(){
    ...
    tabPanel2.add(getImprovementCollaborationContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tabPanel2.add(getYoungDementiaPatinetAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tabPanel2.add(getOralHygieneControlSystemContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tabPanel2.add(getNutritionScreeningContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tabPanel2.add(getCollaborationAtDischargeRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTabPanel3(){
    ...
    tabPanel3.add(getDementiaProfessionalCareAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tabPanel3.add(getServiceAddProvisionStructuralRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tabPanel3.add(getCalculationDivisionRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTabPanel4(){
    ...
    tabPanel4.add(getServiceSettingPanel(), VRLayout.NORTH);
  ...
  protected void addTabPanel5(){
    ...
    tabPanel5.add(getVisitCareGroup(), VRLayout.NORTH);

    tabPanel5.add(getVisitNursingRadioGroup(), VRLayout.NORTH);
  ...
  protected void addTabPanel6(){
    ...
    tabPanel6.add(getVisitRehabiliGroup(), VRLayout.NORTH);

    tabPanel6.add(getExpertPlaceNursingGroup(), VRLayout.NORTH);
  ...
  protected void addVisitRehabiliRadioModel(){
    ...
    getVisitRehabiliRadioItem3().setButtonIndex(3);

    getVisitRehabiliRadioModel().add(getVisitRehabiliRadioItem3());
   ...
   * 介護医療院に内部項目を追加します。
   */
  protected void addVisitRehabiliRadioItem3(){
  ...
  protected void addExpertPlaceNursingRadioModel(){
    ...
    getExpertPlaceNursingRadioItem2().setButtonIndex(1);

    getExpertPlaceNursingRadioModel().add(getExpertPlaceNursingRadioItem2());

    getExpertPlaceNursingRadioItem3().setButtonIndex(2);

    getExpertPlaceNursingRadioModel().add(getExpertPlaceNursingRadioItem3());

    getExpertPlaceNursingRadioItem4().setButtonIndex(3);
  ...
  protected void addTabPanel7(){
    ...
    tabPanel7.add(getExpertPlaceRehabiliGroup(), VRLayout.NORTH);
  ...
  protected void addExpertPlaceRehabiliRadioModel(){
    ...
    getExpertPlaceRehabiliRadioItem7().setButtonIndex(3);

    getExpertPlaceRehabiliRadioModel().add(getExpertPlaceRehabiliRadioItem7());

    getExpertPlaceRehabiliRadioItem3().setButtonIndex(4);

    getExpertPlaceRehabiliRadioModel().add(getExpertPlaceRehabiliRadioItem3());

    getExpertPlaceRehabiliRadioItem4().setButtonIndex(5);

    getExpertPlaceRehabiliRadioModel().add(getExpertPlaceRehabiliRadioItem4());

    getExpertPlaceRehabiliRadioItem8().setButtonIndex(6);

    getExpertPlaceRehabiliRadioModel().add(getExpertPlaceRehabiliRadioItem8());

    getExpertPlaceRehabiliRadioItem5().setButtonIndex(7);

    getExpertPlaceRehabiliRadioModel().add(getExpertPlaceRehabiliRadioItem5());

    getExpertPlaceRehabiliRadioItem6().setButtonIndex(8);

    getExpertPlaceRehabiliRadioModel().add(getExpertPlaceRehabiliRadioItem6());

    getExpertPlaceRehabiliRadioItem9().setButtonIndex(9);

    getExpertPlaceRehabiliRadioModel().add(getExpertPlaceRehabiliRadioItem9());
  ...
  /**
   * 通常規模事業所（介護医療院）に内部項目を追加します。
   */
  protected void addExpertPlaceRehabiliRadioItem7(){
   ...
   */
  protected void addExpertPlaceRehabiliRadioItem8(){
   ...
   */
  protected void addExpertPlaceRehabiliRadioItem9(){
  ...
  protected void addTabPanel8(){
    ...
    tabPanel8.add(getWelfareToolsGroup(), VRLayout.NORTH);

    tabPanel8.add(getNinchishoTaioTsushoGroup(), VRLayout.NORTH);
   ...
   * タブパネル9に内部項目を追加します。
   */
  protected void addTabPanel9(){

    tabPanel9.add(getChiikiDayCareGroup(), VRLayout.NORTH);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_13311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_13311_201804Design getThis() {
    return this;
  }
}
