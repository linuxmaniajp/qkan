 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン訪問リハ (QS001_11411_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン訪問リハ画面項目デザイン(QS001_11411_201804) 
 */
public class QS001_11411_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getHoumonRehabilitationManagementAddRadio(){
    if(houmonRehabilitationManagementAddRadio==null){
      ...
      houmonRehabilitationManagementAddRadio.setValues(new int[]{1,2,3,4,5});
  ...
  public ACRadioButtonItem getHoumonRehabilitationManagementAddRadioItem4(){
    if(houmonRehabilitationManagementAddRadioItem4==null){
      ...
      houmonRehabilitationManagementAddRadioItem4.setText("III型");
  ...
  public ACRadioButtonItem getHoumonRehabilitationManagementAddRadioItem5(){
    if(houmonRehabilitationManagementAddRadioItem5==null){
      ...
      houmonRehabilitationManagementAddRadioItem5.setText("IV型");
  ...
  public ACValueArrayRadioButtonGroup getPlannedUnexecutedSubRadioGroup(){
    if(plannedUnexecutedSubRadioGroup==null){
      ...
      plannedUnexecutedSubRadioGroup.setBindPath("1140113");
   ...
   * コンストラクタです。
   */
  public QS001_11411_201804Design() {
  ...
  protected void addTab2(){
    ...
    tab2.add(getPlannedUnexecutedSubRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_11411_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_11411_201804Design getThis() {
    return this;
  }
}
