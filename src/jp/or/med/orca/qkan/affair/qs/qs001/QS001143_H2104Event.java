...
/**
 * サービスパターン介護予防特定施設入居者生活介護イベント定義(QS001143_H2104) 
 */
public abstract class QS001143_H2104Event extends QS001143_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001143_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
