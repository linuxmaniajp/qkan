 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防訪問リハビリテーション (QS001133)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防訪問リハビリテーション画面項目デザイン(QS001133) 
 */
public class QS001133Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getHoumonRehabiliManagementAddRadio(){
    if(houmonRehabiliManagementAddRadio==null){
      ...
      houmonRehabiliManagementAddRadio.setBindPath("1640102");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001133Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001133Design getThis() {
    return this;
  }
}
