...
/**
 * サービスパターン特定施設入所者生活介護状態定義(QS001_13311_201804) 
 */
public class QS001_13311_201804State extends QS001_13311_201804Design {
  /**
   * コンストラクタです。
   */
  public QS001_13311_201804State(){
  }
  ...
  public void setState_SELECT_SPECIAL() throws Exception {
        ...
        getPhysicalRestraintNotRepealed().setEnabled(true);
        getPhysicalRestraintNotRepealed().getParent().setEnabled(true);

        getSupportForContinuedTenancy().setEnabled(true);
        getSupportForContinuedTenancy().getParent().setEnabled(true);

        getImprovementCollaboration().setEnabled(true);
        getImprovementCollaboration().getParent().setEnabled(true);

        getYoungDementiaPatinetAddRadioGroup().setEnabled(true);
        getYoungDementiaPatinetAddRadioGroup().getParent().setEnabled(true);

        getOralHygieneControlSystem().setEnabled(true);
        getOralHygieneControlSystem().getParent().setEnabled(true);

        getNutritionScreening().setEnabled(true);
        getNutritionScreening().getParent().setEnabled(true);

        getCollaborationAtDischargeRadioGroup().setEnabled(true);
        getCollaborationAtDischargeRadioGroup().getParent().setEnabled(true);
  ...
  public void setState_SELECT_OUT() throws Exception {
        ...
        getPhysicalRestraintNotRepealed().setEnabled(false);
        getPhysicalRestraintNotRepealed().getParent().setEnabled(false);

        getSupportForContinuedTenancy().setEnabled(false);
        getSupportForContinuedTenancy().getParent().setEnabled(false);

        getImprovementCollaboration().setEnabled(false);
        getImprovementCollaboration().getParent().setEnabled(false);

        getYoungDementiaPatinetAddRadioGroup().setEnabled(false);
        getYoungDementiaPatinetAddRadioGroup().getParent().setEnabled(false);

        getOralHygieneControlSystem().setEnabled(false);
        getOralHygieneControlSystem().getParent().setEnabled(false);

        getNutritionScreening().setEnabled(false);
        getNutritionScreening().getParent().setEnabled(false);

        getCollaborationAtDischargeRadioGroup().setEnabled(false);
        getCollaborationAtDischargeRadioGroup().getParent().setEnabled(false);
