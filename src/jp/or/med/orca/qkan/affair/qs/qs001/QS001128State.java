 ...
 * アプリ: QKANCHO
 * 開発者: 上司　和善
 * 作成日: 2006/03/29  日本コンピューター株式会社 上司　和善 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービスパターン地域密着型特定施設入居者生活介護 (001)
 * プログラム サービスパターン地域密着型特定施設入居者生活介護 (QS001128)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン地域密着型特定施設入居者生活介護状態定義(QS001128) 
 */
public class QS001128State extends QS001128Design {
  /**
   * コンストラクタです。
   */
  public QS001128State(){
  }
