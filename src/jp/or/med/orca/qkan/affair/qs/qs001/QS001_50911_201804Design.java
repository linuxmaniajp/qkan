...
/**
 * サービスパターンその他の生活支援サービス(配食定率)画面項目デザイン(QS001_50911_201804) 
 */
public class QS001_50911_201804Design extends QS001ServicePanelSogo {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_50911_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_50911_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_50911_201804Design getThis() {
    return this;
  }
}
