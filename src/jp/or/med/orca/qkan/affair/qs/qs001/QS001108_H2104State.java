...
/**
 * サービスパターン通所リハ状態定義(QS001108_H2104) 
 */
public class QS001108_H2104State extends QS001108_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001108_H2104State(){
  }
  ...
  /**
   * 「研修を終了した看護師等によるサービス提供・有効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_VALID_BODY_WORK() throws Exception {

        getBodyworkAddRadioGroup().setEnabled(true);

  }

  /**
   * 「研修を終了した看護師等によるサービス提供・無効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_INVALID_BODY_WORK() throws Exception {

        getBodyworkAddRadioGroup().setEnabled(false);
   ...
   * @throws Exception 処理例外
   */
  public void setState_VALID_OPEN_STOCK_REHABILITATION() throws Exception {

        getOpenStockRehabilitationConcentrationAddRadio().setEnabled(true);
   ...
   * @throws Exception 処理例外
   */
  public void setState_INVALID_OPEN_STOCK_REHABILITATION() throws Exception {

        getOpenStockRehabilitationConcentrationAddRadio().setEnabled(false);
