 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン地域密着型特定施設入所者生活介護 (QS001128_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン地域密着型特定施設入所者生活介護イベント定義(QS001128_H2104) 
 */
public abstract class QS001128_H2104Event extends QS001128_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001128_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
