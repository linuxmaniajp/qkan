...
/**
 * サービスパターン認知症対応型通所介護イベント定義(QS001124_H2104) 
 */
public abstract class QS001124_H2104Event extends QS001124_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001124_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
