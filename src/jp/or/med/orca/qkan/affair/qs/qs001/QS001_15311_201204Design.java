...
/**
 * サービスパターン介護療養型医療施設（病院）画面項目デザイン(QS001_15311_201204) 
 */
public class QS001_15311_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup medicalFacilityHospitalHospitalDivision;
  ...
  private ACValueArrayRadioButtonGroup oralMaintenanceRadio;
   ...
   * @return 人員配置区分
   */
  public ACValueArrayRadioButtonGroup getMedicalFacilityHospitalHospitalDivision(){
    if(medicalFacilityHospitalHospitalDivision==null){

      medicalFacilityHospitalHospitalDivision = new ACValueArrayRadioButtonGroup();
      ...
      medicalFacilityHospitalHospitalDivision.setValues(new int[]{1,2,3});
   ...
   * @return 経口維持加算
   */
  public ACValueArrayRadioButtonGroup getOralMaintenanceRadio(){
    if(oralMaintenanceRadio==null){

      oralMaintenanceRadio = new ACValueArrayRadioButtonGroup();
      ...
      oralMaintenanceRadio.setValues(new int[]{1,2,3});
   ...
   * コンストラクタです。
   */
  public QS001_15311_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_15311_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_15311_201204Design getThis() {
    return this;
  }
}
