...
/**
 * サービスパターン福祉用具イベント定義(QS001_11711_201204) 
 */
public abstract class QS001_11711_201204Event extends QS001_11711_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_11711_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
