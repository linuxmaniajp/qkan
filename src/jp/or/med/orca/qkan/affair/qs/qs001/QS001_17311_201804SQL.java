 ...
 * アプリ: QKANCHO
 * 開発者: サービス予定
 * 作成日: 2011/11/15  日本コンピューター株式会社 サービス予定 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン小規模多機能型居宅介護 (QS001_17311_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン小規模多機能型居宅介護SQL定義(QS001_17311_201804) 
 */
@SuppressWarnings("serial")
public class QS001_17311_201804SQL extends QS001_17311_201804State {
  private ACSQLSafeDateFormat dateFormat = new ACSQLSafeDateFormat();
  /**
   * コンストラクタです。
   */
  public QS001_17311_201804SQL() {
  }
