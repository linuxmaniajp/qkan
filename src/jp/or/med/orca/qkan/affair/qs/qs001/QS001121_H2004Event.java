...
/**
 * サービスパターン介護療養型医療施設（診療所）イベント定義(QS001121_H2004) 
 */
public abstract class QS001121_H2004Event extends QS001121_H2004State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001121_H2004Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
