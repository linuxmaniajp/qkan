...
/**
 * サービスパターン通所型サービス(独自定額)画面項目デザイン(QS001_50811_201504) 
 */
public class QS001_50811_201504Design extends QS001ServicePanelSogo {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_50811_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_50811_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_50811_201504Design getThis() {
    return this;
  }
}
