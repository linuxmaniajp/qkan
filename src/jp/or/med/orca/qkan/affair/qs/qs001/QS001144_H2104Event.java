...
/**
 * サービスパターン介護予防福祉用具貸与イベント定義(QS001144_H2104) 
 */
public abstract class QS001144_H2104Event extends QS001144_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001144_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
