...
/**
 * サービスパターン訪問介護イベント定義(QS001101_H2104) 
 */
public abstract class QS001101_H2104Event extends QS001101_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001101_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
