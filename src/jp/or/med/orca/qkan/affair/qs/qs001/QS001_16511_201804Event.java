...
/**
 * サービスパターン介護予防通所介護イベント定義(QS001_16511_201804) 
 */
public abstract class QS001_16511_201804Event extends QS001_16511_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_16511_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
