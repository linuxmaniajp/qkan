 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン短期入所療養介護（痴呆療養） (QS001113_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所療養介護（痴呆療養）画面項目デザイン(QS001113_H2104) 
 */
public class QS001113_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001113_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001113_H2104Design getThis() {
    return this;
  }
}
