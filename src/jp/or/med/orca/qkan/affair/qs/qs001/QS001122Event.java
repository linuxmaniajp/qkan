 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2006/03/22  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン介護療養型医療施設（認知症）イベント定義(QS001122) 
 */
public abstract class QS001122Event extends QS001122State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001122Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
