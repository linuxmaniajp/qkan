...
/**
 * サービスパターン特定施設入所者生活介護画面項目デザイン(QS001_13311_201204) 
 */
public class QS001_13311_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_13311_201204Design() {
  ...
  protected void addTabPanel1(){
    ...
    tabPanel1.add(getTerminalCareAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTabPanel6(){
    ...
    tabPanel6.add(getNinchishoTaioTsushoGroup(), VRLayout.NORTH);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_13311_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_13311_201204Design getThis() {
    return this;
  }
}
