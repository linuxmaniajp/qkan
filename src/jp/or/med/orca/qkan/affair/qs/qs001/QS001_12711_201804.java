...
/**
 * サービスパターン特定施設入所者生活介護（短期利用）(QS001_12711_201804)
 */
@SuppressWarnings("serial")
public class QS001_12711_201804 extends QS001_12711_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_12711_201804() {
        // 必須の事業所設定項目
        putCheckProviderBindPath("介護職員処遇改善加算", "4");

        // 値を転記する事業所設定項目
        putImportProviderBindPath("夜間看護体制", "1270103", "1270102");
        putImportProviderBindPath("サービス提供体制強化加算", "1270104", "1270103");
        
        
        // 値により入力を禁止する事業所設定項目
        putRestrictProviderBindPath("若年性認知症入居者受入加算", "1270105", "1270104"); //[H30.4改正]
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12711_201804.class.getName(),
                param));
    }
