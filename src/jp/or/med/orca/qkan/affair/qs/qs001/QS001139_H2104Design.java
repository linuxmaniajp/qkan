...
/**
 * サービスパターン介護予防短期入所療養介護（病院）画面項目デザイン(QS001139_H2104) 
 */
public class QS001139_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001139_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001139_H2104Design getThis() {
    return this;
  }
}
