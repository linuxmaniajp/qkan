 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン地域密着型介護老人福祉施設入所者生活介護 (QS001_15411_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン地域密着型介護老人福祉施設入所者生活介護画面項目デザイン(QS001_15411_201504) 
 */
public class QS001_15411_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_15411_201504Design() {
  ...
  protected void addTab5(){
    ...
    tab5.add(getKaigoWelfareFacilityOldMeasuresPerson(), VRLayout.FLOW_INSETLINE_RETURN);
    ...
    tab5.add(getKaigoWelfareFacilityCalculationDivisionRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_15411_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_15411_201504Design getThis() {
    return this;
  }
}
