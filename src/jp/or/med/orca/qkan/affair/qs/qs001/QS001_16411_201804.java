...
/**
 * サービスパターン介護予防訪問リハビリテーション(QS001_16411_201804)
 */
@SuppressWarnings("serial")
public class QS001_16411_201804 extends QS001_16411_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_16411_201804() {
        
        // 値を転記する事業所設定項目
        putImportProviderBindPath("施設区分", "1640101", "1640101");
        putImportProviderBindPath("サービス提供体制強化加算", "1640102", "1640104");
        putImportProviderBindPath("リハビリテーション・マネジメント加算", "1640103", "1640102"); //[H30.4改正]
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_16411_201804.class.getName(),
                param));
    }
    ...
    public void checkState() throws Exception {
      // ※画面状態制御処理を行います。
      // 　リハビリテーションマネジメント加算の値を取得する。
      if (getHoumonRehabilitationManagementAddRadio().getSelectedIndex() > 1) {
          // 事業所評価加算（サービスパネル）のEnableを true にする。
          setState_VALID_OFFICE_EVALUATION();
      }else{
    	  // 事業所評価加算（サービスパネル）のEnableを false にする。
    	  setState_INVALID_OFFICE_EVALUATION();
      }

    }
    
    /**
     * 「リハビリテーションマネジメント加算」イベントです。
     * @param e イベント情報
     * @throws Exception 処理例外
     */
    protected void houmonRehabilitationManagementAddRadioSelectionChanged(
