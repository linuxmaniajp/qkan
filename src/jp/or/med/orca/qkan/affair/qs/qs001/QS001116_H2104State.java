...
/**
 * サービスパターン福祉用具状態定義(QS001116_H2104) 
 */
public class QS001116_H2104State extends QS001116_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001116_H2104State(){
  }
   ...
   */
  public void setState_VALID_ADD_SPECIAL_ARE() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_INVALID_ADD_SPECIAL_ARE() throws Exception {
