 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン地域密着型介護福祉施設 (QS001_15411_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン地域密着型介護福祉施設(QS001_15411_201504)
 */
@SuppressWarnings("serial")
public class QS001_15411_201504 extends QS001_15411_201504Event {
    /**
     * コンストラクタです。
     */
    public QS001_15411_201504() {
    ...
    protected void kaigoWelfareFacilityNutritionRadioSelectionChanged(ListSelectionEvent e) throws Exception{
        ...
        if (getKaigoWelfareFacilityNutritionRadioItem1().isSelected()) {
    ...
    protected void oralMaintenanceAddActionPerformed(
        ...
        if (getOralMaintenanceAddItem2().isSelected()) {
        	...
        	getOralMaintenanceAddItem3().setSelected(false);
            setState_VALID_ORAL_SWITCH();
        }
    ...
    protected void oralMaintenanceAddItem3ActionPerformed(
    		ActionEvent e) throws Exception {
        // 経口維持加算
        if (getOralMaintenanceAddItem3().isSelected()) {
        	getOralMaintenanceAddItem2().setSelected(true);
            setState_INVALID_ORAL_SWITCH();
        }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_15411_201504.class.getName(),
                param));
    }
