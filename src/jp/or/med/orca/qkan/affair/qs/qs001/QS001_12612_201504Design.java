...
/**
 * サービスパターン介護予防短期入所療養介護（診療所）画面項目デザイン(QS001_12612_201504) 
 */
public class QS001_12612_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_12612_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12612_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12612_201504Design getThis() {
    return this;
  }
}
