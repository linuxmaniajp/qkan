 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン福祉用具 (QS001_11711_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン福祉用具イベント定義(QS001_11711_201504) 
 */
public abstract class QS001_11711_201504Event extends QS001_11711_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_11711_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
