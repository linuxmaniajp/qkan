...
/**
 * サービスパターン短期入所療養介護(介護老人保健施設)イベント定義(QS001_12211_201804) 
 */
public abstract class QS001_12211_201804Event extends QS001_12211_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12211_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
