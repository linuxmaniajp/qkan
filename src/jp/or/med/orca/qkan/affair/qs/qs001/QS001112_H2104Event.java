...
/**
 * サービスパターン短期入所療養介護（診療所療養）イベント定義(QS001112_H2104) 
 */
public abstract class QS001112_H2104Event extends QS001112_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001112_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
