...
/**
 * サービスパターン介護療養型医療施設（診療所）イベント定義(QS001_15312_201804) 
 */
public abstract class QS001_15312_201804Event extends QS001_15312_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_15312_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  protected void addEvents() {
    ...
    getMedicalFacilityClinicNutritionRadio().addListSelectionListener(new ListSelectionListener(){
        private boolean lockFlag = false;
        public void valueChanged(ListSelectionEvent e) {
            ...
            lockFlag = true;
            try {
                medicalFacilityClinicNutritionRadioSelectionChanged(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void medicalFacilityClinicNutritionRadioSelectionChanged(ListSelectionEvent e) throws Exception;
