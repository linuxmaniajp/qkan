...
/**
 * サービスパターン地域密着型特定施設入所者生活介護(QS001_13611_201204)
 */
@SuppressWarnings("serial")
public class QS001_13611_201204 extends QS001_13611_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_13611_201204() {
        // チェック
        putCheckProviderBindPath("看取り介護", "1360105");

        // 事業所からの値の引き継ぎ
        putImportProviderBindPath("個別機能訓練指導加算", "1360101", "1360102");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_13611_201204.class.getName(),
                param));
    }
