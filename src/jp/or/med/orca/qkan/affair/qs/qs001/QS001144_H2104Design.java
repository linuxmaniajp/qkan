...
/**
 * サービスパターン介護予防福祉用具貸与画面項目デザイン(QS001144_H2104) 
 */
public class QS001144_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001144_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001144_H2104Design getThis() {
    return this;
  }
}
