...
/**
 * サービスパターン介護療養型医療施設（認知症）画面項目デザイン(QS001122) 
 */
public class QS001122Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  protected ACLabelContainer getMedicalFacilityCognitiveHospitalNutritionManageRadioContainer(){
    if(medicalFacilityCognitiveHospitalNutritionManageRadioContainer==null){
      ...
      medicalFacilityCognitiveHospitalNutritionManageRadioContainer.setFollowChildEnabled(true);
      medicalFacilityCognitiveHospitalNutritionManageRadioContainer.setVAlignment(VRLayout.CENTER);
  ...
  public ACRadioButtonItem getMedicalFacilityCognitiveHospitalNutritionManageRadioItem2(){
    if(medicalFacilityCognitiveHospitalNutritionManageRadioItem2==null){
      ...
      medicalFacilityCognitiveHospitalNutritionManageRadioItem2.setText("管理栄養士");
  ...
  public ACRadioButtonItem getMedicalFacilityCognitiveHospitalNutritionManageRadioItem3(){
    if(medicalFacilityCognitiveHospitalNutritionManageRadioItem3==null){
      ...
      medicalFacilityCognitiveHospitalNutritionManageRadioItem3.setText("栄養士");
   ...
   * 自身を返します。
   */
  protected QS001122Design getThis() {
    return this;
  }
}
