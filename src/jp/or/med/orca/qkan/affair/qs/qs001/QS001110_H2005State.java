 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2008/04/16  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービスパターン短期入所療養介護 (001)
 * プログラム サービスパターン短期入所療養介護 (QS001110_H2005)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所療養介護状態定義(QS001110_H2005) 
 */
public class QS001110_H2005State extends QS001110_H2005Design {
  /**
   * コンストラクタです。
   */
  public QS001110_H2005State(){
  }
