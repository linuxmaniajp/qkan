...
/**
 * サービスパターン日常生活上の活動(QS001_90201_201204)
 */
@SuppressWarnings("serial")
public class QS001_90201_201204 extends QS001_90201_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_90201_201204() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_90201_201204.class.getName()));
    }
    ...
    protected void etcContentDetailIListSelectionChanged(ListSelectionEvent e)
        ...
        if (getEtcContentDetailIList().isSelected()) {
            // リストを選択している場合
            getEtcContentDetailInput().setText(
                    ACCastUtilities.toString(getEtcContentDetailIList()
                            .getSelectedValue()));
            // 編集有効状態にする。
            setState_VALID_EDIT();
        } else {
