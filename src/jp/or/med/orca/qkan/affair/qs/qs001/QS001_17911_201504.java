 ...
 * アプリ: QKANCHO
 * 開発者: 日高しのぶ
 * 作成日: 2015/02/17  MIS九州株式会社　日高しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン複合型サービス（看護小規模多機能型居宅介護・短期利用） (QS001_17911_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン複合型サービス（看護小規模多機能型居宅介護・短期利用）(QS001_17911_201504)
 */
public class QS001_17911_201504 extends QS001_17911_201504Event {
    /**
     * コンストラクタです。
     */
    public QS001_17911_201504() {
        // 必須の事業所設定項目
        putCheckProviderBindPath("職員の欠員による減算の状況", "1790101");

        // 値を転記する事業所設定項目
        putImportProviderBindPath("サービス提供強化加算", "1790102", "1790102");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_17911_201504.class.getName(),
                param));
    }
