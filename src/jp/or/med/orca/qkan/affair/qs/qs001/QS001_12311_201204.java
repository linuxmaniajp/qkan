...
/**
 * サービスパターン短期入所療養介護（病院療養）(QS001_12311_201204)
 */
@SuppressWarnings("serial")
public class QS001_12311_201204 extends QS001_12311_201204Event {
    /**
     * コンストラクタです。
     */
    public QS001_12311_201204() {
        // 必須の事業所設定項目
        putCheckProviderBindPath("介護職員処遇改善加算", "4");

        // 値を転記する事業所設定項目
        putImportProviderBindPath("施設区分", "1230124", "1230101");
        putImportProviderBindPath("人員配置区分", "1230126", "1230102");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12311_201204.class.getName(),
                param));
    }
