...
/**
 * サービスパターン定期巡回・随時対応型訪問介護看護画面項目デザイン(QS001_17611_201804) 
 */
public class QS001_17611_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getHoumonNeededRadio(){
    if(houmonNeededRadio==null){
      ...
      houmonNeededRadio.setBindPath("1760114");
  ...
  public ACRadioButtonItem getHoumonNeededRadioItem2(){
    if(houmonNeededRadioItem2==null){
      ...
      houmonNeededRadioItem2.setText("I型");
  ...
  public ACRadioButtonItem getHoumonNeededRadioItem3(){
    if(houmonNeededRadioItem3==null){
      ...
      houmonNeededRadioItem3.setText("II型(50人以上)");
   ...
   * コンストラクタです。
   */
  public QS001_17611_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17611_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17611_201804Design getThis() {
    return this;
  }
}
