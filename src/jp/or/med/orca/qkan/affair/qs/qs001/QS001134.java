...
/**
 * サービスパターン介護予防居宅療養管理指導(QS001134) 
 */
public class QS001134 extends QS001134Event {
  /**
   * コンストラクタです。
   */
  public QS001134(){
   ...
   */
  protected void recuperationManagementGuidanceOccupationalCategoryActionPerformed(ActionEvent e) throws Exception{
    // 職員区分選択時の処理
    // 職員区分をチェックする
    // 　画面の状態を変更する。
    checkState();
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QS001134.class.getName(), param));
  }
