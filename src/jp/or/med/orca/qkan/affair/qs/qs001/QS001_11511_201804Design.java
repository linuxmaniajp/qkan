...
/**
 * サービスパターン通所介護画面項目デザイン(QS001_11511_201804) 
 */
public class QS001_11511_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getTsuusyoKaigoTimeContenaFacilityDivision(){
    if(tsuusyoKaigoTimeContenaFacilityDivision==null){
      ...
      tsuusyoKaigoTimeContenaFacilityDivision.setValues(new int[]{1,2,3});
  ...
  public ACRadioButtonItem getTsuusyoKaigoFacilitiesDivisionProviderTypeRadio2(){
    if(tsuusyoKaigoFacilitiesDivisionProviderTypeRadio2==null){
      ...
      tsuusyoKaigoFacilitiesDivisionProviderTypeRadio2.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACRadioButtonItem getTsuusyoKaigoFacilitiesDivisionProviderTypeRadio3(){
    if(tsuusyoKaigoFacilitiesDivisionProviderTypeRadio3==null){
      ...
      tsuusyoKaigoFacilitiesDivisionProviderTypeRadio3.setConstraints(VRLayout.FLOW);
  ...
  public ACValueArrayRadioButtonGroup getDementiaElderlyAccepted(){
    if(dementiaElderlyAccepted==null){
      ...
      dementiaElderlyAccepted.setBindPath("1150121");
  ...
  public ACValueArrayRadioButtonGroup getSevereCareRecipientsAccepted(){
    if(severeCareRecipientsAccepted==null){
      ...
      severeCareRecipientsAccepted.setBindPath("1150122");
  ...
  public ACValueArrayRadioButtonGroup getImprovementCollaboration(){
    if(improvementCollaboration==null){
      ...
      improvementCollaboration.setBindPath("1150126");
  ...
  public ACValueArrayRadioButtonGroup getAdlMaintenanceRadioGroup(){
    if(adlMaintenanceRadioGroup==null){
      ...
      adlMaintenanceRadioGroup.setBindPath("1150127");
  ...
  public ACValueArrayRadioButtonGroup getNutritionScreening(){
    if(nutritionScreening==null){
      ...
      nutritionScreening.setBindPath("1150128");
  ...
  public ACValueArrayRadioButtonGroup getDeploymentLifeCounselor(){
    if(deploymentLifeCounselor==null){
      ...
      deploymentLifeCounselor.setBindPath("1150125");
   ...
   * コンストラクタです。
   */
  public QS001_11511_201804Design() {
  ...
  protected void addTab2(){
    ...
    tab2.add(getDementiaElderlyAcceptedContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab2.add(getSevereCareRecipientsAcceptedContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_11511_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_11511_201804Design getThis() {
    return this;
  }
}
