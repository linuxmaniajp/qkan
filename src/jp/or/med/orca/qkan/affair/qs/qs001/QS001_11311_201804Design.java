...
/**
 * サービスパターン訪問看護（介護）画面項目デザイン(QS001_11311_201804) 
 */
public class QS001_11311_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACRadioButtonItem houmonKangoNumberOfPeople3;
  ...
  public ACRadioButtonItem getHoumonKangoKaigoClass2(){
    if(houmonKangoKaigoClass2==null){
      ...
      houmonKangoKaigoClass2.setConstraints(VRLayout.FLOW);
  ...
  public ACValueArrayRadioButtonGroup getHoumonKangoNumberOfPeople(){
    if(houmonKangoNumberOfPeople==null){
      ...
      houmonKangoNumberOfPeople.setValues(new int[]{1,2,3});
  ...
  public ACRadioButtonItem getHoumonKangoNumberOfPeople1(){
    if(houmonKangoNumberOfPeople1==null){
      ...
      houmonKangoNumberOfPeople1.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACRadioButtonItem getHoumonKangoNumberOfPeople2(){
    if(houmonKangoNumberOfPeople2==null){
      ...
      houmonKangoNumberOfPeople2.setText("2人(看護師)");
   ...
   * @return 2人(補助者)
   */
  public ACRadioButtonItem getHoumonKangoNumberOfPeople3(){
    if(houmonKangoNumberOfPeople3==null){

      houmonKangoNumberOfPeople3 = new ACRadioButtonItem();

      houmonKangoNumberOfPeople3.setText("2人(補助者)");

      houmonKangoNumberOfPeople3.setGroup(getHoumonKangoNumberOfPeople());

      houmonKangoNumberOfPeople3.setConstraints(VRLayout.FLOW);

      addHoumonKangoNumberOfPeople3();
    }
    return houmonKangoNumberOfPeople3;
  ...
  public ACRadioButtonItem getCareSupportSystemItem2(){
    if(careSupportSystemItem2==null){
      ...
      careSupportSystemItem2.setText("I型");
  ...
  public ACRadioButtonItem getCareSupportSystemItem3(){
    if(careSupportSystemItem3==null){
      ...
      careSupportSystemItem3.setText("II型");
   ...
   * コンストラクタです。
   */
  public QS001_11311_201804Design() {
  ...
  protected void addTab2(){
    ...
    tab2.add(getSpecialManagementRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTab3(){
    ...
    tab3.add(getHoumonKangoNumberOfPeopleContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab3.add(getHoumonKangoNumberOfPeopleTimeContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addHoumonKangoNumberOfPeopleModel(){
    ...
    getHoumonKangoNumberOfPeople3().setButtonIndex(3);

    getHoumonKangoNumberOfPeopleModel().add(getHoumonKangoNumberOfPeople3());
   ...
   * 2人(補助者)に内部項目を追加します。
   */
  protected void addHoumonKangoNumberOfPeople3(){
  ...
  protected void addCareSupportSystemModel(){
    ...
    getCareSupportSystemItem3().setButtonIndex(3);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_11311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_11311_201804Design getThis() {
    return this;
  }
}
