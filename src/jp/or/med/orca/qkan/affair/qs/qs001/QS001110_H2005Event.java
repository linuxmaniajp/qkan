...
/**
 * サービスパターン短期入所療養介護(介護老人保健施設)イベント定義(QS001110_H2005) 
 */
public abstract class QS001110_H2005Event extends QS001110_H2005State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001110_H2005Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
