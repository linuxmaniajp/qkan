...
/**
 * サービスパターン短期入所療養介護（病院療養）画面項目デザイン(QS001111_H2104) 
 */
public class QS001111_H2104Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getShortStayHospitalRecuperationInstitutionDivisionRadio(){
    if(shortStayHospitalRecuperationInstitutionDivisionRadio==null){
      ...
      shortStayHospitalRecuperationInstitutionDivisionRadio.setValues(new int[]{1,2,4,5,3});
  ...
  public ACValueArrayRadioButtonGroup getNightStaffDispositionAddRadioGroup(){
    if(nightStaffDispositionAddRadioGroup==null){
      ...
      nightStaffDispositionAddRadioGroup.setBindPath("1230119");
  ...
  protected void addTab3(){
    ...
    tab3.add(getShortStayHospitalRecuperationEmergencyNetworkAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001111_H2104Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001111_H2104Design getThis() {
    return this;
  }
}
