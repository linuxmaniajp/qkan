 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2018/02/08  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム サービス予定作成/変更 (S)
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン短期入所療養介護（痴呆療養） (QS001_12313_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所療養介護（痴呆療養）画面項目デザイン(QS001_12313_201804) 
 */
public class QS001_12313_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup shortStayDementiaRecuperationSickroomDivisionRadio;
  ...
  private ACRadioButtonItem shortStayDementiaRecuperationMedicalExpensesRadioItem3;

  private ACRadioButtonItem shortStayDementiaRecuperationMedicalExpensesRadioItem4;
  ...
  public ACValueArrayRadioButtonGroup getShortStayDementiaRecuperationInstitutionDivisionRadio(){
    if(shortStayDementiaRecuperationInstitutionDivisionRadio==null){
      ...
      shortStayDementiaRecuperationInstitutionDivisionRadio.setValues(new int[]{1,2,3,4});
  ...
  public ACRadioButtonItem getShortStayDementiaRecuperationUnitHospitalRoomRadioItem1(){
    if(shortStayDementiaRecuperationUnitHospitalRoomRadioItem1==null){
      ...
      shortStayDementiaRecuperationUnitHospitalRoomRadioItem1.setText("ﾕﾆｯﾄ型個室");
  ...
  public ACRadioButtonItem getShortStayDementiaRecuperationUnitHospitalRoomRadioItem2(){
    if(shortStayDementiaRecuperationUnitHospitalRoomRadioItem2==null){
      ...
      shortStayDementiaRecuperationUnitHospitalRoomRadioItem2.setText("ﾕﾆｯﾄ型個室的多床室");
   ...
   */
  public ACValueArrayRadioButtonGroup getShortStayDementiaRecuperationSickroomDivisionRadio(){
    if(shortStayDementiaRecuperationSickroomDivisionRadio==null){

      shortStayDementiaRecuperationSickroomDivisionRadio = new ACValueArrayRadioButtonGroup();
      ...
      shortStayDementiaRecuperationSickroomDivisionRadio.setValues(new int[]{1,2,3,4});
  ...
  public ACRadioButtonItem getShortStayDementiaRecuperationSickroomDivisionRadioItem3(){
    if(shortStayDementiaRecuperationSickroomDivisionRadioItem3==null){
      ...
      shortStayDementiaRecuperationSickroomDivisionRadioItem3.setText("ﾕﾆｯﾄ型個室");
  ...
  public ACRadioButtonItem getShortStayDementiaRecuperationSickroomDivisionRadioItem4(){
    if(shortStayDementiaRecuperationSickroomDivisionRadioItem4==null){
      ...
      shortStayDementiaRecuperationSickroomDivisionRadioItem4.setText("ﾕﾆｯﾄ型個室的多床室");
  ...
  public ACComboBox getTankinyusyoTimeDivision(){
    if(tankinyusyoTimeDivision==null){
      ...
      tankinyusyoTimeDivision.setBindPath("1230352");

      tankinyusyoTimeDivision.setEditable(false);

      tankinyusyoTimeDivision.setModelBindPath("1230352");
  ...
  public ACValueArrayRadioButtonGroup getShortStayDementiaRecuperationMedicalExpensesRadio(){
    if(shortStayDementiaRecuperationMedicalExpensesRadio==null){
      ...
      shortStayDementiaRecuperationMedicalExpensesRadio.setValues(new int[]{1,2,3,4});
  ...
  public ACRadioButtonItem getShortStayDementiaRecuperationMedicalExpensesRadioItem2(){
    if(shortStayDementiaRecuperationMedicalExpensesRadioItem2==null){
      ...
      shortStayDementiaRecuperationMedicalExpensesRadioItem2.setText("3回");
   ...
   * @return 2回
   */
  public ACRadioButtonItem getShortStayDementiaRecuperationMedicalExpensesRadioItem3(){
    if(shortStayDementiaRecuperationMedicalExpensesRadioItem3==null){

      shortStayDementiaRecuperationMedicalExpensesRadioItem3 = new ACRadioButtonItem();

      shortStayDementiaRecuperationMedicalExpensesRadioItem3.setText("2回");

      shortStayDementiaRecuperationMedicalExpensesRadioItem3.setGroup(getShortStayDementiaRecuperationMedicalExpensesRadio());

      shortStayDementiaRecuperationMedicalExpensesRadioItem3.setConstraints(VRLayout.FLOW);

      addShortStayDementiaRecuperationMedicalExpensesRadioItem3();
    }
    return shortStayDementiaRecuperationMedicalExpensesRadioItem3;
   ...
   * @return 1回
   */
  public ACRadioButtonItem getShortStayDementiaRecuperationMedicalExpensesRadioItem4(){
    if(shortStayDementiaRecuperationMedicalExpensesRadioItem4==null){

      shortStayDementiaRecuperationMedicalExpensesRadioItem4 = new ACRadioButtonItem();

      shortStayDementiaRecuperationMedicalExpensesRadioItem4.setText("1回");

      shortStayDementiaRecuperationMedicalExpensesRadioItem4.setGroup(getShortStayDementiaRecuperationMedicalExpensesRadio());

      shortStayDementiaRecuperationMedicalExpensesRadioItem4.setConstraints(VRLayout.FLOW);

      addShortStayDementiaRecuperationMedicalExpensesRadioItem4();
    }
    return shortStayDementiaRecuperationMedicalExpensesRadioItem4;
  ...
  public ACValueArrayRadioButtonGroup getEmergencyAcceptanceRadioGroup(){
    if(emergencyAcceptanceRadioGroup==null){
      ...
      emergencyAcceptanceRadioGroup.setBindPath("1230312");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("1230351");
   ...
   * コンストラクタです。
   */
  public QS001_12313_201804Design() {
  ...
  protected void addShortStayDementiaRecuperationInstitutionDivisionRadioModel(){
    ...
    getShortStayDementiaRecuperationInstitutionDivisionRadioItem4().setButtonIndex(3);
    ...
    getShortStayDementiaRecuperationInstitutionDivisionRadioItem3().setButtonIndex(4);
  ...
  protected void addTab2(){
    ...
    tab2.add(getShortStayDementiaRecuperationMedicalExpensesRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addShortStayDementiaRecuperationMedicalExpensesRadioModel(){
    ...
    getShortStayDementiaRecuperationMedicalExpensesRadioItem3().setButtonIndex(3);

    getShortStayDementiaRecuperationMedicalExpensesRadioModel().add(getShortStayDementiaRecuperationMedicalExpensesRadioItem3());

    getShortStayDementiaRecuperationMedicalExpensesRadioItem4().setButtonIndex(4);

    getShortStayDementiaRecuperationMedicalExpensesRadioModel().add(getShortStayDementiaRecuperationMedicalExpensesRadioItem4());
   ...
   * 2回に内部項目を追加します。
   */
  protected void addShortStayDementiaRecuperationMedicalExpensesRadioItem3(){
   ...
   * 1回に内部項目を追加します。
   */
  protected void addShortStayDementiaRecuperationMedicalExpensesRadioItem4(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12313_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12313_201804Design getThis() {
    return this;
  }
}
