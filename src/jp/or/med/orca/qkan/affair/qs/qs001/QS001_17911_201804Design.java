 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン看護小規模多機能型居宅介護 (QS001_17911_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン看護小規模多機能型居宅介護画面項目デザイン(QS001_17911_201804) 
 */
public class QS001_17911_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_17911_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17911_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17911_201804Design getThis() {
    return this;
  }
}
