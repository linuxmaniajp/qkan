...
/**
 * サービスパターン短期入所療養介護（診療所療養）イベント定義(QS001_12312_201204) 
 */
public abstract class QS001_12312_201204Event extends QS001_12312_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12312_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
