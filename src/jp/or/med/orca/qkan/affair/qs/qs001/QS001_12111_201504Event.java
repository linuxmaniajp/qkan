 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン短期入所生活介護 (QS001_12111_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所生活介護イベント定義(QS001_12111_201504) 
 */
public abstract class QS001_12111_201504Event extends QS001_12111_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12111_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
