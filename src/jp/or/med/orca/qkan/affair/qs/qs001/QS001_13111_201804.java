...
/**
 * サービスパターン居宅療養管理指導(QS001_13111_201804)
 */
@SuppressWarnings("serial")
public class QS001_13111_201804 extends QS001_13111_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_13111_201804() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_13111_201804.class.getName(),
                param));
    }
   ...
   */
    ...
    private void setTantosha() throws Exception {
        ...
        case 1:
            // 医師(I)選択時
        	setUnit1("（31-1111：　507単位）");
        	setUnit2("（31-1113：　483単位）");
        	setUnit3("（31-1115：　442単位）");
            break;
        case 8:
            // 医師(II)選択時
        	setUnit1("（31-1112：　294単位）");
        	setUnit2("（31-1114：　284単位）");
        	setUnit3("（31-1116：　260単位）");
            break;
        case 2:
            // 歯科医師選択時
        	setUnit1("（31-2111：　507単位）");
        	setUnit2("（31-2112：　483単位）");
        	setUnit3("（31-2113：　442単位）");
            break;
        case 3:
            // 薬剤師（医療機関）選択時
        	setUnit1("（558単位）");
        ...
        case 5:
            // 栄養士選択時
        	setUnit1("（31-1131：　537単位）");
        	setUnit2("（31-1132：　483単位）");
        	setUnit3("（31-1133：　442単位）");
            break;
        case 6:
            // 歯科衛生士選択時
        	setUnit1("（31-1241：　355単位）");
        	setUnit2("（31-1243：　323単位）");
        	setUnit3("（31-1250：　295単位）");
            break;
        case 7:
            // 看護師
