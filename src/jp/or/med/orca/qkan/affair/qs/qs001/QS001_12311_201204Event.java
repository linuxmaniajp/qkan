...
/**
 * サービスパターン短期入所療養介護（病院療養）イベント定義(QS001_12311_201204) 
 */
public abstract class QS001_12311_201204Event extends QS001_12311_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12311_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
