 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2018/03/03  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
...
/**
 * サービスパターン通所介護状態定義(QS001_11511_201804) 
 */
public class QS001_11511_201804State extends QS001_11511_201804Design {
  /**
   * コンストラクタです。
   */
  public QS001_11511_201804State(){
  }
