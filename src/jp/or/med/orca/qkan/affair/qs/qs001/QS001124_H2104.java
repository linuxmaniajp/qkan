...
/**
 * サービスパターン認知症対応型通所介護(QS001124_H2104) 
 */
public class QS001124_H2104 extends QS001124_H2104Event {
  /**
   * コンストラクタです。
   */
  public QS001124_H2104(){
  }
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QS001124_H2104.class.getName(), param));
  }
  ...
  public void providerSelected(VRMap provider) throws Exception{
    ...
    // 栄養改善加算
    obj = VRBindPathParser.get("1720109", provider);
    if (obj != null) {
    ...
    //若年性認知症利用者受入加算（事業所パネル）KEY：1720107の値をチェックする。
    obj = VRBindPathParser.get("1720107", provider);
    switch (ACCastUtilities.toInt(obj,0)) {
    //値が次のいずれかだった場合
    case 2:
        //2（あり）
    ...
    //常にdefaultMapに KEY：1720109 VALUE：1（なし）を設定する。
    VRBindPathParser.set("1720109", defaultMap, new Integer(1));   

    // サービス提供体制強化加算
    obj = VRBindPathParser.get("1720108", provider);
    if (obj != null) {
        defaultMap.setData("1720110", obj);
    }
