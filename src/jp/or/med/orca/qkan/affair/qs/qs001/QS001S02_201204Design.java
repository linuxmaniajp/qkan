...
public class QS001S02_201204Design extends QkanAffairDialog {
  //GUIコンポーネント
  ...
  public ACGroupBox getEtcFrame(){
    if(etcFrame==null){
      ...
      etcFrame.setPreferredSize(new Dimension(1,115));
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      new QS001S02_201204Design().setVisible(true);
      System.exit(0);
    } catch (Exception e) {
      e.printStackTrace();
    }
   ...
   * 自身を返します。
   */
  protected QS001S02_201204Design getThis() {
    return this;
  }
}
