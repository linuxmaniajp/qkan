 ...
 * アプリ: QKANCHO
 * 開発者: 松本　幸一
 * 作成日: 2006/02/24  日本コンピューター株式会社 松本　幸一 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン福祉用具画面項目デザイン(QS001116) 
 */
public class QS001116Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.getInstance().getContentPane().add(new QS001116Design());
   ...
   * 自身を返します。
   */
  protected QS001116Design getThis() {
    return this;
  }
}
