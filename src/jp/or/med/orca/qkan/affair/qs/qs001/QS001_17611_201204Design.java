 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン定期巡回・随時対応型訪問介護看護 (QS001_17611_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン定期巡回・随時対応型訪問介護看護画面項目デザイン(QS001_17611_201204) 
 */
public class QS001_17611_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_17611_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17611_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17611_201204Design getThis() {
    return this;
  }
}
