...
/**
 * サービスパターン特定施設入所者生活介護(QS001_13311_201804)
 */
@SuppressWarnings("serial")
public class QS001_13311_201804 extends QS001_13311_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_13311_201804() {
        // 必須の事業所設定項目
        ...
        putImportProviderBindPath("入居継続支援加算", "1330113", "1330138"); //[H30.4改正]
        ...
        putRestrictProviderBindPath("入居継続支援加算", "1330113", "1330138"); //[H30.4改正]
        putRestrictProviderBindPath("生活機能向上連携加算", "1330114", "1330139"); //[H30.4改正]
        putRestrictProviderBindPath("若年性認知症入居者受入加算", "1330115", "1330140"); //[H30.4改正]
    }
    ...
    protected void expertPlaceNursingRadioActionPerformed(ActionEvent e)
            throws Exception {
        // 通所介護施設区分選択（H30.04改正でIndexを変更2,3,4→1,2,3）
        VRMap comboItemMap = new VRHashMap();
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_13311_201804.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            // 身体拘束未実施減算
            obj = VRBindPathParser.get("1330112", provider);
            if (obj != null) {
                // 身体拘束未実施取組みなしだった場合
                if (ACCastUtilities.toInt(obj) == 1) {
                    VRBindPathParser.set("1330137", defaultMap, new Integer(2));
                } else if (ACCastUtilities.toInt(obj) == 2) {
                    // 身体拘束未実施取組みありだった場合
                    VRBindPathParser.set("1330137", defaultMap, new Integer(1));
                }
            }
