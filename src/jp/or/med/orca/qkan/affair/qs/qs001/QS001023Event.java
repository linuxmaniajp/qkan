...
/**
 * サービスパターン介護療養型医療施設（病院）イベント定義(QS001023) 
 */
public abstract class QS001023Event extends QS001023State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001023Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int SYSTEM_SERVICE_KIND_DETAIL = 15301;
  //getter/setter
