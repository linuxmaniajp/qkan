...
/**
 * サービスパターン介護療養型医療施設（認知症）イベント定義(QS001122_H2104) 
 */
public abstract class QS001122_H2104Event extends QS001122_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001122_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
