...
/**
 * サービスパターン訪問看護（介護)イベント定義(QS001103_H2104) 
 */
public abstract class QS001103_H2104Event extends QS001103_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001103_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
