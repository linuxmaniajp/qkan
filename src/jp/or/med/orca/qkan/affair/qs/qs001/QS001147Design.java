 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防小規模多機能型居宅介護 (QS001147)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防小規模多機能型居宅介護画面項目デザイン(QS001147) 
 */
public class QS001147Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001147Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001147Design getThis() {
    return this;
  }
}
