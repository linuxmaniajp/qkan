 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防通所リハビリテーション (QS001136)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防通所リハビリテーション画面項目デザイン(QS001136) 
 */
public class QS001136Design extends QS001ServicePanel {
  //GUIコンポーネント

  private ACPanel preventiveExpertPlaceRihaMultiPatterns;
   ...
   */
  public ACPanel getPreventiveExpertPlaceRihaMultiPatterns(){
    if(preventiveExpertPlaceRihaMultiPatterns==null){

      preventiveExpertPlaceRihaMultiPatterns = new ACPanel();

      preventiveExpertPlaceRihaMultiPatterns.setAutoWrap(false);

      preventiveExpertPlaceRihaMultiPatterns.setHgrid(200);
  ...
  /**
   * 医師、PT・OT・ST、看護・介護職員が欠員を取得します。
   * @return 医師、PT・OT・ST、看護・介護職員が欠員
   */
  ...
  protected void addPreventiveExpertPlaceRihaMultiPatterns(){
    ...
    preventiveExpertPlaceRihaMultiPatterns.add(getStaffSubtractionRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    preventiveExpertPlaceRihaMultiPatterns.add(getCrackOnDayCheck(), VRLayout.FLOW_RETURN);

    preventiveExpertPlaceRihaMultiPatterns.add(getMoveFunctionImprovementAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    preventiveExpertPlaceRihaMultiPatterns.add(getNourishmentImprovementAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    preventiveExpertPlaceRihaMultiPatterns.add(getMouthFunctionImprovementAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    preventiveExpertPlaceRihaMultiPatterns.add(getOfficeEvaluationAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    preventiveExpertPlaceRihaMultiPatterns.add(getHoumonKaigoTimeContainer(), VRLayout.FLOW_DOUBLEINSETLINE_RETURN);
  ...
  /**
   * 医師、PT・OT・ST、看護・介護職員が欠員に内部項目を追加します。
   */
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001136Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001136Design getThis() {
    return this;
  }
}
