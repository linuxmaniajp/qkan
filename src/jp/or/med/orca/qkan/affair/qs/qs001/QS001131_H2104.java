 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン介護予防訪問入浴介護 (QS001131_H2104)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防訪問入浴介護(QS001131_H2104) 
 */
public class QS001131_H2104 extends QS001131_H2104Event {
  /**
   * コンストラクタです。
   */
  public QS001131_H2104(){
  }
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QS001131_H2104.class.getName(), param));
  }
  ...
  public void providerSelected(VRMap provider) throws Exception{
      ...
      if (provider != null) {
          ...
          // ※以下の内容詳細項目は、選択事業所の値を設定する。
          // 施設区分
          obj = VRBindPathParser.get("1620105", provider);
          if (obj != null) {
              VRBindPathParser.set("1620103", defaultMap, obj);
          }
