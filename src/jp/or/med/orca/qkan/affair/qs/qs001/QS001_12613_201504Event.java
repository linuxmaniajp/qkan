...
/**
 * サービスパターン介護予防短期入所療養介護（認知症）イベント定義(QS001_12613_201504) 
 */
@SuppressWarnings("serial")
public abstract class QS001_12613_201504Event extends QS001_12613_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12613_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
