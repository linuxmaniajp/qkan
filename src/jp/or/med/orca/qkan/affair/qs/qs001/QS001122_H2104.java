...
/**
 * サービスパターン介護療養型医療施設（認知症）(QS001122_H2104)
 */
public class QS001122_H2104 extends QS001122_H2104Event {
    /**
     * コンストラクタです。
     */
    public QS001122_H2104() {
    }
    ...
    protected void medicalFacilityCognitiveHospitalOralSwitchRadioSelectionChanged(
        ...
        if (getMedicalFacilityCognitiveHospitalOralSwitchRadioItem1()
                .isSelected()) {
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001122_H2104.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            // サービス提供体制強化加算
            VRBindPathParser.set("1530360", defaultMap, VRBindPathParser.get(
                    "1530320", provider));
            ...
            // 栄養マネジメント加算
            obj = VRBindPathParser.get("1530322", provider);
            if (obj != null) {
                switch (ACCastUtilities.toInt(obj)) {
                case 2:
                    // 「あり」の場合
            ...
            //療養食加算（事業所パネル）KEY：1530319の値をチェックする。
            obj = VRBindPathParser.get("1530319", provider);
...
//                //defaultMapに KEY：1530311 VALUE：2（あり）を設定する。
//                VRBindPathParser.set("1530311", defaultMap, new Integer(2));   
            ...
            // [ID:0000481][Tozo TANAKA] 2009/04/08 delete begin 平成21年4月法改正対応(療養食)
//                //defaultMapに KEY：1530311 VALUE：1（なし）を設定する。
//                VRBindPathParser.set("1530311", defaultMap, new Integer(1));   
            // [ID:0000481][Tozo TANAKA] 2009/04/08 delete end
                break;
            }
            // [ID:0000481][Tozo TANAKA] 2009/04/08 add begin 平成21年4月法改正対応(療養食)
            //常にdefaultMapに KEY：1530311 VALUE：1（なし）を設定する。
            VRBindPathParser.set("1530311", defaultMap, new Integer(1));   
