...
/**
 * サービスパターン介護予防短期入所生活介護(QS001_12411_201804)
 */
@SuppressWarnings("serial")
public class QS001_12411_201804 extends QS001_12411_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_12411_201804() {
        // 必須の事業所設定項目
        ...
        //putImportProviderBindPath("共生型", "1240121", "22"); //[H30.4改正]
        putImportProviderBindPath("生活相談員配置等加算", "1240122", "1240116"); //[H30.4改正]        
        ...
        putRestrictProviderBindPath("認知症専門ケア加算", "1240124", "1240118"); //[H30.4改正]
        putRestrictProviderBindPath("生活機能向上連携加算", "1240123", "1240117"); //[H30.4改正]
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_12411_201804.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            // 共生型サービスの提供
            obj = VRBindPathParser.get("1240121", provider);
            if (obj != null) {
                // 事業所登録の設定項目に合わせ初期値を調整
                switch (ACCastUtilities.toInt(obj)) {
                case 2: // ありだった場合
                    VRBindPathParser.set("22", defaultMap, new Integer(10));
                    break;
                }
            }
