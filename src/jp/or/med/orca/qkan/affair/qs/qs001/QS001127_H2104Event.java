...
/**
 * サービスパターン認知症対応共同生活介護イベント定義(QS001127_H2104) 
 */
public abstract class QS001127_H2104Event extends QS001127_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001127_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
