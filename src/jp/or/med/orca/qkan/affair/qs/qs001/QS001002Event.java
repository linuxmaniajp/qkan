...
public abstract class QS001002Event extends QS001002State {
  ...
  protected void addEvents() {
    ...
    getTokubetuButton().addActionListener(new ActionListener(){
        private boolean lockFlag = false;
        public void actionPerformed(ActionEvent e) {
            if (lockFlag) {
                return;
            ...
            lockFlag = true;
            try {
                tokubetuButtonActionPerformed(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void tokubetuButtonActionPerformed(ActionEvent e) throws Exception;
