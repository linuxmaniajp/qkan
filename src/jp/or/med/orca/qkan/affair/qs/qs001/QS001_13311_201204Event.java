 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2012/02/14  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム サービス予定作成/変更 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン特定施設入所者生活介護 (QS001_13311_201204)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン特定施設入所者生活介護イベント定義(QS001_13311_201204) 
 */
public abstract class QS001_13311_201204Event extends QS001_13311_201204State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_13311_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
