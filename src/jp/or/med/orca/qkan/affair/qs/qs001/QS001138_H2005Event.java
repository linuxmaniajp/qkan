...
/**
 * サービスパターン介護予防短期入所療養介護（介護老人保健施設）イベント定義(QS001138_H2005) 
 */
public abstract class QS001138_H2005Event extends QS001138_H2005State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001138_H2005Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
