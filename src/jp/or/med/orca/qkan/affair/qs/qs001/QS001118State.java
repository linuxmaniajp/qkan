...
/**
 * サービスパターン介護老人福祉施設状態定義(QS001118) 
 */
public class QS001118State extends QS001118Design {
  /**
   * コンストラクタです。
   */
  public QS001118State(){
  }
  ...
  /**
   * 「重度化対応加算・有効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_VALID_HEAVILY_CORRE_SPONDENCE_ADD() throws Exception {
  ...
  /**
   * 「重度化対応加算・無効」の状態に設定します。
   * @throws Exception 処理例外
   */
  public void setState_INVALID_HEAVILY_CORRE_SPONDENCE_ADD() throws Exception {
