...
/**
 * サービスパターン介護予防短期入所療養介護（診療所）イベント定義(QS001140_H2104) 
 */
public abstract class QS001140_H2104Event extends QS001140_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001140_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
