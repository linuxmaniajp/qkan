...
/**
 * サービスパターン介護予防支援費(QS001145_H2104) 
 */
public class QS001145_H2104 extends QS001145_H2104Event {
  /**
   * コンストラクタです。
   */
  public QS001145_H2104(){
  }
      ...
      if (getConsignmentProvider().isSelected()
          ...
          while (it.hasNext()) {
              ...
              VRBindPathParser.set("CONSIGNMENT_STAFF_NAME", row, QkanCommon
                      .toFullName(VRBindPathParser.get("STAFF_FAMILY_NAME",
                              row), VRBindPathParser.get("STAFF_FIRST_NAME",
                              row)));
          }
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QS001145_H2104.class.getName(), param));
  }
