 ...
 * アプリ: QKANCHO
 * 開発者: 日高　しのぶ
 * 作成日: 2016/01/28  日本コンピューター株式会社 日高　しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン地域密着型通所介護画面項目デザイン(QS001_17811_201504) 
 */
public class QS001_17811_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_17811_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17811_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17811_201504Design getThis() {
    return this;
  }
}
