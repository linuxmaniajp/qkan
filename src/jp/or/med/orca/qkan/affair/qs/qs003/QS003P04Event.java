 ...
 */
public abstract class QS003P04Event  {
  /**
   * コンストラクタです。
   */
  public QS003P04Event(){
  }
  /**
   * 印刷します。
   ...
   * @return VRList
   */
  public abstract VRList tabulation(VRList serviceData, VRList printList, VRMap footerMap, String 事業所番号) throws Exception;
   ...
   *
   * @param anotherProvider VRMap
   * @param recNow VRMap
   * @throws Exception 処理例外
   *
   */
  public abstract void addRecordValueToAnotherProvider(VRMap anotherProvider, VRMap recNow) throws Exception;
