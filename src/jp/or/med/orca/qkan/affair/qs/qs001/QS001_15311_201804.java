...
/**
 * サービスパターン介護療養型医療施設（病院）(QS001_15311_201804)
 */
@SuppressWarnings("serial")
public class QS001_15311_201804 extends QS001_15311_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_15311_201804() {
        ...
        putImportProviderBindPath("入院患者に関する基準", "1530134", "1530171"); //[H30.4改正]
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
			...
			// 夜間勤務条件基準
			obj = VRBindPathParser.get("1530130", provider);
			if (obj != null) {
				// 事業所登録の減算項目に合わせ初期値を調整
				switch (ACCastUtilities.toInt(obj)) {
				case 1: // 基準型
					VRBindPathParser.set("1530163", defaultMap, new Integer(1));
					break;
				case 2: // 加算型I
					VRBindPathParser.set("1530172", defaultMap, new Integer(2));
					break;
				case 3: // 加算型II
					VRBindPathParser.set("1530172", defaultMap, new Integer(3));
					break;
				case 4: // 加算型III
					VRBindPathParser.set("1530172", defaultMap, new Integer(4));
					break;
				case 6: // 加算型IV
					VRBindPathParser.set("1530172", defaultMap, new Integer(5));
					break;
				case 5: // 減算型
					VRBindPathParser.set("1530163", defaultMap, new Integer(2));
					break;
				}
			}
