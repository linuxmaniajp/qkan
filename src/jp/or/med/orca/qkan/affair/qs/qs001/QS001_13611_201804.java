...
/**
 * サービスパターン地域密着型特定施設入所者生活介護(QS001_13611_201804)
 */
@SuppressWarnings("serial")
public class QS001_13611_201804 extends QS001_13611_201804Event {
    /**
     * コンストラクタです。
     */
    public QS001_13611_201804() {
        // チェック
        ...
        putImportProviderBindPath("入居継続支援加算", "1360110", "1360110"); //[H30.4改正]
        ...
        putRestrictProviderBindPath("入居継続支援加算", "1360110", "1360110"); //[H30.4改正]
        putRestrictProviderBindPath("生活機能向上連携加算", "1360112", "1360111"); //[H30.4改正]
        putRestrictProviderBindPath("若年性認知症利用者受入加算", "1360111", "1360112"); //[H30.4改正]
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_13611_201804.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        // 身体拘束未実施減算
        obj = VRBindPathParser.get("1360109", provider);
        if (obj != null) {
            // 身体拘束未実施取組みなしだった場合
            if (ACCastUtilities.toInt(obj) == 1) {
                VRBindPathParser.set("1360109", defaultMap, new Integer(2));
            } else if (ACCastUtilities.toInt(obj) == 2) {
                // 身体拘束未実施取組みありだった場合
                VRBindPathParser.set("1360109", defaultMap, new Integer(1));
            }
        }
