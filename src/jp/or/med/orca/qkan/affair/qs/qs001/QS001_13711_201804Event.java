...
/**
 * サービスパターン介護予防認知症対応型共同生活介護（短期利用以外）イベント定義(QS001_13711_201804) 
 */
public abstract class QS001_13711_201804Event extends QS001_13711_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_13711_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
