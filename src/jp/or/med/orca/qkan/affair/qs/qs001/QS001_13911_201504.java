 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン介護予防認知症対応型共同生活介護 (QS001_13911_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防認知症対応型共同生活介護(QS001_13911_201504)
 */
@SuppressWarnings("serial")
public class QS001_13911_201504 extends QS001_13911_201504Event {
    /**
     * コンストラクタです。
     */
    public QS001_13911_201504() {
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_13911_201504.class.getName(),
                param));
    }
    ...
    public void providerSelected(VRMap provider) throws Exception {
        ...
        if (provider != null) {
            ...
            if (obj != null) {
                ...
                case 1: // なし
                    VRBindPathParser.set("1390103", defaultMap, new Integer(1));
                    break;
                case 2: // 加算I
                case 3: // 加算II
                    VRBindPathParser.set("1390103", defaultMap, new Integer(2));
                    break;
                }
            }
