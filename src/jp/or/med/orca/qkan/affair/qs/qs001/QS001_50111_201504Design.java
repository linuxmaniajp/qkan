 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン訪問型サービス（みなし） (QS001_50111_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン訪問型サービス（みなし）画面項目デザイン(QS001_50111_201504) 
 */
public class QS001_50111_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getVisitCareExpenseAddRadio(){
    if(visitCareExpenseAddRadio==null){
      ...
      visitCareExpenseAddRadio.setBindPath("5010101");
  ...
  public ACValueArrayRadioButtonGroup getClassEmploymentAddRadio(){
    if(classEmploymentAddRadio==null){
      ...
      classEmploymentAddRadio.setBindPath("5010102");
  ...
  public ACValueArrayRadioButtonGroup getHoumonKaigoFirstAddRadioGroup(){
    if(houmonKaigoFirstAddRadioGroup==null){
      ...
      houmonKaigoFirstAddRadioGroup.setBindPath("5010104");
  ...
  public ACValueArrayRadioButtonGroup getRehabilitationProAddRadioGroup(){
    if(rehabilitationProAddRadioGroup==null){
      ...
      rehabilitationProAddRadioGroup.setBindPath("5010105");
  ...
  public ACIntegerCheckBox getCrackOnDayCheck(){
    if(crackOnDayCheck==null){
      ...
      crackOnDayCheck.setBindPath("5010103");
  ...
  public ACLabel getInfoLabel(){
    if(infoLabel==null){
      ...
      infoLabel.setText("月途中で区分変更となる場合、" + ACConstants.LINE_SEPARATOR + "（要支援1⇔要支援2、事業対象者→要支援）" + ACConstants.LINE_SEPARATOR + "各日割りサービスを全ての日数に貼り付け" + ACConstants.LINE_SEPARATOR + "実際の提供日には『提供日』のチェックをつけ" + ACConstants.LINE_SEPARATOR + "〔設定〕ボタンをクリックしてください。");
   ...
   * コンストラクタです。
   */
  public QS001_50111_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_50111_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_50111_201504Design getThis() {
    return this;
  }
}
