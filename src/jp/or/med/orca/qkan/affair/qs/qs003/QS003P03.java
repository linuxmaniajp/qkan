 ...
 * 帳票定義体ファイル名 ： 
 */
public class QS003P03 extends QS003P03Event {
  /**
   * コンストラクタです。
   */
  public QS003P03(){
  ...
  public boolean doPrint(ACChotarouXMLWriter writer, VRMap printParam) throws Exception {
    ...
    //pd.addFormat("mainFormat", ACFrame.getInstance().getExeFolderPath() + ACConstants.FILE_SEPARATOR + "format" + ACConstants.FILE_SEPARATOR + "提供票");
    //pd.beginPrintEdit();
    //＜＜＜呼び出しもとで行なう処理
