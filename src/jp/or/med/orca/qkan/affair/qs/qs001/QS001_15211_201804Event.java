...
/**
 * サービスパターン介護老人保健施設イベント定義(QS001_15211_201804) 
 */
public abstract class QS001_15211_201804Event extends QS001_15211_201804State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_15211_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  protected void addEvents() {
    ...
    getKaigoHealthCareOfTheAgedNutritionRadio().addListSelectionListener(new ListSelectionListener(){
        private boolean lockFlag = false;
        public void valueChanged(ListSelectionEvent e) {
            ...
            lockFlag = true;
            try {
                kaigoHealthCareOfTheAgedNutritionRadioSelectionChanged(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
    ...
    getKaigoHealthCareOfTheAgedStayingOutOvernightCostRadio().addListSelectionListener(new ListSelectionListener(){
        private boolean lockFlag = false;
        public void valueChanged(ListSelectionEvent e) {
            if (lockFlag) {
                return;
            ...
            lockFlag = true;
            try {
                kaigoHealthCareOfTheAgedStayingOutOvernightCostRadioSelectionChanged(e);
            }catch(Throwable ex){
                ACCommon.getInstance().showExceptionMessage(ex);
            }finally{
                lockFlag = false;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void kaigoHealthCareOfTheAgedNutritionRadioSelectionChanged(ListSelectionEvent e) throws Exception;
   ...
   * @throws Exception 処理例外
   */
  protected abstract void kaigoHealthCareOfTheAgedStayingOutOvernightCostRadioSelectionChanged(ListSelectionEvent e) throws Exception;
