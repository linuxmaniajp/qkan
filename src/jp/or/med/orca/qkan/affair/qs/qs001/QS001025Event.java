...
/**
 * サービスパターン介護療養型医療施設（認知症）イベント定義(QS001025) 
 */
public abstract class QS001025Event extends QS001025State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001025Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int SYSTEM_SERVICE_KIND_DETAIL = 15303;
  //getter/setter
