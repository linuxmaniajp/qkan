 ...
 * 利用・提供票印刷(QS001031)
 */
public class QS001031 extends QS001031Event {
    /**
     * コンストラクタです。
     */
    public QS001031() {
    ...
    protected void printActionPerformed(ActionEvent e) throws Exception {
        ...
        print(writer, buildParam, printMain, mainFormat, mainInsuredPages, new HashMap(), printSub, subFormat, subInsuredPages);
        ...
        if (printBackup && printMain) {
            ...
            print(writer, buildParam, printMain, mainFormat, mainInsuredPages, allTexts, printSub, subFormat, subInsuredPages);
    ...
    public void print(ACChotarouXMLWriter writer,
        ...
        if(printMain){
            if (printSub) {
                //本表と別表
                int end = Math.min(mainInsuredPages.size(), subInsuredPages.size());
                for(int i=0; i<end; i++){
     ...
     * 
     * @param writer ACChotarouXMLWriter
     * @param mng QS001ServicePrintTableManager
     * @param subFormat String
     * @param pages List
     * @throws Exception 処理例外
     */
    public void printSubTable(ACChotarouXMLWriter writer,
            String subFormat, List pages)
            throws Exception {
        // ■別表を印刷します。
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                ACChotarouXMLUtilities.setValue(writer, ACCastUtilities
                        .toString(ent.getKey()), ACCastUtilities.toString(ent
                        .getValue()));
     ...
     * @param pages List
     * @param invisibles, Map allTexts List
     * @throws Exception 処理例外
     */
    public void printMainTable(ACChotarouXMLWriter writer,
            String mainFormat, List pages,
            List invisibles, Map allTexts) throws Exception {
        // ■本票を印刷します。
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ACChotarouXMLUtilities.setInvisible(writer, ACCastUtilities
                        .toString(it2.next()));
            }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001031.class.getName(), param));
    }
     ...
     * @param patientInsureInfoHistoryList VRList
     * @param inSpecialFacilityFlag int
     * @throws Exception 処理例外
     */
    ...
    public void setInitValue() throws Exception {
        ...
        if (getPatent().isSelected()) {
            ...
            if (history != null) {
                Date reportDay = ACCastUtilities.toDate(history
                        .get("REPORTED_DATE"), null);
                if (reportDay != null) {
                    // 届出日が設定されていれば転記
        ...
        if (patientInsureInfoFirst != patientInsureInfoLast) {
            ...
            Date begin = ACCastUtilities.toDate(patientInsureInfoFirst
                    .get("INSURE_VALID_START"), null);
            if (begin != null) {
        ...
        getApplicationPeriodEnd().setText(
                yearMonthFormat.format(ACCastUtilities
                        .toDate(patientInsureInfoHeaviest
