...
/**
 * サービスパターン地域密着型介護老人福祉施設入所者生活介護状態定義(QS001_15411_201804) 
 */
public class QS001_15411_201804State extends QS001_15411_201804Design {
  /**
   * コンストラクタです。
   */
  public QS001_15411_201804State(){
  }
  ...
  public void setState_VALID_TERMINAL() throws Exception {
        ...
        getKaigoWelfareFacilityTakingCareNursingAddRadio().setEnabled(true);
  ...
  public void setState_INVALID_TERMINAL() throws Exception {
        ...
        getKaigoWelfareFacilityTakingCareNursingAddRadio().setEnabled(false);
   ...
   * @throws Exception 処理例外
   */
  public void setState_VALID_TERMINAL_DAYS() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_INVALID_TERMINAL_DAYS() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_VALID_OUT_OVERNIGHT_COST() throws Exception {

        getKaigoWelfareFacilityStayingOutOvernightCostRadio().setEnabled(true);
        getKaigoWelfareFacilityStayingOutOvernightCostRadio().getParent().setEnabled(true);
   ...
   * @throws Exception 処理例外
   */
  public void setState_INVALID_OUT_OVERNIGHT_COST() throws Exception {

        getKaigoWelfareFacilityStayingOutOvernightCostRadio().setEnabled(false);
        getKaigoWelfareFacilityStayingOutOvernightCostRadio().getParent().setEnabled(false);
