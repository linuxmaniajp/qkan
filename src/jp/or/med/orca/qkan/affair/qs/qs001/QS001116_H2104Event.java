...
/**
 * サービスパターン福祉用具イベント定義(QS001116_H2104) 
 */
public abstract class QS001116_H2104Event extends QS001116_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001116_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
