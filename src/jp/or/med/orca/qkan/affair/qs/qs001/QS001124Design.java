...
/**
 * サービスパターン認知症対応型通所介護画面項目デザイン(QS001124) 
 */
public class QS001124Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getNourishmentManagementAddRadio(){
    if(nourishmentManagementAddRadio==null){
      ...
      getNourishmentManagementAddRadioContainer().setText("栄養マネジメント加算");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001124Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001124Design getThis() {
    return this;
  }
}
