 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン短期入所療養介護(介護老人保健施設) (QS001110)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン短期入所療養介護(介護老人保健施設)イベント定義(QS001110) 
 */
public abstract class QS001110Event extends QS001110State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001110Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
