...
/**
 * サービスパターン介護予防通所介護(QS001_16511_201504)
 */
@SuppressWarnings("serial")
public class QS001_16511_201504 extends QS001_16511_201504Event {
    /**
     * コンストラクタです。
     */
    public QS001_16511_201504() {
        ...
        putRestrictProviderBindPath("選択的サービス複数実施加算", "1650109", "1650111");
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001_16511_201504.class.getName(),
                param));
    }
    ...
    public void checkState() throws Exception {
        ...
        // 運動器機能向上加算・栄養改善加算・口腔機能向上加算・選択的サービス複数実施加算のいづれかがついた場合
