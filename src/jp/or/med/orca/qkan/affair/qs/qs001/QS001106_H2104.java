 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2009/02/12  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン居宅療養管理指導(QS001106_H2104)
 */
public class QS001106_H2104 extends QS001106_H2104Event {
    /**
     * コンストラクタです。
     */
    public QS001106_H2104() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001106_H2104.class.getName(),
                param));
    }
     ...
     * 所在地区分情報を選択時の処理
     */
    protected void patientRadioGroupSelectionChanged(ListSelectionEvent e) throws Exception {
        changeState();
