...
/**
 * サービスパターン短期入所療養介護（診療所療養）画面項目デザイン(QS001_12312_201804) 
 */
public class QS001_12312_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getShortStayClinicRecuperationSickroomDivisionRadioItem3(){
    if(shortStayClinicRecuperationSickroomDivisionRadioItem3==null){
      ...
      shortStayClinicRecuperationSickroomDivisionRadioItem3.setText("ﾕﾆｯﾄ型個室");
  ...
  public ACRadioButtonItem getShortStayClinicRecuperationSickroomDivisionRadioItem4(){
    if(shortStayClinicRecuperationSickroomDivisionRadioItem4==null){
      ...
      shortStayClinicRecuperationSickroomDivisionRadioItem4.setText("ﾕﾆｯﾄ型個室的多床室");
  ...
  public ACValueArrayRadioButtonGroup getMealSystemSubRadio(){
    if(mealSystemSubRadio==null){
      ...
      mealSystemSubRadio.setBindPath("1230258");
  ...
  public ACValueArrayRadioButtonGroup getDementiaProfessionalCareAddRadioGroup(){
    if(dementiaProfessionalCareAddRadioGroup==null){
      ...
      dementiaProfessionalCareAddRadioGroup.setBindPath("1230259");
   ...
   * コンストラクタです。
   */
  public QS001_12312_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12312_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12312_201804Design getThis() {
    return this;
  }
}
