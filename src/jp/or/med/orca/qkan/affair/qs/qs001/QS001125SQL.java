 ...
 * アプリ: QKANCHO
 * 開発者: サービス予定
 * 作成日: 2006/04/11  日本コンピューター株式会社 サービス予定 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターン小規模多機能型居宅介護 (QS001125)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン小規模多機能型居宅介護SQL定義(QS001125) 
 */
public class QS001125SQL extends QS001125Design {
