...
/**
 * サービスパターン介護予防小規模多機能居宅介護イベント定義(QS001147_H2104) 
 */
public abstract class QS001147_H2104Event extends QS001147_H2104SQL implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001147_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
