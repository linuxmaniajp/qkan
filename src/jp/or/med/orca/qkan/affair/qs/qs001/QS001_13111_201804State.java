...
/**
 * サービスパターン居宅療養管理指導状態定義(QS001_13111_201804) 
 */
public class QS001_13111_201804State extends QS001_13111_201804Design {
  /**
   * コンストラクタです。
   */
  public QS001_13111_201804State(){
  }
  ...
  public void setState_DOCTOR() throws Exception {
        ...
        getPatientRadioGroup().setVisible(true);

        getPatientRadioGroup().setEnabled(true);
        getPatientRadioGroup().getParent().setEnabled(true);

        getPatientOldRadioGroup().setVisible(false);

        getPatientOldRadioGroup().setEnabled(true);
        getPatientOldRadioGroup().getParent().setEnabled(true);
  ...
  public void setState_KANGO() throws Exception {
        ...
        getPatientRadioGroup().setVisible(false);

        getPatientRadioGroup().setEnabled(true);
        getPatientRadioGroup().getParent().setEnabled(true);

        getPatientOldRadioGroup().setVisible(true);
  ...
  public void setState_INVALID_PATIENT_RADIO() throws Exception {
        ...
        getPatientOldRadioGroup().setEnabled(false);
        getPatientOldRadioGroup().getParent().setEnabled(false);
