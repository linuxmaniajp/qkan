 ...
 * アプリ: QKANCHO
 * 開発者: 亀井　陽一郎
 * 作成日: 2016/11/28  MIS九州株式会社 亀井　陽一郎 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム サービス予定作成/変更 (S)
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防通所介護 (QS001_16511_201504)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防通所介護画面項目デザイン(QS001_16511_201504) 
 */
public class QS001_16511_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getSentakutekiServiceRadio(){
    if(sentakutekiServiceRadio==null){
      ...
      sentakutekiServiceRadio.setBindPath("1650111");
   ...
   * コンストラクタです。
   */
  public QS001_16511_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_16511_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_16511_201504Design getThis() {
    return this;
  }
}
