...
/**
 * サービスパターン介護老人保健施設画面項目デザイン(QS001119) 
 */
public class QS001119Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getKaigoHealthCareOfTheAgedDivisionRadioItem4(){
    if(kaigoHealthCareOfTheAgedDivisionRadioItem4==null){
      ...
      kaigoHealthCareOfTheAgedDivisionRadioItem4.setText("ユニット型小規模介護保健施設");

      kaigoHealthCareOfTheAgedDivisionRadioItem4.setGroup(getKaigoHealthCareOfTheAgedDivisionRadio());

      kaigoHealthCareOfTheAgedDivisionRadioItem4.setConstraints(VRLayout.FLOW);
  ...
  protected void addKaigoHealthCareOfTheAgedDivisionRadioModel(){
    ...
    getKaigoHealthCareOfTheAgedDivisionRadioItem3().setButtonIndex(2);
   ...
   * 自身を返します。
   */
  protected QS001119Design getThis() {
    return this;
  }
}
