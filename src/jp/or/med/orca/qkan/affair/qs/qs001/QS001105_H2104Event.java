...
/**
 * サービスパターン訪問リハイベント定義(QS001105_H2104) 
 */
public abstract class QS001105_H2104Event extends QS001105_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001105_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
