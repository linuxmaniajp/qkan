...
/**
 * サービスパターン介護予防通所リハビリテーションイベント定義(QS001_16611_201504) 
 */
@SuppressWarnings("serial")
public abstract class QS001_16611_201504Event extends QS001_16611_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_16611_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
