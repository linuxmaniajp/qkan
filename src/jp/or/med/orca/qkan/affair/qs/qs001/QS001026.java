 ...
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
 * プログラム サービスパターンその他内容詳細 (QS001028)
 *
 *****************************************************************
 */
...
/**
 * サービスパターンその他内容詳細(QS001028)
 */
public class QS001026 extends QS001026Event {
    /**
     * コンストラクタです。
     */
    public QS001026() {
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QS001026.class.getName()));
    }
