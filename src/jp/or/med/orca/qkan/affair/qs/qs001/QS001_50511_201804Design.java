 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン通所型サービス(みなし) (QS001_50511_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン通所型サービス(みなし)画面項目デザイン(QS001_50511_201804) 
 */
public class QS001_50511_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getPreventiveExpertPlaceCareServiceRadio(){
    if(preventiveExpertPlaceCareServiceRadio==null){
      ...
      preventiveExpertPlaceCareServiceRadio.setBindPath("5050101");
  ...
  public ACIntegerCheckBox getCrackOnCntCheck(){
    if(crackOnCntCheck==null){
      ...
      crackOnCntCheck.setBindPath("5050102");
  ...
  public ACIntegerCheckBox getCrackOnDayCheck(){
    if(crackOnDayCheck==null){
      ...
      crackOnDayCheck.setBindPath("5050104");
  ...
  public ACClearableRadioButtonGroup getActivityAddRadio(){
    if(activityAddRadio==null){
      ...
      activityAddRadio.setBindPath("5050105");
  ...
  public ACValueArrayRadioButtonGroup getMoveFunctionImprovementAddRadio(){
    if(moveFunctionImprovementAddRadio==null){
      ...
      moveFunctionImprovementAddRadio.setBindPath("5050106");
  ...
  public ACValueArrayRadioButtonGroup getNourishmentImprovementAddRadio(){
    if(nourishmentImprovementAddRadio==null){
      ...
      nourishmentImprovementAddRadio.setBindPath("5050107");
  ...
  public ACValueArrayRadioButtonGroup getMouthFunctionImprovementAddRadio(){
    if(mouthFunctionImprovementAddRadio==null){
      ...
      mouthFunctionImprovementAddRadio.setBindPath("5050108");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("5050111");
  ...
  public ACValueArrayRadioButtonGroup getStaffSubtractionRadio(){
    if(staffSubtractionRadio==null){
      ...
      staffSubtractionRadio.setBindPath("5050103");
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("5050110");
  ...
  public ACValueArrayRadioButtonGroup getOfficeEvaluationAddRadio(){
    if(officeEvaluationAddRadio==null){
      ...
      officeEvaluationAddRadio.setBindPath("5050109");
   ...
   * コンストラクタです。
   */
  public QS001_50511_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_50511_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_50511_201804Design getThis() {
    return this;
  }
}
