 ...
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン地域密着型特定施設入所者生活介護（短期利用） (QS001_12811_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン地域密着型特定施設入所者生活介護（短期利用）画面項目デザイン(QS001_12811_201804) 
 */
public class QS001_12811_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1280104");
   ...
   * コンストラクタです。
   */
  public QS001_12811_201804Design() {
  ...
  protected void addRegionSpecificFacilityPatterns(){
    ...
    regionSpecificFacilityPatterns.add(getYoungDementiaPatinetAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12811_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12811_201804Design getThis() {
    return this;
  }
}
