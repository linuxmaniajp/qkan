 ...
 * アプリ: QKANCHO
 * 開発者: 上司　和善
 * 作成日: 2015/02/17  日本コンピューター株式会社 上司　和善 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン複合型サービス（看護小規模多機能型居宅介護・短期利用以外）画面項目デザイン(QS001_17711_201504) 
 */
public class QS001_17711_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getNursingStrengthenAddRadio(){
    if(nursingStrengthenAddRadio==null){
      ...
      getNursingStrengthenAddRadioContainer().setText("訪問看護体制強化加算");
      ...
      nursingStrengthenAddRadio.setValues(new int[]{1,2});
   ...
   * コンストラクタです。
   */
  public QS001_17711_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17711_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17711_201504Design getThis() {
    return this;
  }
}
