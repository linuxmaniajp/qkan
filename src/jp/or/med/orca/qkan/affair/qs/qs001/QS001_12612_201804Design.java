 ...
 * アプリ: QKANCHO
 * 開発者: 日高　しのぶ
 * 作成日: 2018/03/14  日本コンピューター株式会社 日高　しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム サービス予定作成/変更 (S)
 * プロセス サービス予定週間 (001)
 * プログラム サービスパターン介護予防短期入所療養介護（診療所） (QS001_12612_201804)
 *
 *****************************************************************
 */
...
/**
 * サービスパターン介護予防短期入所療養介護（診療所）画面項目デザイン(QS001_12612_201804) 
 */
public class QS001_12612_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup mealSystemSubRadio;

  private ACLabelContainer mealSystemSubRadioContainer;

  private ACListModelAdapter mealSystemSubRadioModel;

  private ACRadioButtonItem mealSystemSubRadioItem1;

  private ACRadioButtonItem mealSystemSubRadioItem2;
  ...
  private ACRadioButtonItem shortStayClinicRecuperationMedicalExpensesRadioItem3;

  private ACRadioButtonItem shortStayClinicRecuperationMedicalExpensesRadioItem4;
  ...
  public ACValueArrayRadioButtonGroup getShortStayClinicRecuperationInstitutionDivisionRadio(){
    if(shortStayClinicRecuperationInstitutionDivisionRadio==null){
      ...
      shortStayClinicRecuperationInstitutionDivisionRadio.setValues(new int[]{1,2});
  ...
  public ACRadioButtonItem getShortStayClinicRecuperationInstitutionDivisionRadioItem1(){
    if(shortStayClinicRecuperationInstitutionDivisionRadioItem1==null){
      ...
      shortStayClinicRecuperationInstitutionDivisionRadioItem1.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignment2Division(){
    if(staffAssignment2Division==null){
      ...
      staffAssignment2Division.setBindPath("1260217");
  ...
  public ACRadioButtonItem getShortStayClinicRecuperationUnitHospitalRoomRadioItem1(){
    if(shortStayClinicRecuperationUnitHospitalRoomRadioItem1==null){
      ...
      shortStayClinicRecuperationUnitHospitalRoomRadioItem1.setText("ﾕﾆｯﾄ型個室");
  ...
  public ACRadioButtonItem getShortStayClinicRecuperationUnitHospitalRoomRadioItem2(){
    if(shortStayClinicRecuperationUnitHospitalRoomRadioItem2==null){
      ...
      shortStayClinicRecuperationUnitHospitalRoomRadioItem2.setText("ﾕﾆｯﾄ型個室的多床室");
   ...
   * @return 食堂の有無
   */
  public ACValueArrayRadioButtonGroup getMealSystemSubRadio(){
    if(mealSystemSubRadio==null){

      mealSystemSubRadio = new ACValueArrayRadioButtonGroup();

      getMealSystemSubRadioContainer().setText("食堂の有無");

      mealSystemSubRadio.setBindPath("1260218");

      mealSystemSubRadio.setUseClearButton(false);

      mealSystemSubRadio.setModel(getMealSystemSubRadioModel());

      mealSystemSubRadio.setValues(new int[]{1,2});

      addMealSystemSubRadio();
    }
    return mealSystemSubRadio;
   ...
   * @return 食堂の有無コンテナ
   */
  protected ACLabelContainer getMealSystemSubRadioContainer(){
    if(mealSystemSubRadioContainer==null){
      mealSystemSubRadioContainer = new ACLabelContainer();
      mealSystemSubRadioContainer.setFollowChildEnabled(true);
      mealSystemSubRadioContainer.setVAlignment(VRLayout.CENTER);
      mealSystemSubRadioContainer.add(getMealSystemSubRadio(), null);
    }
    return mealSystemSubRadioContainer;
  }
   ...
   * @return 食堂の有無モデル
   */
  protected ACListModelAdapter getMealSystemSubRadioModel(){
    if(mealSystemSubRadioModel==null){
      mealSystemSubRadioModel = new ACListModelAdapter();
      addMealSystemSubRadioModel();
    }
    return mealSystemSubRadioModel;
  }
   ...
   * @return 基準型
   */
  public ACRadioButtonItem getMealSystemSubRadioItem1(){
    if(mealSystemSubRadioItem1==null){

      mealSystemSubRadioItem1 = new ACRadioButtonItem();

      mealSystemSubRadioItem1.setText("基準型");

      mealSystemSubRadioItem1.setGroup(getMealSystemSubRadio());

      mealSystemSubRadioItem1.setConstraints(VRLayout.FLOW);

      addMealSystemSubRadioItem1();
    }
    return mealSystemSubRadioItem1;
   ...
   * @return 減算型
   */
  public ACRadioButtonItem getMealSystemSubRadioItem2(){
    if(mealSystemSubRadioItem2==null){

      mealSystemSubRadioItem2 = new ACRadioButtonItem();

      mealSystemSubRadioItem2.setText("減算型");

      mealSystemSubRadioItem2.setGroup(getMealSystemSubRadio());

      mealSystemSubRadioItem2.setConstraints(VRLayout.FLOW);

      addMealSystemSubRadioItem2();
    }
    return mealSystemSubRadioItem2;
  ...
  public ACValueArrayRadioButtonGroup getShortStayClinicRecuperationMedicalExpensesRadio(){
    if(shortStayClinicRecuperationMedicalExpensesRadio==null){
      ...
      shortStayClinicRecuperationMedicalExpensesRadio.setValues(new int[]{1,2,3,4});
  ...
  public ACRadioButtonItem getShortStayClinicRecuperationMedicalExpensesRadioItem2(){
    if(shortStayClinicRecuperationMedicalExpensesRadioItem2==null){
      ...
      shortStayClinicRecuperationMedicalExpensesRadioItem2.setText("3回");
   ...
   * @return 2回
   */
  public ACRadioButtonItem getShortStayClinicRecuperationMedicalExpensesRadioItem3(){
    if(shortStayClinicRecuperationMedicalExpensesRadioItem3==null){

      shortStayClinicRecuperationMedicalExpensesRadioItem3 = new ACRadioButtonItem();

      shortStayClinicRecuperationMedicalExpensesRadioItem3.setText("2回");

      shortStayClinicRecuperationMedicalExpensesRadioItem3.setGroup(getShortStayClinicRecuperationMedicalExpensesRadio());

      shortStayClinicRecuperationMedicalExpensesRadioItem3.setConstraints(VRLayout.FLOW);

      addShortStayClinicRecuperationMedicalExpensesRadioItem3();
    }
    return shortStayClinicRecuperationMedicalExpensesRadioItem3;
   ...
   * @return 1回
   */
  public ACRadioButtonItem getShortStayClinicRecuperationMedicalExpensesRadioItem4(){
    if(shortStayClinicRecuperationMedicalExpensesRadioItem4==null){

      shortStayClinicRecuperationMedicalExpensesRadioItem4 = new ACRadioButtonItem();

      shortStayClinicRecuperationMedicalExpensesRadioItem4.setText("1回");

      shortStayClinicRecuperationMedicalExpensesRadioItem4.setGroup(getShortStayClinicRecuperationMedicalExpensesRadio());

      shortStayClinicRecuperationMedicalExpensesRadioItem4.setConstraints(VRLayout.FLOW);

      addShortStayClinicRecuperationMedicalExpensesRadioItem4();
    }
    return shortStayClinicRecuperationMedicalExpensesRadioItem4;
  ...
  public ACValueArrayRadioButtonGroup getDementiaProfessionalCareAddRadioGroup(){
    if(dementiaProfessionalCareAddRadioGroup==null){
      ...
      dementiaProfessionalCareAddRadioGroup.setBindPath("1260219");
   ...
   * コンストラクタです。
   */
  public QS001_12612_201804Design() {
  ...
  protected void addTab1(){
    ...
    tab1.add(getMealSystemSubRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   * 食堂の有無に内部項目を追加します。
   */
  protected void addMealSystemSubRadio(){
   ...
   * 食堂の有無モデルに内部項目を追加します。
   */
  protected void addMealSystemSubRadioModel(){

    getMealSystemSubRadioItem1().setButtonIndex(1);

    getMealSystemSubRadioModel().add(getMealSystemSubRadioItem1());

    getMealSystemSubRadioItem2().setButtonIndex(2);

    getMealSystemSubRadioModel().add(getMealSystemSubRadioItem2());
   ...
   * 基準型に内部項目を追加します。
   */
  protected void addMealSystemSubRadioItem1(){
   ...
   * 減算型に内部項目を追加します。
   */
  protected void addMealSystemSubRadioItem2(){
  ...
  protected void addShortStayClinicRecuperationMedicalExpensesRadioModel(){
    ...
    getShortStayClinicRecuperationMedicalExpensesRadioItem3().setButtonIndex(3);

    getShortStayClinicRecuperationMedicalExpensesRadioModel().add(getShortStayClinicRecuperationMedicalExpensesRadioItem3());

    getShortStayClinicRecuperationMedicalExpensesRadioItem4().setButtonIndex(4);

    getShortStayClinicRecuperationMedicalExpensesRadioModel().add(getShortStayClinicRecuperationMedicalExpensesRadioItem4());
   ...
   * 2回に内部項目を追加します。
   */
  protected void addShortStayClinicRecuperationMedicalExpensesRadioItem3(){
   ...
   * 1回に内部項目を追加します。
   */
  protected void addShortStayClinicRecuperationMedicalExpensesRadioItem4(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_12612_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_12612_201804Design getThis() {
    return this;
  }
}
