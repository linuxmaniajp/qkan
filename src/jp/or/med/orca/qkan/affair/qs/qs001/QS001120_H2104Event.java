...
/**
 * サービスパターン介護療養型医療施設（病院）イベント定義(QS001120_H2104) 
 */
public abstract class QS001120_H2104Event extends QS001120_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001120_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
