...
/**
 * サービスパターン夜間対応型訪問介護画面項目デザイン(QS001_17111_201804) 
 */
public class QS001_17111_201804Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_17111_201804Design() {
  ...
  protected void addNightTypeVisitCarePatterns(){
    ...
    nightTypeVisitCarePatterns.add(getHoumonNeededRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17111_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17111_201804Design getThis() {
    return this;
  }
}
