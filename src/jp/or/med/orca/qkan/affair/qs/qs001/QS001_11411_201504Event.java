...
/**
 * サービスパターン訪問リハイベント定義(QS001_11411_201504) 
 */
public abstract class QS001_11411_201504Event extends QS001_11411_201504State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_11411_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
