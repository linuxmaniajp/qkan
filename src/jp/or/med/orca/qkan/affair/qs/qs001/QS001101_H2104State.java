 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2009/03/07  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム 予定管理 (S)
 * プロセス サービス予定 (001)
...
/**
 * サービスパターン訪問介護状態定義(QS001101_H2104) 
 */
public class QS001101_H2104State extends QS001101_H2104Design {
  /**
   * コンストラクタです。
   */
  public QS001101_H2104State(){
  }
