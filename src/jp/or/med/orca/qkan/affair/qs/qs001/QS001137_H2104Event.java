...
/**
 * サービスパターン介護予防短期入所生活介護イベント定義(QS001137_H2104) 
 */
public abstract class QS001137_H2104Event extends QS001137_H2104State implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001137_H2104Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
