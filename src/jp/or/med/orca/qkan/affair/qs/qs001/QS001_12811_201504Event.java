...
/**
 * サービスパターン地域密着型特定施設入所者生活介護（短期利用）イベント定義(QS001_12811_201504) 
 */
public abstract class QS001_12811_201504Event extends QS001_12811_201504Design implements QS001Service {
  /**
   * コンストラクタです。
   */
  public QS001_12811_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
