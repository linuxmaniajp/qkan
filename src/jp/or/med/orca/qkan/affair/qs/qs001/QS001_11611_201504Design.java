...
/**
 * サービスパターン通所リハ画面項目デザイン(QS001_11611_201504) 
 */
public class QS001_11611_201504Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getHoumonRehabilitationManagementAddRadio(){
    if(houmonRehabilitationManagementAddRadio==null){
      ...
      houmonRehabilitationManagementAddRadio.setValues(new int[]{1,2,3,4});
  ...
  public ACRadioButtonItem getHoumonRehabilitationManagementAddRadioItem3(){
    if(houmonRehabilitationManagementAddRadioItem3==null){
      ...
      houmonRehabilitationManagementAddRadioItem3.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACRadioButtonItem getHoumonRehabilitationManagementAddRadioItem4(){
    if(houmonRehabilitationManagementAddRadioItem4==null){
      ...
      houmonRehabilitationManagementAddRadioItem4.setConstraints(VRLayout.FLOW);
   ...
   * コンストラクタです。
   */
  public QS001_11611_201504Design() {
  ...
  protected void addTab1(){
    ...
    tab1.add(getHoumonRehabilitationSubtractionContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addTab3(){
    ...
    tab3.add(getLifeActsImproveRehabilitationRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab3.add(getLifeActsImproveRehaSubtractionRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab3.add(getSevereCareRecipientsAcceptedContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_11611_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_11611_201504Design getThis() {
    return this;
  }
}
