 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2012/02/09  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
...
/**
 * サービスパターン認知症対応型通所介護画面項目デザイン(QS001_17211_201204) 
 */
public class QS001_17211_201204Design extends QS001ServicePanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QS001_17211_201204Design() {
  ...
  protected void addTab1(){
    ...
    tab1.add(getNourishmentManagementAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab1.add(getBathCareAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab1.add(getFunctionTrainingAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    tab1.add(getOralFunctionAddRadioContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QS001_17211_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QS001_17211_201204Design getThis() {
    return this;
  }
}
