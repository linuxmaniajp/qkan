 ...
 */
public class QkanBrowseLogger {
	
	private static Logger logger = Logger.getLogger(QkanBrowseLogger.class.getName());
	...
	static {
	    ...
	    try {
	        ...
	        handler.setFormatter(new QkanBrowseLoggerFormatter());
