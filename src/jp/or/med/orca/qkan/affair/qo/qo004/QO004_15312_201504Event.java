...
/**
 * 介護療養施設サービス（診療所型）イベント定義(QO004_15312_201504) 
 */
public abstract class QO004_15312_201504Event extends QO004_15312_201504SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_15312_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
