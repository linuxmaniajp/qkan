 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 小規模多機能型居宅介護(短期利用以外) (QO004_17311_201804)
 *
 *****************************************************************
 */
...
/**
 * 小規模多機能型居宅介護(短期利用以外)画面項目デザイン(QO004_17311_201804) 
 */
public class QO004_17311_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1730109");
   ...
   * コンストラクタです。
   */
  public QO004_17311_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_17311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_17311_201804Design getThis() {
    return this;
  }
}
