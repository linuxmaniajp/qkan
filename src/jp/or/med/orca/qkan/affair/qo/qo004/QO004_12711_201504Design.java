 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 特定施設入居者生活介護（短期利用） (QO004_12711_201504)
 *
 *****************************************************************
 */
...
/**
 * 特定施設入居者生活介護（短期利用）画面項目デザイン(QO004_12711_201504) 
 */
public class QO004_12711_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_12711_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12711_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12711_201504Design getThis() {
    return this;
  }
}
