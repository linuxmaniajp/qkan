 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム その他の生活支援サービス（その他／定額） (QO004_51411_201504)
 *
 *****************************************************************
 */
...
/**
 * その他の生活支援サービス（その他／定額）画面項目デザイン(QO004_51411_201504) 
 */
public class QO004_51411_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("その他の生活支援サービス（その他／定額）");
  ...
  public ACLabel getExplanationTitleLabel(){
    if(explanationTitleLabel==null){
      ...
      explanationTitleLabel.setText("設定項目はありません。このまま「反映」ボタンを押してください。");
   ...
   * コンストラクタです。
   */
  public QO004_51411_201504Design() {
  ...
  protected void addMainGroup(){
    ...
    mainGroup.add(getExplanationTitleLabel(), VRLayout.NORTH);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_51411_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_51411_201504Design getThis() {
    return this;
  }
}
