 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防短期入所療養介護(病院療養型) (QO004_12611_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護予防短期入所療養介護(病院療養型)画面項目デザイン(QO004_12611_201804) 
 */
public class QO004_12611_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignment1Division(){
    if(staffAssignment1Division==null){
      ...
      staffAssignment1Division.setBindPath("1260123");
  ...
  public ACRadioButtonItem getStaffAssignment1DivisionItem4(){
    if(staffAssignment1DivisionItem4==null){
      ...
      staffAssignment1DivisionItem4.setText("II型（療養機能強化型以外）");
  ...
  public ACRadioButtonItem getStaffAssignment1DivisionItem5(){
    if(staffAssignment1DivisionItem5==null){
      ...
      staffAssignment1DivisionItem5.setText("II型（療養機能強化型）");
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignment2Division(){
    if(staffAssignment2Division==null){
      ...
      staffAssignment2Division.setBindPath("1260126");
  ...
  public ACRadioButtonItem getStaffAssignmentDivisionItem1(){
    if(staffAssignmentDivisionItem1==null){
      ...
      staffAssignmentDivisionItem1.setText("療養機能強化型以外");

      staffAssignmentDivisionItem1.setGroup(getStaffAssignment2Division());
  ...
  public ACRadioButtonItem getStaffAssignmentDivisionItem2(){
    if(staffAssignmentDivisionItem2==null){
      ...
      staffAssignmentDivisionItem2.setText("療養機能強化型A");

      staffAssignmentDivisionItem2.setGroup(getStaffAssignment2Division());
  ...
  public ACRadioButtonItem getStaffAssignmentDivisionItem3(){
    if(staffAssignmentDivisionItem3==null){
      ...
      staffAssignmentDivisionItem3.setText("療養機能強化型B");

      staffAssignmentDivisionItem3.setGroup(getStaffAssignment2Division());
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignment3Division(){
    if(staffAssignment3Division==null){
      ...
      staffAssignment3Division.setBindPath("1260127");
  ...
  public ACValueArrayRadioButtonGroup getDementiaCareRadioGroup(){
    if(dementiaCareRadioGroup==null){
      ...
      dementiaCareRadioGroup.setBindPath("1260128");
   ...
   * コンストラクタです。
   */
  public QO004_12611_201804Design() {
  ...
  protected void addStaffAssignment2DivisionModel(){
    ...
    getStaffAssignment2DivisionModel().add(getStaffAssignmentDivisionItem1());

    getStaffAssignmentDivisionItem2().setButtonIndex(2);

    getStaffAssignment2DivisionModel().add(getStaffAssignmentDivisionItem2());

    getStaffAssignmentDivisionItem3().setButtonIndex(3);

    getStaffAssignment2DivisionModel().add(getStaffAssignmentDivisionItem3());
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12611_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12611_201804Design getThis() {
    return this;
  }
}
