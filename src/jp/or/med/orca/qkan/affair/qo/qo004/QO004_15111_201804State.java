 ...
 * アプリ: QKANCHO
 * 開発者: 上司　和善
 * 作成日: 2018/02/28  日本コンピューター株式会社 上司　和善 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
...
/**
 * 介護福祉施設サービス状態定義(QO004_15111_201804) 
 */
public class QO004_15111_201804State extends QO004_15111_201804Design {
  /**
   * コンストラクタです。
   */
  public QO004_15111_201804State(){
  }
   ...
   * @throws Exception 処理例外
   */
  public void setState_VALID_ORAL_MAINTENANCE() throws Exception {
   ...
   * @throws Exception 処理例外
   */
  public void setState_INVALID_ORAL_MAINTENANCE() throws Exception {
