 ...
 * アプリ: QKANCHO
 * 開発者: 松本　幸一
 * 作成日: 2018/01/30  日本コンピューター株式会社 松本　幸一 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 夜間対応型訪問看護 (QO004_17111_201804)
 *
 *****************************************************************
 */
...
/**
 * 夜間対応型訪問看護画面項目デザイン(QO004_17111_201804) 
 */
public class QO004_17111_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_17111_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_17111_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_17111_201804Design getThis() {
    return this;
  }
}
