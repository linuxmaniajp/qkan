...
/**
 * 認知症対応型共同生活介護（短期利用以外）イベント定義(QO004126) 
 */
@SuppressWarnings("serial")
public abstract class QO004_13211_201504Event extends QO004_13211_201504State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_13211_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
