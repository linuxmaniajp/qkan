...
/**
 * 特定施設入所者介護（短期利用）イベント定義(QO004_12711_201804) 
 */
public abstract class QO004_12711_201804Event extends QO004_12711_201804State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_12711_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
