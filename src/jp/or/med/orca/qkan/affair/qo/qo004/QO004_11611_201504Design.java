...
/**
 * 通所リハ画面項目デザイン(QO004_11611_201504) 
 */
public class QO004_11611_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getFacilitiesDivisionAfterH2104RadioGroup(){
    if(facilitiesDivisionAfterH2104RadioGroup==null){
      ...
      facilitiesDivisionAfterH2104RadioGroup.setValues(new int[]{1,2,3,4,5,6});
   ...
   * コンストラクタです。
   */
  public QO004_11611_201504Design() {
  ...
  protected void addCalculationDetails(){
    ...
    calculationDetails.add(getIntensiveRehabilitationRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    calculationDetails.add(getDementiaRihaAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    calculationDetails.add(getLifeActsImproveRehabilitationRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_11611_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_11611_201504Design getThis() {
    return this;
  }
}
