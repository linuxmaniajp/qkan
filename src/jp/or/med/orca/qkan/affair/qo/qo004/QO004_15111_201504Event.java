 ...
 * アプリ: QKANCHO
 * 開発者: 上司　和善
 * 作成日: 2015/02/10  日本コンピューター株式会社 上司　和善 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 介護福祉施設サービス (QO004_15111_201504)
 *
 *****************************************************************
 */
...
/**
 * 介護福祉施設サービスイベント定義(QO004_15111_201504) 
 */
public abstract class QO004_15111_201504Event extends QO004_15111_201504SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_15111_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int FACILITY_TYPE_RYOYOGATA_HOKEN = 3;
  public static final int FACILITY_TYPE_RYOYOGATA_UNIT_HOKEN = 4;
  //getter/setter
