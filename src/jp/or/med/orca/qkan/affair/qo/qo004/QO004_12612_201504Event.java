...
/**
 * 介護予防短期入所療養介護（診療所療養型）イベント定義(QO004140) 
 */
@SuppressWarnings("serial")
public abstract class QO004_12612_201504Event extends QO004_12612_201504SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_12612_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
