 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 訪問型サービス（独自定額） (QO004_50411_201804)
 *
 *****************************************************************
 */
...
/**
 * 訪問型サービス（独自定額）画面項目デザイン(QO004_50411_201804) 
 */
public class QO004_50411_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("訪問型サービス（独自／定額）");
   ...
   * コンストラクタです。
   */
  public QO004_50411_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_50411_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_50411_201804Design getThis() {
    return this;
  }
}
