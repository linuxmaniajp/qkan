 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防認知症対応型共同生活介護（短期利用） (QO004_13911_201504)
 *
 *****************************************************************
 */
...
/**
 * 介護予防認知症対応型共同生活介護（短期利用）画面項目デザイン(QO004_13911_201504) 
 */
public class QO004_13911_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防認知症対応型共同生活介護（短期利用）");
  ...
  public ACValueArrayRadioButtonGroup getFacilitiesDivision(){
    if(facilitiesDivision==null){
      ...
      facilitiesDivision.setBindPath("1390107");
  ...
  public ACValueArrayRadioButtonGroup getNightWorkDivision(){
    if(nightWorkDivision==null){
      ...
      nightWorkDivision.setBindPath("1390101");
  ...
  public ACValueArrayRadioButtonGroup getNightCareSystemAddRadioGroup(){
    if(nightCareSystemAddRadioGroup==null){
      ...
      nightCareSystemAddRadioGroup.setBindPath("1390103");
   ...
   * コンストラクタです。
   */
  public QO004_13911_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_13911_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_13911_201504Design getThis() {
    return this;
  }
}
