...
/**
 * 通所型サービス（独自）イベント定義(QO004_50611_201504) 
 */
public abstract class QO004_50611_201504Event extends QO004_50611_201504State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_50611_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
