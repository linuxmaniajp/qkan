...
/**
 * 介護予防訪問リハ画面項目デザイン(QO004133) 
 */
public class QO004133Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004133Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004133Design getThis() {
    return this;
  }
}
