 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム その他の生活支援サービス（配食／定額） (QO004_51011_201804)
 *
 *****************************************************************
 */
...
/**
 * その他の生活支援サービス（配食／定額）画面項目デザイン(QO004_51011_201804) 
 */
public class QO004_51011_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("その他の生活支援サービス（配食／定額）");
   ...
   * コンストラクタです。
   */
  public QO004_51011_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_51011_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_51011_201804Design getThis() {
    return this;
  }
}
