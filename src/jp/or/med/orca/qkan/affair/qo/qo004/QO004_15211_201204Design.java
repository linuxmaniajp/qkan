 ...
 * アプリ: QKANCHO
 * 開発者: 松本　幸一
 * 作成日: 2012/02/01  日本コンピューター株式会社 松本　幸一 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
...
/**
 * 介護老人保健施設画面項目デザイン(QO004_15211_201204) 
 */
public class QO004_15211_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_15211_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_15211_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_15211_201204Design getThis() {
    return this;
  }
}
