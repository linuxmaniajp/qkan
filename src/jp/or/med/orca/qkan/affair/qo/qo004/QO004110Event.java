 ...
 */
public abstract class QO004110Event extends QO004110SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004110Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int FACILITY_TYPE_NORMAL_ROUKEN = 1;
  //getter/setter
