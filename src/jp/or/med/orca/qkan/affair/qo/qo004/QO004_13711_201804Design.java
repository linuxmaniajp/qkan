 ...
 * アプリ: QKANCHO
 * 開発者: 廣瀬 一海
 * 作成日: 2018/01/31  日本コンピューター株式会社 廣瀬 一海 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防認知症対応型共同生活介護（短期利用以外） (QO004_13711_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護予防認知症対応型共同生活介護（短期利用以外）画面項目デザイン(QO004_13711_201804) 
 */
public class QO004_13711_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防認知症対応型共同生活介護（短期利用以外）");
  ...
  public ACValueArrayRadioButtonGroup getFacilitiesDivision(){
    if(facilitiesDivision==null){
      ...
      facilitiesDivision.setBindPath("1370107");
  ...
  public ACValueArrayRadioButtonGroup getNightWorkDivision(){
    if(nightWorkDivision==null){
      ...
      nightWorkDivision.setBindPath("1370101");
  ...
  public ACValueArrayRadioButtonGroup getBodyRestraintAbolished(){
    if(bodyRestraintAbolished==null){
      ...
      bodyRestraintAbolished.setBindPath("1370108");
  ...
  public ACValueArrayRadioButtonGroup getNightCareSystemAddRadioGroup(){
    if(nightCareSystemAddRadioGroup==null){
      ...
      nightCareSystemAddRadioGroup.setBindPath("1370103");
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1370104");
  ...
  public ACValueArrayRadioButtonGroup getStructureDuringHospitalization(){
    if(structureDuringHospitalization==null){
      ...
      structureDuringHospitalization.setBindPath("1370109");
  ...
  public ACValueArrayRadioButtonGroup getDementiaProfessionalCareAddRadioGroup(){
    if(dementiaProfessionalCareAddRadioGroup==null){
      ...
      dementiaProfessionalCareAddRadioGroup.setBindPath("1370105");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("1370106");
   ...
   * コンストラクタです。
   */
  public QO004_13711_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_13711_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_13711_201804Design getThis() {
    return this;
  }
}
