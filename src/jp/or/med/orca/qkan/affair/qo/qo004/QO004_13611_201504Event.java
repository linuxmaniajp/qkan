...
/**
 * 地域密着型特定施設入居者生活介護イベント定義(QO004128) 
 */
@SuppressWarnings("serial")
public abstract class QO004_13611_201504Event extends QO004_13611_201504State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_13611_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
