 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム その他の生活支援サービス（見守り／定率） (QO004_51111_201804)
 *
 *****************************************************************
 */
...
/**
 * その他の生活支援サービス（見守り／定率）画面項目デザイン(QO004_51111_201804) 
 */
public class QO004_51111_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("その他の生活支援サービス（見守り／定率）");
   ...
   * コンストラクタです。
   */
  public QO004_51111_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_51111_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_51111_201804Design getThis() {
    return this;
  }
}
