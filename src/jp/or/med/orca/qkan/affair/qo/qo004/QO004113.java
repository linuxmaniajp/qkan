...
/**
 * 短期入所療養介護（認知症疾患型）(QO004113) 
 */
public class QO004113 extends QO004113Event {
  /**
   * コンストラクタです。
   */
  public QO004113(){
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QO004113.class.getName(), param));
  }
...
//    }
  ...
  public void removeInvalidData(VRMap map) throws Exception{
	  ...
	  // ・hospitalDivision 削除KEY：1230317
	  // ・staffAssignmentDivision 削除KEY：1230302
	  // ・unitCareMaintenance 削除KEY：1230315
//	  if(!getHospitalDivision().isEnabled()){
//		  map.removeData("1230317");
//	  }
	  if(!getStaffAssignmentDivision().isEnabled()){
		  map.removeData("1230302");
	  }
	  if(!getUnitCareMaintenance().isEnabled()){
		  map.removeData("1230315");
	  }
