 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防短期入所療養介護(診療所型) (QO004_12612_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護予防短期入所療養介護(診療所型)画面項目デザイン(QO004_12612_201804) 
 */
public class QO004_12612_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防短期入所療養介護（診療所型）");
  ...
  public ACValueArrayRadioButtonGroup getShokudoRadioGroup(){
    if(shokudoRadioGroup==null){
      ...
      shokudoRadioGroup.setBindPath("1260220");
  ...
  public ACValueArrayRadioButtonGroup getDementiaCareRadioGroup(){
    if(dementiaCareRadioGroup==null){
      ...
      dementiaCareRadioGroup.setBindPath("1260221");
  ...
  /**
   * 集団コミュニケーション療法チェックを取得します。
   * @return 集団コミュニケーション療法チェック
   */
   ...
   * コンストラクタです。
   */
  public QO004_12612_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12612_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12612_201804Design getThis() {
    return this;
  }
}
