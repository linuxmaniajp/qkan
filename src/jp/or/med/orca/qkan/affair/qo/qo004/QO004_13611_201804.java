...
public class QO004_13611_201804 extends QO004_13611_201804Event {
    /**
     * コンストラクタです。
     */
    public QO004_13611_201804() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QO004_13611_201804.class.getName(),
                param));
    }
    ...
    public boolean isValidInput() throws Exception {
        ...
        // サテライトは選択不可
        if (getFacilitiesDivisionItem4().isSelected() ||
        		getFacilitiesDivisionItem5().isSelected() ||
        		getFacilitiesDivisionItem6().isSelected()) {
	...
	public void setState() throws Exception {
		...
		getFacilitiesDivisionItem5().setEnabled(false);
		getFacilitiesDivisionItem6().setEnabled(false);
        // 2018/03/01 [H30.4改正対応][Shinobu Hitaka] add - end
