 ...
 * アプリ: QKANCHO
 * 開発者: 上司　和善
 * 作成日: 2018/02/18  日本コンピューター株式会社 上司　和善 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
...
/**
 * 短期入所療養介護(介護老人保健施設)状態定義(QO004_12211_201804) 
 */
public class QO004_12211_201804State extends QO004_12211_201804Design {
  /**
   * コンストラクタです。
   */
  public QO004_12211_201804State(){
  }
  ...
  public void setState_FACILITY_TYPE_1() throws Exception {
        ...
        getPersonnelDivision1RadioGroup().getParent().setEnabled(true);
  ...
  public void setState_FACILITY_TYPE_3() throws Exception {
        ...
        getPersonnelDivision1RadioGroup().getParent().setEnabled(false);
