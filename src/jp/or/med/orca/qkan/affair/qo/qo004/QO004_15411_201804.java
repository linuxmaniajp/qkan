...
/**
 * 地域密着型介護老人福祉施設(QO004129)
 */
@SuppressWarnings("serial")
public class QO004_15411_201804 extends QO004_15411_201804Event {
    /**
     * コンストラクタです。
     */
    public QO004_15411_201804() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QO004_15411_201804.class.getName(),
                param));
    }
        ...
        if (residenceFood != null) {
            for (int i = 0; i < residenceFood.size(); i++) {
                ...
                case 4:
                    ...
                    break;
                // 多床室
                // [H27.8改正対応][Shinobu Hitaka] 2015/6/9 edit - begin 多床室(7:特養等と6:老健・療養等)に分けて保持
                //case 6:
                case 7:
                    getTasyouRoom().setText(cost);
                    break;
                // [H27.8改正対応][Shinobu Hitaka] 2015/6/9 edit - end
                }
    ...
    public boolean isValidInput() throws Exception {
        ...
        // サテライトは選択不可
        if (getFacilitiesDivisionItem2().isSelected() ||
        		getFacilitiesDivisionItem4().isSelected()) {
            QkanMessageList.getInstance().QO004_ERROR_OF_SATERAITO();
            // エラーが発生したインスタンスにフォーカスを当てる。
    ...
    public void setState() throws Exception {
        ...
        // 2018/03/01 [H30.4改正対応][Shinobu Hitaka] add - begin
        // サテライトは選択不可
        getFacilitiesDivisionItem2().setEnabled(false);
        getFacilitiesDivisionItem4().setEnabled(false);
        // 2018/03/01 [H30.4改正対応][Shinobu Hitaka] add - end
    }
    ...
    public void setStateByFacilitiesDivision() throws Exception {
        ...
        if (getFacilitiesDivision().getSelectedIndex() == FACILITY_TYPE_FUKUSHI
                || getFacilitiesDivision().getSelectedIndex() == FACILITY_TYPE_FUKUSHI_ST) {
            // 「介護老人福祉施設」「サテライト型介護老人福祉施設」が選択された場合
            setState_FACILITY_TYPE_NORMAL();
        } else {
            // 「介護老人福祉施設」「サテライト型介護老人福祉施設」以外が選択された場合
