 ...
 */
public class QO004143 extends QO004143Event {
	/**
	 * コンストラクタです。
	 */
	public QO004143() {
	 ...
	 *             処理例外
	 */
	protected void staffAssignmentDivisionSelectionChanged(ListSelectionEvent e) throws Exception {
		// 画面状態設定
		// 人員配置区分の値を確認
		// 「一般型」が選択された場合
	...
	public static void main(String[] args) {
		...
		ACFrame.debugStart(new ACAffairInfo(QO004143.class.getName(), param));
	}
