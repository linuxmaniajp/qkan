 ...
 * サブシステム 請求書出力 (O)
 * プロセス 請求処理 (002)
 * プログラム 保険者情報詳細 (QO002_InsurerRelation)
 * @since V5.4.9
 *
 *****************************************************************
 */
public class QO002_InsurerRelation implements  KeyListener, FocusListener, VRBindEventListener {
    // DB
     ...
     */
    public QO002_InsurerRelation(ACDBManager insurerDbm,
        ...
        // データ設定
        buildData(insurerNoText, insurerNameText, isChangeNo, isChangeName,
                isCheckNo, isCheckName);
    }
