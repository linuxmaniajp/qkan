 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 通所型サービス（独自定率） (QO004_50711_201804)
 *
 *****************************************************************
 */
...
/**
 * 通所型サービス（独自定率）画面項目デザイン(QO004_50711_201804) 
 */
public class QO004_50711_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_50711_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_50711_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_50711_201804Design getThis() {
    return this;
  }
}
