 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 事業者登録(介護予防短期入所療養介護(認知症疾患型)) (QO004_12613_201204)
 *
 *****************************************************************
 */
...
/**
 * 事業者登録(介護予防短期入所療養介護(認知症疾患型))画面項目デザイン(QO004_12613_201204) 
 */
public class QO004_12613_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_12613_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12613_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12613_201204Design getThis() {
    return this;
  }
}
