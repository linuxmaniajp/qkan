 ...
 * 短期入所生活介護(QO004109) 
 */
public class QO004109 extends QO004109Event {
  /**
   * コンストラクタです。
   */
  public QO004109(){
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QO004109.class.getName(), param));
  }
...
//		getStayHeavyAdd().setSelectedIndex(1);
        ...
        //＜平成21年4月法改正対応＞
        //看護体制加算の初期値として「なし」を選択する。
        getNurseStructuralAddRadioGroup().setSelectedIndex(1);
...
//    // ・stayHeavyAdd（在宅中重度者受入体制ラジオグループ）
//    // ※ errMsg = 在宅中重度者受入体制
//    if(!getStayHeavyAdd().isSelected()){
//    	errMsg = "在宅中重度者受入体制";
//    	QkanMessageList.getInstance().ERROR_OF_NEED_CHECK_FOR_SELECT(errMsg);
//    	getStayHeavyAdd().requestFocus();
//    	return false;
//    }
...
//
//    // 全ての食費テキストが入力されていなかった場合
//    // ・dinnerTotal（食費基準額・合計）
...
//    }
  ...
  public void removeInvalidData(VRMap map) throws Exception{
	  ...
	  // ・unitCareMaintenance　KEY：1210116
