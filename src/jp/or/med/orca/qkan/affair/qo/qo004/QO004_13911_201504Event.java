...
/**
 * 介護予防認知症対応型共同生活介護（短期利用）イベント定義(QO004149) 
 */
@SuppressWarnings("serial")
public abstract class QO004_13911_201504Event extends QO004_13911_201504State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_13911_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
