...
/**
 * 介護予防短期入所療養介護（介護老人保健施設）(QO004138)
 */
public class QO004138 extends QO004138Event {
	/**
	 * コンストラクタです。
	 */
	public QO004138() {
	...
	public static void main(String[] args) {
		...
		ACFrame.debugStart(new ACAffairInfo(QO004138.class.getName(), param));
	}
	...
	public boolean isValidInput() throws Exception {
		...
		// ・rehabilitationReinforcement（リハビリテーション機能強化ラジオグループ） ※errMsg = リハビリテーション機能強化
