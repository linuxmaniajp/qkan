 ...
 * アプリ: QKANCHO
 * 開発者: 日高　しのぶ
 * 作成日: 2018/03/08  日本コンピューター株式会社 日高　しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その多機能 (O)
 * プロセス 事業所情報登録 (004)
 * プログラム 介護医療院 (QO004_15511_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護医療院画面項目デザイン(QO004_15511_201804) 
 */
public class QO004_15511_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup severeDementiaDisease;

  private ACLabelContainer severeDementiaDiseaseContainer;

  private ACListModelAdapter severeDementiaDiseaseModel;

  private ACRadioButtonItem severeDementiaDiseaseRadioItem1;

  private ACRadioButtonItem severeDementiaDiseaseRadioItem2;

  private ACRadioButtonItem severeDementiaDiseaseRadioItem3;

  private ACValueArrayRadioButtonGroup transferFixingSupport;

  private ACLabelContainer transferFixingSupportContainer;

  private ACListModelAdapter transferFixingSupportModel;

  private ACRadioButtonItem transferFixingSupportRadioItem1;

  private ACRadioButtonItem transferFixingSupportRadioItem2;
  ...
  public ACValueArrayRadioButtonGroup getFacilitiesDivision(){
    if(facilitiesDivision==null){
      ...
      facilitiesDivision.setBindPath("1550101");
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignmentDivision1(){
    if(staffAssignmentDivision1==null){
      ...
      staffAssignmentDivision1.setBindPath("1550102");
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignmentDivision2(){
    if(staffAssignmentDivision2==null){
      ...
      staffAssignmentDivision2.setBindPath("1550103");
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignmentDivision3(){
    if(staffAssignmentDivision3==null){
      ...
      staffAssignmentDivision3.setBindPath("1550104");
  ...
  public ACValueArrayRadioButtonGroup getNightWorkDivision(){
    if(nightWorkDivision==null){
      ...
      nightWorkDivision.setBindPath("1550105");
  ...
  public ACValueArrayRadioButtonGroup getStaffLack(){
    if(staffLack==null){
      ...
      staffLack.setBindPath("1550106");

      staffLack.setUseClearButton(false);

      staffLack.setModel(getStaffLackModel());

      staffLack.setValues(new int[]{1,2,3,4,5,6});
  ...
  public ACRadioButtonItem getStaffLackItem6(){
    if(staffLackItem6==null){
      ...
      staffLackItem6.setText("介護支援専門員");
  ...
  public ACValueArrayRadioButtonGroup getUnitCareMaintenance(){
    if(unitCareMaintenance==null){
      ...
      unitCareMaintenance.setBindPath("1550107");
  ...
  public ACValueArrayRadioButtonGroup getBodyRestraintAbolition(){
    if(bodyRestraintAbolition==null){
      ...
      bodyRestraintAbolition.setBindPath("1550108");
  ...
  public ACValueArrayRadioButtonGroup getRecuperationEnvironmental1(){
    if(recuperationEnvironmental1==null){
      ...
      recuperationEnvironmental1.setBindPath("1550109");
  ...
  public ACValueArrayRadioButtonGroup getRecuperationEnvironmental2(){
    if(recuperationEnvironmental2==null){
      ...
      recuperationEnvironmental2.setBindPath("1550110");
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1550111");
  ...
  public ACValueArrayRadioButtonGroup getNourishmentImprovement(){
    if(nourishmentImprovement==null){
      ...
      nourishmentImprovement.setBindPath("1550112");
  ...
  public ACValueArrayRadioButtonGroup getMedicalFoodAddRadioGroup(){
    if(medicalFoodAddRadioGroup==null){
      ...
      medicalFoodAddRadioGroup.setBindPath("1550113");
  ...
  public ACValueArrayRadioButtonGroup getDementiaRihaAddRadioGroup(){
    if(dementiaRihaAddRadioGroup==null){
      ...
      dementiaRihaAddRadioGroup.setBindPath("1550126");
  ...
  public ACValueArrayRadioButtonGroup getDementiaCareRadioGroup(){
    if(dementiaCareRadioGroup==null){
      ...
      dementiaCareRadioGroup.setBindPath("1550114");
   ...
   */
  public ACValueArrayRadioButtonGroup getSevereDementiaDisease(){
    if(severeDementiaDisease==null){

      severeDementiaDisease = new ACValueArrayRadioButtonGroup();

      getSevereDementiaDiseaseContainer().setText("重度認知症疾患療養体制加算");

      severeDementiaDisease.setBindPath("1550115");

      severeDementiaDisease.setNoSelectIndex(0);

      severeDementiaDisease.setUseClearButton(false);

      severeDementiaDisease.setModel(getSevereDementiaDiseaseModel());

      severeDementiaDisease.setValues(new int[]{1,2,3});

      addSevereDementiaDisease();
    }
    return severeDementiaDisease;
   ...
   */
  protected ACLabelContainer getSevereDementiaDiseaseContainer(){
    if(severeDementiaDiseaseContainer==null){
      severeDementiaDiseaseContainer = new ACLabelContainer();
      severeDementiaDiseaseContainer.setFollowChildEnabled(true);
      severeDementiaDiseaseContainer.setVAlignment(VRLayout.CENTER);
      severeDementiaDiseaseContainer.add(getSevereDementiaDisease(), null);
    }
    return severeDementiaDiseaseContainer;
  }
   ...
   */
  protected ACListModelAdapter getSevereDementiaDiseaseModel(){
    if(severeDementiaDiseaseModel==null){
      severeDementiaDiseaseModel = new ACListModelAdapter();
      addSevereDementiaDiseaseModel();
    }
    return severeDementiaDiseaseModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getSevereDementiaDiseaseRadioItem1(){
    if(severeDementiaDiseaseRadioItem1==null){

      severeDementiaDiseaseRadioItem1 = new ACRadioButtonItem();

      severeDementiaDiseaseRadioItem1.setText("なし");

      severeDementiaDiseaseRadioItem1.setGroup(getSevereDementiaDisease());

      severeDementiaDiseaseRadioItem1.setConstraints(VRLayout.FLOW);

      addSevereDementiaDiseaseRadioItem1();
    }
    return severeDementiaDiseaseRadioItem1;
   ...
   * @return 加算I
   */
  public ACRadioButtonItem getSevereDementiaDiseaseRadioItem2(){
    if(severeDementiaDiseaseRadioItem2==null){

      severeDementiaDiseaseRadioItem2 = new ACRadioButtonItem();

      severeDementiaDiseaseRadioItem2.setText("加算I");

      severeDementiaDiseaseRadioItem2.setGroup(getSevereDementiaDisease());

      severeDementiaDiseaseRadioItem2.setConstraints(VRLayout.FLOW);

      addSevereDementiaDiseaseRadioItem2();
    }
    return severeDementiaDiseaseRadioItem2;
   ...
   * @return 加算II
   */
  public ACRadioButtonItem getSevereDementiaDiseaseRadioItem3(){
    if(severeDementiaDiseaseRadioItem3==null){

      severeDementiaDiseaseRadioItem3 = new ACRadioButtonItem();

      severeDementiaDiseaseRadioItem3.setText("加算II");

      severeDementiaDiseaseRadioItem3.setGroup(getSevereDementiaDisease());

      severeDementiaDiseaseRadioItem3.setConstraints(VRLayout.FLOW);

      addSevereDementiaDiseaseRadioItem3();
    }
    return severeDementiaDiseaseRadioItem3;
   ...
   * @return 移行定着支援加算
   */
  public ACValueArrayRadioButtonGroup getTransferFixingSupport(){
    if(transferFixingSupport==null){

      transferFixingSupport = new ACValueArrayRadioButtonGroup();

      getTransferFixingSupportContainer().setText("移行定着支援加算");

      transferFixingSupport.setBindPath("1550116");

      transferFixingSupport.setNoSelectIndex(0);

      transferFixingSupport.setUseClearButton(false);

      transferFixingSupport.setModel(getTransferFixingSupportModel());

      transferFixingSupport.setValues(new int[]{1,2});

      addTransferFixingSupport();
    }
    return transferFixingSupport;
   ...
   * @return 移行定着支援加算コンテナ
   */
  protected ACLabelContainer getTransferFixingSupportContainer(){
    if(transferFixingSupportContainer==null){
      transferFixingSupportContainer = new ACLabelContainer();
      transferFixingSupportContainer.setFollowChildEnabled(true);
      transferFixingSupportContainer.setVAlignment(VRLayout.CENTER);
      transferFixingSupportContainer.add(getTransferFixingSupport(), null);
    }
    return transferFixingSupportContainer;
  }
   ...
   * @return 移行定着支援加算モデル
   */
  protected ACListModelAdapter getTransferFixingSupportModel(){
    if(transferFixingSupportModel==null){
      transferFixingSupportModel = new ACListModelAdapter();
      addTransferFixingSupportModel();
    }
    return transferFixingSupportModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getTransferFixingSupportRadioItem1(){
    if(transferFixingSupportRadioItem1==null){

      transferFixingSupportRadioItem1 = new ACRadioButtonItem();

      transferFixingSupportRadioItem1.setText("なし");

      transferFixingSupportRadioItem1.setGroup(getTransferFixingSupport());

      transferFixingSupportRadioItem1.setConstraints(VRLayout.FLOW);

      addTransferFixingSupportRadioItem1();
    }
    return transferFixingSupportRadioItem1;
   ...
   * @return あり
   */
  public ACRadioButtonItem getTransferFixingSupportRadioItem2(){
    if(transferFixingSupportRadioItem2==null){

      transferFixingSupportRadioItem2 = new ACRadioButtonItem();

      transferFixingSupportRadioItem2.setText("あり");

      transferFixingSupportRadioItem2.setGroup(getTransferFixingSupport());

      transferFixingSupportRadioItem2.setConstraints(VRLayout.FLOW);

      addTransferFixingSupportRadioItem2();
    }
    return transferFixingSupportRadioItem2;
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("1550117");
  ...
  public ACTextField getDinnerTotal(){
    if(dinnerTotal==null){
      ...
      dinnerTotal.setBindPath("1550118");
  ...
  public ACTextField getDinnerMorning(){
    if(dinnerMorning==null){
      ...
      dinnerMorning.setBindPath("1550119");
  ...
  public ACTextField getDinnerNoon(){
    if(dinnerNoon==null){
      ...
      dinnerNoon.setBindPath("1550120");
  ...
  public ACTextField getDinnerNight(){
    if(dinnerNight==null){
      ...
      dinnerNight.setBindPath("1550121");
  ...
  public ACTextField getUnitSemiRoom(){
    if(unitSemiRoom==null){
      ...
      unitSemiRoom.setBindPath("1550123");
  ...
  public ACTextField getNormalRoom(){
    if(normalRoom==null){
      ...
      normalRoom.setBindPath("1550124");
  ...
  public ACTextField getTasyouRoom(){
    if(tasyouRoom==null){
      ...
      tasyouRoom.setBindPath("1550125");
   ...
   * コンストラクタです。
   */
  public QO004_15511_201804Design() {
  ...
  protected void addPanel1(){
    ...
    panel1.add(getBodyRestraintAbolitionContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addPanel2(){
    ...
    panel2.add(getRecuperationEnvironmental1Container(), VRLayout.FLOW_INSETLINE_RETURN);

    panel2.add(getRecuperationEnvironmental2Container(), VRLayout.FLOW_INSETLINE_RETURN);

    panel2.add(getYoungDementiaPatinetAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    panel2.add(getNourishmentImprovementContainer(), VRLayout.FLOW_INSETLINE_RETURN);
    ...
    panel2.add(getDementiaRihaAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    panel2.add(getDementiaCareRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    panel2.add(getSevereDementiaDiseaseContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    panel2.add(getTransferFixingSupportContainer(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   */
  protected void addSevereDementiaDisease(){
   ...
   */
  protected void addSevereDementiaDiseaseModel(){

    getSevereDementiaDiseaseRadioItem1().setButtonIndex(1);

    getSevereDementiaDiseaseModel().add(getSevereDementiaDiseaseRadioItem1());

    getSevereDementiaDiseaseRadioItem2().setButtonIndex(2);

    getSevereDementiaDiseaseModel().add(getSevereDementiaDiseaseRadioItem2());

    getSevereDementiaDiseaseRadioItem3().setButtonIndex(3);

    getSevereDementiaDiseaseModel().add(getSevereDementiaDiseaseRadioItem3());
   ...
   * なしに内部項目を追加します。
   */
  protected void addSevereDementiaDiseaseRadioItem1(){
   ...
   * 加算Iに内部項目を追加します。
   */
  protected void addSevereDementiaDiseaseRadioItem2(){
   ...
   * 加算IIに内部項目を追加します。
   */
  protected void addSevereDementiaDiseaseRadioItem3(){
   ...
   * 移行定着支援加算に内部項目を追加します。
   */
  protected void addTransferFixingSupport(){
   ...
   */
  protected void addTransferFixingSupportModel(){

    getTransferFixingSupportRadioItem1().setButtonIndex(1);

    getTransferFixingSupportModel().add(getTransferFixingSupportRadioItem1());

    getTransferFixingSupportRadioItem2().setButtonIndex(2);

    getTransferFixingSupportModel().add(getTransferFixingSupportRadioItem2());
   ...
   * なしに内部項目を追加します。
   */
  protected void addTransferFixingSupportRadioItem1(){
   ...
   * ありに内部項目を追加します。
   */
  protected void addTransferFixingSupportRadioItem2(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_15511_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_15511_201804Design getThis() {
    return this;
  }
}
