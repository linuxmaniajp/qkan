 ...
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 介護療養型医療施設（診療所型） (QO004_15312_201204)
 *
 *****************************************************************
 */
...
/**
 * 介護療養型医療施設（診療所型）イベント定義(QO004_15312_201204) 
 */
public abstract class QO004_15312_201204Event extends QO004_15312_201204SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_15312_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
