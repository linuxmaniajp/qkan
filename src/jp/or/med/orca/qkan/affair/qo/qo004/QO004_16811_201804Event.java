...
/**
 * 小規模多機能型居宅介護(短期利用)イベント定義(QO004168) 
 */
public abstract class QO004_16811_201804Event extends QO004_16811_201804State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_16811_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
