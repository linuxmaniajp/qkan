 ...
 * アプリ: QKANCHO
 * 開発者: 廣瀬 一海
 * 作成日: 2008/04/16  日本コンピューター株式会社 廣瀬 一海 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
...
/**
 * 介護予防短期入所療養介護（介護老人保健施設）イベント定義(QO004138) 
 */
public abstract class QO004138Event extends QO004138SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004138Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
