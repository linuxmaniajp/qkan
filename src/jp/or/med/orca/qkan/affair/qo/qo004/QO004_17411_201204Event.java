...
/**
 * 介護予防認知症対応型通所介護イベント定義(QO004146) 
 */
public abstract class QO004_17411_201204Event extends QO004_17411_201204State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_17411_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
