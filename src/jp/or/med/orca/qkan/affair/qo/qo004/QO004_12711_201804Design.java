 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 特定施設入居者生活介護（短期利用） (QO004_12711_201804)
 *
 *****************************************************************
 */
...
/**
 * 特定施設入居者生活介護（短期利用）画面項目デザイン(QO004_12711_201804) 
 */
public class QO004_12711_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("特定施設入居者生活介護（短期利用）");
  ...
  public ACValueArrayRadioButtonGroup getFacilitiesDivision(){
    if(facilitiesDivision==null){
      ...
      facilitiesDivision.setBindPath("1270101");
  ...
  public ACValueArrayRadioButtonGroup getNightNursingSystemAdd(){
    if(nightNursingSystemAdd==null){
      ...
      nightNursingSystemAdd.setBindPath("1270103");
  ...
  public ACValueArrayRadioButtonGroup getAcceptanceOfJuvenileDementia(){
    if(acceptanceOfJuvenileDementia==null){
      ...
      acceptanceOfJuvenileDementia.setBindPath("1270105");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("1270104");
   ...
   * コンストラクタです。
   */
  public QO004_12711_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12711_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12711_201804Design getThis() {
    return this;
  }
}
