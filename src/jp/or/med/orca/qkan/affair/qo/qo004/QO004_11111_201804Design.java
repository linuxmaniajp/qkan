 ...
 * アプリ: QKANCHO
 * 開発者: 日高　しのぶ
 * 作成日: 2018/01/21  MIS 日高　しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 訪問介護 (QO004_11111_201804)
 *
 *****************************************************************
 */
...
/**
 * 訪問介護画面項目デザイン(QO004_11111_201804) 
 */
public class QO004_11111_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup kyoseiServiceKyotakuRadioGroup;

  private ACLabelContainer kyoseiServiceKyotakuRadioGroupContainer;

  private ACListModelAdapter kyoseiServiceKyotakuRadioGroupModel;

  private ACRadioButtonItem kyoseiServiceKyotakuRadioItem1;

  private ACRadioButtonItem kyoseiServiceKyotakuRadioItem2;

  private ACValueArrayRadioButtonGroup kyoseiServiceJudoRadioGroup;

  private ACLabelContainer kyoseiServiceJudoRadioGroupContainer;

  private ACListModelAdapter kyoseiServiceJudoRadioGroupModel;

  private ACRadioButtonItem kyoseiServiceJudoRadioItem1;

  private ACRadioButtonItem kyoseiServiceJudoRadioItem2;
  ...
  /**
   * 共生型サービスの提供（居宅介護事業所）を取得します。
   * @return 共生型サービスの提供（居宅介護事業所）
   */
  public ACValueArrayRadioButtonGroup getKyoseiServiceKyotakuRadioGroup(){
    if(kyoseiServiceKyotakuRadioGroup==null){

      kyoseiServiceKyotakuRadioGroup = new ACValueArrayRadioButtonGroup();

      getKyoseiServiceKyotakuRadioGroupContainer().setText("共生型サービスの提供（居宅介護事業所）");

      kyoseiServiceKyotakuRadioGroup.setBindPath("1110105");

      kyoseiServiceKyotakuRadioGroup.setVisible(true);

      kyoseiServiceKyotakuRadioGroup.setEnabled(true);

      kyoseiServiceKyotakuRadioGroup.setNoSelectIndex(0);

      kyoseiServiceKyotakuRadioGroup.setUseClearButton(false);

      kyoseiServiceKyotakuRadioGroup.setModel(getKyoseiServiceKyotakuRadioGroupModel());

      kyoseiServiceKyotakuRadioGroup.setValues(new int[]{1,2});

      addKyoseiServiceKyotakuRadioGroup();
    }
    return kyoseiServiceKyotakuRadioGroup;

  }

  /**
   * 共生型サービスの提供（居宅介護事業所）コンテナを取得します。
   * @return 共生型サービスの提供（居宅介護事業所）コンテナ
   */
  protected ACLabelContainer getKyoseiServiceKyotakuRadioGroupContainer(){
    if(kyoseiServiceKyotakuRadioGroupContainer==null){
      kyoseiServiceKyotakuRadioGroupContainer = new ACLabelContainer();
      kyoseiServiceKyotakuRadioGroupContainer.setFollowChildEnabled(true);
      kyoseiServiceKyotakuRadioGroupContainer.setVAlignment(VRLayout.CENTER);
      kyoseiServiceKyotakuRadioGroupContainer.add(getKyoseiServiceKyotakuRadioGroup(), null);
    }
    return kyoseiServiceKyotakuRadioGroupContainer;
  }

  /**
   * 共生型サービスの提供（居宅介護事業所）モデルを取得します。
   * @return 共生型サービスの提供（居宅介護事業所）モデル
   */
  protected ACListModelAdapter getKyoseiServiceKyotakuRadioGroupModel(){
    if(kyoseiServiceKyotakuRadioGroupModel==null){
      kyoseiServiceKyotakuRadioGroupModel = new ACListModelAdapter();
      addKyoseiServiceKyotakuRadioGroupModel();
    }
    return kyoseiServiceKyotakuRadioGroupModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getKyoseiServiceKyotakuRadioItem1(){
    if(kyoseiServiceKyotakuRadioItem1==null){

      kyoseiServiceKyotakuRadioItem1 = new ACRadioButtonItem();

      kyoseiServiceKyotakuRadioItem1.setText("なし");

      kyoseiServiceKyotakuRadioItem1.setGroup(getKyoseiServiceKyotakuRadioGroup());

      kyoseiServiceKyotakuRadioItem1.setConstraints(VRLayout.FLOW);

      addKyoseiServiceKyotakuRadioItem1();
    }
    return kyoseiServiceKyotakuRadioItem1;
   ...
   * @return あり
   */
  public ACRadioButtonItem getKyoseiServiceKyotakuRadioItem2(){
    if(kyoseiServiceKyotakuRadioItem2==null){

      kyoseiServiceKyotakuRadioItem2 = new ACRadioButtonItem();

      kyoseiServiceKyotakuRadioItem2.setText("あり");

      kyoseiServiceKyotakuRadioItem2.setGroup(getKyoseiServiceKyotakuRadioGroup());

      kyoseiServiceKyotakuRadioItem2.setConstraints(VRLayout.FLOW);

      addKyoseiServiceKyotakuRadioItem2();
    }
    return kyoseiServiceKyotakuRadioItem2;

  }

  /**
   * 共生型サービスの提供（重度訪問介護事業所）を取得します。
   * @return 共生型サービスの提供（重度訪問介護事業所）
   */
  public ACValueArrayRadioButtonGroup getKyoseiServiceJudoRadioGroup(){
    if(kyoseiServiceJudoRadioGroup==null){

      kyoseiServiceJudoRadioGroup = new ACValueArrayRadioButtonGroup();

      getKyoseiServiceJudoRadioGroupContainer().setText("共生型サービスの提供（重度訪問介護事業所）");

      kyoseiServiceJudoRadioGroup.setBindPath("1110106");

      kyoseiServiceJudoRadioGroup.setVisible(true);

      kyoseiServiceJudoRadioGroup.setEnabled(true);

      kyoseiServiceJudoRadioGroup.setNoSelectIndex(0);

      kyoseiServiceJudoRadioGroup.setUseClearButton(false);

      kyoseiServiceJudoRadioGroup.setModel(getKyoseiServiceJudoRadioGroupModel());

      kyoseiServiceJudoRadioGroup.setValues(new int[]{1,2});

      addKyoseiServiceJudoRadioGroup();
    }
    return kyoseiServiceJudoRadioGroup;

  }

  /**
   * 共生型サービスの提供（重度訪問介護事業所）コンテナを取得します。
   * @return 共生型サービスの提供（重度訪問介護事業所）コンテナ
   */
  protected ACLabelContainer getKyoseiServiceJudoRadioGroupContainer(){
    if(kyoseiServiceJudoRadioGroupContainer==null){
      kyoseiServiceJudoRadioGroupContainer = new ACLabelContainer();
      kyoseiServiceJudoRadioGroupContainer.setFollowChildEnabled(true);
      kyoseiServiceJudoRadioGroupContainer.setVAlignment(VRLayout.CENTER);
      kyoseiServiceJudoRadioGroupContainer.add(getKyoseiServiceJudoRadioGroup(), null);
    }
    return kyoseiServiceJudoRadioGroupContainer;
  }

  /**
   * 共生型サービスの提供（重度訪問介護事業所）モデルを取得します。
   * @return 共生型サービスの提供（重度訪問介護事業所）モデル
   */
  protected ACListModelAdapter getKyoseiServiceJudoRadioGroupModel(){
    if(kyoseiServiceJudoRadioGroupModel==null){
      kyoseiServiceJudoRadioGroupModel = new ACListModelAdapter();
      addKyoseiServiceJudoRadioGroupModel();
    }
    return kyoseiServiceJudoRadioGroupModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getKyoseiServiceJudoRadioItem1(){
    if(kyoseiServiceJudoRadioItem1==null){

      kyoseiServiceJudoRadioItem1 = new ACRadioButtonItem();

      kyoseiServiceJudoRadioItem1.setText("なし");

      kyoseiServiceJudoRadioItem1.setGroup(getKyoseiServiceJudoRadioGroup());

      kyoseiServiceJudoRadioItem1.setConstraints(VRLayout.FLOW);

      addKyoseiServiceJudoRadioItem1();
    }
    return kyoseiServiceJudoRadioItem1;
   ...
   * @return あり
   */
  public ACRadioButtonItem getKyoseiServiceJudoRadioItem2(){
    if(kyoseiServiceJudoRadioItem2==null){

      kyoseiServiceJudoRadioItem2 = new ACRadioButtonItem();

      kyoseiServiceJudoRadioItem2.setText("あり");

      kyoseiServiceJudoRadioItem2.setGroup(getKyoseiServiceJudoRadioGroup());

      kyoseiServiceJudoRadioItem2.setConstraints(VRLayout.FLOW);

      addKyoseiServiceJudoRadioItem2();
    }
    return kyoseiServiceJudoRadioItem2;
   ...
   * コンストラクタです。
   */
  public QO004_11111_201804Design() {
  ...
  protected void addMainGroup(){
    ...
    mainGroup.add(getKyoseiServiceKyotakuRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    mainGroup.add(getKyoseiServiceJudoRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  /**
   * 共生型サービスの提供（居宅介護事業所）に内部項目を追加します。
   */
  protected void addKyoseiServiceKyotakuRadioGroup(){

  }

  /**
   * 共生型サービスの提供（居宅介護事業所）モデルに内部項目を追加します。
   */
  protected void addKyoseiServiceKyotakuRadioGroupModel(){

    getKyoseiServiceKyotakuRadioItem1().setButtonIndex(1);

    getKyoseiServiceKyotakuRadioGroupModel().add(getKyoseiServiceKyotakuRadioItem1());

    getKyoseiServiceKyotakuRadioItem2().setButtonIndex(2);

    getKyoseiServiceKyotakuRadioGroupModel().add(getKyoseiServiceKyotakuRadioItem2());
   ...
   * なしに内部項目を追加します。
   */
  protected void addKyoseiServiceKyotakuRadioItem1(){
   ...
   * ありに内部項目を追加します。
   */
  protected void addKyoseiServiceKyotakuRadioItem2(){

  }

  /**
   * 共生型サービスの提供（重度訪問介護事業所）に内部項目を追加します。
   */
  protected void addKyoseiServiceJudoRadioGroup(){

  }

  /**
   * 共生型サービスの提供（重度訪問介護事業所）モデルに内部項目を追加します。
   */
  protected void addKyoseiServiceJudoRadioGroupModel(){

    getKyoseiServiceJudoRadioItem1().setButtonIndex(1);

    getKyoseiServiceJudoRadioGroupModel().add(getKyoseiServiceJudoRadioItem1());

    getKyoseiServiceJudoRadioItem2().setButtonIndex(2);

    getKyoseiServiceJudoRadioGroupModel().add(getKyoseiServiceJudoRadioItem2());
   ...
   * なしに内部項目を追加します。
   */
  protected void addKyoseiServiceJudoRadioItem1(){
   ...
   * ありに内部項目を追加します。
   */
  protected void addKyoseiServiceJudoRadioItem2(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_11111_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_11111_201804Design getThis() {
    return this;
  }
}
