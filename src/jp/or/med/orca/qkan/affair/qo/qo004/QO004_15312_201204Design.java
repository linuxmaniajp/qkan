...
/**
 * （介護療養型医療施設（診療所型）画面項目デザイン(QO004_15312_201204) 
 */
public class QO004_15312_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_15312_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_15312_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_15312_201204Design getThis() {
    return this;
  }
}
