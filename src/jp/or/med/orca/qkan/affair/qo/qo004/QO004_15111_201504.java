...
public class QO004_15111_201504 extends QO004_15111_201504Event {
    /**
     * コンストラクタです。
     */
    public QO004_15111_201504() {
    }
    ...
    public static void main(String[] args) {
        ...
        ACFrame.debugStart(new ACAffairInfo(QO004_15111_201504.class.getName(),
                param));
    }
    ...
    public void setStateByFacilitiesDivision() throws Exception {
        ...
        if (getFacilitiesDivision().getSelectedIndex() == FACILITY_TYPE_FUKUSHI
            ...
            // 「介護福祉施設」「小規模介護福祉施設」が選択された場合
            setState_FACILITY_TYPE_NORMAL();
        } else {
            // 「介護福祉施設」「小規模介護福祉施設」以外が選択された場合
