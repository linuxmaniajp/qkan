 ...
 * アプリ: QKANCHO
 * 開発者: 松本　幸一
 * 作成日: 2015/03/02  日本コンピューター株式会社 松本　幸一 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 事業者登録(短期入所療養介護認知症疾患型) (QO004_12313_201504)
 *
 *****************************************************************
 */
...
/**
 * 事業者登録(短期入所療養介護認知症疾患型)画面項目デザイン(QO004_12313_201504) 
 */
public class QO004_12313_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_12313_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12313_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12313_201504Design getThis() {
    return this;
  }
}
