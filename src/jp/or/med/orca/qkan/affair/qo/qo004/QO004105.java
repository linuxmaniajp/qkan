 ...
 * 訪問リハ(QO004105) 
 */
public class QO004105 extends QO004105Event {
  /**
   * コンストラクタです。
   */
  public QO004105(){
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QO004105.class.getName(), param));
  }
...
//	getRehabilitationManagementAdd().setSelectedIndex(1);
...
//    // ・rehabilitationManagementAdd（リハビリ・マネジメント体制ラジオグループ）※ errMsg = リハビリ・マネジメント体制
