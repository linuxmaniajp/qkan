 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 短期入所療養介護診療所型 (QO004_12312_201804)
 *
 *****************************************************************
 */
...
/**
 * 短期入所療養介護診療所型画面項目デザイン(QO004_12312_201804) 
 */
public class QO004_12312_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup shokudoRadioGroup;

  private ACLabelContainer shokudoRadioGroupContainer;

  private ACListModelAdapter shokudoRadioGroupModel;

  private ACRadioButtonItem shokudoRadioItem1;

  private ACRadioButtonItem shokudoRadioItem2;
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("短期入所療養介護（診療所型）");
  ...
  public ACValueArrayRadioButtonGroup getFacilitiesDivision(){
    if(facilitiesDivision==null){
      ...
      facilitiesDivision.setBindPath("1230201");
  ...
  public ACRadioButtonItem getStaffAssignment1DivisionItem1(){
    if(staffAssignment1DivisionItem1==null){
      ...
      staffAssignment1DivisionItem1.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACRadioButtonItem getStaffAssignment1DivisionItem2(){
    if(staffAssignment1DivisionItem2==null){
      ...
      staffAssignment1DivisionItem2.setConstraints(VRLayout.FLOW);
  ...
  public ACRadioButtonItem getStaffAssignment1DivisionItem4(){
    if(staffAssignment1DivisionItem4==null){
      ...
      staffAssignment1DivisionItem4.setText("II 型");
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignment2Division(){
    if(staffAssignment2Division==null){
      ...
      staffAssignment2Division.setBindPath("1230223");
  ...
  public ACRadioButtonItem getStaffAssignment2DivisionItem1(){
    if(staffAssignment2DivisionItem1==null){
      ...
      staffAssignment2DivisionItem1.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACValueArrayRadioButtonGroup getUnitCareMaintenance(){
    if(unitCareMaintenance==null){
      ...
      unitCareMaintenance.setBindPath("1230216");
   ...
   * @return 食堂の有無
   */
  public ACValueArrayRadioButtonGroup getShokudoRadioGroup(){
    if(shokudoRadioGroup==null){

      shokudoRadioGroup = new ACValueArrayRadioButtonGroup();

      getShokudoRadioGroupContainer().setText("食堂の有無");

      shokudoRadioGroup.setBindPath("1230224");

      shokudoRadioGroup.setNoSelectIndex(0);

      shokudoRadioGroup.setUseClearButton(false);

      shokudoRadioGroup.setModel(getShokudoRadioGroupModel());

      shokudoRadioGroup.setValues(new int[]{1,2});

      addShokudoRadioGroup();
    }
    return shokudoRadioGroup;
   ...
   * @return 食堂の有無コンテナ
   */
  protected ACLabelContainer getShokudoRadioGroupContainer(){
    if(shokudoRadioGroupContainer==null){
      shokudoRadioGroupContainer = new ACLabelContainer();
      shokudoRadioGroupContainer.setFollowChildEnabled(true);
      shokudoRadioGroupContainer.setVAlignment(VRLayout.CENTER);
      shokudoRadioGroupContainer.add(getShokudoRadioGroup(), null);
    }
    return shokudoRadioGroupContainer;
  }
   ...
   * @return 食堂の有無モデル
   */
  protected ACListModelAdapter getShokudoRadioGroupModel(){
    if(shokudoRadioGroupModel==null){
      shokudoRadioGroupModel = new ACListModelAdapter();
      addShokudoRadioGroupModel();
    }
    return shokudoRadioGroupModel;
  }
   ...
   * @return 基準型
   */
  public ACRadioButtonItem getShokudoRadioItem1(){
    if(shokudoRadioItem1==null){

      shokudoRadioItem1 = new ACRadioButtonItem();

      shokudoRadioItem1.setText("基準型");

      shokudoRadioItem1.setGroup(getShokudoRadioGroup());

      shokudoRadioItem1.setConstraints(VRLayout.FLOW);

      addShokudoRadioItem1();
    }
    return shokudoRadioItem1;
   ...
   * @return 減算型
   */
  public ACRadioButtonItem getShokudoRadioItem2(){
    if(shokudoRadioItem2==null){

      shokudoRadioItem2 = new ACRadioButtonItem();

      shokudoRadioItem2.setText("減算型");

      shokudoRadioItem2.setGroup(getShokudoRadioGroup());

      shokudoRadioItem2.setConstraints(VRLayout.FLOW);

      addShokudoRadioItem2();
    }
    return shokudoRadioItem2;
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1230219");
  ...
  public ACValueArrayRadioButtonGroup getMeetingAndSendingOffSystem(){
    if(meetingAndSendingOffSystem==null){
      ...
      meetingAndSendingOffSystem.setBindPath("1230204");
  ...
  public ACValueArrayRadioButtonGroup getMedicalFoodAddRadioGroup(){
    if(medicalFoodAddRadioGroup==null){
      ...
      medicalFoodAddRadioGroup.setBindPath("1230220");
  ...
  public ACValueArrayRadioButtonGroup getDementiaCareRadioGroup(){
    if(dementiaCareRadioGroup==null){
      ...
      dementiaCareRadioGroup.setBindPath("1230225");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("1230221");
  ...
  public ACTextField getDinnerTotal(){
    if(dinnerTotal==null){
      ...
      dinnerTotal.setBindPath("1230208");
  ...
  public ACTextField getDinnerMorning(){
    if(dinnerMorning==null){
      ...
      dinnerMorning.setBindPath("1230209");
  ...
  public ACTextField getDinnerNoon(){
    if(dinnerNoon==null){
      ...
      dinnerNoon.setBindPath("1230210");
  ...
  public ACTextField getDinnerNight(){
    if(dinnerNight==null){
      ...
      dinnerNight.setBindPath("1230211");
  ...
  public ACTextField getUnitSemiRoom(){
    if(unitSemiRoom==null){
      ...
      unitSemiRoom.setBindPath("1230213");
  ...
  public ACTextField getNormalRoom(){
    if(normalRoom==null){
      ...
      normalRoom.setBindPath("1230214");
  ...
  public ACTextField getTasyouRoom(){
    if(tasyouRoom==null){
      ...
      tasyouRoom.setBindPath("1230215");
   ...
   * コンストラクタです。
   */
  public QO004_12312_201804Design() {
  ...
  protected void addCalculationDetails(){
    ...
    calculationDetails.add(getShokudoRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
    ...
    calculationDetails.add(getDementiaCareRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   * 食堂の有無に内部項目を追加します。
   */
  protected void addShokudoRadioGroup(){
   ...
   * 食堂の有無モデルに内部項目を追加します。
   */
  protected void addShokudoRadioGroupModel(){

    getShokudoRadioItem1().setButtonIndex(1);

    getShokudoRadioGroupModel().add(getShokudoRadioItem1());

    getShokudoRadioItem2().setButtonIndex(2);

    getShokudoRadioGroupModel().add(getShokudoRadioItem2());
   ...
   * 基準型に内部項目を追加します。
   */
  protected void addShokudoRadioItem1(){
   ...
   * 減算型に内部項目を追加します。
   */
  protected void addShokudoRadioItem2(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12312_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12312_201804Design getThis() {
    return this;
  }
}
