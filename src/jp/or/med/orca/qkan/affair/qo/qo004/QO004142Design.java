...
/**
 * 介護予防短期入所療養介護(基準適合診療所型)画面項目デザイン(QO004142) 
 */
public class QO004142Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防短期入所療養介護（基準適合診療所型）");
  ...
  public ACClearableRadioButtonGroup getMeetingAndSendingOffSystem(){
    if(meetingAndSendingOffSystem==null){
      ...
      meetingAndSendingOffSystem.setBindPath("1260401");
  ...
  public ACClearableRadioButtonGroup getNourishmentControlAdd(){
    if(nourishmentControlAdd==null){
      ...
      nourishmentControlAdd.setBindPath("1260402");
  ...
  public ACTextField getDinnerTotal(){
    if(dinnerTotal==null){
      ...
      dinnerTotal.setBindPath("1260403");
  ...
  public ACTextField getDinnerMorning(){
    if(dinnerMorning==null){
      ...
      dinnerMorning.setBindPath("1260404");
  ...
  public ACTextField getDinnerNoon(){
    if(dinnerNoon==null){
      ...
      dinnerNoon.setBindPath("1260405");
  ...
  public ACTextField getDinnerNight(){
    if(dinnerNight==null){
      ...
      dinnerNight.setBindPath("1260406");
  ...
  public ACTextField getUnitSemiRoom(){
    if(unitSemiRoom==null){
      ...
      unitSemiRoom.setBindPath("1260408");
  ...
  public ACTextField getNormalRoom(){
    if(normalRoom==null){
      ...
      normalRoom.setBindPath("1260409");
  ...
  public ACTextField getTasyouRoom(){
    if(tasyouRoom==null){
      ...
      tasyouRoom.setBindPath("1260410");
  ...
  protected void addCalculationDetails2(){
    ...
    calculationDetails2.add(getOldLowElementArea(), VRLayout.FLOW_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004142Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004142Design getThis() {
    return this;
  }
}
