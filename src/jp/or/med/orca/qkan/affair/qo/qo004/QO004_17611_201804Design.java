 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2018/01/30  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防訪問介護 (QO004_17611_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護予防訪問介護画面項目デザイン(QO004_17611_201804) 
 */
public class QO004_17611_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getSpecialRadioItem1(){
    if(specialRadioItem1==null){
      ...
      specialRadioItem1.setText("対応不可");
  ...
  public ACValueArrayRadioButtonGroup getComprehensiveManagementSystemRadioGroup(){
    if(comprehensiveManagementSystemRadioGroup==null){
      ...
      comprehensiveManagementSystemRadioGroup.setBindPath("1760106");
   ...
   * コンストラクタです。
   */
  public QO004_17611_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_17611_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_17611_201804Design getThis() {
    return this;
  }
}
