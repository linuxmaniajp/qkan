 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 特定施設入居者生活介護 (QO004_13311_201804)
 *
 *****************************************************************
 */
...
/**
 * 特定施設入居者生活介護画面項目デザイン(QO004_13311_201804) 
 */
public class QO004_13311_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getBodyRestraintAbolished(){
    if(bodyRestraintAbolished==null){
      ...
      bodyRestraintAbolished.setBindPath("1330112");
  ...
  public ACValueArrayRadioButtonGroup getMedicalCareProvision(){
    if(medicalCareProvision==null){
      ...
      medicalCareProvision.setBindPath("1330113");
  ...
  public ACValueArrayRadioButtonGroup getSeikatsuKinouGroup(){
    if(seikatsuKinouGroup==null){
      ...
      seikatsuKinouGroup.setBindPath("1330114");
  ...
  public ACValueArrayRadioButtonGroup getAcceptanceOfJuvenileDementia(){
    if(acceptanceOfJuvenileDementia==null){
      ...
      acceptanceOfJuvenileDementia.setBindPath("1330115");
   ...
   * コンストラクタです。
   */
  public QO004_13311_201804Design() {
  ...
  protected void addCalculationDetails(){
    ...
    calculationDetails.add(getBodyRestraintAbolishedContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    calculationDetails.add(getMedicalCareProvisionContainer(), VRLayout.FLOW_INSETLINE_RETURN);
    ...
    calculationDetails.add(getAcceptanceOfJuvenileDementiaContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_13311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_13311_201804Design getThis() {
    return this;
  }
}
