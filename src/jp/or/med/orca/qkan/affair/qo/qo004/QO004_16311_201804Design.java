 ...
 * アプリ: QKANCHO
 * 開発者: 上司　和善
 * 作成日: 2018/01/31  日本コンピューター株式会社 上司　和善 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防訪問看護 (QO004_16311_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護予防訪問看護画面項目デザイン(QO004_16311_201804) 
 */
public class QO004_16311_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getCareSupportSystem(){
    if(careSupportSystem==null){
      ...
      careSupportSystem.setBindPath("1630107");
   ...
   * コンストラクタです。
   */
  public QO004_16311_201804Design() {
  ...
  protected void addMainGroup(){
    ...
    mainGroup.add(getCareSupportSystemContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_16311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_16311_201804Design getThis() {
    return this;
  }
}
