 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 事業者登録(短期入所生活介護) (QO004_12111_201204)
 *
 *****************************************************************
 */
...
/**
 * 事業者登録(短期入所生活介護)画面項目デザイン(QO004_12111_201204) 
 */
public class QO004_12111_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup emergencyShortStaySystemAdd;

  private ACLabelContainer emergencyShortStaySystemAddContainer;

  private ACListModelAdapter emergencyShortStaySystemAddModel;

  private ACRadioButtonItem emergencyShortStaySystemAddRadioItem1;

  private ACRadioButtonItem emergencyShortStaySystemAddRadioItem2;
  ...
  /**
   * 看護体制加算ラジオグループコンテナを取得します。
   * @return 看護体制加算ラジオグループコンテナ
   */
  ...
  /**
   * 看護体制加算ラジオグループモデルを取得します。
   * @return 看護体制加算ラジオグループモデル
   */
   ...
   * @return 緊急短期入所体制確保加算
   */
  public ACValueArrayRadioButtonGroup getEmergencyShortStaySystemAdd(){
    if(emergencyShortStaySystemAdd==null){

      emergencyShortStaySystemAdd = new ACValueArrayRadioButtonGroup();

      getEmergencyShortStaySystemAddContainer().setText("緊急短期入所体制確保加算");

      emergencyShortStaySystemAdd.setBindPath("1210126");

      emergencyShortStaySystemAdd.setUseClearButton(false);

      emergencyShortStaySystemAdd.setModel(getEmergencyShortStaySystemAddModel());

      emergencyShortStaySystemAdd.setValues(new int[]{1,2});

      addEmergencyShortStaySystemAdd();
    }
    return emergencyShortStaySystemAdd;
   ...
   */
  protected ACLabelContainer getEmergencyShortStaySystemAddContainer(){
    if(emergencyShortStaySystemAddContainer==null){
      emergencyShortStaySystemAddContainer = new ACLabelContainer();
      emergencyShortStaySystemAddContainer.setFollowChildEnabled(true);
      emergencyShortStaySystemAddContainer.setVAlignment(VRLayout.CENTER);
      emergencyShortStaySystemAddContainer.add(getEmergencyShortStaySystemAdd(), null);
    }
    return emergencyShortStaySystemAddContainer;
  }
   ...
   */
  protected ACListModelAdapter getEmergencyShortStaySystemAddModel(){
    if(emergencyShortStaySystemAddModel==null){
      emergencyShortStaySystemAddModel = new ACListModelAdapter();
      addEmergencyShortStaySystemAddModel();
    }
    return emergencyShortStaySystemAddModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getEmergencyShortStaySystemAddRadioItem1(){
    if(emergencyShortStaySystemAddRadioItem1==null){

      emergencyShortStaySystemAddRadioItem1 = new ACRadioButtonItem();

      emergencyShortStaySystemAddRadioItem1.setText("なし");

      emergencyShortStaySystemAddRadioItem1.setGroup(getEmergencyShortStaySystemAdd());

      emergencyShortStaySystemAddRadioItem1.setConstraints(VRLayout.FLOW);

      addEmergencyShortStaySystemAddRadioItem1();
    }
    return emergencyShortStaySystemAddRadioItem1;
   ...
   * @return あり
   */
  public ACRadioButtonItem getEmergencyShortStaySystemAddRadioItem2(){
    if(emergencyShortStaySystemAddRadioItem2==null){

      emergencyShortStaySystemAddRadioItem2 = new ACRadioButtonItem();

      emergencyShortStaySystemAddRadioItem2.setText("あり");

      emergencyShortStaySystemAddRadioItem2.setGroup(getEmergencyShortStaySystemAdd());

      emergencyShortStaySystemAddRadioItem2.setConstraints(VRLayout.FLOW);

      addEmergencyShortStaySystemAddRadioItem2();
    }
    return emergencyShortStaySystemAddRadioItem2;

  }

  /**
   * サービス提供強化加算（単独型・併設型）を取得します。
   * @return サービス提供強化加算（単独型・併設型）
   */
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      getServiceAddProvisionStructuralRadioGroupContainer().setText("サービス提供強化加算（単独型・併設型）");
  ...
  /**
   * サービス提供強化加算（単独型・併設型）コンテナを取得します。
   * @return サービス提供強化加算（単独型・併設型）コンテナ
   */
  ...
  /**
   * サービス提供強化加算（単独型・併設型）モデルを取得します。
   * @return サービス提供強化加算（単独型・併設型）モデル
   */
  ...
  /**
   * サービス提供強化加算（空床型）を取得します。
   * @return サービス提供強化加算（空床型）
   */
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralKusyoRadioGroup(){
    if(serviceAddProvisionStructuralKusyoRadioGroup==null){
      ...
      getServiceAddProvisionStructuralKusyoRadioGroupContainer().setText("サービス提供強化加算（空床型）");
  ...
  /**
   * サービス提供強化加算（空床型）コンテナを取得します。
   * @return サービス提供強化加算（空床型）コンテナ
   */
  ...
  /**
   * サービス提供強化加算（空床型）モデルを取得します。
   * @return サービス提供強化加算（空床型）モデル
   */
   ...
   * コンストラクタです。
   */
  public QO004_12111_201204Design() {
  ...
  protected void addPanel1(){
    ...
    panel1.add(getCalculationDetails2(), VRLayout.NORTH);
  ...
  protected void addCalculationDetails(){
    ...
    calculationDetails.add(getEmergencyShortStaySystemAddContainer(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   */
  protected void addEmergencyShortStaySystemAdd(){
   ...
   */
  protected void addEmergencyShortStaySystemAddModel(){

    getEmergencyShortStaySystemAddRadioItem1().setButtonIndex(1);

    getEmergencyShortStaySystemAddModel().add(getEmergencyShortStaySystemAddRadioItem1());

    getEmergencyShortStaySystemAddRadioItem2().setButtonIndex(2);

    getEmergencyShortStaySystemAddModel().add(getEmergencyShortStaySystemAddRadioItem2());
   ...
   * なしに内部項目を追加します。
   */
  protected void addEmergencyShortStaySystemAddRadioItem1(){
   ...
   * ありに内部項目を追加します。
   */
  protected void addEmergencyShortStaySystemAddRadioItem2(){

  }

  /**
   * サービス提供強化加算（単独型・併設型）に内部項目を追加します。
   */
  ...
  /**
   * サービス提供強化加算（単独型・併設型）モデルに内部項目を追加します。
   */
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12111_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12111_201204Design getThis() {
    return this;
  }
}
