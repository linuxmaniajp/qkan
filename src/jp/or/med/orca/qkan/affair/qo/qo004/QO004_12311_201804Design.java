 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 短期入所療養介護病院療養型 (QO004_12311_201804)
 *
 *****************************************************************
 */
...
/**
 * 短期入所療養介護病院療養型画面項目デザイン(QO004_12311_201804) 
 */
public class QO004_12311_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getStaffAssignmentDivisionItem4(){
    if(staffAssignmentDivisionItem4==null){
      ...
      staffAssignmentDivisionItem4.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACValueArrayRadioButtonGroup getDementiaCareRadioGroup(){
    if(dementiaCareRadioGroup==null){
      ...
      dementiaCareRadioGroup.setBindPath("1230131");
   ...
   * コンストラクタです。
   */
  public QO004_12311_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12311_201804Design getThis() {
    return this;
  }
}
