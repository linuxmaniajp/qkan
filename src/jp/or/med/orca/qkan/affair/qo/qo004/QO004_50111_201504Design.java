 ...
 * アプリ: QKANCHO
 * 開発者: 日高　しのぶ
 * 作成日: 2016/07/07  日本コンピューター株式会社 日高　しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 訪問型サービス (QO004_50111_201504)
 *
 *****************************************************************
 */
...
/**
 * 訪問型サービス画面項目デザイン(QO004_50111_201504) 
 */
public class QO004_50111_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getSecondClassOfferRadioGroup(){
    if(secondClassOfferRadioGroup==null){
      ...
      secondClassOfferRadioGroup.setBindPath("5010101");
   ...
   * コンストラクタです。
   */
  public QO004_50111_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_50111_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_50111_201504Design getThis() {
    return this;
  }
}
