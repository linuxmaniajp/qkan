 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 夜間対応型訪問看護 (QO004_17111_201204)
 *
 *****************************************************************
 */
...
/**
 * 夜間対応型訪問看護画面項目デザイン(QO004_17111_201204) 
 */
public class QO004_17111_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_17111_201204Design() {
  ...
  protected void addProviderMainPanel(){
    ...
    providerMainPanel.add(getSameBuildingRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_17111_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_17111_201204Design getThis() {
    return this;
  }
}
