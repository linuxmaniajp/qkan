...
/**
 * 介護予防短期入所療養介護（認知症疾患型）イベント定義(QO004141) 
 */
@SuppressWarnings("serial")
public abstract class QO004_12613_201804Event extends QO004_12613_201804SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_12613_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
