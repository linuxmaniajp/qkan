...
/**
 * 認知症対応型共同生活介護（短期利用）イベント定義(QO004127) 
 */
@SuppressWarnings("serial")
public abstract class QO004_13811_201204Event extends QO004_13811_201204State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_13811_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
