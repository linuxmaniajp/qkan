 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 地域密着型介護老人福祉施設入所者生活介護 (QO004_15411_201504)
 *
 *****************************************************************
 */
...
/**
 * 地域密着型介護老人福祉施設入所者生活介護画面項目デザイン(QO004_15411_201504) 
 */
public class QO004_15411_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getNurseStructuralAddRadioItem3(){
    if(nurseStructuralAddRadioItem3==null){
      ...
      nurseStructuralAddRadioItem3.setText("加算II");
  ...
  public ACValueArrayRadioButtonGroup getHandicappedPersonSupport(){
    if(handicappedPersonSupport==null){
      ...
      handicappedPersonSupport.setValues(new int[]{1,2});
   ...
   * コンストラクタです。
   */
  public QO004_15411_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_15411_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_15411_201504Design getThis() {
    return this;
  }
}
