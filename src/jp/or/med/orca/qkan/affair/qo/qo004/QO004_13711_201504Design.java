 ...
 * アプリ: QKANCHO
 * 開発者: 廣瀬 一海
 * 作成日: 2015/02/18  日本コンピューター株式会社 廣瀬 一海 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防認知症対応型共同生活介護（短期利用以外） (QO004_13711_201504)
 *
 *****************************************************************
 */
...
/**
 * 介護予防認知症対応型共同生活介護（短期利用以外）画面項目デザイン(QO004_13711_201504) 
 */
public class QO004_13711_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_13711_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_13711_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_13711_201504Design getThis() {
    return this;
  }
}
