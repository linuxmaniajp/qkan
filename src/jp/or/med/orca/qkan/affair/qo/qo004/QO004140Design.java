 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防短期入所療養介護(診療所療養型) (QO004140)
 *
 *****************************************************************
 */
 ...
 */
public class QO004140Design extends QS001ServicePanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防短期入所療養介護（診療所療養型）");
  ...
  public ACClearableRadioButtonGroup getRecuperationEnvironmental(){
    if(recuperationEnvironmental==null){
      ...
      recuperationEnvironmental.setBindPath("1260204");
  ...
  public ACClearableRadioButtonGroup getNourishmentControlAdd(){
    if(nourishmentControlAdd==null){
      ...
      nourishmentControlAdd.setBindPath("1260206");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004140Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004140Design getThis() {
    return this;
  }
}
