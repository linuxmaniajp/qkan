...
/**
 * 介護保健施設サービス画面項目デザイン(QO004_15211_201804) 
 */
public class QO004_15211_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getFacilitiesDivisionItem7(){
    if(facilitiesDivisionItem7==null){
      ...
      facilitiesDivisionItem7.setText("介護保健施設（IV）");
  ...
  /**
   * ユニット型介護保健施設（IV）を取得します。
   * @return ユニット型介護保健施設（IV）
   */
  public ACRadioButtonItem getFacilitiesDivisionItem8(){
    if(facilitiesDivisionItem8==null){
      ...
      facilitiesDivisionItem8.setText("ユニット型介護保健施設（IV）");
  ...
  public ACRadioButtonItem getStaffLackItem6(){
    if(staffLackItem6==null){
      ...
      staffLackItem6.setConstraints(VRLayout.FLOW_RETURN);
  ...
  public ACValueArrayRadioButtonGroup getMedicalSystemUpkeep2(){
    if(MedicalSystemUpkeep2==null){
      ...
      MedicalSystemUpkeep2.setBindPath("1520136");
  ...
  public ACValueArrayRadioButtonGroup getPressureUlcerManagement(){
    if(pressureUlcerManagement==null){
      ...
      pressureUlcerManagement.setBindPath("1520135");
   ...
   * コンストラクタです。
   */
  public QO004_15211_201804Design() {
  ...
  protected void addCalculationDetails2(){
    ...
    calculationDetails2.add(getAggressiveSupportRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_15211_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_15211_201804Design getThis() {
    return this;
  }
}
