 ...
 * アプリ: QKANCHO
 * 開発者: 日高　しのぶ
 * 作成日: 2018/02/04  日本コンピューター株式会社 日高　しのぶ 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 介護予防短期入所療養介護（介護医療院） (QO004_204311_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護予防短期入所療養介護（介護医療院）(QO004_204311_201804)
 */
@SuppressWarnings("serial")
public class QO004_204311_201804 extends QO004_204311_201804Event {
	/**
	 * コンストラクタです。
	 */
	public QO004_204311_201804() {
	}
	...
	public static void main(String[] args) {
		...
		ACFrame.debugStart(new ACAffairInfo(
				QO004_204311_201804.class.getName(), param));
	}
	...
	public void setStateByFacilitiesDivision() throws Exception {
		...
		if (facilityType == FACILITY_TYPE_1) {
			// 「I型介護医療院」が選択された場合
			setState_FACILITY_TYPE_1();
		} else if (facilityType == FACILITY_TYPE_2) {
			// 「II型介護医療院」が選択された場合
			setState_FACILITY_TYPE_2();
		} else if (facilityType == FACILITY_TYPE_3) {
			// 「特別介護医療院」が選択された場合
			setState_FACILITY_TYPE_3();
		} else if (facilityType == FACILITY_TYPE_4) {
			// 「ユニット型I型介護医療院」が選択された場合
			setState_FACILITY_TYPE_4();
		} else if (facilityType == FACILITY_TYPE_5) {
			// 「ユニット型II型介護医療院」が選択された場合
			setState_FACILITY_TYPE_5();
		} else {
			// 「ユニット型特別介護医療院」が選択された場合
