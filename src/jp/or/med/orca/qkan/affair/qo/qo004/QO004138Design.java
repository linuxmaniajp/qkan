 ...
 * サブシステム その他機能 (O)
 * プロセス 事業所情報登録 (004)
 * プログラム 介護予防短期入所療養介護（介護老人保健施設） (QO004138)
 *
 *****************************************************************
 */
...
/**
 * 介護予防短期入所療養介護（介護老人保健施設）画面項目デザイン(QO004138) 
 */
public class QO004138Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACClearableRadioButtonGroup getStaffAssignmentDivision(){
    if(staffAssignmentDivision==null){
      ...
      staffAssignmentDivision.setBindPath("1250116");
  ...
  public ACClearableRadioButtonGroup getStaffLack_H2103(){
    if(staffLack_H2103==null){
      ...
      staffLack_H2103.setBindPath("1250103");
