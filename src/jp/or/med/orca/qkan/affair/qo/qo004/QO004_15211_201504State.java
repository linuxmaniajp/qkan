 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2015/02/11  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
...
/**
 * 介護保健施設サービス状態定義(QO004_15211_201504) 
 */
public class QO004_15211_201504State extends QO004_15211_201504Design {
  /**
   * コンストラクタです。
   */
  public QO004_15211_201504State(){
  }
