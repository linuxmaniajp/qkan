...
/**
 * 地域密着型介護老人福祉施設イベント定義(QO004129) 
 */
public abstract class QO004129Event extends QO004129SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004129Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int FACILITY_TYPE_FUKUSHI = 1;
  public static final int FACILITY_TYPE_FUKUSHI_ST = 2;
  //getter/setter
