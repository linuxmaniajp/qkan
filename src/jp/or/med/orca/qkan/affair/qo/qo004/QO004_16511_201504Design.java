 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防通所介護 (QO004_16511_201504)
 *
 *****************************************************************
 */
...
/**
 * 介護予防通所介護画面項目デザイン(QO004_16511_201504) 
 */
public class QO004_16511_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1650106");
  ...
  public ACValueArrayRadioButtonGroup getSmallGroupsLifeRadioGroup(){
    if(smallGroupsLifeRadioGroup==null){
      ...
      smallGroupsLifeRadioGroup.setBindPath("1650108");
  ...
  public ACValueArrayRadioButtonGroup getSelectiveServiceRadioGroup(){
    if(selectiveServiceRadioGroup==null){
      ...
      selectiveServiceRadioGroup.setBindPath("1650109");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("1650107");
   ...
   * コンストラクタです。
   */
  public QO004_16511_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_16511_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_16511_201504Design getThis() {
    return this;
  }
}
