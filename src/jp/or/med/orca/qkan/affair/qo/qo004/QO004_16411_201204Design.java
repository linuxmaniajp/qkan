 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防訪問リハ (QO004_16411_201204)
 *
 *****************************************************************
 */
...
/**
 * 介護予防訪問リハ画面項目デザイン(QO004_16411_201204) 
 */
public class QO004_16411_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_16411_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_16411_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_16411_201204Design getThis() {
    return this;
  }
}
