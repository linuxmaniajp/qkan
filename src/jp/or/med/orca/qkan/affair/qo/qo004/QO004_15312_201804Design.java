 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護療養施設サービス（診療所型） (QO004_15312_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護療養施設サービス（診療所型）画面項目デザイン(QO004_15312_201804) 
 */
public class QO004_15312_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護療養施設サービス（診療所型）");
  ...
  public ACValueArrayRadioButtonGroup getStaffAssignment2Division(){
    if(staffAssignment2Division==null){
      ...
      staffAssignment2Division.setBindPath("1530226");
  ...
  public ACValueArrayRadioButtonGroup getHospitalizedPatientRadioGroup(){
    if(hospitalizedPatientRadioGroup==null){
      ...
      hospitalizedPatientRadioGroup.setBindPath("1530227");
   ...
   * コンストラクタです。
   */
  public QO004_15312_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_15312_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_15312_201804Design getThis() {
    return this;
  }
}
