...
/**
 * 介護療養型医療施設（認知症疾患型）イベント定義(QO004122) 
 */
public abstract class QO004122Event extends QO004122SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004122Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int CODE_STAFF_REDUCE = 188;
  ...
  public static final String PATH_STAFF_REDUCE = "1530307";
  //getter/setter
