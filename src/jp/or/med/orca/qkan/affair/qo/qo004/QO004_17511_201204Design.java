 ...
 * アプリ: QKANCHO
 * 開発者: 廣瀬 一海
 * 作成日: 2012/02/03  日本コンピューター株式会社 廣瀬 一海 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防小規模多機能型居宅介護 (QO004_17511_201204)
 *
 *****************************************************************
 */
...
/**
 * 介護予防小規模多機能型居宅介護画面項目デザイン(QO004_17511_201204) 
 */
public class QO004_17511_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防小規模多機能型居宅介護");
   ...
   * コンストラクタです。
   */
  public QO004_17511_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_17511_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_17511_201204Design getThis() {
    return this;
  }
}
