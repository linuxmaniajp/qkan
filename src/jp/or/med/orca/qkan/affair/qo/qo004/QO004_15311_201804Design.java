 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護療養施設サービス（病院療養型） (QO004_15311_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護療養施設サービス（病院療養型）画面項目デザイン(QO004_15311_201804) 
 */
public class QO004_15311_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup hospitalizedPatientRadioGroup;

  private ACLabelContainer hospitalizedPatientRadioGroupContainer;

  private ACListModelAdapter hospitalizedPatientRadioGroupModel;

  private ACRadioButtonItem hospitalizedPatientItem1;

  private ACRadioButtonItem hospitalizedPatientItem2;
   ...
   * @return 入院患者に関する基準
   */
  public ACValueArrayRadioButtonGroup getHospitalizedPatientRadioGroup(){
    if(hospitalizedPatientRadioGroup==null){

      hospitalizedPatientRadioGroup = new ACValueArrayRadioButtonGroup();

      getHospitalizedPatientRadioGroupContainer().setText("入院患者に関する基準");

      hospitalizedPatientRadioGroup.setBindPath("1530134");

      hospitalizedPatientRadioGroup.setNoSelectIndex(0);

      hospitalizedPatientRadioGroup.setUseClearButton(false);

      hospitalizedPatientRadioGroup.setModel(getHospitalizedPatientRadioGroupModel());

      hospitalizedPatientRadioGroup.setValues(new int[]{1,2});

      addHospitalizedPatientRadioGroup();
    }
    return hospitalizedPatientRadioGroup;
   ...
   */
  protected ACLabelContainer getHospitalizedPatientRadioGroupContainer(){
    if(hospitalizedPatientRadioGroupContainer==null){
      hospitalizedPatientRadioGroupContainer = new ACLabelContainer();
      hospitalizedPatientRadioGroupContainer.setFollowChildEnabled(true);
      hospitalizedPatientRadioGroupContainer.setVAlignment(VRLayout.CENTER);
      hospitalizedPatientRadioGroupContainer.add(getHospitalizedPatientRadioGroup(), null);
    }
    return hospitalizedPatientRadioGroupContainer;
  }
   ...
   */
  protected ACListModelAdapter getHospitalizedPatientRadioGroupModel(){
    if(hospitalizedPatientRadioGroupModel==null){
      hospitalizedPatientRadioGroupModel = new ACListModelAdapter();
      addHospitalizedPatientRadioGroupModel();
    }
    return hospitalizedPatientRadioGroupModel;
  }
   ...
   * @return 基準型
   */
  public ACRadioButtonItem getHospitalizedPatientItem1(){
    if(hospitalizedPatientItem1==null){

      hospitalizedPatientItem1 = new ACRadioButtonItem();

      hospitalizedPatientItem1.setText("基準型");

      hospitalizedPatientItem1.setGroup(getHospitalizedPatientRadioGroup());

      hospitalizedPatientItem1.setConstraints(VRLayout.FLOW);

      addHospitalizedPatientItem1();
    }
    return hospitalizedPatientItem1;
   ...
   * @return 減算型
   */
  public ACRadioButtonItem getHospitalizedPatientItem2(){
    if(hospitalizedPatientItem2==null){

      hospitalizedPatientItem2 = new ACRadioButtonItem();

      hospitalizedPatientItem2.setText("減算型");

      hospitalizedPatientItem2.setGroup(getHospitalizedPatientRadioGroup());

      hospitalizedPatientItem2.setConstraints(VRLayout.FLOW);

      addHospitalizedPatientItem2();
    }
    return hospitalizedPatientItem2;
   ...
   * コンストラクタです。
   */
  public QO004_15311_201804Design() {
  ...
  protected void addCalculationDetails(){
    ...
    calculationDetails.add(getHospitalizedPatientRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   */
  protected void addHospitalizedPatientRadioGroup(){
   ...
   */
  protected void addHospitalizedPatientRadioGroupModel(){

    getHospitalizedPatientItem1().setButtonIndex(1);

    getHospitalizedPatientRadioGroupModel().add(getHospitalizedPatientItem1());

    getHospitalizedPatientItem2().setButtonIndex(2);

    getHospitalizedPatientRadioGroupModel().add(getHospitalizedPatientItem2());
   ...
   * 基準型に内部項目を追加します。
   */
  protected void addHospitalizedPatientItem1(){
   ...
   * 減算型に内部項目を追加します。
   */
  protected void addHospitalizedPatientItem2(){
  ...
  protected void addCalculationDetails2(){
    ...
    calculationDetails2.add(getRecuperationEnvironmentalH2104Container(), VRLayout.FLOW_INSETLINE_RETURN);

    calculationDetails2.add(getDoctorsAssignmentContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_15311_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_15311_201804Design getThis() {
    return this;
  }
}
