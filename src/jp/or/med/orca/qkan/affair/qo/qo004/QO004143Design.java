 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防特定施設入居者生活介護 (QO004143)
 *
 *****************************************************************
 */
...
/**
 * 介護予防特定施設入居者生活介護画面項目デザイン(QO004143) 
 */
public class QO004143Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004143Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004143Design getThis() {
    return this;
  }
}
