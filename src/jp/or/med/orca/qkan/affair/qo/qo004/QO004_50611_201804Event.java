...
/**
 * 通所型サービス（独自）イベント定義(QO004_50611_201804) 
 */
public abstract class QO004_50611_201804Event extends QO004_50611_201804State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_50611_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
