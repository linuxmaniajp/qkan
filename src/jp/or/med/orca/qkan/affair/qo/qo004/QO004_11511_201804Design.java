 ...
 * アプリ: QKANCHO
 * 開発者: 樋口　雅彦
 * 作成日: 2018/01/27  日本コンピューター株式会社 樋口　雅彦 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 通所介護 (QO004_11511_201804)
 *
 *****************************************************************
 */
...
/**
 * 通所介護画面項目デザイン(QO004_11511_201804) 
 */
public class QO004_11511_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getFacilitiesDivision(){
    if(facilitiesDivision==null){
      ...
      facilitiesDivision.setValues(new int[]{2,4,5});
  ...
  public ACRadioButtonItem getFacilitiesDivisionItem4(){
    if(facilitiesDivisionItem4==null){
      ...
      facilitiesDivisionItem4.setText("大規模型(I)");
  ...
  public ACRadioButtonItem getFacilitiesDivisionItem5(){
    if(facilitiesDivisionItem5==null){
      ...
      facilitiesDivisionItem5.setText("大規模型(II)");

      facilitiesDivisionItem5.setGroup(getFacilitiesDivision());

      facilitiesDivisionItem5.setConstraints(VRLayout.FLOW);
  ...
  public ACValueArrayRadioButtonGroup getKyoseiServiceSeikatsuRadioGroup(){
    if(kyoseiServiceSeikatsuRadioGroup==null){
      ...
      kyoseiServiceSeikatsuRadioGroup.setBindPath("1150121");
  ...
  public ACValueArrayRadioButtonGroup getKyoseiServiceJiritsuRadioGroup(){
    if(kyoseiServiceJiritsuRadioGroup==null){
      ...
      kyoseiServiceJiritsuRadioGroup.setBindPath("1150122");
  ...
  public ACValueArrayRadioButtonGroup getKyoseiServiceJidoRadioGroup(){
    if(kyoseiServiceJidoRadioGroup==null){
      ...
      kyoseiServiceJidoRadioGroup.setBindPath("1150123");
  ...
  public ACValueArrayRadioButtonGroup getKyoseiServiceDayRadioGroup(){
    if(kyoseiServiceDayRadioGroup==null){
      ...
      kyoseiServiceDayRadioGroup.setBindPath("1150124");
  ...
  public ACValueArrayRadioButtonGroup getSeikatsuSoudanGroup(){
    if(seikatsuSoudanGroup==null){
      ...
      seikatsuSoudanGroup.setBindPath("1150125");
  ...
  public ACValueArrayRadioButtonGroup getSeikatsuKinouGroup(){
    if(seikatsuKinouGroup==null){
      ...
      seikatsuKinouGroup.setBindPath("1150126");
  ...
  public ACValueArrayRadioButtonGroup getIndividualfunctionTrainingSystem(){
    if(individualfunctionTrainingSystem==null){
      ...
      individualfunctionTrainingSystem.setBindPath("1150116");
  ...
  public ACValueArrayRadioButtonGroup getIndividualfunctionTrainingSystem2(){
    if(individualfunctionTrainingSystem2==null){
      ...
      individualfunctionTrainingSystem2.setBindPath("1150127");
  ...
  public ACValueArrayRadioButtonGroup getAdlIjiGroup(){
    if(adlIjiGroup==null){
      ...
      adlIjiGroup.setBindPath("1150128");
  ...
  public ACValueArrayRadioButtonGroup getAdlIjiGroup2(){
    if(adlIjiGroup2==null){
      ...
      adlIjiGroup2.setBindPath("1150129");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setValues(new int[]{1,5,2,3});
   ...
   * コンストラクタです。
   */
  public QO004_11511_201804Design() {
  ...
  protected void addCalculationDetails2(){
    ...
    calculationDetails2.add(getProviderSubPanel(), VRLayout.NORTH);
  ...
  protected void addProviderSubPanel(){
    ...
    providerSubPanel.add(getDementiaAddContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    providerSubPanel.add(getYoungDementiaPatinetAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    providerSubPanel.add(getNourishmentImprovementContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    providerSubPanel.add(getMouthImprovementAddContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    providerSubPanel.add(getServiceAddProvisionStructuralRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    providerSubPanel.add(getStaffUpgradeRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_11511_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_11511_201804Design getThis() {
    return this;
  }
}
