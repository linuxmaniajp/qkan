 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防通所リハ (QO004_16611_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護予防通所リハ画面項目デザイン(QO004_16611_201804) 
 */
public class QO004_16611_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getRehabilitationManagementRadioGroup(){
    if(rehabilitationManagementRadioGroup==null){
      ...
      rehabilitationManagementRadioGroup.setBindPath("1660110");
  ...
  public ACValueArrayRadioButtonGroup getProviderEvaluationSystem(){
    if(providerEvaluationSystem==null){
      ...
      getProviderEvaluationSystemContainer().setText("生活行為向上リハビリテーション実施加算");

      providerEvaluationSystem.setBindPath("1660111");
   ...
   * コンストラクタです。
   */
  public QO004_16611_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_16611_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_16611_201804Design getThis() {
    return this;
  }
}
