 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 事業者登録(短期入所療養介護認知症疾患型) (QO004113)
 *
 *****************************************************************
 */
...
/**
 * 事業者登録(短期入所療養介護認知症疾患型)画面項目デザイン(QO004113) 
 */
public class QO004113Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * 自身を返します。
   */
  protected QO004113Design getThis() {
    return this;
  }
}
