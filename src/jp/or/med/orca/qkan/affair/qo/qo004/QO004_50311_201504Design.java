...
/**
 * 訪問型サービス（独自定率）画面項目デザイン(QO004_50311_201504) 
 */
public class QO004_50311_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_50311_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_50311_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_50311_201504Design getThis() {
    return this;
  }
}
