 ...
 * アプリ: QKANCHO
 * 開発者: 上司　和善
 * 作成日: 2011/12/07  日本コンピューター株式会社 上司　和善 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 特定施設入所者介護 (QO004_13311_201504)
 *
 *****************************************************************
 */
...
/**
 * 特定施設入所者介護状態定義(QO004_13311_201504) 
 */
public class QO004_13311_201504State extends QO004_13311_201504Design {
  /**
   * コンストラクタです。
   */
  public QO004_13311_201504State(){
  }
  ...
  public void setState_STAFF_ASSIGNMENT_TYPE_OUTSIDE_SERVICE() throws Exception {
        ...
        getNightNursingSystemAdd().setEnabled(false);
        getNightNursingSystemAdd().getParent().setEnabled(false);
        ...
        getTerminalCareSystem().setEnabled(false);
        getTerminalCareSystem().getParent().setEnabled(false);
  ...
  public void setState_STAFF_ASSIGNMENT_TYPE_NORMAL() throws Exception {
        ...
        getNightNursingSystemAdd().setEnabled(true);
        getNightNursingSystemAdd().getParent().setEnabled(true);
        ...
        getTerminalCareSystem().setEnabled(true);
        getTerminalCareSystem().getParent().setEnabled(true);
