 ...
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 介護療養施設サービス（療養型病院） (QO004_15311_201504)
 *
 *****************************************************************
 */
...
/**
 * 介護療養施設サービス（療養型病院）イベント定義(QO004_15311_201504) 
 */
public abstract class QO004_15311_201504Event extends QO004_15311_201504SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_15311_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
