 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 小規模多機能型居宅介護 (QO004_17311_201204)
 *
 *****************************************************************
 */
...
/**
 * 小規模多機能型居宅介護画面項目デザイン(QO004_17311_201204) 
 */
public class QO004_17311_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_17311_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_17311_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_17311_201204Design getThis() {
    return this;
  }
}
