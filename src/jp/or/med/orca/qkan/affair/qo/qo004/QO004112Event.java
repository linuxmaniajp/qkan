...
/**
 * 短期入所療養介護（診療所療養型）イベント定義(QO004112) 
 */
public abstract class QO004112Event extends QO004112SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004112Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int FACILITY_TYPE_SHINRYOJO = 1;
  //getter/setter
