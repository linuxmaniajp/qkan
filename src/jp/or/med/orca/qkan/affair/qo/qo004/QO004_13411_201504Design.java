 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防居宅療養管理指導 (QO004_13411_201504)
 *
 *****************************************************************
 */
...
/**
 * 介護予防居宅療養管理指導画面項目デザイン(QO004_13411_201504) 
 */
public class QO004_13411_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防居宅療養管理指導");
   ...
   * コンストラクタです。
   */
  public QO004_13411_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_13411_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_13411_201504Design getThis() {
    return this;
  }
}
