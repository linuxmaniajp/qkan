 ...
 * 訪問介護(QO004101) 
 */
public class QO004101 extends QO004101Event {
  /**
   * コンストラクタです。
   */
  public QO004101(){
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QO004101.class.getName(), param));
  }
  ...
  public boolean isValidInput() throws Exception{
    ...
    // ・specificProviderAdd（特定事業所体制ラジオグループ）※ errMsg = 特定事業所体制
