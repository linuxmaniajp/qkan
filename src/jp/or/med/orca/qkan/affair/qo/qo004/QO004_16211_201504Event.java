...
/**
 * 介護予防訪問入浴イベント定義(QO004131) 
 */
public abstract class QO004_16211_201504Event extends QO004_16211_201504State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_16211_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
