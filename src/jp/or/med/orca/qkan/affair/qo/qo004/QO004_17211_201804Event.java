...
/**
 * 認知症対応型通所介護イベント定義(QO004124) 
 */
public abstract class QO004_17211_201804Event extends QO004_17211_201804State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_17211_201804Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
