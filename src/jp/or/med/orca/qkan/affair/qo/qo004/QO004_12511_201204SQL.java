 ...
 * アプリ: QKANCHO
 * 開発者: 事業所登録
 * 作成日: 2008/04/16  日本コンピューター株式会社 事業所登録 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
...
/**
 * 介護予防短期入所療養介護(介護老人保健施設)SQL定義(QO004138) 
 */
public class QO004_12511_201204SQL extends QO004_12511_201204State {
  private ACSQLSafeDateFormat dateFormat = new ACSQLSafeDateFormat();
  /**
   * コンストラクタです。
   */
  public QO004_12511_201204SQL() {
  }
