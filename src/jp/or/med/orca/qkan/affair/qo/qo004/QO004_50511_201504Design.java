 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 通所型サービス（みなし） (QO004_50511_201504)
 *
 *****************************************************************
 */
...
/**
 * 通所型サービス（みなし）画面項目デザイン(QO004_50511_201504) 
 */
public class QO004_50511_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("5050106");
  ...
  public ACValueArrayRadioButtonGroup getSmallGroupsLifeRadioGroup(){
    if(smallGroupsLifeRadioGroup==null){
      ...
      smallGroupsLifeRadioGroup.setBindPath("5050108");
  ...
  public ACValueArrayRadioButtonGroup getFunctionImprovement(){
    if(functionImprovement==null){
      ...
      functionImprovement.setBindPath("5050102");
  ...
  public ACValueArrayRadioButtonGroup getNourishmentImprovement(){
    if(nourishmentImprovement==null){
      ...
      nourishmentImprovement.setBindPath("5050103");
  ...
  public ACValueArrayRadioButtonGroup getMouthImprovementAdd(){
    if(mouthImprovementAdd==null){
      ...
      mouthImprovementAdd.setBindPath("5050104");
  ...
  public ACValueArrayRadioButtonGroup getSelectiveServiceRadioGroup(){
    if(selectiveServiceRadioGroup==null){
      ...
      selectiveServiceRadioGroup.setBindPath("5050109");
  ...
  public ACValueArrayRadioButtonGroup getProviderEvaluation(){
    if(providerEvaluation==null){
      ...
      providerEvaluation.setBindPath("5050105");
  ...
  public ACValueArrayRadioButtonGroup getServiceAddProvisionStructuralRadioGroup(){
    if(serviceAddProvisionStructuralRadioGroup==null){
      ...
      serviceAddProvisionStructuralRadioGroup.setBindPath("5050107");
   ...
   * コンストラクタです。
   */
  public QO004_50511_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_50511_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_50511_201504Design getThis() {
    return this;
  }
}
