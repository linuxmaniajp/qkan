 ...
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 介護療養型医療施設（療養型病院） (QO004_15311_201204)
 *
 *****************************************************************
 */
...
/**
 * 介護療養型医療施設（療養型病院）イベント定義(QO004_15311_201204) 
 */
public abstract class QO004_15311_201204Event extends QO004_15311_201204SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_15311_201204Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
