 ...
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 特定施設入所者介護（短期利用） (QO004_12711_201504)
 *
 *****************************************************************
 */
...
/**
 * 特定施設入所者介護（短期利用）イベント定義(QO004_12711_201504) 
 */
public abstract class QO004_12711_201504Event extends QO004_12711_201504State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_12711_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
