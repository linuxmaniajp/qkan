...
/**
 * 介護予防通所介護イベント定義(QO004135) 
 */
public abstract class QO004_16511_201504Event extends QO004_16511_201504State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_16511_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
