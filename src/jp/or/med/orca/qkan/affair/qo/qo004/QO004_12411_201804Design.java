 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 事業者登録(介護予防短期入所生活介護) (QO004_12411_201804)
 *
 *****************************************************************
 */
...
/**
 * 事業者登録(介護予防短期入所生活介護)画面項目デザイン(QO004_12411_201804) 
 */
public class QO004_12411_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getKyoseiServiceTankiRadioGroup(){
    if(kyoseiServiceTankiRadioGroup==null){
      ...
      kyoseiServiceTankiRadioGroup.setBindPath("1240121");
  ...
  public ACValueArrayRadioButtonGroup getSeikatsuSoudanGroup(){
    if(seikatsuSoudanGroup==null){
      ...
      seikatsuSoudanGroup.setBindPath("1240122");
  ...
  public ACValueArrayRadioButtonGroup getSeikatsuKinouGroup(){
    if(seikatsuKinouGroup==null){
      ...
      seikatsuKinouGroup.setBindPath("1240123");
  ...
  public ACValueArrayRadioButtonGroup getIndividualfunctionTrainingSystem(){
    if(individualfunctionTrainingSystem==null){
      ...
      individualfunctionTrainingSystem.setBindPath("1240120");
  ...
  public ACValueArrayRadioButtonGroup getDementiaCareRadioGroup(){
    if(dementiaCareRadioGroup==null){
      ...
      dementiaCareRadioGroup.setBindPath("1240124");
   ...
   * コンストラクタです。
   */
  public QO004_12411_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12411_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12411_201804Design getThis() {
    return this;
  }
}
