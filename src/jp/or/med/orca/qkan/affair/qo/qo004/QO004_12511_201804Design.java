...
/**
 * 介護予防短期入所療養介護（介護老人保健施設）画面項目デザイン(QO004_12511_201804) 
 */
public class QO004_12511_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防短期入所療養介護（介護老人保健施設）");
  ...
  public ACRadioButtonItem getStaffAssignment1DivisionItem1(){
    if(staffAssignment1DivisionItem1==null){
      ...
      staffAssignment1DivisionItem1.setText("基本型");
  ...
  public ACValueArrayRadioButtonGroup getAggressiveSupportRadioGroup(){
    if(aggressiveSupportRadioGroup==null){
      ...
      aggressiveSupportRadioGroup.setBindPath("1250125");
  ...
  public ACLabelContainer getSpecialMedicalDetailsContaine(){
    if(specialMedicalDetailsContaine==null){
      ...
      specialMedicalDetailsContaine.setText("特別療養費加算項目");
  ...
  /**
   * 療養体制維持特別加算Iコンテナを取得します。
   * @return 療養体制維持特別加算Iコンテナ
   */
  ...
  /**
   * 療養体制維持特別加算Iモデルを取得します。
   * @return 療養体制維持特別加算Iモデル
   */
  ...
  public ACValueArrayRadioButtonGroup getMedicalSystemUpkeep2(){
    if(MedicalSystemUpkeep2==null){
      ...
      MedicalSystemUpkeep2.setBindPath("1250127");
  ...
  /**
   * 療養体制維持特別加算IIコンテナを取得します。
   * @return 療養体制維持特別加算IIコンテナ
   */
  ...
  /**
   * 療養体制維持特別加算IIモデルを取得します。
   * @return 療養体制維持特別加算IIモデル
   */
  ...
  public ACValueArrayRadioButtonGroup getDementiaCareRadioGroup(){
    if(dementiaCareRadioGroup==null){
      ...
      dementiaCareRadioGroup.setBindPath("1250126");
   ...
   * コンストラクタです。
   */
  public QO004_12511_201804Design() {
  ...
  protected void addCalculationDetails(){
    ...
    calculationDetails.add(getAggressiveSupportRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addCalculationDetails2(){
    ...
    calculationDetails2.add(getSpecialMedicalDetailsContaine(), VRLayout.FLOW_INSETLINE_RETURN);

    calculationDetails2.add(getMedicalSystemUpkeepContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    calculationDetails2.add(getMedicalSystemUpkeep2Container(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12511_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12511_201804Design getThis() {
    return this;
  }
}
