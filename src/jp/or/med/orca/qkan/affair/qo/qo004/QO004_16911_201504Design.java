 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防小規模多機能型居宅介護（短期利用以外） (QO004_16911_201504)
 *
 *****************************************************************
 */
...
/**
 * 介護予防小規模多機能型居宅介護（短期利用以外）画面項目デザイン(QO004_16911_201504) 
 */
public class QO004_16911_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防小規模多機能型居宅介護（短期利用）");
  ...
  public ACValueArrayRadioButtonGroup getFacilityDivisionRadioGroup(){
    if(facilityDivisionRadioGroup==null){
      ...
      facilityDivisionRadioGroup.setBindPath("1690103");
   ...
   * コンストラクタです。
   */
  public QO004_16911_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_16911_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_16911_201504Design getThis() {
    return this;
  }
}
