 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 地域密着型介護老人福祉施設入所者生活介護 (QO004_15411_201804)
 *
 *****************************************************************
 */
...
/**
 * 地域密着型介護老人福祉施設入所者生活介護画面項目デザイン(QO004_15411_201804) 
 */
public class QO004_15411_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup smallFootholdConcentration;
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("地域密着型介護老人福祉施設入所者生活介護");
  ...
  public ACRadioButtonItem getFacilitiesDivisionItem1(){
    if(facilitiesDivisionItem1==null){
      ...
      facilitiesDivisionItem1.setText("地域密着型介護老人福祉施設");
  ...
  /**
   * サテライト型地域密着型介護老人福祉施設を取得します。
   * @return サテライト型地域密着型介護老人福祉施設
   */
  public ACRadioButtonItem getFacilitiesDivisionItem2(){
    if(facilitiesDivisionItem2==null){
      ...
      facilitiesDivisionItem2.setText("サテライト型地域密着型介護老人福祉施設");
  ...
  /**
   * ユニット型地域密着型介護老人福祉施設を取得します。
   * @return ユニット型地域密着型介護老人福祉施設
   */
  public ACRadioButtonItem getFacilitiesDivisionItem3(){
    if(facilitiesDivisionItem3==null){
      ...
      facilitiesDivisionItem3.setText("ユニット型地域密着型介護老人福祉施設");
  ...
  /**
   * サテライト型ユニット型地域密着型介護老人福祉施設を取得します。
   * @return サテライト型ユニット型地域密着型介護老人福祉施設
   */
  public ACRadioButtonItem getFacilitiesDivisionItem4(){
    if(facilitiesDivisionItem4==null){
      ...
      facilitiesDivisionItem4.setText("サテライト型ユニット型地域密着型介護老人福祉施設");
  ...
  public ACValueArrayRadioButtonGroup getNurseStructuralAddRadio2Group(){
    if(nurseStructuralAddRadio2Group==null){
      ...
      nurseStructuralAddRadio2Group.setBindPath("1540139");
  ...
  public ACValueArrayRadioButtonGroup getKaigoRobotRadioGroup(){
    if(kaigoRobotRadioGroup==null){
      ...
      kaigoRobotRadioGroup.setBindPath("1540136");
  ...
  public ACValueArrayRadioButtonGroup getSeikatsuKinouGroup(){
    if(seikatsuKinouGroup==null){
      ...
      seikatsuKinouGroup.setBindPath("1540140");
  ...
  public ACValueArrayRadioButtonGroup getPlacementDoctorEmergency(){
    if(placementDoctorEmergency==null){
      ...
      placementDoctorEmergency.setBindPath("1540137");
   ...
   * @return 小規模拠点集合体制
   */
  public ACValueArrayRadioButtonGroup getSmallFootholdConcentration(){
    if(smallFootholdConcentration==null){

      smallFootholdConcentration = new ACValueArrayRadioButtonGroup();
      ...
      smallFootholdConcentration.setValues(new int[]{1,2});
  ...
  public ACValueArrayRadioButtonGroup getPressureUlcerManagement(){
    if(pressureUlcerManagement==null){
      ...
      pressureUlcerManagement.setBindPath("1540138");
   ...
   * コンストラクタです。
   */
  public QO004_15411_201804Design() {
  ...
  /**
   * サテライト型地域密着型介護老人福祉施設に内部項目を追加します。
   */
  ...
  /**
   * サテライト型ユニット型地域密着型介護老人福祉施設に内部項目を追加します。
   */
  ...
  protected void addCalculationDetails2(){
    ...
    calculationDetails2.add(getFunctionTrainingGuidanceSystemContainer(), VRLayout.FLOW_INSETLINE_RETURN);
  ...
  protected void addPanel3(){
    ...
    panel3.add(getCalculationDetails3(), VRLayout.NORTH);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_15411_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_15411_201804Design getThis() {
    return this;
  }
}
