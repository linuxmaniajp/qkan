 ...
 * アプリ: QKANCHO
 * 開発者: 事業所登録
 * 作成日: 2006/03/02  日本コンピューター株式会社 事業所登録 新規作成
 * 更新日: ----/--/--
 * システム 給付管理台帳 (Q)
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 介護予防短期入所療養介護(介護医療院) (QO004111)
 *
 *****************************************************************
 */
...
/**
 * 介護予防短期入所療養介護(介護医療院)SQL定義(QO004111) 
 */
public class QO004_204311_201804SQL extends QO004_204311_201804State {
  private ACSQLSafeDateFormat dateFormat = new ACSQLSafeDateFormat();
  /**
   * コンストラクタです。
   */
  public QO004_204311_201804SQL() {
  }
