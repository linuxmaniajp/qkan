 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 介護予防小規模多機能型居宅介護（短期利用以外） (QO004_17511_201804)
 *
 *****************************************************************
 */
...
/**
 * 介護予防小規模多機能型居宅介護（短期利用以外）画面項目デザイン(QO004_17511_201804) 
 */
public class QO004_17511_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACGroupBox getMainGroup(){
    if(mainGroup==null){
      ...
      mainGroup.setText("介護予防小規模多機能型居宅介護（短期利用以外）");
  ...
  public ACValueArrayRadioButtonGroup getFacilityDivisionRadioGroup(){
    if(facilityDivisionRadioGroup==null){
      ...
      facilityDivisionRadioGroup.setBindPath("1750103");
  ...
  /**
   * 介護予防小規模多機能型居宅介護事業所を取得します。
   * @return 介護予防小規模多機能型居宅介護事業所
   */
  public ACRadioButtonItem getFacilityDivisionRadioItem1(){
    if(facilityDivisionRadioItem1==null){
      ...
      facilityDivisionRadioItem1.setText("介護予防小規模多機能型居宅介護事業所");
  ...
  /**
   * サテライト型介護予防小規模多機能型居宅介護事業所を取得します。
   * @return サテライト型介護予防小規模多機能型居宅介護事業所
   */
  public ACRadioButtonItem getFacilityDivisionRadioItem2(){
    if(facilityDivisionRadioItem2==null){
      ...
      facilityDivisionRadioItem2.setText("サテライト型介護予防小規模多機能型居宅介護事業所");
  ...
  public ACValueArrayRadioButtonGroup getYoungDementiaPatinetAddRadioGroup(){
    if(youngDementiaPatinetAddRadioGroup==null){
      ...
      youngDementiaPatinetAddRadioGroup.setBindPath("1750105");
  ...
  public ACValueArrayRadioButtonGroup getComprehensiveManagementSystemRadioGroup(){
    if(comprehensiveManagementSystemRadioGroup==null){
      ...
      comprehensiveManagementSystemRadioGroup.setBindPath("1750104");
   ...
   * コンストラクタです。
   */
  public QO004_17511_201804Design() {
  ...
  /**
   * サテライト型介護予防小規模多機能型居宅介護事業所に内部項目を追加します。
   */
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_17511_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_17511_201804Design getThis() {
    return this;
  }
}
