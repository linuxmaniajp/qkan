...
/**
 * 介護療養型医療施設（診療所型）(QO004121) 
 */
public class QO004121 extends QO004121Event {
  /**
   * コンストラクタです。
   */
  public QO004121(){
  ...
  public static void main(String[] args) {
    ...
    ACFrame.debugStart(new ACAffairInfo(QO004121.class.getName(), param));
  }
...
//    }
  ...
  public void removeInvalidData(VRMap map) throws Exception{
	  ...
	  // ・staffAssignmentDivision　削除KEY：1530202
	  // ・unitCareMaintenance　削除KEY：1530217
	  if(!getStaffAssignmentDivision().isEnabled()){
		  map.removeData("1530202");
	  }
	  if(!getUnitCareMaintenance().isEnabled()){
		  map.removeData("1530217");
	  }
