...
/**
 * 介護予防短期入所療養介護（介護老人保健施設）画面項目デザイン(QO004_12511_201204) 
 */
public class QO004_12511_201204Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACRadioButtonItem getStaffAssignment2DivisionItem1(){
    if(staffAssignment2DivisionItem1==null){
      ...
      staffAssignment2DivisionItem1.setText("療養型");
  ...
  public ACRadioButtonItem getStaffAssignment2DivisionItem2(){
    if(staffAssignment2DivisionItem2==null){
      ...
      staffAssignment2DivisionItem2.setText("療養強化型");
   ...
   * コンストラクタです。
   */
  public QO004_12511_201204Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12511_201204Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12511_201204Design getThis() {
    return this;
  }
}
