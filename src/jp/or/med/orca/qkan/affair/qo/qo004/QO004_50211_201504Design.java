 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 訪問型サービス（独自） (QO004_50211_201504)
 *
 *****************************************************************
 */
...
/**
 * 訪問型サービス（独自）画面項目デザイン(QO004_50211_201504) 
 */
public class QO004_50211_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getSecondClassOfferRadioGroup(){
    if(secondClassOfferRadioGroup==null){
      ...
      secondClassOfferRadioGroup.setBindPath("5020101");
   ...
   * コンストラクタです。
   */
  public QO004_50211_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_50211_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_50211_201504Design getThis() {
    return this;
  }
}
