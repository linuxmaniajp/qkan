 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 地域密着特定施設入所者介護 (QO004_12811_201504)
 *
 *****************************************************************
 */
...
/**
 * 地域密着特定施設入所者介護画面項目デザイン(QO004_12811_201504) 
 */
public class QO004_12811_201504Design extends QO004ProviderPanel {
  //GUIコンポーネント
   ...
   * コンストラクタです。
   */
  public QO004_12811_201504Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_12811_201504Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_12811_201504Design getThis() {
    return this;
  }
}
