 ...
 * サブシステム その他機能 (O)
 * プロセス 事業所登録 (004)
 * プログラム 短期入所療養介護（病院療養型） (QO004_12311_201504)
 *
 *****************************************************************
 */
...
/**
 * 短期入所療養介護（病院療養型）イベント定義(QO004_12311_201504) 
 */
public abstract class QO004_12311_201504Event extends QO004_12311_201504SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_12311_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
