 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 認知症対応型共同生活介護（短期利用以外） (QO004_13211_201804)
 *
 *****************************************************************
 */
...
/**
 * 認知症対応型共同生活介護（短期利用以外）画面項目デザイン(QO004_13211_201804) 
 */
public class QO004_13211_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  private ACValueArrayRadioButtonGroup nightCareSystemAddRadioGroup;

  private ACLabelContainer nightCareSystemAddRadioGroupContainer;

  private ACListModelAdapter nightCareSystemAddRadioGroupModel;

  private ACRadioButtonItem nightCareSystemAddRadioItem1;

  private ACRadioButtonItem nightCareSystemAddRadioItem2;

  private ACRadioButtonItem nightCareSystemAddRadioItem3;
  ...
  private ACValueArrayRadioButtonGroup structureDuringHospitalization;

  private ACLabelContainer structureDuringHospitalizationContainer;

  private ACListModelAdapter structureDuringHospitalizationModel;

  private ACRadioButtonItem structureDuringHospitalizationItem1;

  private ACRadioButtonItem structureDuringHospitalizationItem2;
  ...
  private ACRadioButtonItem medicalCooperationSystemAddItem3;

  private ACRadioButtonItem medicalCooperationSystemAddItem4;
  ...
  public ACValueArrayRadioButtonGroup getBodyRestraintAbolished(){
    if(bodyRestraintAbolished==null){
      ...
      bodyRestraintAbolished.setBindPath("1320111");
   ...
   * @return 夜間支援体制加算
   */
  public ACValueArrayRadioButtonGroup getNightCareSystemAddRadioGroup(){
    if(nightCareSystemAddRadioGroup==null){

      nightCareSystemAddRadioGroup = new ACValueArrayRadioButtonGroup();

      getNightCareSystemAddRadioGroupContainer().setText("夜間支援体制加算");

      nightCareSystemAddRadioGroup.setBindPath("1320105");

      nightCareSystemAddRadioGroup.setNoSelectIndex(0);

      nightCareSystemAddRadioGroup.setUseClearButton(false);

      nightCareSystemAddRadioGroup.setModel(getNightCareSystemAddRadioGroupModel());

      nightCareSystemAddRadioGroup.setValues(new int[]{1,2,3});

      addNightCareSystemAddRadioGroup();
    }
    return nightCareSystemAddRadioGroup;
   ...
   * @return 夜間支援体制加算コンテナ
   */
  protected ACLabelContainer getNightCareSystemAddRadioGroupContainer(){
    if(nightCareSystemAddRadioGroupContainer==null){
      nightCareSystemAddRadioGroupContainer = new ACLabelContainer();
      nightCareSystemAddRadioGroupContainer.setFollowChildEnabled(true);
      nightCareSystemAddRadioGroupContainer.setVAlignment(VRLayout.CENTER);
      nightCareSystemAddRadioGroupContainer.add(getNightCareSystemAddRadioGroup(), null);
    }
    return nightCareSystemAddRadioGroupContainer;
  }
   ...
   * @return 夜間支援体制加算モデル
   */
  protected ACListModelAdapter getNightCareSystemAddRadioGroupModel(){
    if(nightCareSystemAddRadioGroupModel==null){
      nightCareSystemAddRadioGroupModel = new ACListModelAdapter();
      addNightCareSystemAddRadioGroupModel();
    }
    return nightCareSystemAddRadioGroupModel;
  }
   ...
   * @return なし
   */
  public ACRadioButtonItem getNightCareSystemAddRadioItem1(){
    if(nightCareSystemAddRadioItem1==null){

      nightCareSystemAddRadioItem1 = new ACRadioButtonItem();

      nightCareSystemAddRadioItem1.setText("なし");

      nightCareSystemAddRadioItem1.setGroup(getNightCareSystemAddRadioGroup());

      nightCareSystemAddRadioItem1.setConstraints(VRLayout.FLOW);

      addNightCareSystemAddRadioItem1();
    }
    return nightCareSystemAddRadioItem1;
   ...
   * @return 加算I
   */
  public ACRadioButtonItem getNightCareSystemAddRadioItem2(){
    if(nightCareSystemAddRadioItem2==null){

      nightCareSystemAddRadioItem2 = new ACRadioButtonItem();

      nightCareSystemAddRadioItem2.setText("加算I");

      nightCareSystemAddRadioItem2.setGroup(getNightCareSystemAddRadioGroup());

      nightCareSystemAddRadioItem2.setConstraints(VRLayout.FLOW);

      addNightCareSystemAddRadioItem2();
    }
    return nightCareSystemAddRadioItem2;
   ...
   * @return 加算II
   */
  public ACRadioButtonItem getNightCareSystemAddRadioItem3(){
    if(nightCareSystemAddRadioItem3==null){

      nightCareSystemAddRadioItem3 = new ACRadioButtonItem();

      nightCareSystemAddRadioItem3.setText("加算II");

      nightCareSystemAddRadioItem3.setGroup(getNightCareSystemAddRadioGroup());

      nightCareSystemAddRadioItem3.setConstraints(VRLayout.FLOW);

      addNightCareSystemAddRadioItem3();
    }
    return nightCareSystemAddRadioItem3;
   ...
   * @return 利用者の入院期間中の体制
   */
  public ACValueArrayRadioButtonGroup getStructureDuringHospitalization(){
    if(structureDuringHospitalization==null){

      structureDuringHospitalization = new ACValueArrayRadioButtonGroup();

      getStructureDuringHospitalizationContainer().setText("利用者の入院期間中の体制");

      structureDuringHospitalization.setBindPath("1320112");

      structureDuringHospitalization.setUseClearButton(false);

      structureDuringHospitalization.setModel(getStructureDuringHospitalizationModel());

      structureDuringHospitalization.setValues(new int[]{1,2});

      addStructureDuringHospitalization();
    }
    return structureDuringHospitalization;

  }

  /**
   * 利用者の入院期間中の体制コンテナを取得します。
   * @return 利用者の入院期間中の体制コンテナ
   */
  protected ACLabelContainer getStructureDuringHospitalizationContainer(){
    if(structureDuringHospitalizationContainer==null){
      structureDuringHospitalizationContainer = new ACLabelContainer();
      structureDuringHospitalizationContainer.setFollowChildEnabled(true);
      structureDuringHospitalizationContainer.setVAlignment(VRLayout.CENTER);
      structureDuringHospitalizationContainer.add(getStructureDuringHospitalization(), null);
    }
    return structureDuringHospitalizationContainer;
  }

  /**
   * 利用者の入院期間中の体制モデルを取得します。
   * @return 利用者の入院期間中の体制モデル
   */
  protected ACListModelAdapter getStructureDuringHospitalizationModel(){
    if(structureDuringHospitalizationModel==null){
      structureDuringHospitalizationModel = new ACListModelAdapter();
      addStructureDuringHospitalizationModel();
    }
    return structureDuringHospitalizationModel;
  }
   ...
   * @return 対応不可
   */
  public ACRadioButtonItem getStructureDuringHospitalizationItem1(){
    if(structureDuringHospitalizationItem1==null){

      structureDuringHospitalizationItem1 = new ACRadioButtonItem();

      structureDuringHospitalizationItem1.setText("対応不可");

      structureDuringHospitalizationItem1.setGroup(getStructureDuringHospitalization());

      addStructureDuringHospitalizationItem1();
    }
    return structureDuringHospitalizationItem1;
   ...
   * @return 対応可
   */
  public ACRadioButtonItem getStructureDuringHospitalizationItem2(){
    if(structureDuringHospitalizationItem2==null){

      structureDuringHospitalizationItem2 = new ACRadioButtonItem();

      structureDuringHospitalizationItem2.setText("対応可");

      structureDuringHospitalizationItem2.setGroup(getStructureDuringHospitalization());

      addStructureDuringHospitalizationItem2();
    }
    return structureDuringHospitalizationItem2;
  ...
  public ACValueArrayRadioButtonGroup getMedicalCooperationSystemAdd(){
    if(medicalCooperationSystemAdd==null){
      ...
      medicalCooperationSystemAdd.setValues(new int[]{1,2,3,4});
  ...
  public ACRadioButtonItem getMedicalCooperationSystemAddItem1(){
    if(medicalCooperationSystemAddItem1==null){
      ...
      medicalCooperationSystemAddItem1.setText("なし");
  ...
  public ACRadioButtonItem getMedicalCooperationSystemAddItem2(){
    if(medicalCooperationSystemAddItem2==null){
      ...
      medicalCooperationSystemAddItem2.setText("加算I");
   ...
   * @return 加算II
   */
  public ACRadioButtonItem getMedicalCooperationSystemAddItem3(){
    if(medicalCooperationSystemAddItem3==null){

      medicalCooperationSystemAddItem3 = new ACRadioButtonItem();

      medicalCooperationSystemAddItem3.setText("加算II");

      medicalCooperationSystemAddItem3.setGroup(getMedicalCooperationSystemAdd());

      medicalCooperationSystemAddItem3.setConstraints(VRLayout.FLOW);

      addMedicalCooperationSystemAddItem3();
    }
    return medicalCooperationSystemAddItem3;
   ...
   * @return 加算III
   */
  public ACRadioButtonItem getMedicalCooperationSystemAddItem4(){
    if(medicalCooperationSystemAddItem4==null){

      medicalCooperationSystemAddItem4 = new ACRadioButtonItem();

      medicalCooperationSystemAddItem4.setText("加算III");

      medicalCooperationSystemAddItem4.setGroup(getMedicalCooperationSystemAdd());

      medicalCooperationSystemAddItem4.setConstraints(VRLayout.FLOW);

      addMedicalCooperationSystemAddItem4();
    }
    return medicalCooperationSystemAddItem4;
   ...
   * コンストラクタです。
   */
  public QO004_13211_201804Design() {
  ...
  protected void addMainGroup(){
    ...
    mainGroup.add(getNightCareSystemAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    mainGroup.add(getYoungDementiaPatinetAddRadioGroupContainer(), VRLayout.FLOW_INSETLINE_RETURN);

    mainGroup.add(getStructureDuringHospitalizationContainer(), VRLayout.FLOW_INSETLINE_RETURN);
   ...
   * 夜間支援体制加算に内部項目を追加します。
   */
  protected void addNightCareSystemAddRadioGroup(){
   ...
   */
  protected void addNightCareSystemAddRadioGroupModel(){

    getNightCareSystemAddRadioItem1().setButtonIndex(1);

    getNightCareSystemAddRadioGroupModel().add(getNightCareSystemAddRadioItem1());

    getNightCareSystemAddRadioItem2().setButtonIndex(2);

    getNightCareSystemAddRadioGroupModel().add(getNightCareSystemAddRadioItem2());

    getNightCareSystemAddRadioItem3().setButtonIndex(3);

    getNightCareSystemAddRadioGroupModel().add(getNightCareSystemAddRadioItem3());
   ...
   * なしに内部項目を追加します。
   */
  protected void addNightCareSystemAddRadioItem1(){
   ...
   * 加算Iに内部項目を追加します。
   */
  protected void addNightCareSystemAddRadioItem2(){
   ...
   * 加算IIに内部項目を追加します。
   */
  protected void addNightCareSystemAddRadioItem3(){
  ...
  /**
   * 利用者の入院期間中の体制に内部項目を追加します。
   */
  protected void addStructureDuringHospitalization(){

  }

  /**
   * 利用者の入院期間中の体制モデルに内部項目を追加します。
   */
  protected void addStructureDuringHospitalizationModel(){

    getStructureDuringHospitalizationItem1().setButtonIndex(1);

    getStructureDuringHospitalizationModel().add(getStructureDuringHospitalizationItem1());

    getStructureDuringHospitalizationItem2().setButtonIndex(2);

    getStructureDuringHospitalizationModel().add(getStructureDuringHospitalizationItem2());
   ...
   * 対応不可に内部項目を追加します。
   */
  protected void addStructureDuringHospitalizationItem1(){
   ...
   * 対応可に内部項目を追加します。
   */
  protected void addStructureDuringHospitalizationItem2(){
  ...
  protected void addMedicalCooperationSystemAddModel(){
    ...
    getMedicalCooperationSystemAddItem3().setButtonIndex(3);

    getMedicalCooperationSystemAddModel().add(getMedicalCooperationSystemAddItem3());

    getMedicalCooperationSystemAddItem4().setButtonIndex(4);

    getMedicalCooperationSystemAddModel().add(getMedicalCooperationSystemAddItem4());
   ...
   * 加算IIに内部項目を追加します。
   */
  protected void addMedicalCooperationSystemAddItem3(){
   ...
   * 加算IIIに内部項目を追加します。
   */
  protected void addMedicalCooperationSystemAddItem4(){
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_13211_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_13211_201804Design getThis() {
    return this;
  }
}
