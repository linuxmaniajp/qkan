 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 複合型サービス（看護小規模多機能型居宅介護・短期利用） (QO004_17911_201804)
 *
 *****************************************************************
 */
...
/**
 * 複合型サービス（看護小規模多機能型居宅介護・短期利用）画面項目デザイン(QO004_17911_201804) 
 */
public class QO004_17911_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getFacilityDivisionRadioGroup(){
    if(facilityDivisionRadioGroup==null){
      ...
      facilityDivisionRadioGroup.setBindPath("1790103");
   ...
   * コンストラクタです。
   */
  public QO004_17911_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_17911_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_17911_201804Design getThis() {
    return this;
  }
}
