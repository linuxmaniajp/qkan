 ...
 * サブシステム その他機能 (O)
 * プロセス 事業者登録 (004)
 * プログラム 認知症対応型共同生活介護（短期利用） (QO004_13811_201804)
 *
 *****************************************************************
 */
...
/**
 * 認知症対応型共同生活介護（短期利用）画面項目デザイン(QO004_13811_201804) 
 */
public class QO004_13811_201804Design extends QO004ProviderPanel {
  //GUIコンポーネント
  ...
  public ACValueArrayRadioButtonGroup getFacilitiesDivision(){
    if(facilitiesDivision==null){
      ...
      facilitiesDivision.setBindPath("1380108");
  ...
  public ACValueArrayRadioButtonGroup getNightCareSystemAddRadioGroup(){
    if(nightCareSystemAddRadioGroup==null){
      ...
      nightCareSystemAddRadioGroup.setBindPath("1380104");
   ...
   * コンストラクタです。
   */
  public QO004_13811_201804Design() {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO004_13811_201804Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
   ...
   * 自身を返します。
   */
  protected QO004_13811_201804Design getThis() {
    return this;
  }
}
