 ...
 */
public abstract class QO004118Event extends QO004118SQL implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004118Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
  ...
  public static final int FACILITY_TYPE_SHOKIBO_FUKUSHI = 2;
  //getter/setter
