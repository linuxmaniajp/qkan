...
/**
 * 訪問型サービス（独自定率）イベント定義(QO004_50311_201504) 
 */
public abstract class QO004_50311_201504Event extends QO004_50311_201504State implements iProviderServicePanel {
  /**
   * コンストラクタです。
   */
  public QO004_50311_201504Event(){
    addEvents();
  }
  /**
   * イベント発生条件を定義します。
