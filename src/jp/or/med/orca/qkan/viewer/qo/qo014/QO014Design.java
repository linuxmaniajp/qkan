...
/**
 * ログビューア画面項目デザイン(QO014) 
 */
@SuppressWarnings("serial")
public class QO014Design extends QkanAffairContainer implements ACAffairable {
  //GUIコンポーネント
  ...
  public ACAffairButtonBar getButtons(){
    if(buttons==null){
      ...
      buttons.setText("給付管理/介護報酬請求 ログファイルビューア");
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ACFrame.debugStart(new ACAffairInfo(QO014Design.class.getName()));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
