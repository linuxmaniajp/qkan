...
public class QO012 extends QO012Event {
    ...
    public void dataMapping() throws Exception {
        ...
        //[H30.4 改正対応][Shinobu Hitaka] 2018/02 add 2A, 55, 2B 追加
        String[] csvDataTableSchema = new String[] {
                "YEAR_AND_MONTH", "INSURED_ID", "NAME", "CARE_LEVEL",
                "11", "12", "13", "14", "15", "16", "17", "21", "22", "23",
                "2A", "31", "32", "33", "27", "36", "28", "38", "51", "52",
                "53", "54", "55", "71", "72", "76", "77", "79", "73", "68",
                "78", "43", "61", "62", "63", "64", "65", "66", "67", "24",
                "25", "26", "2B", "34", "35", "46", "74", "75", "69", "37",
                "39",
...
//[H30.4 改正対応][Shinobu Hitaka] 2018/04 add end
    ...
    static {
        ...
        //[H30.4 改正対応][Shinobu Hitaka] 2018/02 add begin サービス種類追加
        serviceCodeSet.add("2A"); //短期入所療養介護(介護医療院)
        serviceCodeSet.add("2B"); //介護予防短期入所療養介護(介護医療院)
        serviceCodeSet.add("55"); //介護医療院
        //[H30.4 改正対応][Shinobu Hitaka] 2018/02 add end
