 ...
 * プログラム 介護保険サービス利用請求書(振込口座欄あり) (QP001P24_1)
 *
 *****************************************************************
 */
...
/**
 * 介護保険サービス利用請求書(振込口座欄あり)詳細版 帳票定義体ファイル名 ： QP001P222.xml
 */
public class QP001P222 extends QP001P22Event {
    /**
     * コンストラクタです。
     */
    public QP001P222() {
    ...
    public boolean doPrint()
        ...
        // 必要であれば帳票IDを書き換えること。
        ACChotarouXMLUtilities.addFormat(writer, "QP001P222", "QP001P222.xml");
        // ページ開始
        writer.beginPageEdit("QP001P222");
