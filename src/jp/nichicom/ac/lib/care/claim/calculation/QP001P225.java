 ...
 * プログラム 介護保険サービス利用領収書（領収欄あり） (QP001P27_1)
 *
 *****************************************************************
 */
...
/**
 * 介護保険サービス利用領収書（領収欄あり）詳細版 帳票定義体ファイル名 ： QP001P225.xml
 */
public class QP001P225 extends QP001P22Event {
    /**
     * コンストラクタです。
     */
    public QP001P225() {
    ...
    public boolean doPrint()
            throws Exception {
        // 必要であれば帳票IDを書き換えること。
        ACChotarouXMLUtilities.addFormat(writer, "QP001P225", "QP001P225.xml");
        // ページ開始
        writer.beginPageEdit("QP001P225");
