 ...
 * プログラム 介護保険サービス利用領収書(振込口座欄あり) (QP001P26_1)
 *
 *****************************************************************
 */
...
/**
 * 介護保険サービス利用領収書(振込口座欄あり)詳細版 帳票定義体ファイル名 ： QP001P224.xml
 */
public class QP001P224 extends QP001P22Event {
    /**
     * コンストラクタです。
     */
    public QP001P224() {
    ...
    public boolean doPrint()
            throws Exception {
        // 必要であれば帳票IDを書き換えること。
        ACChotarouXMLUtilities.addFormat(writer, "QP001P224", "QP001P224.xml");
        // ページ開始
        writer.beginPageEdit("QP001P224");
