 ...
 */
public class QP001P10_201804 extends QP001P02_10Event {
     ...
     * コンストラクタです。
     */
    public QP001P10_201804() {
    }

    public void addFormat() throws Exception {
        ACChotarouXMLUtilities.addFormat(writer, getFormatId(), "QP001P100_201804.xml");
    }

    public String getFormatId() throws Exception {
        return "QP001P100_201804";
    }  
