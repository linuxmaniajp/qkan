 ...
 * 
 */
public class QP001Style3 extends QP001StyleAbstract {
     ...
     * 社会福祉減免レコード(一帳票にひとつ)
     */
    private QP001RecordReduction reduction = new QP001RecordReduction();
    ...
    public QP001Style3(int claimStyleFormat,QP001Manager manager){
    ...
    public void parse(VRMap serviceDetail, Date targetDate,
        ...
        /* 社福減免対象かチェック */
        if(QP001RecordReduction.isMakeRecord(targetDate,targetServiceDate,serviceDetail,serviceCode,patientState,manager)){
            reduction.parse(serviceDetail, targetDate, patientState,
                    serviceCode, identificationNo,manager);
        }
...
//        int nursintTotal = 0;
//        if (nursing != null) {
//            nursintTotal = nursing.get_801024();
//        }
//        reduction.commitRecord(type.get_701017() + nursintTotal);
        reduction.commitRecord(type.get_701017());
//        reduction.set_901008("21");
    ...
    public VRList getRecords(int patient_id, Date claimDate)
        ...
        //社福減免レコード
        if (!reduction.isNew()) {
            list.add(reduction.getRecord(style));
        }
