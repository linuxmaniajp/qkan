 ...
 * 
 */
public class QP001Style10 extends QP001StyleAbstract {
    ...
    public QP001Style10(int claimStyleFormat,QP001Manager manager){
...
//        }
        ...
        //集計順序の入れ替え(公費自己負担が本体請求に先に適用されるようにするため)
...
//
//        // 集計情報レコードの確定処理
//        type.commitRecord(kohiTypes, patientState,styles);
        // 集計情報レコードの確定処理
