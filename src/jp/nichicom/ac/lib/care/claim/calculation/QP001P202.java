...
/**
 * 介護保険サービス利用請求書(振込口座欄あり) 帳票定義体ファイル名 ： QP001P202.xml
 */
public class QP001P202 extends QP001P20Event {
    /**
     * コンストラクタです。
     */
    public QP001P202() {
    ...
    public boolean doPrint()
        ...
        // 必要であれば帳票IDを書き換えること。
        ACChotarouXMLUtilities.addFormat(writer, "QP001P202", "QP001P202.xml");
        // ページ開始
        writer.beginPageEdit("QP001P202");
