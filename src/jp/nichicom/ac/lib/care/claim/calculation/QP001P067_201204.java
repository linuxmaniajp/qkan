 ...
 * プログラム (在宅サービス介護給付費明細書（認知症対応型・特定施設入所者） (QP001P075)
 *
 *****************************************************************
 */
...
public class QP001P067_201204 extends QP001P06_201204{
    
    //様式第六の七 201204以降
    
    @Override
    public void addFormat() throws Exception {
        ACChotarouXMLUtilities.addFormat(writer, getFormatId(), "QP001P067_201204.xml");
    }

    @Override
    public String getFormatId() throws Exception {
        return "QP001P067_201204";
    }
