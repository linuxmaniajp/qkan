 ...
 * 201504年以降（給管鳥はH29.8～対応）
 * 様式第七とは異なるので様式第七のクラスを継承しない（様式第二の三に似ている）
 */
public class QP001P073_201504 extends QP001P02_10Event{
    /**
     * コンストラクタです。
     */
    public QP001P073_201504() {
    }

    public void addFormat() throws Exception {
    	ACChotarouXMLUtilities.addFormat(writer, getFormatId(), "QP001P073_201504.xml");
        
    }

    public String getFormatId() throws Exception {
    	return "QP001P073_201504";
    }
