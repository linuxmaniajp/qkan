 ...
 * プログラム (在宅サービス介護給付費明細書（認知症対応型・特定施設入所者） (QP001P073)
 *
 *****************************************************************
 */
...
public class QP001P063_201204 extends QP001P06_201204{
    ...
    public void addFormat() throws Exception {
        ACChotarouXMLUtilities.addFormat(writer, getFormatId(), "QP001P063_201204.xml");
    }

    public String getFormatId() throws Exception {
        return "QP001P063_201204";
    }
