 ...
 */
public class QP001P11_201804 extends QP001PrintEvent {
    ...
    public boolean doPrint(ACChotarouXMLWriter writer, VRMap printParam)
            throws Exception {
        // 必要であれば帳票IDを書き換えること。
        ACChotarouXMLUtilities.addFormat(writer, "QP001P110_201804", "QP001P110_201804.xml");
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            writer.beginPageEdit("QP001P110_201804");
