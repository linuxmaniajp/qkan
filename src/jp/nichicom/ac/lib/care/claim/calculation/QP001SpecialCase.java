...
public class QP001SpecialCase {
    ...
    public static boolean isOutRealDay(String discriminationNo) throws Exception {
        //—l®‘æ“ñA‘æ“ñ‚Ì“ñA‘æ“ñ‚ÌOA‘æOA‘æO‚Ì“ñA‘ælA‘æl‚Ì“ñA‘æŒÜA‘æŒÜ‚Ì“ñA‘æ˜Z‚ÌŒÜA‘æ˜Z‚Ì˜Z
        ...
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2016/7/8 add - begin ‘‡–‹Æ‘Î‰
        if (QP001StyleAbstract.IDENTIFICATION_NO_2_3_201504.equals(discriminationNo)) {
            return true;
        }
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2016/7/8 add - end
        if (QP001StyleAbstract.IDENTIFICATION_NO_3_201204.equals(discriminationNo)) {
            return true;
        }
        if (QP001StyleAbstract.IDENTIFICATION_NO_3_2_201204.equals(discriminationNo)) {
    ...
    public static boolean isOutLimitUncontrolledUnit(String discriminationNo) throws Exception {
        //—l®‘æ“ñA“ñ‚Ì“ñA“ñ‚ÌOAOAO‚Ì“ñAlAl‚Ì“ñAŒÜAŒÜ‚Ì“ñ
...
//        return SEIHO_SELF_PAY;
     ...
     * @param serviceCodeItem
     * @param totalGroupingType Z’è’PˆÊi1:‰ñ” 2:“ú 3:Œj¦[‘‡–‹Æ“Æ©‘Î‰][Shinobu Hitaka] 2016/09/30 add
     * @return
     * @throws Exception
     */
// [‘‡–‹Æ“Æ©‘Î‰][Shinobu Hitaka] 2016/09/30 mod - begin Z’è’PˆÊ‚ªŒ‚Ìê‡‚ÍÈ—ª‚·‚é‚½‚ßƒpƒ‰ƒ[ƒ^’Ç‰Á
...
// [‘‡–‹Æ“Æ©‘Î‰][Shinobu Hitaka] 2016/09/30 mod - end
...
//        		|| "4005".equals(item)	//–K–âŠÅŒì‘Ì§‹­‰»‰ÁZ 2015/03/25 ’Ç‰Á‚µ‚æ‚¤‚Æv‚Á‚½‚ª‘¼‚Ì‰ÁZ—Ş‚ğŠÜ‚ß‚Ä‚¢‚È‚¢‚½‚ß•Û—¯
        ...
        if ("35".equals(kind)) {
            if ("1311".equals(item)		//—\–hŠO•”–K–â‰îŒì‡T
            	...
            	|| "2211".equals(item)	//—\–hŠO•”–K–âŒ^ƒT[ƒrƒX‡T 2015/03/25 add
            	|| "2221".equals(item)	//—\–hŠO•”–K–âŒ^ƒT[ƒrƒX‡U 2015/03/25 add
            	|| "2232".equals(item)	//—\–hŠO•”–K–âŒ^ƒT[ƒrƒX‡V 2015/03/25 add
            	|| "2311".equals(item)	//—\–hŠO•”’ÊŠŒ^ƒT[ƒrƒX‚P 2015/03/25 add
            	|| "2313".equals(item)	//—\–hŠO•”’ÊŠŒ^ƒT[ƒrƒX‚Q 2015/03/25 add
            	) {
                result = true;
            }
    	}
        ...
        if ("65".equals(kind)) {
            if ("1111".equals(item)		//—\–h’ÊŠ‰îŒì‚P
            	...
            	|| "6107".equals(item)	//—\–h’ÊŠƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚P‚P 2015/03/25 add
            	|| "6108".equals(item)	//—\–h’ÊŠƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚P‚Q 2015/03/25 add
            	|| "6101".equals(item)	//—\–h’ÊŠƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚Q‚P
            	|| "6102".equals(item)	//—\–h’ÊŠƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚Q‚Q
            	|| "6103".equals(item)	//—\–h’ÊŠƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡U‚P
            	|| "6104".equals(item)	//—\–h’ÊŠƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡U‚Q
            	|| "6105".equals(item)	//—\–h’ÊŠ‰îŒì“¯ˆêŒš•¨Œ¸Z‚P
            	|| "6106".equals(item)	//—\–h’ÊŠ‰îŒì“¯ˆêŒš•¨Œ¸Z‚Q
        ...
        if ("66".equals(kind)) {
            if ("1111".equals(item)		//—\–h’ÊŠƒŠƒnƒrƒŠ‚P‚P
            	...
            	|| "6117".equals(item)	//—\’ÊƒŠƒnƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚P‚P 2015/03/25 add
            	|| "6118".equals(item)	//—\’ÊƒŠƒnƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚P‚Q 2015/03/25 add
            	|| "6101".equals(item)	//—\’ÊƒŠƒnƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚Q‚P
            	|| "6102".equals(item)	//—\’ÊƒŠƒnƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚Q‚Q
        ...
        if ("71".equals(kind)) {
        	if ("1111".equals(item)		//–éŠÔ–K–â‰îŒì‡TŠî–{
            	...
            	|| "6110".equals(item)	//–éŠÔ–K–âƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡U‚P 2015/03/25 add
            	|| "6102".equals(item)	//–éŠÔ–K–âƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡U‚Q
        ...
        //¬‹K–Í‘½‹@”\Œ^‹‘î‰îŒì
        if ("73".equals(kind)) {
        	if ("1111".equals(item)		//¬‹K–Í‘½‹@”\‚P‚P
            	|| "1113".equals(item)	//¬‹K–Í‘½‹@”\‚P‚PE‰ß­
            //	|| "1115".equals(item)	//¬‹K–Í‘½‹@”\‚PE“¯ˆê       2015/03/25 del
            //	|| "1117".equals(item)	//¬‹K–Í‘½‹@”\‚PE“¯ˆêE‰ß­ 2015/03/25 del
            	|| "1121".equals(item)	//¬‹K–Í‘½‹@”\‚P‚Q
            	|| "1123".equals(item)	//¬‹K–Í‘½‹@”\‚P‚QE‰ß­
            //	|| "1125".equals(item)	//¬‹K–Í‘½‹@”\‚QE“¯ˆê       2015/03/25 del
            //	|| "1127".equals(item)	//¬‹K–Í‘½‹@”\‚QE“¯ˆêE‰ß­ 2015/03/25 del
            	|| "1131".equals(item)	//¬‹K–Í‘½‹@”\‚P‚R
            	|| "1133".equals(item)	//¬‹K–Í‘½‹@”\‚P‚RE‰ß­
            //	|| "1135".equals(item)	//¬‹K–Í‘½‹@”\‚RE“¯ˆê       2015/03/25 del
            //	|| "1137".equals(item)	//¬‹K–Í‘½‹@”\‚RE“¯ˆêE‰ß­ 2015/03/25 del
            	|| "1141".equals(item)	//¬‹K–Í‘½‹@”\‚P‚S
            	|| "1143".equals(item)	//¬‹K–Í‘½‹@”\‚P‚SE‰ß­
            //	|| "1145".equals(item)	//¬‹K–Í‘½‹@”\‚SE“¯ˆê       2015/03/25 del
            //	|| "1147".equals(item)	//¬‹K–Í‘½‹@”\‚SE“¯ˆêE‰ß­ 2015/03/25 del
            	|| "1151".equals(item)	//¬‹K–Í‘½‹@”\‚P‚T
            	|| "1153".equals(item)	//¬‹K–Í‘½‹@”\‚P‚TE‰ß­
            //	|| "1155".equals(item)	//¬‹K–Í‘½‹@”\‚TE“¯ˆê       2015/03/25 del
            //	|| "1157".equals(item)	//¬‹K–Í‘½‹@”\‚TE“¯ˆêE‰ß­ 2015/03/25 del
            	|| "1211".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚P       2015/03/25 add
            	|| "1213".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚PE‰ß­ 2015/03/25 add
            	|| "1221".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚Q       2015/03/25 add
            	|| "1223".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚QE‰ß­ 2015/03/25 add
            	|| "1231".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚R       2015/03/25 add
            	|| "1233".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚RE‰ß­ 2015/03/25 add
            	|| "1241".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚S       2015/03/25 add
            	|| "1243".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚SE‰ß­ 2015/03/25 add
            	|| "1251".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚T       2015/03/25 add
            	|| "1253".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚TE‰ß­ 2015/03/25 add
            	|| "4005".equals(item)	//¬‹K–Í‘½‹@”\Œ^–K–â‘Ì§‹­‰»‰ÁZ     2015/03/25 add
            	|| "4010".equals(item)	//¬‘½‹@”\Œ^‘‡ƒ}ƒlƒWƒƒ“ƒg‰ÁZ     2015/03/25 add
            	|| "6100".equals(item)	//¬‘½‹@”\Œ^ƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚P 2015/03/25 add
            	|| "6101".equals(item)	//¬‘½‹@”\Œ^ƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚Q
            ...
            //	|| "6139".equals(item)	//¬‹K–Í‘½‹@”\Œ^–‹ÆŠJnx‰‡‰ÁZ   2015/03/25 del
            	|| "6141".equals(item)	//¬‹K–Í‘½‹@”\Œ^ŠÅŒìEˆõ”z’u‰ÁZ‡V 2015/03/25 add
            	|| "6310".equals(item)	//¬‘½‹@”\Œ^’†RŠÔ’nˆæ“™’ñ‹Ÿ‰ÁZ   2015/03/25 add
            	...
            	|| "8011".equals(item)	//¬‹K–Í‘½‹@”\‚P‚PE’è’´
            	|| "8013".equals(item)	//¬‹K–Í‘½‹@”\‚P‚PE’è’´E‰ß­
            //	|| "8015".equals(item)	//¬‹K–Í‘½‹@”\‚PE’è’´E“¯ˆê       2015/03/25 del
            //	|| "8017".equals(item)	//¬‹K–Í‘½‹@”\‚PE’è’´E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "8021".equals(item)	//¬‹K–Í‘½‹@”\‚P‚QE’è’´
            	|| "8023".equals(item)	//¬‹K–Í‘½‹@”\‚P‚QE’è’´E‰ß­
            //	|| "8025".equals(item)	//¬‹K–Í‘½‹@”\‚QE’è’´E“¯ˆê       2015/03/25 del
            //	|| "8027".equals(item)	//¬‹K–Í‘½‹@”\‚QE’è’´E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "8031".equals(item)	//¬‹K–Í‘½‹@”\‚P‚RE’è’´
            	|| "8033".equals(item)	//¬‹K–Í‘½‹@”\‚P‚RE’è’´E‰ß­
            //	|| "8035".equals(item)	//¬‹K–Í‘½‹@”\‚RE’è’´E“¯ˆê       2015/03/25 del
            //	|| "8037".equals(item)	//¬‹K–Í‘½‹@”\‚RE’è’´E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "8041".equals(item)	//¬‹K–Í‘½‹@”\‚SE’è’´
            	|| "8043".equals(item)	//¬‹K–Í‘½‹@”\‚P‚SE’è’´E‰ß­
            //	|| "8045".equals(item)	//¬‹K–Í‘½‹@”\‚P‚SE’è’´E“¯ˆê     2015/03/25 del
            //	|| "8047".equals(item)	//¬‹K–Í‘½‹@”\‚SE’è’´E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "8051".equals(item)	//¬‹K–Í‘½‹@”\‚P‚TE’è’´
            	|| "8053".equals(item)	//¬‹K–Í‘½‹@”\‚P‚TE’è’´E‰ß­
            //	|| "8055".equals(item)	//¬‹K–Í‘½‹@”\‚TE’è’´E“¯ˆê       2015/03/25 del
            //	|| "8057".equals(item)	//¬‹K–Í‘½‹@”\‚TE’è’´E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "8111".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚PE’è’´       2015/03/25 add
            	|| "8113".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚PE’è’´E‰ß­ 2015/03/25 add
            	|| "8121".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚QE’è’´       2015/03/25 add
            	|| "8123".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚QE’è’´E‰ß­ 2015/03/25 add
            	|| "8131".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚RE’è’´       2015/03/25 add
            	|| "8133".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚RE’è’´E‰ß­ 2015/03/25 add
            	|| "8141".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚SE’è’´       2015/03/25 add
            	|| "8143".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚SE’è’´E‰ß­ 2015/03/25 add
            	|| "8151".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚TE’è’´       2015/03/25 add
            	|| "8153".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚TE’è’´E‰ß­ 2015/03/25 add
            	|| "9011".equals(item)	//¬‹K–Í‘½‹@”\‚P‚PElŒ‡
            	|| "9013".equals(item)	//¬‹K–Í‘½‹@”\‚P‚PElŒ‡E‰ß­
            //	|| "9015".equals(item)	//¬‹K–Í‘½‹@”\‚PElŒ‡E“¯ˆê       2015/03/25 del
            //	|| "9017".equals(item)	//¬‹K–Í‘½‹@”\‚PElŒ‡E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "9021".equals(item)	//¬‹K–Í‘½‹@”\‚P‚QElŒ‡
            	|| "9023".equals(item)	//¬‹K–Í‘½‹@”\‚P‚QElŒ‡E‰ß­
            //	|| "9025".equals(item)	//¬‹K–Í‘½‹@”\‚QElŒ‡E“¯ˆê       2015/03/25 del
            //	|| "9027".equals(item)	//¬‹K–Í‘½‹@”\‚QElŒ‡E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "9031".equals(item)	//¬‹K–Í‘½‹@”\‚P‚RElŒ‡
            	|| "9033".equals(item)	//¬‹K–Í‘½‹@”\‚P‚RElŒ‡E‰ß­
            //	|| "9035".equals(item)	//¬‹K–Í‘½‹@”\‚RElŒ‡E“¯ˆê       2015/03/25 del
            //	|| "9037".equals(item)	//¬‹K–Í‘½‹@”\‚RElŒ‡E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "9041".equals(item)	//¬‹K–Í‘½‹@”\‚P‚SElŒ‡
            	|| "9043".equals(item)	//¬‹K–Í‘½‹@”\‚P‚SElŒ‡E‰ß­
            //	|| "9045".equals(item)	//¬‹K–Í‘½‹@”\‚SElŒ‡E“¯ˆê       2015/03/25 del
            //	|| "9047".equals(item)	//¬‹K–Í‘½‹@”\‚SElŒ‡E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "9051".equals(item)	//¬‹K–Í‘½‹@”\‚P‚TElŒ‡
            	|| "9053".equals(item)	//¬‹K–Í‘½‹@”\‚P‚TElŒ‡E‰ß­
            //	|| "9055".equals(item)	//¬‹K–Í‘½‹@”\‚TElŒ‡E“¯ˆê       2015/03/25 del
            //	|| "9057".equals(item)	//¬‹K–Í‘½‹@”\‚TElŒ‡E“¯ˆêE‰ß­ 2015/03/25 del
            	|| "9111".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚PElŒ‡       2015/03/25 add
            	|| "9113".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚PElŒ‡E‰ß­ 2015/03/25 add
            	|| "9121".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚QElŒ‡       2015/03/25 add
            	|| "9123".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚QElŒ‡E‰ß­ 2015/03/25 add
            	|| "9131".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚RElŒ‡       2015/03/25 add
            	|| "9133".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚RElŒ‡E‰ß­ 2015/03/25 add
            	|| "9141".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚SElŒ‡       2015/03/25 add
        ...
        if ("75".equals(kind)) {
	        ...
	        //	|| "1127".equals(item)	//—\¬‹K–Í‘½‹@”\‚QE“¯ˆêE‰ß­ 2015/03/25 del
	            ...
	            || "1221".equals(item)	//—\¬‹K–Í‘½‹@”\‚Q‚Q       2015/03/25 add
	            || "1223".equals(item)	//—\¬‹K–Í‘½‹@”\‚Q‚QE‰ß­ 2015/03/25 add
	            || "4010".equals(item)	//—\¬‘½‹@”\‘‡ƒ}ƒlƒWƒƒ“ƒg‰ÁZ     2015/03/25 add
	        ...
	        //	|| "6139".equals(item)	//—\¬‘½‹@”\Œ^–‹ÆŠJnx‰‡‰ÁZ   2015/03/25 del
	            || "6310".equals(item)	//—\¬‘½‹@”\’†RŠÔ’nˆæ“™’ñ‹Ÿ‰ÁZ 2015/03/25 add
	            || "8011".equals(item)	//—\¬‹K–Í‘½‹@”\‚P‚PE’´
	            || "8013".equals(item)	//—\¬‹K–Í‘½‹@”\‚P‚PE’´E‰ß­
	        //	|| "8015".equals(item)	//—\¬‹K–Í‘½‹@”\‚PE’´E“¯ˆê       2015/03/25 del
	        //	|| "8017".equals(item)	//—\¬‹K–Í‘½‹@”\‚PE’´E“¯ˆêE‰ß­ 2015/03/25 del
	            || "8021".equals(item)	//—\¬‹K–Í‘½‹@”\‚P‚QE’´
	            || "8023".equals(item)	//—\¬‹K–Í‘½‹@”\‚P‚QE’´E‰ß­
	        //	|| "8025".equals(item)	//—\¬‹K–Í‘½‹@”\‚QE’´E“¯ˆê       2015/03/25 del
	        //	|| "8027".equals(item)	//—\¬‹K–Í‘½‹@”\‚QE’´E“¯ˆêE‰ß­ 2015/03/25 del
	            || "8111".equals(item)	//—\¬‹K–Í‘½‹@”\‚Q‚PE’´       2015/03/25 add
	            || "8113".equals(item)	//—\¬‹K–Í‘½‹@”\‚Q‚PE’´E‰ß­ 2015/03/25 add
	            || "8121".equals(item)	//—\¬‹K–Í‘½‹@”\‚Q‚QE’´       2015/03/25 add
	            || "8123".equals(item)	//—\¬‹K–Í‘½‹@”\‚Q‚QE’´E‰ß­ 2015/03/25 add
	            || "9011".equals(item)	//—\¬‹K–Í‘½‹@”\‚P‚PEŒ‡
	            || "9013".equals(item)	//—\¬‹K–Í‘½‹@”\‚P‚PEŒ‡E‰ß­
	        //	|| "9015".equals(item)	//—\¬‹K–Í‘½‹@”\‚PEŒ‡E“¯ˆê       2015/03/25 del
	        //	|| "9017".equals(item)	//—\¬‹K–Í‘½‹@”\‚PEŒ‡E“¯ˆêE‰ß­ 2015/03/25 del
	            || "9021".equals(item)	//—\¬‹K–Í‘½‹@”\‚P‚QEŒ‡
	            || "9023".equals(item)	//—\¬‹K–Í‘½‹@”\‚P‚QEŒ‡E‰ß­
	        //	|| "9025".equals(item)	//—\¬‹K–Í‘½‹@”\‚QEŒ‡E“¯ˆê       2015/03/25 del
	        //	|| "9027".equals(item)	//—\¬‹K–Í‘½‹@”\‚QEŒ‡E“¯ˆêE‰ß­ 2015/03/25 del
	            || "9111".equals(item)	//—\¬‹K–Í‘½‹@”\‚Q‚PEŒ‡       2015/03/25 add
        ...
        //•¡‡Œ^ƒT[ƒrƒX
        if ("77".equals(kind)) {
        	if ("1111".equals(item)		//ŠÅŒì¬‹K–Í‚P‚P
	            || "1113".equals(item)	//ŠÅŒì¬‹K–Í‚P‚PE‰ß­
	            || "1121".equals(item)	//ŠÅŒì¬‹K–Í‚P‚Q
	            || "1123".equals(item)	//ŠÅŒì¬‹K–Í‚P‚QE‰ß­
	            || "1131".equals(item)	//ŠÅŒì¬‹K–Í‚P‚R
	            || "1133".equals(item)	//ŠÅŒì¬‹K–Í‚P‚RE‰ß­
	            || "1141".equals(item)	//ŠÅŒì¬‹K–Í‚P‚S
	            || "1143".equals(item)	//ŠÅŒì¬‹K–Í‚P‚SE‰ß­
	            || "1151".equals(item)	//ŠÅŒì¬‹K–Í‚P‚T
	            || "1153".equals(item)	//ŠÅŒì¬‹K–Í‚P‚TE‰ß­
	            || "1211".equals(item)	//ŠÅŒì¬‹K–Í‚P‚P       2015/03/25 add
	            || "1213".equals(item)	//ŠÅŒì¬‹K–Í‚P‚PE‰ß­ 2015/03/25 add
	            || "1221".equals(item)	//ŠÅŒì¬‹K–Í‚P‚Q       2015/03/25 add
	            || "1223".equals(item)	//ŠÅŒì¬‹K–Í‚P‚QE‰ß­ 2015/03/25 add
	            || "1231".equals(item)	//ŠÅŒì¬‹K–Í‚P‚R       2015/03/25 add
	            || "1233".equals(item)	//ŠÅŒì¬‹K–Í‚P‚RE‰ß­ 2015/03/25 add
	            || "1241".equals(item)	//ŠÅŒì¬‹K–Í‚P‚S       2015/03/25 add
	            ...
	            || "6007".equals(item)	//ŠÅŒì¬‹K–Íˆã—Ã–K–âŠÅŒìŒ¸Z‚S
	            || "6009".equals(item)	//ŠÅŒì¬‹K–Íˆã—Ã–K–âŠÅŒìŒ¸Z‚T
	            || "6021".equals(item)	//ŠÅŒì¬‹K–Í–K–âŠÅŒì‘Ì§Œ¸Z‚P 2015/03/25 add
	            || "6023".equals(item)	//ŠÅŒì¬‹K–Í–K–âŠÅŒì‘Ì§Œ¸Z‚Q 2015/03/25 add
	            || "6025".equals(item)	//ŠÅŒì¬‹K–Í–K–âŠÅŒì‘Ì§Œ¸Z‚R 2015/03/25 add
	            || "6027".equals(item)	//ŠÅŒì¬‹K–Í–K–âŠÅŒì‘Ì§Œ¸Z‚S 2015/03/25 add
	            || "6029".equals(item)	//ŠÅŒì¬‹K–Í–K–âŠÅŒì‘Ì§Œ¸Z‚T 2015/03/25 add
	            || "6100".equals(item)	//ŠÅŒì¬‹K–Íƒ^[ƒ~ƒiƒ‹ƒPƒA‰ÁZ
	            || "6111".equals(item)	//ŠÅŒì¬‹K–ÍƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚P 2015/03/25 add
	            || "6101".equals(item)	//ŠÅŒì¬‹K–ÍƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚Q
	            || "6102".equals(item)	//ŠÅŒì¬‹K–ÍƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡U
	            ...
	            || "7107".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚S
	            || "7109".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚T
	            || "7111".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚U
	            || "7113".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚V
	            || "7115".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚W
	            || "7117".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚X
	            || "7119".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚O
	            || "7121".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚P
	            || "7123".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚Q
	            || "7125".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚R
	            || "7127".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚S
	            || "7129".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚T
	            || "7131".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚U
	            || "7133".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚V
	            || "7135".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚W
	            || "7137".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚P‚X
	            || "7139".equals(item)	//ŠÅŒì¬‹K–Ís’¬‘º“Æ©‰ÁZ‚Q‚O
	            || "8011".equals(item)	//ŠÅŒì¬‹K–Í‚P‚PE’è’´
	            || "8013".equals(item)	//ŠÅŒì¬‹K–Í‚P‚PE’è’´E‰ß­
	            || "8021".equals(item)	//ŠÅŒì¬‹K–Í‚P‚QE’è’´
	            || "8023".equals(item)	//ŠÅŒì¬‹K–Í‚P‚QE’è’´E‰ß­
	            || "8031".equals(item)	//ŠÅŒì¬‹K–Í‚P‚RE’è’´
	            || "8033".equals(item)	//ŠÅŒì¬‹K–Í‚P‚RE’è’´E‰ß­
	            || "8041".equals(item)	//ŠÅŒì¬‹K–Í‚P‚SE’è’´
	            || "8043".equals(item)	//ŠÅŒì¬‹K–Í‚P‚SE’è’´E‰ß­
	            || "8051".equals(item)	//ŠÅŒì¬‹K–Í‚P‚TE’è’´
	            || "8053".equals(item)	//ŠÅŒì¬‹K–Í‚P‚TE’è’´E‰ß­
	            || "8111".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚PE’è’´       2015/03/25 add
	            || "8113".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚PE’è’´E‰ß­ 2015/03/25 add
	            || "8121".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚QE’è’´       2015/03/25 add
	            || "8123".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚QE’è’´E‰ß­ 2015/03/25 add
	            || "8131".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚RE’è’´       2015/03/25 add
	            || "8133".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚RE’è’´E‰ß­ 2015/03/25 add
	            || "8141".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚SE’è’´       2015/03/25 add
	            ...
	            || "9023".equals(item)	//ŠÅŒì¬‹K–Í‚P‚QElŒ‡E‰ß­
	            || "9031".equals(item)	//ŠÅŒì¬‹K–Í‚P‚RElŒ‡
	            || "9033".equals(item)	//ŠÅŒì¬‹K–Í‚P‚RElŒ‡E‰ß­
	            || "9041".equals(item)	//ŠÅŒì¬‹K–Í‚P‚SElŒ‡
	            || "9043".equals(item)	//ŠÅŒì¬‹K–Í‚P‚SElŒ‡E‰ß­
	            || "9051".equals(item)	//ŠÅŒì¬‹K–Í‚P‚TElŒ‡
	            || "9053".equals(item)	//ŠÅŒì¬‹K–Í‚P‚TElŒ‡E‰ß­
	            || "9111".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚PElŒ‡       2015/03/25 add
	            || "9113".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚PElŒ‡E‰ß­ 2015/03/25 add
	            || "9121".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚QElŒ‡       2015/03/25 add
	            || "9123".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚QElŒ‡E‰ß­ 2015/03/25 add
	            || "9131".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚RElŒ‡       2015/03/25 add
	            || "9133".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚RElŒ‡E‰ß­ 2015/03/25 add
	            || "9141".equals(item)	//ŠÅŒì¬‹K–Í‚Q‚SElŒ‡       2015/03/25 add
        ...
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2016/7/21 add - begin ‘‡–‹Æ‘Î‰
        //–K–âŒ^ƒT[ƒrƒXi‚İ‚È‚µj
        if ("A1".equals(kind)) {
        	if ("1111".equals(item)		//–K–âŒ^ƒT[ƒrƒX‚P
            	|| "1113".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚PE‰”C
            	|| "1114".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚PE“¯ˆê
            	|| "1115".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚PE‰”CE“¯ˆê
            	|| "1211".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚Q
            	|| "1213".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚QE‰”C
            	|| "1214".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚QE“¯ˆê
            	|| "1215".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚QE‰”CE“¯ˆê
            	|| "1321".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚R
            	|| "1323".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚RE‰”C
            	|| "1324".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚RE“¯ˆê
            	|| "1325".equals(item)	//–K–âŒ^ƒT[ƒrƒX‚RE‰”CE“¯ˆê
            	|| "4001".equals(item)	//–K–âŒ^ƒT[ƒrƒX‰‰ñ‰ÁZ
            	|| "4002".equals(item)	//–K–âŒ^ƒT[ƒrƒX¶Šˆ‹@”\Œüã‰ÁZ
            	|| "8000".equals(item)	//–K–âŒ^ƒT[ƒrƒX“Á•Ê’nˆæ‰ÁZ
            	|| "8100".equals(item)	//–K–âŒ^ƒT[ƒrƒX¬‹K–Í–‹ÆŠ‰ÁZ
            	|| "8110".equals(item)	//–K–âŒ^ƒT[ƒrƒX’†RŠÔ’nˆæ“™’ñ‹Ÿ‰ÁZ
            	) {
                result = true;
            }
        }
        //’ÊŠŒ^ƒT[ƒrƒXi‚İ‚È‚µj
        if ("A5".equals(kind)) {
            if ("1111".equals(item)		//’ÊŠŒ^ƒT[ƒrƒX‚P
            	|| "1121".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX‚Q
            	|| "5002".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX‰^“®Ší‹@”\Œüã‰ÁZ
            	|| "5003".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX‰h—{‰ü‘P‰ÁZ
            	|| "5004".equals(item)	//’ÊŠŒ^ƒT[ƒrƒXŒûo‹@”\Œüã‰ÁZ
            	|| "5005".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX–‹ÆŠ•]‰¿‰ÁZ
            	|| "5006".equals(item)	//’ÊŠŒ^•¡”ƒT[ƒrƒXÀ{‰ÁZ‡T‚P
            	|| "5007".equals(item)	//’ÊŠŒ^•¡”ƒT[ƒrƒXÀ{‰ÁZ‡T‚Q
            	|| "5008".equals(item)	//’ÊŠŒ^•¡”ƒT[ƒrƒXÀ{‰ÁZ‡T‚R
            	|| "5009".equals(item)	//’ÊŠŒ^•¡”ƒT[ƒrƒXÀ{‰ÁZ‡U
            	|| "5010".equals(item)	//’ÊŠŒ^¶ŠˆŒüãƒOƒ‹[ƒvŠˆ“®‰ÁZ
            	|| "6107".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚P‚P
            	|| "6108".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚P‚Q
            	|| "6101".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚Q‚P
            	|| "6102".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡T‚Q‚Q
            	|| "6103".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡U‚P
            	|| "6104".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ‡U‚Q
            	|| "6105".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX“¯ˆêŒš•¨Œ¸Z‚P
            	|| "6106".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX“¯ˆêŒš•¨Œ¸Z‚Q
            	|| "6109".equals(item)	//’ÊŠŒ^ƒT[ƒrƒXá”N«”F’mÇó“ü‰ÁZ
            	|| "8001".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX‚PE’è’´
            	|| "8011".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX‚QE’è’´
            	|| "8110".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX’†RŠÔ’nˆæ“™’ñ‹Ÿ‰ÁZ
            	|| "9001".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX‚PElŒ‡
            	|| "9011".equals(item)	//’ÊŠŒ^ƒT[ƒrƒX‚QElŒ‡
            	) {
                result = true;
            }
        }
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2016/7/21 add - end
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2016/9/30 add - begin
        //–K–âŒ^ƒT[ƒrƒXi“Æ©j
        ...
        // “Æ©’è—¦E“Æ©’èŠz‚Ìê‡‚ÍŒŠzZ’è‚ª‘S‚Ä‘ÎÛ
    	...
    	// [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2016/9/30 add - end
...
//        int item = ACCastUtilities.toInt(serviceCodeItem,0);
        ...
        */
        if ("71".equals(serviceCodeKind)) {
        	...
        	// [‘‡–‹Æ“Æ©‘Î‰][Shinobu Hitaka] 2016/09/30 mod - begin Z’è’PˆÊƒpƒ‰ƒ[ƒ^’Ç‰Á
    ...
    public static boolean isSingleCountService(String serviceCodeKind, String serviceCodeItem) throws Exception {
        ...
        if ("73".equals(kind)) {
            if ("1111".equals(item)	//¬‹K–Í‘½‹@”\‚P‚P
	            ...
	            || "1151".equals(item)	//¬‹K–Í‘½‹@”\‚P‚T
	        	|| "1153".equals(item)	//¬‹K–Í‘½‹@”\‚P‚TE‰ß­
	        	|| "1211".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚P
	        	|| "1213".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚PE‰ß­
	        	|| "1221".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚Q
	        	|| "1223".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚QE‰ß­
	        	|| "1231".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚R
	        	|| "1233".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚RE‰ß­
	        	|| "1241".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚S
	        	|| "1243".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚SE‰ß­
	        	|| "1251".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚T
	        	|| "1253".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚TE‰ß­
	        //	|| "8001".equals(item)	//¬‘½‹@”\Œ^‹‘î‰îŒìŒoE’è’´   2015/03/25 del
	            || "8011".equals(item)	//¬‹K–Í‘½‹@”\‚P‚PE’è’´
	        	|| "8013".equals(item)	//¬‹K–Í‘½‹@”\‚P‚PE’è’´E‰ß­
	            || "8021".equals(item)	//¬‹K–Í‘½‹@”\‚P‚QE’è’´
	        	|| "8023".equals(item)	//¬‹K–Í‘½‹@”\‚P‚QE’è’´E‰ß­
            	...
            	|| "8151".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚TE’è’´       2015/03/25 add
            	|| "8153".equals(item)	//¬‹K–Í‘½‹@”\‚Q‚TE’è’´E‰ß­ 2015/03/25 add
	        //	|| "9001".equals(item)	//¬‘½‹@”\Œ^‹‘î‰îŒìŒoElŒ‡   2015/03/25 del
	            || "9011".equals(item)	//¬‹K–Í‘½‹@”\‚P‚PElŒ‡
...
//            }
    ...
    public static boolean isRegionStickingService(String serviceCodeKind) throws Exception {
    	...
    	if ("32".equals(serviceCodeKind)	//”F’mÇ‘Î‰Œ^
    		...
    		|| "78".equals(serviceCodeKind)	//’nˆæ–§’…Œ^’ÊŠ 2016.02.01 add
    		) {
    		result = true;
    	}
    	return result;
...
// 2014/12/24 [Yoichiro Kamei] add - begin ZŠ’n“Á—á‘Î‰
    ...
    public static boolean isRegionStickingServiceForJushotiTokurei(String serviceCodeKind) throws Exception {
        ...
        if (   "71".equals(serviceCodeKind) //–éŠÔ–K–â‰îŒì
            ...
            || "68".equals(serviceCodeKind) //¬‹K–Í‘½‹@”\i’ZŠú—˜—pj
            || "69".equals(serviceCodeKind) //‰îŒì—\–h¬‹K–Íi’ZŠú—˜—pj
            || "79".equals(serviceCodeKind) //•¡‡Œ^ƒT[ƒrƒXi’ZŠú—˜—pj
            || "78".equals(serviceCodeKind) //’nˆæ–§’…Œ^’ÊŠ 2016.02.01 add
            ) {
            result = true;
        }
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2016/7/22 add - begin ‘‡–‹Æ‘Î‰i2016/10/06 A1,A5ˆÈŠO’Ç‰Áj
        if (   "A1".equals(serviceCodeKind) //–K–âŒ^ƒT[ƒrƒXi‚İ‚È‚µj
            || "A2".equals(serviceCodeKind) //–K–âŒ^ƒT[ƒrƒXi“Æ©j
            || "A3".equals(serviceCodeKind) //–K–âŒ^ƒT[ƒrƒXi“Æ©^’è—¦j
            || "A4".equals(serviceCodeKind) //–K–âŒ^ƒT[ƒrƒXi“Æ©^’èŠzj
            || "A5".equals(serviceCodeKind) //’ÊŠŒ^ƒT[ƒrƒXi‚İ‚È‚µj
            || "A6".equals(serviceCodeKind) //’ÊŠŒ^ƒT[ƒrƒXi“Æ©j
            || "A7".equals(serviceCodeKind) //’ÊŠŒ^ƒT[ƒrƒXi“Æ©^’è—¦j
            || "A8".equals(serviceCodeKind) //’ÊŠŒ^ƒT[ƒrƒXi“Æ©^’èŠzj
            || "A9".equals(serviceCodeKind) //‚»‚Ì‘¼‚Ì¶Šˆx‰‡ƒT[ƒrƒXi”zH^’è—¦j
            || "AA".equals(serviceCodeKind) //‚»‚Ì‘¼‚Ì¶Šˆx‰‡ƒT[ƒrƒXi”zH^’èŠzj
            || "AB".equals(serviceCodeKind) //‚»‚Ì‘¼‚Ì¶Šˆx‰‡ƒT[ƒrƒXiŒ©ç‚è^’è—¦j
            || "AC".equals(serviceCodeKind) //‚»‚Ì‘¼‚Ì¶Šˆx‰‡ƒT[ƒrƒXiŒ©ç‚è^’èŠzj
            || "AD".equals(serviceCodeKind) //‚»‚Ì‘¼‚Ì¶Šˆx‰‡ƒT[ƒrƒXi‚»‚Ì‘¼^’è—¦j
            || "AE".equals(serviceCodeKind) //‚»‚Ì‘¼‚Ì¶Šˆx‰‡ƒT[ƒrƒXi‚»‚Ì‘¼^’èŠzj
            ) {
                result = true;
        }
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2016/7/22 add - end
...
//		}
        ...
        // 2016/7/21 [Yoichiro Kamei] add - begin ‘‡–‹Æ‘Î‰
        // ‘‡–‹Æ‚Ì‚İ‚È‚µ•ª‚à’Ç‰Á
        if ("A1".equals(serviceCodeKind)) {	// –K–âŒ^ƒT[ƒrƒX
        	if ("1111".equals(serviceCodeItem)		//–K–âŒ^ƒT[ƒrƒX‚P
				|| "1113".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚PE‰”C
				|| "1114".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚PE“¯ˆê
				|| "1115".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚PE‰”CE“¯ˆê
				|| "1211".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚Q
				|| "1213".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚QE‰”C
				|| "1214".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚QE“¯ˆê
				|| "1215".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚QE‰”CE“¯ˆê
				|| "1321".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚R
				|| "1323".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚RE‰”C
				|| "1324".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚RE“¯ˆê
				|| "1325".equals(serviceCodeItem)	//–K–âŒ^ƒT[ƒrƒX‚RE‰”CE“¯ˆê
        		) {
        		result = true;
        	}
        }
        ...
        // 2016/10/6 [Shinobu Hitaka] add - begin ‘‡–‹Æ“Æ©‘Î‰
        // ‘‡–‹Æ‚Ì“Æ©•ª‚à’Ç‰Á
        if ("A2".equals(serviceCodeKind)) {	// –K–âŒ^ƒT[ƒrƒX
        	if ("1111".equals(serviceCodeItem)		//–K–âŒ^“Æ©ƒT[ƒrƒX‚P
				|| "1113".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚PE‰”C
				|| "1114".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚PE“¯ˆê
				|| "1115".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚PE‰”CE“¯ˆê
				|| "1211".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q
				|| "1213".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚QE‰”C
				|| "1214".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚QE“¯ˆê
				|| "1215".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚QE‰”CE“¯ˆê
				|| "1321".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R
				|| "1323".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚RE‰”C
				|| "1324".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚RE“¯ˆê
				|| "1325".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚RE‰”CE“¯ˆê
				|| "1121".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚Q
				|| "1123".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚QE‰”C
				|| "1124".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚QE“¯ˆê
				|| "1125".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚QE‰”CE“¯ˆê
				|| "1221".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚Q
				|| "1223".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚QE‰”C
				|| "1224".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚QE“¯ˆê
				|| "1225".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚QE‰”CE“¯ˆê
				|| "1331".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚Q
				|| "1333".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚QE‰”C
				|| "1334".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚QE“¯ˆê
				|| "1335".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚QE‰”CE“¯ˆê
				|| "1131".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚R
				|| "1133".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚RE‰”C
				|| "1134".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚RE“¯ˆê
				|| "1135".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚RE‰”CE“¯ˆê
				|| "1231".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚R
				|| "1233".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚RE‰”C
				|| "1234".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚RE“¯ˆê
				|| "1235".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚RE‰”CE“¯ˆê
				|| "1341".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚R
				|| "1343".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚RE‰”C
				|| "1344".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚RE“¯ˆê
				|| "1345".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚RE‰”CE“¯ˆê
				|| "1141".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚S
				|| "1143".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚SE‰”C
				|| "1144".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚SE“¯ˆê
				|| "1145".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚SE‰”CE“¯ˆê
				|| "1241".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚S
				|| "1243".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚SE‰”C
				|| "1244".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚SE“¯ˆê
				|| "1245".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚SE‰”CE“¯ˆê
				|| "1351".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚S
				|| "1353".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚SE‰”C
				|| "1354".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚SE“¯ˆê
				|| "1355".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚SE‰”CE“¯ˆê
				|| "1151".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚T
				|| "1153".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚TE‰”C
				|| "1154".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚TE“¯ˆê
				|| "1155".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚P^‚TE‰”CE“¯ˆê
				|| "1251".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚T
				|| "1253".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚TE‰”C
				|| "1254".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚TE“¯ˆê
				|| "1255".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚Q^‚TE‰”CE“¯ˆê
				|| "1361".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚T
				|| "1363".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚TE‰”C
				|| "1364".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚TE“¯ˆê
				|| "1365".equals(serviceCodeItem)	//–K–âŒ^“Æ©ƒT[ƒrƒX‚R^‚TE‰”CE“¯ˆê
        		) {
        		result = true;
        	}
        }
    ...
    //[ID:0000586][Shin Fujihara] 2010/01 edit end 2009”N“x‘Î‰
    	...
    	//[CCCX:2904][Shinobu Hitaka] 2016/05/11 add begin –K–âE’ÊŠƒŠƒnƒ}ƒl‰ÁZ(2)‚Ì‰ÁZ‚Ì‚İ‚ÍÀ“ú”‚ÉƒJƒEƒ“ƒg‚µ‚È‚¢
    	//14–K–âƒŠƒnA‚Ü‚½‚Í16’ÊŠƒŠƒn‚Å‚ ‚éê‡
    	if ("11411".equals(systemServiceKindDetail) || "11611".equals(systemServiceKindDetail)) {
    		//‰ÁZ‚Ì‚İ‚ÅZ’è‚³‚ê‚Ä‚¢‚éê‡‚ÍAÀ“ú”‚Æ‚µ‚ÄŒvã‚µ‚È‚¢
    		//‰ÁZ‚Ì‚İ‚Ìê‡‚ÍAƒ}ƒlƒWƒƒ“ƒg‰ÁZ(2)‚Ì‚Ì‚İ‚Ì‚½‚ßAƒT[ƒrƒXƒR[ƒh‚ÍQÆ‚µ‚È‚¢
    		if (serviceDetail.containsKey("9")) {
    			if (ACCastUtilities.toInt(serviceDetail.get("9"), 0) == 2) {
    				return false;
    			}
    	...
    	//[CCCX:2929][Shinobu Hitaka] 2016/05/11 add begin –K–âŠÅŒì“Á•Êw¦Œ¸Z‚ªİ’è‚³‚ê‚Ä‚¢‚éê‡‚ÍÀ“ú”‚ÉƒJƒEƒ“ƒg‚µ‚È‚¢
    	//13–K–âŠÅŒì‚Å‚ ‚éê‡
    	if ("11311".equals(systemServiceKindDetail)) {
    		//–K–âŠÅŒì“Á•Êw¦Œ¸Z‚ªZ’è‚³‚ê‚Ä‚¢‚éê‡‚ÍAÀ“ú”‚Æ‚µ‚ÄŒvã‚µ‚È‚¢
...
// 2017/3/9 [H27.4‰ü³‘Î‰][Shinobu Hitaka] add - begin
    ...
    public static boolean isMitori(String serviceCodeKind, String serviceCodeItem) throws Exception {
        ...
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2015/3/24 add - begin ’Ç‰ÁƒR[ƒh‘Î‰
        //¬‹K–Í‘½‹@”\
        ...
        // [H27.4‰ü³‘Î‰][Shinobu Hitaka] 2015/3/24 add - end
