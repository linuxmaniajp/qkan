...
/**
 * 介護保険サービス利用領収書（領収欄あり） 帳票定義体ファイル名 ： QP001P205.xml
 */
public class QP001P205 extends QP001P20Event {
    /**
     * コンストラクタです。
     */
    public QP001P205() {
    ...
    public boolean doPrint()
            throws Exception {
        // 必要であれば帳票IDを書き換えること。
        ACChotarouXMLUtilities.addFormat(writer, "QP001P205", "QP001P205.xml");
        // ページ開始
        writer.beginPageEdit("QP001P205");
