...
/**
 * 介護保険サービス利用領収書(振込口座欄あり) 帳票定義体ファイル名 ： QP001P214.xml
 */
public class QP001P214 extends QP001P21Event {
    /**
     * コンストラクタです。
     */
    public QP001P214() {
    ...
    public boolean doPrint()
            throws Exception {
        // 必要であれば帳票IDを書き換えること。
        ACChotarouXMLUtilities.addFormat(writer, "QP001P214", "QP001P214.xml");
        // ページ開始
        writer.beginPageEdit("QP001P214");
