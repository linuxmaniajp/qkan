 ...
 */
public class QP001P08_201804 extends QP001P02_10Event {
     ...
     * コンストラクタです。
     */
    public QP001P08_201804() {
    }
    
    public void addFormat() throws Exception {
        ACChotarouXMLUtilities.addFormat(writer, getFormatId(), "QP001P080_201804.xml");
    }

    public String getFormatId() throws Exception {
        return "QP001P080_201804";
    }
