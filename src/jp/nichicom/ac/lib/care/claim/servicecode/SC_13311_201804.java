...
public class SC_13311_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1330137 身体拘束廃止未実施減算
        int _1330137 = getIntValue(map, "1330137", 1);
        
        // 1330138 入居継続支援加算
        int _1330138 = getIntValue(map, "1330138", 1);
        
        // 1330139 生活機能向上連携加算
        int _1330139 = getIntValue(map, "1330139", 1);
        
        // 1330140 若年性認知症受入加算
        int _1330140 = getIntValue(map, "1330140", 1);
        
        // 1330141 口腔衛生管理体制加算
        int _1330141 = getIntValue(map, "1330141", 1);
        
        // 1330142 栄養スクリーニング加算
        int _1330142 = getIntValue(map, "1330142", 1);
        
        // 1330143 退院・退所時連携加算
        int _1330143 = getIntValue(map, "1330143", 1);
        ...
        // 1330137 身体拘束廃止未実施減算 //2018.04
        if (_1330137 > 1) {
            StringBuilder sb1 = new StringBuilder();
            // プレフィックス
            sb1.append(SYSTEM_SERVICE_CODE_PREFIX_SK);
            // 施設区分
            sb1.append(CODE_CHAR[_1330105]);
            // 要介護度
        ...
        // 1330139 生活機能向上連携加算
        if (_1330139 > 1) {
        	if (_1330103 > 1) { //個別機能訓練指導加算を算定している場合
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItemTushoKaigo(
        ...
        // 1330126 通所介護-施設区分 1-通常規模事業所 2-大規模事業所 I 3-大規模事業所 II
