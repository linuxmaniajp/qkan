 ...
 * 
 */
public class SC_17611_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1760113 生活機能向上連携加算
        int _1760113 = getIntValue(map, "1760113", 1);
        
        // 1760114 同一建物減算
        int _1760114 = getIntValue(map, "1760114", 1);
        ...
        switch(_1760113) {
        case 2:
            putSystemServiceCodeItem(sysSvcCdItems, "Z4012");//2018.04
            break;
        case 3:
            putSystemServiceCodeItem(sysSvcCdItems, "Z4013");//2018.04
            break;
        }
        ...
        if (_1760111 == 1) {
            ...
            // 同一建物減算２
            case 3:
                putSystemServiceCodeItem(sysSvcCdItems, "Z4113");//2018.04
                break;
            }
        ...
        // 日割りあり
            ...
            // 同一建物減算２日割
            case 3:
                putSystemServiceCodeItem(sysSvcCdItems, "Z4114");//2018.04
                break;
            }
