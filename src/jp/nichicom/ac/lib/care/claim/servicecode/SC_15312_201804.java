 ...
 * 
 */
public class SC_15312_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1530267	入院患者に関する基準
        int _1530267 = getIntValue(map, "1530267");        
        
        // 1530268	低栄養リスク改善加算
        int _1530268 = getIntValue(map, "1530268");
        
        // 1530269	排せつ支援加算
        int _1530269 = getIntValue(map, "1530269");
        ...
        if (_9 == 2) {
            ...
            switch (_17) {
            case 6:
                putSystemServiceCodeItem(sysSvcCdItems, "Z3715");//2017.04
                break;
            case 5:
        ...
        if (_1530215 > 1) {
            ...
            // 施設区分
            sb1.append(CODE_CHAR[_1530201]);
            // 人員配置区分１
            if (_1530201 == 1) {
            	sb1.append(CODE_CHAR[_1530202]);
            } else {
            	sb1.append(DEFAULT_CHAR);
            }          
            // 人員配置区分２
            if (_1530201 == 2) {
            	sb1.append(CODE_CHAR[_1530218]);
            } else {
            	sb1.append(DEFAULT_CHAR);
            }
            // 病室区分(従来型個室/多床室)
            sb1.append(CODE_CHAR[_1530203]);
            // 病院区分(ユニット型個室/ユニット型準個室)
            sb1.append(CODE_CHAR[_1530204]);
            // 要介護度
        ...
        // 1530268	低栄養リスク改善加算
        if (_1530268 > 1) {
            putSystemServiceCodeItem(sysSvcCdItems, "Z3716");//2018.04
        }
        
        // 1530269	排せつ支援加算
        if (_1530269 > 1) {
            putSystemServiceCodeItem(sysSvcCdItems, "Z3717");//2018.04
        }
