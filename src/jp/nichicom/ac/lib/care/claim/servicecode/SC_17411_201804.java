 ...
 * 
 */
public class SC_17411_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1740112 生活機能向上連携加算
        int _1740112 = getIntValue(map, "1740112");
        
        // 1740113 栄養スクリーニング加算
        int _1740113 = getIntValue(map, "1740113");
        ...
        // 生活機能向上連携加算
        if (_1740112 > 1) {
        	if (_1740106 > 1) { //個別機能訓練指導加算を算定している場合
