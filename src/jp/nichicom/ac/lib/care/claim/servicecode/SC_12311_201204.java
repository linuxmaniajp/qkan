 ...
 * 
 */
public class SC_12311_201204 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1230105 夜間勤務条件基準　1-基準型 2-加算型I 3-加算型II 4-加算型III 5-減算型 6-加算型IV
        int _1230105 = getIntValue(map, "1230105");

        // 1230118 夜間勤務条件基準(ショートステイ用)　1-基準型 2-減算型
        int _1230118 = getIntValue(map, "1230118");
