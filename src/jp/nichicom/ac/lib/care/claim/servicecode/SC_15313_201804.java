 ...
 * 
 */
public class SC_15313_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1530362	入院患者に関する基準
        int _1530362 = getIntValue(map, "1530362");        
        
        // 1530363	低栄養リスク改善加算
        int _1530363 = getIntValue(map, "1530363");
        
        // 1530364	排せつ支援加算
        int _1530364 = getIntValue(map, "1530364");
        ...
        if (_1530314 > 1) {
            ...
            // 施設区分
            sb1.append(CODE_CHAR[_1530301]);
            // 病院区分(大学/一般病院)
            sb1.append(CODE_CHAR[_1530316]);
            // 人員配置区分
            sb1.append(CODE_CHAR[_1530302]);
            // 病室区分(従来型個室/多床室)
            sb1.append(CODE_CHAR[_1530303]);
            // 病室区分(ユニット型個室/ユニット型準個室)
            sb1.append(CODE_CHAR[_1530304]);
            // 要介護度
        ...
        // 1530363	低栄養リスク改善加算
        if (_1530363 > 1) {
            putSystemServiceCodeItem(sysSvcCdItems, "Z4716");//2018.04
        }
        
        // 1530364	排せつ支援加算
        if (_1530364 > 1) {
            putSystemServiceCodeItem(sysSvcCdItems, "Z4717");//2018.04
        }
