 ...
 * 
 */
public class SC_12511_201204 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1250105 リハビリ機能強化加算　1-なし 2-あり
        int _1250105 = getIntValue(map, "1250105", 1);

        // 1250106 緊急時治療管理加算　1-なし 2-あり
        int _1250106 = getIntValue(map, "1250106", 1);

        // 1250114　療養体制維持特別加算 1-なし 2-あり
        int _1250114 = getIntValue(map, "1250114", 1);

        // 1250108 療養食加算　1-なし 2-あり
        ...
        // 1250124 人員配置区分 1-従来型 2-在宅強化型
        int _1250124 = getIntValue(map, "1250124", 1);
        
        // 1250125 人員配置区分（療養型） 1-療養型 2-療養強化型
        int _1250125 = getIntValue(map, "1250125", 1);
