...
public class SC_17211_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1720112	生活機能向上連携加算
        int _1720112 = getIntValue(map, "1720112");
        
        // 1720113	栄養スクリーニング加算
        int _1720113 = getIntValue(map, "1720113");
        ...
        // 1720112	生活機能向上連携加算
        if (_1720112 > 1) {
        	if (_1720107 > 1) { //個別機能訓練指導加算を算定している場合
