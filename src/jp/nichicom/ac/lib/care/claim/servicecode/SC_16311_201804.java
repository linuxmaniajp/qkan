 ...
 * 
 */
public class SC_16311_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(Map<String, String> map) {
        ...
        // 23 “¯ˆêŒš•¨Œ¸Z
        int _23 = getIntValue(map, "23", 1); //2018.04
        ...
        // ŠÅŒì‘Ì§‹­‰»‰ÁZ
        if (_1630117 > 1) {
            putSystemServiceCodeItem(sysSvcCdItems, "Z4005");
        }
        
        // —\–h–K–âŠÅŒìƒT[ƒrƒX’ñ‹Ÿ‘Ì§‰ÁZ
        if (_1630109 > 1) {
