 ...
 * 
 */
public class SC_13511_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 8-認知症対応型通所介護 9-訪問型サービス 10-通所型サービス
        ...
        // 1350149 身体拘束廃止未実施減算
        int _1350149 = getIntValue(map, "1350149", 1);
        
        // 1350150 生活機能向上連携加算
        int _1350150 = getIntValue(map, "1350150", 1);
        
        // 1350151 若年性認知症受入加算
        int _1350151 = getIntValue(map, "1350151", 1);
        
        // 1350152 口腔衛生管理体制加算
        int _1350152 = getIntValue(map, "1350152", 1);
        
        // 1350153 栄養スクリーニング加算
        int _1350153 = getIntValue(map, "1350153", 1);
        
        // 1350134 認知症専門ケア加算
        int _1350134 = getIntValue(map, "1350134", 1);
        
        // 1350135 サービス提供体制強化加算
        int _1350135 = getIntValue(map, "1350135", 1);
        ...
        // 生活機能向上連携加算
        if (_1350150 > 1) {
        	if (_1350102 > 1) { //個別機能訓練指導加算を算定している場合
        ...
        if (_1350101 == 2) {
            ...
            case 7: // 福祉用具貸与
                ...
                break;
            case 8: // 認知症対応型通所介護
                getSystemServiceCodeItemNinchishoTaiogataTushoKaigo(map, sysSvcCdItems);
                break;
            case 9: // 訪問型サービス
                getSystemServiceCodeItemHomonGataService(map, sysSvcCdItems);
                break;
            case 10: // 通所型サービス
                getSystemServiceCodeItemTushoKaigoGataService(map, sysSvcCdItems);
                break;
            }
        }
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItemHomonReha(
        ...
        // 1350110 訪問リハ-施設等の区分　1-病院又は診療所 2-介護老人保健施設 3-介護医療院
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItemTushoKaigo(
        ...
        // 加算 2018/3/9 [H30.4改正対応][Shinobu Hitaka] 加算一式削除
        // ===========================================================================
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItemTushoReha(
        ...
        // 1350133 施設等の区分 1-病院又は診療所 2-介護老人保健施設 3-介護医療院
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItemNinchishoTaiogataTushoKaigo(
        ...
        // 1350123 認知症対応型通所介護-時間区分　2～9時間（1時間おき）
    ...
    /**
     * 外部サービス・訪問型サービス　2015.4追加
     * 
     * @param map
     * @param sysSvcCdItems
     * @return
     */
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItemHomonGataService(
            Map<String, String> map,
            ArrayList<HashMap<String, String>> sysSvcCdItems) {
        // パラメータ抽出
        // =========================================================================

        // 1350137 訪問型サービス-種別　1-Ⅰ型 2-Ⅱ型 3-Ⅲ型
        int _1350137 = getIntValue(map, "1350137", 1);

        // 1350138 訪問型サービス-日割　1-日割でない 2-日割である
        int _1350138 = getIntValue(map, "1350138", 1);
        ...
        // 訪問型サービス-種別　1-Ⅰ型 2-Ⅱ型 3-Ⅲ型
        sb.append(CODE_CHAR[_1350137]);

        // 訪問型サービス-日割　1-日割でない 2-日割である
        sb.append(CODE_CHAR[_1350138]);
    ...
    /**
     * 外部サービス・通所型サービス　2015.4追加
     * 
     * @param map
     * @param sysSvcCdItems
     * @return
     */
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItemTushoKaigoGataService(
            Map<String, String> map,
            ArrayList<HashMap<String, String>> sysSvcCdItems) {
        // パラメータ抽出
        // =========================================================================

        // 1350140 通所型サービス-日割　1-日割でない 2-日割である
        int _1350140 = getIntValue(map, "1350140", 1);

        // 1350142 通所型サービス-運動機能向上加算　1-なし 2-あり
        int _1350142 = getIntValue(map, "1350142", 1);

        // 1350143 通所型サービス-栄養改善加算　1-なし 2-あり
        int _1350143 = getIntValue(map, "1350143", 1);
