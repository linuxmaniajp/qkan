 ...
 * 
 */
public class SC_17711_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1770121 ƒTƒeƒ‰ƒCƒg‘Ì§–¢®”õŒ¸Z
        int _1770121 = getIntValue(map, "1770121", 1);
        
        // ’†RŠÔ’nˆæ“™‚Å‚ÌƒT[ƒrƒX’ñ‹Ÿ‰ÁZ
        int _12 = getIntValue(map, "12", 1);
        
        // 1770122 á”N«”F’mÇó“ü‰ÁZ
        int _1770122 = getIntValue(map, "1770122", 1);
        
        // 1770123 ‰h—{ƒXƒNƒŠ[ƒjƒ“ƒO‰ÁZ
        int _1770123 = getIntValue(map, "1770123", 1);
        
        // 1770124 –K–â‘Ì§‹­‰»‰ÁZ
        int _1770124 = getIntValue(map, "1770124", 1);
        ...
        // 1770119 ŠÅŒì‘Ì§‹­‰»‰ÁZ 2015.04
        switch (_1770119) {
        case 2:
            // ŠÅŒì‘Ì§‹­‰»‰ÁZI
            putSystemServiceCodeItem(sysSvcCdItems, "Z4014");//2018.04
            break;
        case 3:
            // ŠÅŒì‘Ì§‹­‰»‰ÁZII
        ...
        if (_1770115 == 1) {
            // ’†RŠÔ’nˆæ“™’ñ‹Ÿ‰ÁZ
            if (_12 > 1) {
                putSystemServiceCodeItem(sysSvcCdItems, "Z6310");
            }
            ...
            // ’†RŠÔ’nˆæ“™’ñ‹Ÿ‰ÁZE“úŠ„
            if (_12 > 1) {
                putSystemServiceCodeItem(sysSvcCdItems, "Z6311");//2018.04
            }
