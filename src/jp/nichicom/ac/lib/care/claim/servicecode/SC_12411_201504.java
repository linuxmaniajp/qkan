 ...
 * 
 */
public class SC_12411_201504 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1240105 機能訓練指導加算　1-なし 2-あり
        int _1240105 = getIntValue(map, "1240105", 1);

        // 1240107 療養食加算　1-なし 2-あり
        ...
        // 個別機能訓練加算
        if (_1240115 > 1) {
            putSystemServiceCodeItem(sysSvcCdItems, "Z6005");//TODO:コード値確認
        }
