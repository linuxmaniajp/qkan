...
public class SC_13611_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1360111 ¶Šˆ‹@”\Œüã˜AŒg‰ÁZ
        if (_1360111 > 1) {
        	if (_1360102 > 1) { //ŒÂ•Ê‹@”\ŒP—ûw“±‰ÁZ‚ğZ’è‚µ‚Ä‚¢‚éê‡
