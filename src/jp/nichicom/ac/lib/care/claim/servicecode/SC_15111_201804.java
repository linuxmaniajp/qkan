 ...
 * 
 */
public class SC_15111_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1510147 看取り介護加算型
        int _1510147 = getIntValue(map, "1510147");
        ...
        // 1510148 生活機能向上連携加算
        int _1510148 = getIntValue(map, "1510148", 1);
        
        // 1510149 外泊時在宅サービス利用費用
        int _1510149 = getIntValue(map, "1510149", 1);
        
        // 1510150 再入所時栄養連携加算
        int _1510150 = getIntValue(map, "1510150", 1);
        
        // 1510151 低栄養リスク改善加算
        int _1510151 = getIntValue(map, "1510151", 1);
        
        // 1510152 配置医師緊急時対応加算
        int _1510152 = getIntValue(map, "1510152", 1);
        
        // 1510153 褥瘡マネジメント加算
        int _1510153 = getIntValue(map, "1510153", 1);
        
        // 1510154 排せつ支援加算
        int _1510154 = getIntValue(map, "1510154", 1);
        ...
        if (_1510135 == 2) {
            ...
            case 2:
                ...
                case 1: // 30人以上50人以下
                    // 福祉施設夜勤職員配置加算III１
                    putSystemServiceCodeItem(sysSvcCdItems, "Z6127");//2018.04
                    break;
                case 2: // 51人以上又は経過的小規模
                    // 福祉施設夜勤職員配置加算III２
                    putSystemServiceCodeItem(sysSvcCdItems, "Z6128");//2018.04
                    break;
                }
                break;
            case 3:
            case 4:
                ...
                case 1: // 30人以上50人以下
                    // 福祉施設夜勤職員配置加算IV１
                    putSystemServiceCodeItem(sysSvcCdItems, "Z6129");//2018.04
                    break;
                case 2: // 51人以上又は経過的小規模
                    // 福祉施設夜勤職員配置加算IV２
                    putSystemServiceCodeItem(sysSvcCdItems, "Z6130");//2018.04
                    break;
                }
                break;
            }
        ...
        if (_1510128 > 1) {
            ...
            // 施設区分
            sb1.append(CODE_CHAR[_1510101]);
            // 病室区分(従来型個室/多床室)
            sb1.append(CODE_CHAR[_1510102]);
            // 病室区分(ユニット型個室/ユニット型準個室)
            sb1.append(CODE_CHAR[_1510103]);
            // 要介護度
        ...
        // 1510148	生活機能向上連携加算
        if (_1510148 > 1) {
        	if (_1510107 > 1) { //個別機能訓練指導加算を算定している場合
        ...
        if (!new Integer(1).equals(map.get("7")) && !"1".equals(map.get("7"))) {
            ...
            // または外泊時在宅サービス利用費用がありだった場合
//            if (_1510111 > 1) {
            if (_1510111 > 1 || _1510149 > 1) {
