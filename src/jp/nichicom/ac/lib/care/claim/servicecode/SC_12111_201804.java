 ...
 * 
 */
public class SC_12111_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1210133 看護体制 III型
        int _1210133 = getIntValue(map, "1210133", 1);
        
        // 1210134 看護体制 IV型
        int _1210134 = getIntValue(map, "1210134", 1);
        
        // 1210135 定員要件
        int _1210135 = getIntValue(map, "1210135", 1);
        ...
        // 1210130	生活相談員配置等加算
        int _1210130 = getIntValue(map, "1210130");
        
        // 1210131	生活機能向上連携加算
        int _1210131 = getIntValue(map, "1210131");
        
        // 1210132	認知症専門ケア加算
        int _1210132 = getIntValue(map, "1210132");
        ...
        // 1210133 看護体制加算 III型  //2018.04
        if (_1210133 > 1) {
            switch (_1210135) { // 定員要件
            case 1:// 29人以下
        ...
        if (_1210121 == 2) {
            ...
            // 6123 短期生活夜勤職員配置加算III
            // 6125 短期生活夜勤職員配置加算IV
            switch (_1210101) {
            case 1:// 単独型
            case 2:// 併設型
                putSystemServiceCodeItem(sysSvcCdItems, "Z6123");//2018.04
                break;
            case 3:// 単独型ユニット
            case 4:// 併設型ユニット
                putSystemServiceCodeItem(sysSvcCdItems, "Z6125");//2018.04
                break;
            }
        }
        ...
        // 1210131	生活機能向上連携加算
        if (_1210131 > 1) {
        	if (_1210127 > 1) { //個別機能訓練加算を算定している場合
