 ...
 * 
 */
public class SC_15411_201204 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        if (_9 == 2) {
            ...
            // 看護体制加算の併算定と合わせて修正
            // 看取り看護加算 1-なし 2-施設・在宅死 3-施設・在宅死以外
            switch (_1540134) {
            case 2:
