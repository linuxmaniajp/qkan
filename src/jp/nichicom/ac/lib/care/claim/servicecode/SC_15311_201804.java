 ...
 * 
 */
public class SC_15311_201804 extends Qkan10011_ServiceUnitGetter {
    ...
    public ArrayList<HashMap<String, String>> getSystemServiceCodeItem(
        ...
        // 1530121 人員配置区分（ユニット型病院療養型用）
        int _1530121 = getIntValue(map, "1530121");
        
        // 1530122 人員配置区分（病院経過型用）
        int _1530122 = getIntValue(map, "1530122");
        ...
        // 1530120 経口維持加算II
        int _1530120 = getIntValue(map, "1530120");
        ...
        // 1530171	入院患者に関する基準
        int _1530171 = getIntValue(map, "1530171");
        
        // 1530172	夜間勤務等看護加算
        int _1530172 = getIntValue(map, "1530172");
        
        // 1530173	低栄養リスク改善加算
        int _1530173 = getIntValue(map, "1530173");
        
        // 1530174	排せつ支援加算
        int _1530174 = getIntValue(map, "1530174");
        ...
        if (_1530117 > 1) {
            ...
            // 施設区分
            sb1.append(CODE_CHAR[_1530162]);
            // 人員配置区分１
            if (_1530162 == 1) {
            	sb1.append(CODE_CHAR[_1530102]);
            } else {
            	sb1.append(DEFAULT_CHAR);
            }            
            // 人員配置区分２
            if (_1530162 == 2) {
            	sb1.append(CODE_CHAR[_1530121]);
            } else {
            	sb1.append(DEFAULT_CHAR);
            }            
            // 人員配置区分３
            if (_1530162 == 3) {
            	sb1.append(CODE_CHAR[_1530122]);
            } else {
            	sb1.append(DEFAULT_CHAR);
            }
            // 病室区分(従来型個室/)
            sb1.append(CODE_CHAR[_1530103]);
            // 病室区分(ユニット型個室/ユニット型準個室)
            sb1.append(CODE_CHAR[_1530104]);
            // 要介護度
        ...
        // 1530173	低栄養リスク改善加算
        if (_1530173 > 1) {
            putSystemServiceCodeItem(sysSvcCdItems, "Z2716");//2018.04
        }
        
        // 1530174	排せつ支援加算
        if (_1530174 > 1) {
            putSystemServiceCodeItem(sysSvcCdItems, "Z2717");//2018.04
        }
