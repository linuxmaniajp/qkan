...
public class ACCommon {
    ...
    public Date addDay(Date x, int count) {
        return ACDateUtilities.addDay(x, count);
    }
     ...
     */
    public void addFollowCheckNumberInsert(StringBuilder sb, VRMap map,
     ...
     * @throws ParseException 解析例外
     */
    public void addFollowCheckNumberUpdate(StringBuilder sb, VRMap map,
            String checkNumberKey, String[] followNumberKeys,
            boolean addCheckValue) throws ParseException {
     ...
     * @throws ParseException 解析例外
     */
    public void addFollowCheckTextInsert(StringBuilder sb, VRMap map,
     ...
     * @throws ParseException 解析例外
     */
    public void addFollowCheckTextUpdate(StringBuilder sb, VRMap map,
            String checkNumberKey, String[] followTextKeys,
            boolean addCheckValue) throws ParseException {
    ...
    public Date addHourOfDay(Date x, int count) {
        return ACDateUtilities.addHour(x, count);
    }
    ...
    public Date addMinute(Date x, int count) {
        return ACDateUtilities.addMinute(x, count);
    }
    ...
    public Date addMonth(Date x, int count) {
        return ACDateUtilities.addMonth(x, count);
    }
    ...
    public Date addSecond(Date x, int count) {
        return ACDateUtilities.addSecond(x, count);
    }
    ...
    public Date addYear(Date x, int count) {
        return ACDateUtilities.addYear(x, count);
    }
    ...
    public int compareOnDay(Date x, Date y) {
        return ACDateUtilities.compareOnDay(x, y);
    }
    ...
    public int compareOnMonth(Date x, Date y) {
        return ACDateUtilities.compareOnMonth(x, y);
    }
    ...
    public int compareOnYear(Date x, Date y) {
        return ACDateUtilities.compareOnYear(x, y);
    }
    ...
    public Date createDate(int year) {
        return ACDateUtilities.createDate(year);
    }
    ...
    public Date createDate(int year, int month) {
        return ACDateUtilities.createDate(year, month);
    }
    ...
    public Date createDate(int year, int month, int day) {
        return ACDateUtilities.createDate(year, month, day);
    }
    ...
    public Date createTime(int hour, int minute) {
        return ACDateUtilities.createTime(hour, minute);
    }
    ...
    public Date createTime(int hour, int minute, int second) {
        return ACDateUtilities.createTime(hour, minute, second);
    }
    ...
    public int getDayOfMonth(Date x) {
        return ACDateUtilities.getDayOfMonth(x);
    }
    ...
    public int getDayOfWeek(Date x) {
        return ACDateUtilities.getDayOfWeek(x);
    }
    ...
    public String getDayOfWeekFull(Date x) {
        return ACDateUtilities.getDayOfWeekFull(x);
    }
    ...
    public String getDayOfWeekShort(Date x) {
        return ACDateUtilities.getDayOfWeekShort(x);
    }
    ...
    public int getDifferenceOnDay(Date x, Date y) {
        return ACDateUtilities.getDifferenceOnDay(x, y);
    }
    ...
    public int getDifferenceOnMonth(Date x, Date y) {
        return ACDateUtilities.getDifferenceOnMonth(x, y);
    }
    ...
    public int getDifferenceOnTotalDay(Date x, Date y) {
        return ACDateUtilities.getDifferenceOnTotalDay(x, y);
    }
    ...
    public int getDifferenceOnYear(Date x, Date y) {
        return ACDateUtilities.getDifferenceOnYear(x, y);
    }
    ...
    public String getEraAlphabet(Date x) throws Exception {
        return ACDateUtilities.getEraAlphabet(x);
    }
    ...
    public String getEraFull(Date x) throws Exception {
        return ACDateUtilities.getEraFull(x);
    }
    ...
    public String getEraShort(Date x) throws Exception {
        return ACDateUtilities.getEraShort(x);
    }
    ...
    public int getEraYear(Date x) throws Exception {
        return ACDateUtilities.getEraYear(x);
    }
     ...
     * @return 任意の列の値集合
     */
    public VRHashMapArrayToConstKeyArrayAdapter getFieldRows(ACDBManager dbm,
    ...
    public int getFirstDayOfMonth(Date x) {
        return ACDateUtilities.getFirstDayOfMonth(x);
    }
    ...
    public int getLastDayOfMonth(Date x) {
        return ACDateUtilities.getLastDayOfMonth(x);
    }
     ...
     * @throws ParseException 解析例外
     */
    public void getMasterTable(ACDBManager dbm, HashMap dest, String nameField,
            String table, String codeField, String orderField)
    ...
    public int getMonth(Date x) {
        return ACDateUtilities.getMonth(x);
    }
     ...
     * @return 変換結果
     */
    public VRList getSeriesedKeyListWithoutGroupField(VRList src,
            final String[] groupingConditionFieldNames,
            final String keyFieldName, final String valueFieldName,
            final String[] keyFieldValues, final Object valueFieldDefaultValue)
            throws Exception {
        return ACBindUtilities.getSeriesedKeyListWithoutGroupField(src,
                groupingConditionFieldNames, keyFieldName, valueFieldName,
                keyFieldValues, valueFieldDefaultValue);
    }
     ...
     * @return 変換結果
     */
    public VRList getSeriesedKeyListWithGroupField(VRList src,
            final String[] groupingConditionFieldNames,
            final String keyFieldName, final String valueFieldName,
            final String[] keyFieldValues, final Object valueFieldDefaultValue)
            throws Exception {
        return ACBindUtilities.getSeriesedKeyListWithGroupField(src,
                groupingConditionFieldNames, keyFieldName, valueFieldName,
                keyFieldValues, valueFieldDefaultValue);
    }
    ...
    public int getYear(Date x) {
        return ACDateUtilities.getYear(x);
    }
    ...
    public boolean isHolyday(Date x) {
        return ACDateUtilities.isHolyday(x);
    }
    ...
    public boolean isSaturday(Date x) {
        return ACDateUtilities.isSaturday(x);
    }
    ...
    public boolean isSunday(Date x) {
        return ACDateUtilities.isSunday(x);
    }
    ...
    public boolean isSundayOrHolyday(Date x) {
        return ACDateUtilities.isSundayOrHolyday(x);
    }
    ...
    public Date setDayOfMonth(Date x, int value) {
        return ACDateUtilities.setDayOfMonth(x, value);
    }
    ...
    public Date setHourOfDay(Date x, int value) {
        return ACDateUtilities.setHourOfDay(x, value);
    }
    ...
    public Date setMinute(Date x, int value) {
        return ACDateUtilities.setMinute(x, value);
    }
    ...
    public Date setMonth(Date x, int value) {
        return ACDateUtilities.setMonth(x, value);
    }
    ...
    public Date setSecond(Date x, int value) {
        return ACDateUtilities.setSecond(x, value);
    }
    ...
    public Date setYear(Date x, int value) {
        return ACDateUtilities.setYear(x, value);
    }
    ...
    public static boolean toBoolean(Object obj) throws Exception {
        return ACCastUtilities.toBoolean(obj);
    }
    ...
    public Date toFirstDayOfMonth(Date x) {
        return ACDateUtilities.toFirstDayOfMonth(x);
    }
    ...
    public Date toLastDayOfMonth(Date x) {
        return ACDateUtilities.toLastDayOfMonth(x);
    }
