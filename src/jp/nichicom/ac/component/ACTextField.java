...
//        setSelectionEnd(0);
    ...
    public void setConvertFromCharacter(int fromCharacter) {
        if(getDocument() instanceof ACTextFieldDocument){
            ((ACTextFieldDocument)getDocument()).setConvertFromCharacter(fromCharacter);
        }
    }
    ...
    public void setConvertToCharacter(int toCharacter) {
        if(getDocument() instanceof ACTextFieldDocument){
            ((ACTextFieldDocument)getDocument()).setConvertToCharacter(toCharacter);
        }
    }
    ...
    public int getConvertFromCharacter() {
        if(getDocument() instanceof ACTextFieldDocument){
            return ((ACTextFieldDocument)getDocument()).getConvertFromCharacter();
        }
        return 0;
    }
    ...
    public int getConvertToCharacter() {
        if(getDocument() instanceof ACTextFieldDocument){
            return ((ACTextFieldDocument)getDocument()).getConvertToCharacter();
        }
        return 0;
    }
}
