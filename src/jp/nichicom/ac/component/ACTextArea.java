 ...
 * @see VRTextArear
 */
public class ACTextArea extends AbstractACScrollPane implements VRTextArear, VRBindable,
     ...
     * @param columns 列数
     */
    public ACTextArea(Document doc, String text, int rows, int columns) {
        this();
     ...
     * @param columns 列数
     */
    public ACTextArea(int rows, int columns) {
        this();
        getMainContent().setRows(rows);
        getMainContent().setColumns(columns);
    }
     ...
     * @param columns 列数
     */
    public ACTextArea(String text, int rows, int columns) {
        this();
        getMainContent().setText(text);
        getMainContent().setRows(rows);
        getMainContent().setColumns(columns);
...
//    }
    ...
    protected ACRowMaximumableTextArea createMainContent() {
        return new ACRowMaximumableTextArea();
    }
