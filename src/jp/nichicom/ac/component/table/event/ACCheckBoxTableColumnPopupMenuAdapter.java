...
/**
 * チェックボックステーブルカラム用ポップアップメニューのイベントリスナアダプタクラスです。
 * <p>
 ...
 */
public class ACCheckBoxTableColumnPopupMenuAdapter implements
        ACCheckBoxTableColumnPopupMenuListener {
    /**
     * コンストラクタです。
     */
    public ACCheckBoxTableColumnPopupMenuAdapter() {
        super();
    }
