...
public class ACTableColumn extends VRTableColumn implements
    ...
    public Object getEditorModel() {
        if (getCellEditor() instanceof ACTableCellViewer) {
            return ((ACTableCellViewer) getCellEditor()).getEditorModel();
        }
        return null;
    }
    ...
    public String getEditorRenderBindPath() {
        if (getCellEditor() instanceof ACTableCellViewer) {
            return ((ACTableCellViewer) getCellEditor())
                    .getEditorRenderBindPath();
        }
        return null;
    }
    ...
    public Object getRendererModel() {
        if (getCellRenderer() instanceof ACTableCellViewer) {
            return ((ACTableCellViewer) getCellRenderer()).getRendererModel();
        }
        return null;
    }
    ...
    public String getRendererRenderBindPath() {
        if (getCellRenderer() instanceof ACTableCellViewer) {
            return ((ACTableCellViewer) getCellRenderer())
                    .getRendererRenderBindPath();
        }
        return null;
    }
     ...
     */
    public void setCellEditorStylizeOnRowValue(
            boolean cellEditorStylizeOnRowValue) {
    ...
    public void setEditorModel(Object model) {
        if (getCellEditor() instanceof ACTableCellViewer) {
            ((ACTableCellViewer) getCellEditor()).setEditorModel(model);
        }
    }
    ...
    public void setEditorRenderBindPath(String renderBindPath) {
        if (getCellEditor() instanceof ACTableCellViewer) {
            ((ACTableCellViewer) getCellEditor())
                    .setEditorRenderBindPath(renderBindPath);
        }
    }
    ...
    public void setRendererModel(Object model) {
        if (getCellRenderer() instanceof ACTableCellViewer) {
            ((ACTableCellViewer) getCellRenderer()).setRendererModel(model);
        }
    }
    ...
    public void setRendererRenderBindPath(String renderBindPath) {
        if (getCellRenderer() instanceof ACTableCellViewer) {
            ((ACTableCellViewer) getCellRenderer())
                    .setRendererRenderBindPath(renderBindPath);
        }
    }
