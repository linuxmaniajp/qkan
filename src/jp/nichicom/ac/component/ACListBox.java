 ...
 */
public class ACListBox extends AbstractACScrollPane implements VRListBoxar,
        FocusListener, VRBindEventListener, MouseWheelListener, MouseListener,
        MouseMotionListener, InputMethodListener, KeyListener,
        VRBindModelEventListener, ListSelectionListener {
...
//        initComponent();
    ...
    public void addItem(Object item) {
        AbstractVRListBox lb = getMainContent();
        if (lb instanceof ACMutableListBox) {
            ((ACMutableListBox) lb).addItem(item);
        }
    }
...
//    }
    ...
    public int getColumns() {
        AbstractVRListBox lb = getMainContent();
        if (lb instanceof ACMutableListBox) {
            return ((ACMutableListBox) lb).getColumns();
        }
        return 0;
    }
    ...
    public int getFixedCellWidth() {
    	System.out.println("getFixedCellWidth");
    ...
    public Object getItemAt(int index) {
        AbstractVRListBox lb = getMainContent();
        if (lb instanceof ACMutableListBox) {
            return ((ACMutableListBox) lb).getItemAt(index);
        }
        return null;
    }
    ...
    public int getItemCount() {
        AbstractVRListBox lb = getMainContent();
        if (lb instanceof ACMutableListBox) {
            return ((ACMutableListBox) lb).getItemCount();
        }
        return 0;
    }
...
//        return getMainContent().getBackground();
//    }
//
//    /**
//     * 内部項目の前景色を返します。
...
//        return getMainContent().getForeground();
//    }
    ...
    public VRBindSource getModelAtBindSource() {
        AbstractVRListBox lb = getMainContent();
        if (lb instanceof ACMutableListBox) {
            return ((ACMutableListBox) lb).getModelAtBindSource();
        }
        return null;
    }
...
//    }
    ...
    public Object getSelectedValue() {
        if(getMainContent().isSelectionEmpty()){
            return null;
        }
...
//        return getMainContent().isOpaque();
//    }
...
//    }
    ...
    public void removeItemAt(int index) {
        AbstractVRListBox lb = getMainContent();
        if (lb instanceof ACMutableListBox) {
            ((ACMutableListBox) lb).removeItemAt(index);
        }
    }
    ...
    public void setColumns(int columns) {
        AbstractVRListBox lb = getMainContent();
        if (lb instanceof ACMutableListBox) {
            ((ACMutableListBox) lb).setColumns(columns);
        }
    }
...
//        getMainContent().setBackground(bg);
//    }
//
//    /**
//     * 内部項目の前景色を設定します。
...
//        getMainContent().setForeground(fg);
//    }
//
//    /**
//     * 内部項目の不透明性を設定します。
//     * 
//     * @param isOpaque 内部項目の不透明性
//     */
...
//    }
    ...
    public void setModel(List model) {
        AbstractVRListBox lb = getMainContent();
        if (lb instanceof ACMutableListBox) {
            ((ACMutableListBox) lb).setModel(model);
        }
    }
     ...
     * 1行目を選択します。
     */
    public void setSelectedFirstIndex() {
        if (getItemCount() > 0) {
            setSelectedIndex(0);
        }
    }
     ...
     */
    public void setSelectedIndexOnAfterDelete(int lastSortedSelectedRow) {
        ...
        if (cnt > 0) {
            if (lastSortedSelectedRow <= 0) {
                ...
                // 保持行数を超えていたら最終行を選択する
                setSelectedIndex(cnt - 1);
            } else {
                // 最終選択行-1を選択する
                setSelectedIndex(lastSortedSelectedRow - 1);
            }
        }
    }
     ...
     * 最終行目を選択します。
     */
    public void setSelectedLastIndex() {
...
//            mainContent.addMouseWheelListener(this);
            ...
            mainContent.addListSelectionListener(this);
        }
        return mainContent;
    }
