...
public class ACSplashChaine  {
    ...
    private List<ACSplashable> splashList;
     ...
     */
    public List<ACSplashable> getList() {
        if(splashList==null){
            splashList=new ArrayList<ACSplashable>();
        }
        return splashList;
    }
    /**
    ...
    public ACMessageBoxDialog getLastItem() {
        List<ACSplashable> list = getList();
        if(list.size()>0){
    ...
    public void closeAll(){
        Iterator<ACSplashable> it=iterator();
        while(it.hasNext()){
...
//        clear();
     ...
     * @see #modCount
     */
    public Iterator<ACSplashable> iterator() {
     ...
     */
    public ListIterator<ACSplashable> listIterator() {
