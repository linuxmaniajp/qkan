...
//    private static ACCastUtilities singleton;
    ...
    /**
     * boolaen型にキャスト可能であるかを返します。
     * 
     * @param obj 変換元
     * @return キャスト可能であるか
     * @throws Exception 処理例外
     */
    public static boolean isBoolean(Object obj) throws Exception {
        try {
            toBoolean(obj);
        } catch (Exception ex) {
            return false;
    ...
    /**
     * Date型にキャスト可能であるかを返します。
     * 
     * @param obj 変換元
     * @return キャスト可能であるか
     * @throws Exception 処理例外
     */
    public static boolean isDate(Object obj) throws Exception {
        try {
            toDate(obj);
        } catch (Exception ex) {
            return false;
    ...
    /**
     * double型にキャスト可能であるかを返します。
     * 
     * @param obj 変換元
     * @return キャスト可能であるか
     * @throws Exception 処理例外
     */
    public static boolean isDouble(Object obj) throws Exception {
        try {
            toDouble(obj);
        } catch (Exception ex) {
            return false;
    ...
    /**
     * float型にキャスト可能であるかを返します。
     * 
     * @param obj 変換元
     * @return キャスト可能であるか
     * @throws Exception 処理例外
     */
    public static boolean isFloat(Object obj) throws Exception {
        try {
            toFloat(obj);
        } catch (Exception ex) {
            return false;
    ...
    /**
     * int型にキャスト可能であるかを返します。
     * 
     * @param obj 変換元
     * @return キャスト可能であるか
     * @throws Exception 処理例外
     */
    public static boolean isInt(Object obj) throws Exception {
        try {
            toInt(obj);
        } catch (Exception ex) {
            return false;
    ...
    /**
     * Integer型にキャスト可能であるかを返します。
     * 
     * @param obj 変換元
     * @return キャスト可能であるか
     * @throws Exception 処理例外
     */
    public static boolean isInteger(Object obj) throws Exception {
        try {
            toInteger(obj);
        } catch (Exception ex) {
            return false;
    ...
    /**
     * long型にキャスト可能であるかを返します。
     * 
     * @param obj 変換元
     * @return キャスト可能であるか
     * @throws Exception 処理例外
     */
    public static boolean isLong(Object obj) throws Exception {
        try {
            toLong(obj);
        } catch (Exception ex) {
            return false;
    ...
    /**
     * String型にキャスト可能であるかを返します。
     * 
     * @param obj 変換元
     * @return キャスト可能であるか
     * @throws Exception 処理例外
     */
    public static boolean isString(Object obj) throws Exception {
        try {
            toString(obj);
        } catch (Exception ex) {
            return false;
