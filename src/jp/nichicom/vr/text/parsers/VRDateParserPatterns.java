...
public class VRDateParserPatterns {
    ...
    private ArrayList<VRDateParserPattern> patterns;

    /**
     * デフォルトコンストラクタ
     */
    public VRDateParserPatterns() {
        patterns = new ArrayList<VRDateParserPattern>();
     ...
     * @return パターン集合
     */
    public ArrayList<VRDateParserPattern> getPatterns() {
        return patterns;
    }
    ...
    public Calendar match(String target, VRDateParserLocale locale)
        ...
        Iterator<VRDateParserPattern> it = getPatterns().iterator();
        while (it.hasNext()) {
            Calendar cal = it.next().match(target, locale.getEras(), locale.getLocale());
            if (cal != null) {
                return cal;
            }
        }
     ...
     */
    public void setPatterns(ArrayList<VRDateParserPattern> patterns) {
