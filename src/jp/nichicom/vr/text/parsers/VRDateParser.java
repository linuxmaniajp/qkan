...
public class VRDateParser {
    ...
    public static VRDateParserEra getEra(Calendar date) throws SAXException,
            ...
            ClassNotFoundException {
        ArrayList<VRDateParserEra> eras = getEras();
        Iterator<VRDateParserEra> it = eras.iterator();
        while (it.hasNext()) {
            VRDateParserEra era = it.next();
     ...
     * @throws InstantiationException 祝日計算クラスの生成に失敗
     */
    public static ArrayList<VRDateParserEra> getEras() throws SAXException, IOException,
     ...
     * @throws InstantiationException 祝日計算クラスの生成に失敗
     */
    public static ArrayList<VRDateParserEra> getEras(Locale locale) throws SAXException,
            IOException, ParserConfigurationException, ParseException,
            InstantiationException, IllegalAccessException,
            ClassNotFoundException {
     ...
     * @return 祝日集合
     */
    public static ArrayList<VRDateParserHolyday> getHolydays(Date date, Locale locale)
            throws SAXException, IOException, ParserConfigurationException,
            ParseException, InstantiationException, IllegalAccessException,
            ClassNotFoundException {
        Calendar cal = Calendar.getInstance(locale);
     ...
     * @return 祝日集合
     */
    public static ArrayList<VRDateParserHolyday> getHolydays(Date date) throws SAXException,
            IOException, ParserConfigurationException, ParseException,
            InstantiationException, IllegalAccessException,
            ClassNotFoundException {
     ...
     * @return 祝日集合
     */
    public static ArrayList<VRDateParserHolyday> getHolydays(Calendar date) throws SAXException,
            IOException, ParserConfigurationException, ParseException,
            InstantiationException, IllegalAccessException,
            ClassNotFoundException {
        return getHolydays(date, Locale.getDefault());
     ...
     * @return 祝日集合
     */
    public static ArrayList<VRDateParserHolyday> getHolydays(Calendar date, Locale locale)
            throws SAXException, IOException, ParserConfigurationException,
            ParseException, InstantiationException, IllegalAccessException,
            ClassNotFoundException {
    ...
    private HashMap<String, VRDateParserPatterns> formats;

    private ArrayList<VRDateParserLocale> locales;
    ...
    protected VRDateParser() {
        formats = new HashMap<String, VRDateParserPatterns>();
        locales = new ArrayList<VRDateParserLocale>();
     ...
     */
    public void clear() {
        HashMap<String, VRDateParserPatterns> fm = getFormats();
        if (fm != null) {
            fm.clear();
        }
        ArrayList<VRDateParserLocale> loc = getLocales();
        if (loc != null) {
            loc.clear();
        }
    }
     ...
     * @return 書式集合
     */
    public HashMap<String, VRDateParserPatterns> getFormats() {
        return formats;
    }
     ...
     * @return ロケール暦定義集合
     */
    public ArrayList<VRDateParserLocale> getLocales() {
        return locales;
    }
     ...
     * @param formats 書式集合
     */
    public void setFormats(HashMap<String, VRDateParserPatterns> formats) {
     ...
     */
    public void setLocales(ArrayList<VRDateParserLocale> locales) {
    ...
    protected String formatImpl(Calendar target, String format, Locale locale)
        ...
        ArrayList<VRDateParserFormatStatement> statements = parseFormat(target, format, locale);
        int size = statements.size();
        for (int i = 0; i < size; i++) {
            String txt = statements.get(i).getText();
    ...
    protected VRDateParserEra getEra(VRDateParserLocale locale, Calendar target) {
        ...
        ArrayList<VRDateParserEra> eras = locale.getEras();
        int eraSize = eras.size();
        if (eraSize > 0) {
            for (int i = 0; i < eraSize; i++) {
                VRDateParserEra era = eras.get(i);
     ...
     * @return 祝日集合
     */
    protected ArrayList<VRDateParserHolyday> getHolydaysImpl(Calendar date, Locale locale)
            throws SAXException, IOException, ParserConfigurationException,
            ParseException, InstantiationException, IllegalAccessException,
            ClassNotFoundException {
        ...
        ArrayList<VRDateParserHolyday> stock = new ArrayList<VRDateParserHolyday>();
     ...
     * @throws InstantiationException 祝日計算クラスの生成に失敗
     */
    protected ArrayList<VRDateParserEra> getErasImpl(Locale locale) throws SAXException,
            IOException, ParserConfigurationException, ParseException,
            InstantiationException, IllegalAccessException,
            ClassNotFoundException {
        ...
        if (locale == null) {
            // ロケール指定なし → 空ロケール
            return new ArrayList<VRDateParserEra>();
        }

        // ロケール指定あり
        Iterator<VRDateParserLocale> it = getLocales().iterator();
        while (it.hasNext()) {
            VRDateParserLocale loc = it.next();
    ...
    protected Calendar match(String target, VRDateParserLocale locale)
        ...
        VRDateParserPatterns patterns = getFormats().get(locale.getId());
        if (patterns != null) {
     ...
     * @throws InstantiationException 祝日計算クラスの生成に失敗
     */
    protected ArrayList<VRDateParserFormatStatement> parseFormat(Calendar target, String format,
        ...
        ArrayList<VRDateParserFormatStatement> result = new ArrayList<VRDateParserFormatStatement>();
        int cellBeginPos = 0;
        ...
        if (useEraYear || useEraText || useHolyday) {
            ...
            // 祝日使用
            if (useHolyday) {
                ArrayList<VRDateParserHolyday> holydays = new ArrayList<VRDateParserHolyday>();
                targetLocale.getHolydays().stockHolyday(target, holydays);
                if (freeLocale != null) {
                    freeLocale.getHolydays().stockHolyday(target, holydays);
                }
                StringBuilder sb = new StringBuilder();
                Iterator<VRDateParserHolyday> it = holydays.iterator();
                while (it.hasNext()) {
                    VRDateParserHolyday holyday = it.next();
    ...
    protected void parseNode(NodeList rootChildren) throws ParseException,
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ("locales".equals(nodeName)) {
                if (getLocales() == null) {
                    setLocales(new ArrayList<VRDateParserLocale>());
                }
                ...
                if (getFormats() == null) {
                    setFormats(new HashMap<String, VRDateParserPatterns>());
                }
