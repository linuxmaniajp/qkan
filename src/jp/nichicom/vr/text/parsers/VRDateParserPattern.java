...
public class VRDateParserPattern {
    ...
    private ArrayList<VRDateParserStatementable> statements;

    /**
     * コンストラクタ
     */
    public VRDateParserPattern() {
        this.statements = new ArrayList<VRDateParserStatementable>();
    }
     ...
     * @return 構文集合
     */
    public ArrayList<VRDateParserStatementable> getStatements() {
        return statements;
    }
     ...
     */
    public Calendar match(String target, ArrayList<VRDateParserEra> eras, Locale locale)
        ...
        Iterator<VRDateParserStatementable> it = statements.iterator();
        while (it.hasNext()) {
            VRDateParserStatementable statement = it.next();
        ...
        if ((parseOption.getMachedEra() == null) && (parseOption.getEra() > 0)) {
            ...
            Iterator<VRDateParserEra> eraIt = eras.iterator();
            while (eraIt.hasNext()) {
                VRDateParserEra eraItem = eraIt.next();
...
//            return parseOption.getNow();
     ...
     */
    public void setStatements(ArrayList<VRDateParserStatementable> statements) {
