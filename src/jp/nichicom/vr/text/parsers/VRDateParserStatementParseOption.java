...
public class VRDateParserStatementParseOption {
    private int day = -1;
    private int era = 0;
    private ArrayList<VRDateParserEra> eras;
    private int hour = -1;
     ...
     * @param locale ロケール
     */
    public VRDateParserStatementParseOption(String target, ArrayList<VRDateParserEra> eras,
     ...
     */
    public ArrayList<VRDateParserEra> getEras() {
        return eras;
    }
     ...
     */
    public void setEras(ArrayList<VRDateParserEra> eras) {
        this.eras = eras;
    }
