...
public class VRTextAreaDocument extends AbstractVRTextDocument {
     ...
     *            documents
     */
    public VRTextAreaDocument(AbstractVRTextArea textArea, Content c,
            StyleContext styles) {
        super(c, styles);
        setTextComponent(textArea);
    }
     ...
     */
    public VRTextAreaDocument(AbstractVRTextArea textArea, StyleContext styles) {
        super(styles);
        setTextComponent(textArea);
    }
