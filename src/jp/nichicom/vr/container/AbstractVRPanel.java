...
public class AbstractVRPanel extends JPanel implements VRBindableContainer {
    ...
    public void addBindEventListener(VRBindEventListener listener) {
        ArrayList<Component> coms = getBindableComponents();
        Iterator<Component> it = coms.iterator();
        while (it.hasNext()) {
    ...
    public void addBindModelEventListener(VRBindModelEventListener listener) {
        ArrayList<Component> coms = getModelBindableComponents();
        Iterator<Component> it = coms.iterator();
        while (it.hasNext()) {
     ...
     */
    protected void appendBindableComponents(ArrayList<Component> array, Container container) {
     ...
     * @param container 列挙コンテナ
     */
    protected void appendModelBindableComponents(ArrayList<Component> array,
            Container container) {
     ...
     * @return コンポーネント集合
     */
    protected ArrayList<Component> getBindableComponents() {
     ...
     * @return コンポーネント集合
     */
    protected ArrayList<Component> getModelBindableComponents() {
        ArrayList<Component> array = new ArrayList<Component>();
