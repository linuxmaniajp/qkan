            ...
            while (it.hasNext()) {
                ...
                if (c.isVisible()) {
                    ...
                    if (NORTH.equals(key)) {
                        ...
                        cy += cd.height + vgap;
                        keepwidth = (int) Math.max(keepwidth, cx + cr + cd.width);
                        ...
                        Dimension cd = c.getPreferredSize();
                        cx += cd.width + hgap;
                        keepheight = (int) Math.max(cd.height + cy + cb, keepheight);
            ...
            while (it.hasNext()) {
                ...
                if (c.isVisible()) {
                    ...
                    if (NORTH.equals(key)) {
                        ...
                        c.setBounds(cx, h - cb - cd.height, w - cr - cx, cd.height);
                        cb += cd.height + vgap;
                        ...
                        c.setSize(1, c.getHeight());
                        Dimension cd = c.getPreferredSize();
                        c.setBounds(w - cr - cd.width, cy, cd.width, h - cb - cy);
                        cr = cr + cd.width + hgap;
                    }
