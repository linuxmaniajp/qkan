...
public class VRHashMap extends HashMap implements VRMap {
     ...
     */
      ...
      */
   public VRHashMap(int initialCapacity) {
    ...
    */
    public VRHashMap(int initialCapacity, float loadFactor) {
