...
public class VRDraw {
    ...
    public static void drawButtonBase(Graphics g, Color background,
        ...
        if (!enabled) {
            ...
            back = new Color(back.getRed(), back.getGreen(), back.getGreen(), 128);
            dark = new Color(dark.getRed(), dark.getGreen(), dark.getGreen(), 128);
            bright = new Color(bright.getRed(), bright.getGreen(), bright.getGreen(), 128);
