...
/**
 * VR Look&FeelにおけるパスワードフィールドUIです。
 * <p>
 ...
 */
public class VRPasswordFieldUI extends BasicPasswordFieldUI {
     ...
     * @param c コンポーネント
     */
    public VRPasswordFieldUI(JComponent c) {
        super();
        textComp = c;
    }

    public static ComponentUI createUI(JComponent c) {
        return new VRPasswordFieldUI(c);
    }
