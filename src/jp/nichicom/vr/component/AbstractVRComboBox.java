...
public abstract class AbstractVRComboBox extends JComboBox implements
     ...
     * @return エディタ
     */
    protected VRComboBoxEditor createEditor() {
        return new VRComboBoxEditor();
    }
    ...
    protected int getMaxWidth(){
        return getColumnWidth() * getMaxColumns();
    }
    ...
    protected void initComponent() {
        VRComboBoxEditor edit = createEditor();
