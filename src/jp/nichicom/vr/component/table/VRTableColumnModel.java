...
public class VRTableColumnModel extends DefaultTableColumnModel implements
    ...
    public void moveColumn(int columnIndex, int newIndex) {
        ...
        int fromIndex = columnIndex;
        int toIndex = newIndex;
        if(tableColumns instanceof VRTableColumnModelVector){
            VRTableColumnModelVector col =(VRTableColumnModelVector)tableColumns; 
            fromIndex = col.toRealColumnCount(col.toRealColumnCount(columnIndex));
            toIndex = col.toRealColumnCount(col.toRealColumnCount(newIndex));
        }
        tableColumns.removeElementAt(fromIndex);
        boolean selected = selectionModel.isSelectedIndex(columnIndex); 
        selectionModel.removeIndexInterval(columnIndex,columnIndex);

        tableColumns.insertElementAt(aColumn, toIndex);
