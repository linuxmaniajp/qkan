...
public class VRTable extends JTable implements VRTablar {
    ...
    private HashMap<String, String> sortSequence;
    ...
    public void clearSortSequence() {
        setSortSequence(new HashMap<String, String>());
        repaint();
    }
     ...
     * @return ソート状態マップ
     */
    public HashMap<String, String> getSortSequence() {
        return sortSequence;
    }
     ...
     */
    public void setSortSequence(HashMap<String, String> sortSequence) {
    ...
    public void sort(int column) {
        ...
        if (columnName != null) {
            HashMap<String, String> seq = getSortSequence();
    ...
    protected void initComponent() {
        ...
        // 変数初期化
        sortSequence = new HashMap<String, String>();
        // 初期設定
