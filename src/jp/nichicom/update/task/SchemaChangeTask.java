...
public class SchemaChangeTask extends AbstractTask{
	...
	public boolean runTask() throws Exception{
		...
		try{
			...
			db.exec("UPDATE M_QKAN_VERSION SET SCHEME_VERSION = '" + getVersionNo() + "',LAST_TIME = CURRENT_TIMESTAMP");
			db.commit();
		} catch (Exception e){
			db.rollback();
			throw e;
	...
	public String getDataVersion(DBConnect db) throws Exception {
		return db.execQuerySingle("SELECT SCHEME_VERSION FROM M_QKAN_VERSION");
	}
